...
assert.match(html,/diamond-1\.ogg/,"첫 번째 배경음악이 연결되어야 합니다.");
assert.match(html,/diamond-2\.ogg/,"두 번째 배경음악이 연결되어야 합니다.");
assert.match(html,/diamond-3\.ogg/,"세 번째 배경음악이 연결되어야 합니다.");
assert.match(html,/assets\/images\/diamond-bg\.webp/,"다이아몬드 게임 전용 배경이 연결되어야 합니다.");
