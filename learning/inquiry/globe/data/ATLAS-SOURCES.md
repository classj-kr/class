...
| atlas-climate.json | Peel, Finlayson & McMahon(2007), 원 논문 부록의 0.1° 래스터 | 원본을 새로 다운로드하고 0.25° 셀 중심으로 최근접 표본화. 원본 1–3 → A(열대), 4–7 → B(건조), 8–16 → C(온대), 17–28 → D(냉대), 29–30 → E(한대). 원본 결측 255 보존. 과거 장기 자료 기반 구분이며 현재 날씨나 실시간 기후 지도가 아님. 다운로드 ZIP SHA-256은 JSON에 기록. |
...
- 기후 원본 이용조건: 저자, CC BY-NC-SA 2.5. 본 기후 격자는 이 자료의 파생물이다.
