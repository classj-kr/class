...
// Tab Navigation Logic
        ...
        (function() {
            const quizData = [
                ...
                { cat: "식 현상", q: "태양-달-지구 순서로 거의 일직선이 될 때 일어날 수 있는 현상은?", ans: 0, opts: ["일식", "월식", "보름달", "상현달"], exp: "해설: 달이 태양과 지구 사이에서 태양빛을 가릴 때 일식이 일어납니다." },
                { cat: "식 현상", q: "태양-지구-달 순서로 거의 일직선이 될 때 일어날 수 있는 현상은?", ans: 1, opts: ["일식", "월식", "삭", "상현달"], exp: "해설: 보름달 무렵 달이 지구의 본그림자를 통과하면 월식이 일어날 수 있습니다." },
                { cat: "식 현상", q: "일식과 월식이 매달 일어나지 않는 주된 이유는?", ans: 3, opts: ["달의 자전 주기와 공전 주기가 같아서", "달의 공전 궤도가 원이 아니라 타원이어서", "지구의 자전축이 약 23.5° 기울어져 있어서", "달의 공전 궤도면이 황도면과 약 5° 기울어져 있어서"], exp: "해설: 달의 공전 궤도면은 황도면에 대해 약 5° 기울어져 있어 대부분의 삭과 망에는 세 천체가 정확히 일직선이 되지 않습니다." },
