(function () {
  ...
  function create(api) {
    ...
    function render() {
      ...
      <article class="visual-lesson"><div class="visual-heading"><div><p class="lesson-label">${esc(d.themes[current.topic].label)} · 그림으로 이해하기</p><h2>${esc(current.title)}</h2></div><div class="visual-actions"><button class="quick-practice" id="quickPractice">그림 문제</button><button class="mask-button" id="maskConcept" aria-pressed="false">이름 가리기</button></div></div><div id="lessonDiagram"></div>
