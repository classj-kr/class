  ...
  const ROOM_QUIZZES = {
    ...
    shape:{
      ...
      questions:[
        ...
        {q:'김홍도의 〈무동〉에서 음악과 춤의 흥을 시각적으로 보여 주는 것은?',options:['연주자와 춤꾼의 둥근 흐름','곧게 뻗은 세로줄 무늬','빈 화면 한가운데의 사각형'],answer:0,explain:'악사들의 둥근 배치와 무동의 휘어진 소매가 이어져 흥겨운 장단을 눈으로 느끼게 해요.'},
    ...
    space:{
      ...
      questions:[
        ...
        {q:'얀 반 에이크의 〈아르놀피니 부부의 초상〉에서 부부의 등 뒤 볼록거울에 비친 것은?',options:['방 안 전체와 화가의 뒷모습','창밖 풍경','다른 손님들의 얼굴'],answer:0,explain:'볼록거울에 방 안 전체와 그림을 그리는 화가의 모습까지 작게 비쳐 화면 속에 또 다른 공간이 열려요.'},
        {q:'정선의 〈금강전도〉는 어떤 시점에서 금강산을 그렸을까요?',options:['하늘 위에서 내려다보는 부감법','가까이 다가가 확대해서 보는 시점','땅 아래에서 올려다보는 시점'],answer:0,explain:'하늘 높이 떠서 내려다보듯 봉우리 전체를 한 화면에 담아 깊은 공간감을 만들었어요.'},
        {q:'카날레토의 〈베네치아 대운하〉에서 운하가 실제처럼 깊어 보이는 까닭은?',options:['건축물 선들이 정확한 선원근법으로 그려져서','인물들을 화면 전체에 가득 채워서','하늘과 물만 크게 그려서'],answer:0,explain:'건물의 창문과 다리 난간까지 정확한 선원근법으로 그려 운하가 실제처럼 깊게 뻗어 나가요.'},
        {q:'카라바조의 〈엠마오의 저녁 식사〉에서 인물의 놀란 몸짓이 특히 강조되는 방법은?',options:['팔이 액자 밖으로 튀어나올 듯한 단축법과 강한 명암','배경을 화려한 색으로 채워서','인물을 아주 작게 그려서'],answer:0,explain:'팔을 벌린 순간을 단축법으로 그리고 강한 빛과 그림자를 써서 인물이 화면 앞으로 튀어나오는 듯한 깊이를 만들어요.'}
      ]
    }
  };
