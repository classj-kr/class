...
function build(kind: TranscendentalIntegralKind, next: () => number, id: string): TranscendentalIntegralProblem {
  ...
  if (kind === "natural-exponential") {
    ...
    return { id, kind, prompt: "부정적분을 구하세요.", label: "자연지수함수의 역미분", latex: `\\int ${integrand}e^{${argument}}\\,dx`, answerLatex: answer,
  ...
  if (kind === "general-exponential") {
    ...
    return { id, kind, prompt: "부정적분을 구하세요.", label: "지수함수의 역미분", latex: `\\int ${integrand}\\cdot${base}^{${argument}}\\,dx`, answerLatex: answer,
  ...
  if (kind === "log-derivative") {
    ...
    return { id, kind, prompt: "부정적분을 구하세요.", label: "로그미분형의 역미분", latex: `\\int \\dfrac{${numerator}}{${argument}}\\,dx`, answerLatex: answer,
  ...
  if (kind === "sine-linear") {
    ...
    return { id, kind, prompt: "부정적분을 구하세요.", label: "사인함수의 역미분", latex: `\\int ${integrand}\\sin(${argument})\\,dx`, answerLatex: answer,
  ...
  if (kind === "cosine-linear") {
    ...
    return { id, kind, prompt: "부정적분을 구하세요.", label: "코사인함수의 역미분", latex: `\\int ${integrand}\\cos(${argument})\\,dx`, answerLatex: answer,
  ...
  return { id, kind, prompt: "부정적분을 구하세요.", label: "치환이 필요한 지수함수", latex: `\\int ${integrand}x e^{${exponent}}\\,dx`, answerLatex: answer,
