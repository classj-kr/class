const CHAPTERS = [
        ...
        beats: [
            {
                ...
                emoji: "🌊",
                left: [
                    "옛날 북쪽 땅 부여에 금와라는 임금이 있었습니다. 넓은 들과 큰 강을 낀 힘센 나라였지요.",
                    "어느 날 금와왕이 사냥을 나갔다가 강가에서 걸음을 딱 멈추었어요.",
                    "물가에 한 여인이 혼자 서 있었지요.",
                    "옷차림이 여느 사람과 아주 달랐거든요."
                ],
                right: [
                    "\"거기 누구요?\"",
                    "\"저는 강을 다스리는 하백의 딸 유화라 합니다.\"",
                    "금와왕은 그 여인을 궁으로 데려왔어요. 궁 안 사람들이 저마다 신기해하며 몰려들었지요.",
                    "그런데 그날부터 이상한 일이 시작되었답니다."
                ]
            },
            {
                ...
                right: [
                    ...
                    "어른 머리통만 한 알이 방바닥에 덩그러니 놓여 있었지요.",
                    "\"이런 괴이한 일이 있나!\"",
                    "금와왕이 상을 밀치며 벌떡 일어나 소리쳤답니다."
                ]
            },
            {
                art: "03-throw.webp",
                emoji: "🐖",
                left: [
                    "금와왕은 그 알을 돼지우리에 던져 버렸어요.",
                    "좋지 못한 일이 생길까 겁이 난 것이었지요.",
                    "그런데 돼지들이 알을 밟지 않고 빙 둘러 피해 다녔어요.",
                    "오히려 주둥이로 알을 살살 밀어 마른 자리로 옮겨 주었답니다."
                ],
                right: [
                    "들판에 내다 버렸더니 소와 말이 비켜 갔어요. 숲에 두었더니 새들이 날개로 덮어 주었습니다.",
                    "금와왕은 그 말을 듣고 점점 겁이 났지요.",
                    "\"…도로 가져다주어라.\"",
                    "결국 알은 유화의 품으로 돌아왔답니다."
                ]
            },
            {
                art: "04-hatch.webp",
                emoji: "👶",
                left: [
                    "유화가 알을 품에 안고 아랫목에 이불을 깔았어요. 그러고는 알을 조심스레 뉘었지요.",
                    "얼마 지나지 않아 쩍— 하고 소리가 났습니다.",
                    "금이 사방으로 쭉쭉 뻗어 나갔어요.",
                    "껍데기가 갈라지더니 사내아이가 나왔지요."
                ],
                right: [
                    "눈이 크고 이마가 시원하게 훤히 넓은 아이였어요.",
                    "갓난아이인데도 눈빛이 또렷했지요.",
                    "\"내 아들이구나.\"",
                    "유화가 아이를 두 팔로 꼭 안았습니다.",
                    "아이가 유화를 보고 방긋 웃었답니다. 방 안이 환해지는 것 같았지요."
                ]
            },
            {
                art: "05-bow.webp",
                ...
                left: [
                    ...
                    "나뭇가지를 휘어 시위를 팽팽하게 매었지요.",
                    "그런데 그 활로 쏘았다 하면 백발백중이지 뭐예요.",
                    "파리가 앉은 자리도 그대로 맞힐 정도였어요. 어른들도 그렇게는 못 쏘았지요."
                ],
                right: [
                    "\"저 아이 좀 보아라!\"",
                    "동네 어른들이 저마다 혀를 내둘렀지요. 부여 말로 활 잘 쏘는 사람을 주몽이라 했어요.",
                    "그래서 아이의 이름이 주몽이 되었답니다.",
                    "부여 사람들이 그 이름을 부르며 무척 좋아했지요."
                ]
            }
        ]
    },
    {
        num: 2,
        title: "2장 · 마구간의 말 한 마리",
        beats: [
            {
                art: "06-princes.webp",
                emoji: "😠",
                left: [
                    "금와왕에게는 아들이 일곱이나 줄줄이 있었어요.",
                    "다들 활 솜씨를 뽐내며 자랑하는 왕자들이었지요.",
                    "그런데 활을 쏘았다 하면 번번이 주몽에게 졌습니다.",
                    "활쏘기 시합만 열리면 형제들이 얼굴을 들지 못했답니다."
                ],
                right: [
                    "\"저놈 하나 때문에 우리가 온통 우스워진다.\"",
                    "맏이 대소가 부드득부드득 이를 갈았어요. 소매 속에서 주먹을 부르르 떨었지요.",
                    "\"아버님께 말씀드려야겠다.\"",
                    "일곱 형제가 하나같이 고개를 끄덕였답니다."
                ]
            },
            {
                art: "07-stable.webp",
                emoji: "🐎",
                left: [
                    "왕자들이 어찌나 조르는지 금와왕도 당해 내지 못했어요.",
                    "주몽은 그길로 궁 뒤 마구간으로 보내졌지요.",
                    "날마다 말똥을 치우고 말 먹이를 나르는 일이었습니다.",
                    "새벽부터 밤까지 냄새가 코를 찌르는 일이었답니다."
                ],
                right: [
                    "\"저런 일이나 하다 늙으라지.\"",
            ...
            },
            {
                ...
                emoji: "📌",
                left: [
                    "그러던 어느 날 주몽의 눈에 말 한 마리가 띄었어요. 다리가 길고 눈빛이 반짝이는 말이었지요.",
                    "먹이를 먹을 때도 목을 꼿꼿이 세우고 있었습니다.",
                    "'저 말이다.'",
            ...
            },
            {
                ...
                emoji: "🎁",
                left: [
                    "얼마 뒤 금와왕이 마구간을 둘러보러 나왔어요.",
                    "말들이 하나같이 윤이 나고 살이 올라 있었지요.",
                    "금와왕은 살진 말들을 왕자들에게 나누어 주었습니다.",
                    "왕자들이 서로 좋은 말을 먼저 골라 가겠다고 다투었어요."
                ],
                right: [
                    "그러고는 구석에 선 비쩍 마른 말을 가리켰지요.",
                    "\"저건 네가 가져라.\"",
                    "뼈만 앙상하게 남은 그 말이었어요. 주몽은 고개를 숙여 공손히 절했습니다.",
                    "'됐다!'",
                    "그러면서도 겉으로는 조금도 내색하지 않았답니다."
                ]
            },
            {
                art: "10-secret.webp",
                emoji: "🌙",
                left: [
                    "그날 밤, 아무도 보지 않는 캄캄한 밤이었어요. 주몽이 말의 입을 벌리고 혀 밑을 살폈지요.",
                    "그러고는 꽂아 두었던 바늘을 쏙 뽑았습니다.",
                    "말이 고개를 쳐들고 크게 한 번 울었어요.",
                    "그 소리가 마구간을 쩌렁쩌렁 울렸답니다."
                ],
                right: [
                    "말은 며칠 만에 살이 오르기 시작했어요. 주몽이 달빛 아래에서 시험 삼아 달려 보았지요.",
                    "바람보다 빨랐습니다.",
                    "주몽은 말의 목을 쓰다듬으며 빙그레 웃었어요.",
                    "부여에서 그 말을 따라올 말은 없었답니다."
                ]
            }
        ]
    },
    {
        ...
        beats: [
            {
                ...
                emoji: "🌫️",
                left: [
                    "어느 밤 어머니 유화가 주몽을 흔들어 깨웠어요. 유화의 얼굴이 하얗게 질려 있었지요.",
                    "\"오늘 밤 저들이 너를 해치려 한다.\"",
                    "\"멀리 가서 네 나라를 세우거라.\"",
                    "유화가 곡식 씨앗 주머니를 품에 안겨 주었습니다.",
                    "보리와 콩과 조가 든 주머니였지요."
                ],
                right: [
                    "부여에는 두고 가야 할 아내가 있었어요. 아내는 아이를 가진 몸이었지요.",
                    "주몽은 차고 있던 칼을 반으로 꺾었습니다.",
                    "그러고는 한 쪽을 아내에게 쥐여 주었어요.",
                    "\"아이가 자라거든 이것을 들려 보내시오.\"",
                    "주몽은 그 말만 남기고 돌아섰답니다."
                ]
            },
            {
                ...
                emoji: "🐟",
                left: [
                    "주몽은 벗 셋을 데리고 성을 빠져나갔어요. 오이와 마리와 협보라는 벗들이었지요.",
                    "새벽녘, 앞을 커다란 강이 떡 가로막았습니다.",
                    "물살이 사납고 건널 배 한 척 없었어요.",
                    "뒤에서는 말발굽 소리가 점점 가까워졌답니다."
                ],
                right: [
                    "이제 더는 물러설 데가 없었어요. 주몽이 두 팔을 들고 강물을 향해 크게 외쳤습니다.",
                    "\"나는 하늘의 손자요, 하백의 외손이다!\"",
                    "\"부디 길을 열어 다오!\"",
                    "주몽의 목소리가 강 건너까지 쩌렁쩌렁 울렸답니다."
                ]
            },
            {
                art: "13-bridge.webp",
                ...
                left: [
                    "그러자 강물이 부글부글 끓어올랐어요.",
                    "물살이 쫙 갈라지며 무언가가 떠올랐지요.",
                    "물고기와 자라가 떼로 떠올라 등을 척척 맞대었습니다.",
                    "금세 강을 가로지르는 다리 하나가 떡 하니 놓였어요. 등딱지가 반들반들 빛났답니다."
                ],
                right: [
                    "말발굽 소리가 바로 등 뒤까지 와 있었어요. 네 사람은 그 등을 밟고 강을 건넜습니다.",
                    "다 건너자 다리는 스르르 흩어져 버렸지요.",
                    "쫓아온 군사들은 강가에서 발만 굴렀어요.",
                    "끝내 아무도 그 강을 건너지 못했답니다."
                ]
            },
            {
                art: "14-jolbon.webp",
                emoji: "🏕️",
                left: [
                    "여러 날을 걸어 주몽은 졸본이라는 땅에 닿았어요.",
                    "산이 험하고 물이 맑은 곳이었지요.",
                    "널찍한 들이 강을 따라 펼쳐져 있었습니다.",
                    "곡식을 심으면 아주 잘 자랄 것 같았어요. 주몽이 흙을 한 줌 쥐어 보았답니다."
                ],
                right: [
                    "\"여기다.\"",
                    "주몽이 품에서 어머니가 준 씨앗 주머니를 꺼냈어요.",
                    "그러고는 그것을 들에 골고루 뿌렸지요.",
                    "나라 이름은 고구려라 했습니다.",
                    "높고 큰 나라가 되라는 뜻이었어요. 벗 셋이 손뼉을 쳤답니다."
                ]
            },
            {
                art: "15-yuri.webp",
                emoji: "🗡️",
                left: [
                    "여러 해가 지난 어느 날이었어요. 고구려가 제법 큰 나라가 된 뒤였지요.",
                    "유리라는 소년이 성문 앞에 나타났습니다.",
                    "눈매며 이마며 주몽을 꼭 닮은 소년이었어요.",
                    "소년이 품에서 부러진 칼 반쪽을 조심스레 꺼냈답니다."
                ],
                right: [
                    "\"어머니가 아버지를 찾아가라 하셨습니다.\"",
                    "소년의 목소리가 가늘게 떨렸어요. 주몽이 자리에서 벌떡 일어났지요.",
                    "주몽은 한참 동안 그 소년을 바라보았답니다.",
                    "부여에 두고 온 바로 그 아이였거든요."
                ]
            },
            {
                art: "16-sword.webp",
                emoji: "⚔️",
                left: [
                    "주몽이 제 칼 반쪽을 꺼내 마주 대었습니다.",
                    "부여를 떠나던 날 꺾어 둔 그 반쪽이었지요.",
                    "쩌억— 하고 두 조각이 하나로 척 붙지 뭐예요.",
                    "꺾인 자리가 칼자국 하나 어긋나지 않고 딱 맞았어요. 틈이 보이지 않았답니다."
                ],
                right: [
                    "\"유리로구나.\"",
        ...
        moral: "주몽은 마구간으로 쫓겨났을 때 불평 대신 말을 살폈어요. 가장 낮은 자리에 있는 동안 가장 좋은 말을 알아본 것이지요. 어디에 있느냐보다 그곳에서 무엇을 보고 있느냐가 다음 자리를 만든답니다.",
        question: "하기 싫은 일을 맡았을 때, 그 안에서 배울 만한 것은 무엇이 있을까요?"
    }
];
...
/* 「여기서부터는 진짜 역사」 쪽 — 건국 신화 책에만 있다. */
const HISTORY = {
    title: "여기서부터는 진짜 역사",
    note: "앞까지가 이야기였고, 여기부터는 기록에 남은 사실이에요.",
    paras: [
...
const EN = {
    ...
    words: {
        ...
        "03-throw.webp": [
            ...
            { w: "went round ~ (go)", k: "빙 둘러 피했다", s: "They went round it." },
        ...
        "04-hatch.webp": [
            ...
            { w: "ran out every way (run)", k: "사방으로 뻗었다", s: "The lines ran out every way across it." },
        ...
        "06-princes.webp": [
            ...
            { w: "made much of ~ (make)", k: "뽐냈다", s: "They were princes who made much of their shooting." },
        ...
        "08-needle.webp": [
            { w: "caught ~ eye (catch)", k: "눈에 띄었다", s: "Then one day one horse caught Jumong's eye." },
        ...
        "10-secret.webp": [
            ...
            { w: "called out once (call)", k: "크게 한 번 울었다", s: "The horse lifted its head and called out once, loud." },
        ...
        "12-river.webp": [
            ...
            { w: "ran hard (run)", k: "물살이 사나웠다", s: "The water ran hard and there was not one boat." },
        ...
        "14-jolbon.webp": [
            ...
            { w: "it looked (look)", k: "~ 같았다", s: "Grain would grow well there, it looked." },
        ...
        "15-yuri.webp": [
            ...
            { w: "told me to ~ (tell)", k: "~하라고 하셨다", s: "My mother told me to go and find my father." },
        ...
        "16-sword.webp": [
            { w: "held ~ together (hold)", k: "마주 대었다", s: "Jumong took out his own half and held the two together." },
...
const QUIZ = [
    ...
    { q: "유리가 아버지를 찾아올 때 가져온 것은 무엇인가요?", choices: ["어머니의 편지", "부러진 칼 반쪽", "금으로 만든 활"], answer: 1 },
    {
    ...
    spreads: [
        {
            ...
            left: [
                ...
                "좋은 말 하나만 일부러 여위게 만들고 나머지는 잘 먹여 살을 찌웠습니다. 그래서 왕이 고르고 남은 것을 얻었지요.",
...
const WORDS_KO = {
    ...
    "01-yuhwa.webp": [
        { w: "들", k: "넓고 평평한 땅.", s: "넓은 들과 큰 강을 낀 힘센 나라였지요." },
        { w: "여느", k: "보통의.", s: "옷차림이 여느 사람과 아주 달랐거든요." },
        { w: "다스리다", k: "맡아서 이끌고 살피다.", s: "저는 강을 다스리는 하백의 딸 유화라 합니다." },
        { w: "궁", k: "임금이 사는 큰 집.", s: "금와왕은 그 여인을 궁으로 데려왔어요." }
    ],
    "02-sunlight.webp": [
        { w: "졸졸", k: "바짝 뒤따라 다니는 모양.", s: "햇빛 한 줄기가 유화를 졸졸 따라다녔어요." },
        { w: "발", k: "햇빛을 가리려고 늘어뜨리는 가림막.", s: "방을 옮겨도, 발을 내려도 소용이 없었지요." },
        { w: "궁녀", k: "궁에서 일하던 여자.", s: "궁녀들이 무서워 곁에도 가지 못했어요." },
        { w: "덩그러니", k: "홀로 놓여 있는 모양.", s: "어른 머리통만 한 알이 방바닥에 덩그러니 놓여 있었지요." },
        { w: "괴이하다", k: "이상하고 야릇하다.", s: "이런 괴이한 일이 있나!" }
    ],
    "03-throw.webp": [
        { w: "돼지우리", k: "돼지를 가두어 기르는 곳.", s: "금와왕은 그 알을 돼지우리에 던져 버렸어요." },
        { w: "주둥이", k: "짐승의 뾰족한 입.", s: "주둥이로 알을 살살 밀어 마른 자리로 옮겨 주었답니다." },
        { w: "비켜 가다", k: "옆으로 피해 지나가다.", s: "들판에 내다 버렸더니 소와 말이 비켜 갔어요." }
    ],
    "04-hatch.webp": [
        { w: "아랫목", k: "방에서 불기가 닿아 따뜻한 쪽.", s: "유화가 알을 품에 안고 아랫목에 이불을 깔았어요." },
        { w: "뉘다", k: "눕히다.", s: "그러고는 알을 조심스레 뉘었지요." },
        { w: "사방", k: "온 둘레.", s: "금이 사방으로 쭉쭉 뻗어 나갔어요." },
        { w: "껍데기", k: "겉을 싸고 있는 단단한 것.", s: "껍데기가 갈라지더니 사내아이가 나왔지요." },
        { w: "또렷하다", k: "흐리지 않고 분명하다.", s: "갓난아이인데도 눈빛이 또렷했지요." },
        { w: "방긋", k: "소리 없이 예쁘게 웃는 모양.", s: "아이가 유화를 보고 방긋 웃었답니다." }
    ],
    "05-bow.webp": [
        { w: "시위", k: "활에 걸어 당기는 줄.", s: "나뭇가지를 휘어 시위를 팽팽하게 매었지요." },
        { w: "백발백중", k: "쏘는 대로 다 맞히는 것.", s: "그 활로 쏘았다 하면 백발백중이지 뭐예요." },
        { w: "혀를 내두르다", k: "몹시 놀라 감탄하다.", s: "동네 어른들이 저마다 혀를 내둘렀지요." }
    ],
    "06-princes.webp": [
        { w: "줄줄이", k: "여럿이 줄을 지어.", s: "금와왕에게는 아들이 일곱이나 줄줄이 있었어요." },
        { w: "뽐내다", k: "자랑하며 으스대다.", s: "다들 활 솜씨를 뽐내며 자랑하는 왕자들이었지요." },
        { w: "번번이", k: "그때마다 늘.", s: "활을 쏘았다 하면 번번이 주몽에게 졌습니다." },
        { w: "맏이", k: "맨 먼저 태어난 사람.", s: "맏이 대소가 부드득부드득 이를 갈았어요." },
        { w: "이를 갈다", k: "분해서 두고 보자고 벼르다.", s: "맏이 대소가 부드득부드득 이를 갈았어요." }
    ],
    "07-stable.webp": [
        { w: "조르다", k: "자꾸 해 달라고 보채다.", s: "왕자들이 어찌나 조르는지" },
        { w: "당해 내다", k: "맞서서 견뎌 내다.", s: "금와왕도 당해 내지 못했어요." },
        { w: "마구간", k: "말을 매어 기르는 곳.", s: "주몽은 그길로 궁 뒤 마구간으로 보내졌지요." },
        { w: "군말", k: "하지 않아도 될 불평.", s: "주몽은 군말 없이 묵묵히 일했습니다." },
        { w: "묵묵히", k: "말없이 꾸준하게.", s: "주몽은 군말 없이 묵묵히 일했습니다." },
        { w: "유심히", k: "눈여겨 마음을 두고.", s: "대신 말 한 마리 한 마리를 유심히 살폈지요." }
    ],
    "08-needle.webp": [
    ...
    "09-gift.webp": [
        { w: "윤", k: "매끄럽게 도는 빛.", s: "말들이 하나같이 윤이 나고 살이 올라 있었지요." },
        { w: "살지다", k: "살이 올라 통통하다.", s: "금와왕은 살진 말들을 왕자들에게 나누어 주었습니다." },
        { w: "앙상하다", k: "살이 빠져 뼈만 남다.", s: "뼈만 앙상하게 남은 그 말이었어요." },
        { w: "공손히", k: "예의 바르고 겸손하게.", s: "주몽은 고개를 숙여 공손히 절했습니다." },
        { w: "내색하다", k: "속마음을 겉으로 드러내다.", s: "겉으로는 조금도 내색하지 않았답니다." }
    ],
    "10-secret.webp": [
        { w: "쩌렁쩌렁", k: "소리가 크게 울리는 모양.", s: "그 소리가 마구간을 쩌렁쩌렁 울렸답니다." },
        { w: "시험 삼아", k: "어떤지 알아보려고.", s: "주몽이 달빛 아래에서 시험 삼아 달려 보았지요." },
        { w: "쓰다듬다", k: "손으로 부드럽게 문지르다.", s: "주몽은 말의 목을 쓰다듬으며 빙그레 웃었어요." }
    ],
    "11-flee.webp": [
        { w: "질리다", k: "놀라 얼굴빛이 하얗게 변하다.", s: "유화의 얼굴이 하얗게 질려 있었지요." },
        { w: "해치다", k: "다치게 하거나 죽이려 하다.", s: "오늘 밤 저들이 너를 해치려 한다." },
        { w: "씨앗", k: "심어서 싹이 나게 하는 알.", s: "유화가 곡식 씨앗 주머니를 품에 안겨 주었습니다." },
        { w: "조", k: "알이 아주 작은 곡식.", s: "보리와 콩과 조가 든 주머니였지요." },
        { w: "꺾다", k: "부러뜨리다.", s: "주몽은 차고 있던 칼을 반으로 꺾었습니다." }
    ],
    "12-river.webp": [
        { w: "벗", k: "친구.", s: "주몽은 벗 셋을 데리고 성을 빠져나갔어요." },
        { w: "새벽녘", k: "새벽 무렵.", s: "새벽녘, 앞을 커다란 강이 떡 가로막았습니다." },
        { w: "가로막다", k: "앞을 막아서다.", s: "앞을 커다란 강이 떡 가로막았습니다." },
        { w: "물살", k: "물이 흐르는 힘.", s: "물살이 사납고 건널 배 한 척 없었어요." },
        { w: "척", k: "배를 세는 말.", s: "물살이 사납고 건널 배 한 척 없었어요." },
        { w: "말발굽", k: "말의 단단한 발끝.", s: "뒤에서는 말발굽 소리가 점점 가까워졌답니다." },
        { w: "외손", k: "딸이 낳은 자식.", s: "나는 하늘의 손자요, 하백의 외손이다!" }
    ],
    "13-bridge.webp": [
        { w: "부글부글", k: "물이 끓어오르는 모양.", s: "그러자 강물이 부글부글 끓어올랐어요." },
        { w: "떼", k: "여럿이 모인 무리.", s: "물고기와 자라가 떼로 떠올라 등을 척척 맞대었습니다." },
        { w: "가로지르다", k: "이쪽에서 저쪽으로 질러 가다.", s: "금세 강을 가로지르는 다리 하나가 떡 하니 놓였어요." },
        { w: "등딱지", k: "자라나 거북의 딱딱한 등.", s: "등딱지가 반들반들 빛났답니다." },
        { w: "흩어지다", k: "여기저기 따로 떨어지다.", s: "다 건너자 다리는 스르르 흩어져 버렸지요." },
        { w: "발을 구르다", k: "안타까워 어쩔 줄 몰라 하다.", s: "쫓아온 군사들은 강가에서 발만 굴렀어요." }
    ],
    "14-jolbon.webp": [
        { w: "험하다", k: "가파르고 다니기 어렵다.", s: "산이 험하고 물이 맑은 곳이었지요." },
        { w: "널찍하다", k: "꽤 넓다.", s: "널찍한 들이 강을 따라 펼쳐져 있었습니다." },
        { w: "골고루", k: "빠짐없이 고르게.", s: "그러고는 그것을 들에 골고루 뿌렸지요." }
    ],
    "15-yuri.webp": [
        { w: "눈매", k: "눈이 생긴 모양새.", s: "눈매며 이마며 주몽을 꼭 닮은 소년이었어요." }
    ],
    "16-sword.webp": [
        { w: "마주 대다", k: "서로 맞대다.", s: "주몽이 제 칼 반쪽을 꺼내 마주 대었습니다." },
        { w: "어긋나다", k: "서로 맞지 않고 비뚤어지다.", s: "꺾인 자리가 칼자국 하나 어긋나지 않고 딱 맞았어요." },
        { w: "그렁그렁", k: "눈에 눈물이 가득 고인 모양.", s: "주몽의 두 눈에 눈물이 그렁그렁 맺혔어요." }
    ],
    "after": [
        { w: "여위다", k: "살이 빠져 마르다.", s: "좋은 말 하나만 일부러 여위게 만들고" },
        { w: "대목", k: "이야기 가운데 어느 한 부분.", s: "부러진 칼 반쪽을 아내에게 남긴 대목도 눈여겨볼 만합니다." },
        { w: "불평", k: "마음에 들지 않는다고 늘어놓는 말.", s: "주몽은 마구간으로 쫓겨났을 때 불평 대신 말을 살폈습니다." }
    ]
};
