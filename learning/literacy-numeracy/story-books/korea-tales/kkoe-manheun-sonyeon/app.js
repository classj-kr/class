        ...
        beats: [
            {
                ...
                emoji: "🧒",
                left: [
                    "옛날 어느 고을에 꾀 많기로 이름난 소년이 살았어요. 나이는 이제 열두 살이었지요.",
                    "일찍 부모를 잃고 삼촌 집에 얹혀살았어요. 집은 몹시 가난했지요.",
                    "글을 배운 적도 없었어요.",
                    "그런데도 어른 열이 못 푸는 것을 척척 풀어냈답니다."
                ],
                right: [
                    "장터에 나가면 어른들이 소년을 붙들었어요.",
                    "\"얘야, 이 셈 좀 맞춰 보아라.\"",
                    "\"우리 집 소가 어디로 갔는지도 알겠느냐?\"",
                    "소년은 그때마다 씩 웃고는 답을 내놓았어요.",
                    "\"머리 하나는 정말 좋다니까.\"",
                    "마을 사람들이 혀를 내둘렀답니다."
                ]
            },
            {
                ...
                emoji: "📜",
                left: [
                    "어느 날 이웃 나라 임금이 보낸 사신이 찾아왔어요. 원님이 있는 관아 마당에 관리들이 죽 늘어섰지요.",
                    "사신이 두루마리를 척 펼쳤어요. 두루마리가 제 키만큼 길었지요.",
                    "\"여기 세 가지 문제가 있소.\"",
                    "마당이 조용해졌어요."
                ],
                right: [
                    "\"사흘 안에 다 풀지 못하면, 이 나라에는 지혜로운 이가 없다고 하겠소.\"",
                    "사신의 목소리에 비웃음이 섞여 있었어요.",
                    "원님의 얼굴이 굳어졌어요. 신하들은 서로 눈치만 보았지요.",
                    "아무도 나서지 않았답니다."
                ]
            },
            {
                ...
                emoji: "🪢",
                left: [
                    "관리 하나가 목청을 가다듬고 첫 번째 문제를 읽었어요.",
                    "\"재로 꼰 새끼줄을 가져오시오.\"",
                    "읽은 관리도 무슨 소린지 몰라 두루마리를 다시 들여다보았어요.",
                    "재라니요. 손에 쥐면 바스러지는 그 재 말입니다."
                ],
                right: [
                    "관아 마당이 벌집 쑤신 듯 술렁였어요.",
                    "\"재로 새끼를 꼰다고?\"",
                    "\"재가 손에 잡히기나 하나!\"",
                    "\"저건 사람더러 하라는 소리가 아닐세.\"",
                    "관리들이 서로 얼굴만 쳐다보았어요. 아무도 손을 들지 못했답니다."
                ]
            },
            {
                art: "04-solve1.webp",
                emoji: "🔥",
                left: [
                    "이틀이 지나도록 아무도 답을 내지 못했어요. 원님은 밤새 잠을 이루지 못했지요.",
                    "그때 열두 살짜리가 짚 한 단을 안고 마당으로 들어섰어요.",
                    "\"저 꼬마가 뭘 한다고?\"",
                    "소년은 짚단을 마당 한가운데에 척 내려놓았지요."
                ],
                right: [
                    "소년은 짚을 아주 굵고 단단하게 꼬았어요. 그것을 쟁반에 얹고 불을 붙였습니다.",
                    "치이익— 불이 새끼를 따라 천천히 기어갔어요.",
                    "불이 꺼지자 새끼줄 모양 그대로 재가 남아 있었지요.",
                    "사람들이 우르르 모여들었답니다."
                ]
            }
        ]
        ...
        beats: [
            {
                ...
                emoji: "🔵",
                left: [
                    "사신의 눈이 휘둥그레졌어요. 사신은 헛기침을 두어 번 했지요.",
                    "\"좋소. 그럼 두 번째 문제요.\"",
                    "처음보다 목소리가 한결 낮아져 있었지요. 비웃음도 가셨어요.",
                    "사신이 손바닥에 작고 매끄러운 구슬 하나를 올려놓았습니다."
                ],
                right: [
                    "구슬은 밤톨만 했어요. 겉이 반들반들해서 빛이 미끄러졌지요.",
                    "\"이 구슬 속 구멍은 아홉 번이나 굽어 있소.\"",
                    "\"여기에 실을 꿰어 보시오.\"",
                    "사신이 실 한 오라기를 내밀었어요.",
                    "실은 머리카락처럼 가늘었답니다."
                ]
            },
            {
                ...
                emoji: "😖",
                left: [
                    "어른들이 번갈아 달려들었어요. 누구도 물러서지 않았지요.",
                    "실을 밀어 넣어 보고, 가는 대를 넣어 보고, 입으로 후 불어도 보았어요.",
                    "물에 적셔 넣는 사람도 있었지요.",
                    "하지만 실은 첫 굽이도 넘지 못했어요."
                ],
                right: [
                    "넣으면 도로 빠져나오고, 또 넣으면 또 빠져나왔어요. 해가 기울도록 그 짓만 되풀이했지요.",
                    "\"이건 사람이 할 수 있는 일이 아니오.\"",
                    "원님의 이마에 땀이 맺혔어요.",
                    "사신은 팔짱을 끼고 그 꼴을 지켜보았답니다."
                ]
            },
            {
                art: "07-ant.webp",
                emoji: "🐜",
                left: [
                    "소년은 마당 구석에 쪼그리고 앉았어요. 다들 소년이 포기한 줄 알았지요.",
                    "그런데 소년은 땅바닥만 들여다보고 있었어요.",
                    "그러더니 기어가던 개미 한 마리를 살며시 집어 들었습니다.",
                    "개미가 다리를 버둥거렸지요."
                ],
                right: [
                    "소년이 가느다란 실을 개미 허리에 조심조심 매었어요.",
                    "실이 개미 허리보다도 훨씬 가늘었지요.",
                    "\"쉿. 다들 숨도 쉬지 말고 가만있어 보시오.\"",
                    "사람들이 목을 길게 빼고 들여다보았어요. 숨소리도 나지 않았답니다."
                ]
            },
            {
                art: "08-honey.webp",
                emoji: "🍯",
                left: [
                    "소년은 구슬 한쪽 구멍에 꿀을 살짝 발랐어요.",
                    "그리고 반대쪽 구멍에 개미를 살그머니 놓아 주었습니다. 개미가 쏙 들어갔지요.",
                    "꿀 냄새가 구멍 속으로 솔솔 퍼졌어요.",
                    "하나, 둘, 셋… 소년이 손가락으로 헤아렸지요."
                ],
                right: [
                    "마당이 쥐 죽은 듯 조용해졌어요. 다들 구슬만 보았지요.",
                    "개미가 굽이를 하나 지나고, 둘 지나고, 셋 지났어요.",
                    "그때 반대쪽 구멍에서 까만 더듬이가 쏙 나왔습니다.",
                    "\"나왔다! 나왔어!\"",
                    "구슬에 실이 꿰여 있었답니다."
                ]
            }
        ...
        beats: [
            {
                ...
                emoji: "🪵",
                left: [
                    "사신의 얼굴이 붉어졌어요. 소년을 보는 눈빛이 아까와 달라져 있었지요.",
                    "\"마지막 문제요!\"",
                    "목소리가 아까보다 훨씬 컸지요. 지지 않겠다는 소리였어요.",
                    "사신이 껍질을 말끔히 벗긴 통나무 하나를 내놓았습니다."
                ],
                right: [
                    "어른이 두 팔로 안아야 할 만큼 굵은 나무였어요.",
                    "\"이 나무의 위와 아래를 가려 보시오.\"",
                    "굵기가 어디나 똑같아 도무지 알 수가 없었어요. 관리들이 나무를 이리 굴리고 저리 굴려 보았지요.",
                    "굴려 봐야 그게 그것이었답니다."
                ]
            },
            {
                ...
                emoji: "💧",
                left: [
                    "소년은 물을 가득 채운 통을 가져다 달라고 했어요.",
                    "장정 넷이 낑낑거리며 통을 들고 왔지요. 물이 찰랑찰랑 넘쳤어요.",
                    "소년이 그 통나무를 물속에 가만히 눕혔습니다.",
                    "모두가 숨을 죽이고 통나무만 들여다보았어요."
                ],
                right: [
                    "한참 뒤, 나무 한쪽이 슬며시 기울기 시작했어요.",
                    "천천히, 아주 천천히 기울었지요.",
                    "\"뿌리 쪽이 더 촘촘하고 무겁습니다.\"",
                    "\"가라앉는 쪽이 아래입니다.\"",
                    "소년이 그쪽을 손으로 가리켰어요. 사신의 입이 딱 벌어졌답니다."
                ]
            },
            {
                art: "11-bow.webp",
                emoji: "🙇",
                left: [
                    "사신은 한참 동안 아무 말도 하지 못했어요.",
                    "얼굴이 붉어졌다 하얘졌다 했지요. 손끝이 떨렸어요.",
                    "그러더니 열두 살짜리 앞에 정중히 고개를 숙였습니다.",
                    "관아 마당이 물을 끼얹은 듯 조용해졌지요. 다들 숨을 죽였어요."
                ],
                right: [
                    "\"이 나라에는 지혜로운 이가 있소.\"",
                    "사신의 목소리가 아까와 달리 아주 공손해졌어요.",
                    "\"돌아가 그대로 아뢰겠소.\"",
                    "관아 마당에 와— 하고 함성이 터졌어요. 원님이 달려와 소년의 손을 덥석 붙잡았답니다."
                ]
            },
            {
                art: "12-school.webp",
                emoji: "📖",
                left: [
                    "원님이 소년을 불렀어요. 금이든 비단이든 다 줄 참이었지요.",
                    "\"무엇이든 말해 보아라. 상을 내리마.\"",
                    "모두가 소년의 입을 쳐다보았어요. 무엇을 달라고 할지 궁금했거든요.",
                    "소년은 한참을 생각하다가 입을 열었지요."
                ],
                right: [
                    "\"마을에 글 배우는 서당을 하나 지어 주십시오.\"",
                    "원님이 눈을 크게 떴어요.",
                    "\"저 말고도 배우고 싶은 아이가 많거든요.\"",
                    "소년은 글을 배운 적이 없었어요. 그런데 상으로 글방을 달라고 했지요.",
                    "이듬해 봄, 그 마을에 서당이 섰답니다."
                ]
            }
        ],
        moral: "소년이 푼 세 문제는 힘으로도 재주로도 되지 않는 것이었어요. 다만 다르게 생각했을 뿐이지요. 안 된다고 여기는 순간 길이 막히고, 다른 쪽에서 보는 순간 길이 열린답니다.",
        question: "안 된다고 여겼던 일을 다른 방법으로 풀어 본 적이 있나요?"
    }
];
...
const WORDS_KO = {
    "cover": [
        { w: "쩔쩔매다", k: "어쩔 줄 몰라 애를 태우다.", s: "어른들이 쩔쩔매는 어려운 문제를 아이가 풀어내는 이야기" },
        { w: "갈래", k: "같은 줄기에서 나뉜 무리.", s: "아이가 풀어내는 이야기 갈래에 속한답니다." },
    ...
    "01-boy.webp": [
        ...
        { w: "얹혀살다", k: "남의 집에 붙어살다.", s: "일찍 부모를 잃고 삼촌 집에 얹혀살았어요." },
        { w: "척척", k: "일을 시원스레 해내는 모양.", s: "어른 열이 못 푸는 것을 척척 풀어냈답니다." },
        { w: "셈", k: "수를 헤아리는 일.", s: "얘야, 이 셈 좀 맞춰 보아라." },
        { w: "혀를 내두르다", k: "몹시 놀라 감탄하다.", s: "마을 사람들이 혀를 내둘렀답니다." }
    ],
    "02-envoy.webp": [
        { w: "사신", k: "임금의 심부름으로 다른 나라에 가는 사람.", s: "이웃 나라 임금이 보낸 사신이 찾아왔어요." },
        { w: "원님", k: "옛날 고을을 다스리던 벼슬아치.", s: "원님이 있는 관아 마당에 관리들이 죽 늘어섰지요." },
        { w: "관아", k: "옛날에 고을 일을 보던 관청.", s: "원님이 있는 관아 마당에 관리들이 죽 늘어섰지요." },
        { w: "관리", k: "나라 일을 맡아보던 사람.", s: "관아 마당에 관리들이 죽 늘어섰지요." },
        { w: "두루마리", k: "길게 말아 놓은 종이.", s: "사신이 두루마리를 척 펼쳤어요." },
        { w: "지혜롭다", k: "슬기롭고 밝다.", s: "이 나라에는 지혜로운 이가 없다고 하겠소." },
        { w: "눈치를 보다", k: "남의 기색을 살피다.", s: "신하들은 서로 눈치만 보았지요." }
    ],
    "03-first.webp": [
        { w: "가다듬다", k: "흐트러진 것을 바로잡다.", s: "관리 하나가 목청을 가다듬고 첫 번째 문제를 읽었어요." },
        { w: "꼬다", k: "여러 가닥을 비벼 감다.", s: "재로 꼰 새끼줄을 가져오시오." },
        { w: "바스러지다", k: "부스러져 잘게 깨지다.", s: "손에 쥐면 바스러지는 그 재 말입니다." },
        { w: "술렁이다", k: "여럿이 어수선하게 떠들다.", s: "관아 마당이 벌집 쑤신 듯 술렁였어요." }
    ],
    "04-solve1.webp": [
        { w: "잠을 이루다", k: "잠이 들다.", s: "원님은 밤새 잠을 이루지 못했지요." },
        { w: "짚단", k: "짚을 묶어 놓은 단.", s: "소년은 짚단을 마당 한가운데에 척 내려놓았지요." },
        { w: "쟁반", k: "그릇을 받쳐 드는 넓적한 그릇.", s: "그것을 쟁반에 얹고 불을 붙였습니다." },
        { w: "우르르", k: "여럿이 한꺼번에 몰리는 모양.", s: "사람들이 우르르 모여들었답니다." }
    ],
    "05-second.webp": [
        { w: "휘둥그레지다", k: "놀라서 눈이 커지다.", s: "사신의 눈이 휘둥그레졌어요." },
        { w: "헛기침", k: "일부러 하는 기침.", s: "사신은 헛기침을 두어 번 했지요." },
        { w: "한결", k: "눈에 띄게 훨씬.", s: "처음보다 목소리가 한결 낮아져 있었지요." },
        { w: "가시다", k: "있던 것이 없어지다.", s: "비웃음도 가셨어요." },
        { w: "밤톨", k: "밤 한 알.", s: "구슬은 밤톨만 했어요." },
        { w: "오라기", k: "실이나 끈의 한 가닥.", s: "사신이 실 한 오라기를 내밀었어요." }
    ],
    "06-stuck.webp": [
        { w: "번갈아", k: "차례를 바꾸어 가며.", s: "어른들이 번갈아 달려들었어요." },
        { w: "적시다", k: "물기가 배게 하다.", s: "물에 적셔 넣는 사람도 있었지요." },
        { w: "굽이", k: "휘어 돌아간 곳.", s: "하지만 실은 첫 굽이도 넘지 못했어요." },
        { w: "기울다", k: "해가 저쪽으로 넘어가다.", s: "해가 기울도록 그 짓만 되풀이했지요." },
        { w: "팔짱을 끼다", k: "두 팔을 끼고 보고만 있다.", s: "사신은 팔짱을 끼고 그 꼴을 지켜보았답니다." }
    ],
    "07-ant.webp": [
        { w: "쪼그리다", k: "몸을 웅크려 앉다.", s: "소년은 마당 구석에 쪼그리고 앉았어요." },
        { w: "포기하다", k: "하려던 것을 그만두다.", s: "다들 소년이 포기한 줄 알았지요." },
        { w: "살며시", k: "소리 없이 가만히.", s: "기어가던 개미 한 마리를 살며시 집어 들었습니다." },
        { w: "버둥거리다", k: "팔다리를 마구 놀리다.", s: "개미가 다리를 버둥거렸지요." },
        { w: "목을 빼다", k: "보려고 목을 길게 내밀다.", s: "사람들이 목을 길게 빼고 들여다보았어요." }
    ],
    "08-honey.webp": [
        { w: "살그머니", k: "남모르게 살짝.", s: "반대쪽 구멍에 개미를 살그머니 놓아 주었습니다." },
        { w: "솔솔", k: "냄새나 바람이 가늘게 퍼지는 모양.", s: "꿀 냄새가 구멍 속으로 솔솔 퍼졌어요." },
        { w: "헤아리다", k: "수를 세다.", s: "소년이 손가락으로 헤아렸지요." },
        { w: "쥐 죽은 듯", k: "아무 소리도 없이 아주 조용한 모양.", s: "마당이 쥐 죽은 듯 조용해졌어요." },
        { w: "더듬이", k: "벌레의 머리에 난 가느다란 뿔.", s: "반대쪽 구멍에서 까만 더듬이가 쏙 나왔습니다." }
    ],
    "09-third.webp": [
        { w: "말끔히", k: "아주 깨끗하게.", s: "사신이 껍질을 말끔히 벗긴 통나무 하나를 내놓았습니다." },
        { w: "통나무", k: "켜지 않은 통째의 나무.", s: "껍질을 말끔히 벗긴 통나무 하나를 내놓았습니다." },
        { w: "가리다", k: "어느 쪽인지 밝혀내다.", s: "이 나무의 위와 아래를 가려 보시오." },
        { w: "도무지", k: "아무리 해도.", s: "굵기가 어디나 똑같아 도무지 알 수가 없었어요." }
    ],
    "10-water.webp": [
        { w: "장정", k: "힘이 좋은 젊은 남자.", s: "장정 넷이 낑낑거리며 통을 들고 왔지요." },
        { w: "찰랑찰랑", k: "물이 넘칠 듯 흔들리는 모양.", s: "물이 찰랑찰랑 넘쳤어요." },
        { w: "슬며시", k: "남모르게 살그머니.", s: "나무 한쪽이 슬며시 기울기 시작했어요." },
        { w: "촘촘하다", k: "사이가 배게 빽빽하다.", s: "뿌리 쪽이 더 촘촘하고 무겁습니다." },
        { w: "가라앉다", k: "물속으로 내려가다.", s: "가라앉는 쪽이 아래입니다." }
    ],
    "11-bow.webp": [
        { w: "정중히", k: "예의를 갖추어 무겁게.", s: "열두 살짜리 앞에 정중히 고개를 숙였습니다." },
        { w: "물을 끼얹은 듯", k: "갑자기 아주 조용해진 모양.", s: "관아 마당이 물을 끼얹은 듯 조용해졌지요." },
        { w: "공손하다", k: "예의 바르고 겸손하다.", s: "사신의 목소리가 아까와 달리 아주 공손해졌어요." },
        { w: "아뢰다", k: "웃어른께 말씀드리다.", s: "돌아가 그대로 아뢰겠소." },
        { w: "함성", k: "여럿이 한꺼번에 지르는 큰 소리.", s: "관아 마당에 와— 하고 함성이 터졌어요." },
        { w: "덥석", k: "갑자기 확 잡는 모양.", s: "원님이 달려와 소년의 손을 덥석 붙잡았답니다." }
    ],
    "12-school.webp": [
        { w: "비단", k: "반들반들 윤이 나는 고운 옷감.", s: "금이든 비단이든 다 줄 참이었지요." },
        { w: "서당", k: "옛날에 글을 가르치던 곳.", s: "마을에 글 배우는 서당을 하나 지어 주십시오." },
        { w: "글방", k: "글을 배우는 방.", s: "그런데 상으로 글방을 달라고 했지요." },
        { w: "이듬해", k: "그다음 해.", s: "이듬해 봄, 그 마을에 서당이 섰답니다." }
    ],
    "after": [
        { w: "학식", k: "배워서 알고 있는 것.", s: "아이가 쓰는 것은 힘도 아니고 학식도 아닙니다." },
        { w: "틀", k: "짜여 있는 테두리.", s: "문제를 낸 사람이 정해 놓은 틀 밖에서 보는 것입니다." },
        { w: "뒤집다", k: "앞뒤를 거꾸로 바꾸다.", s: "소년은 그 순서를 뒤집었습니다." }
    ]
};
