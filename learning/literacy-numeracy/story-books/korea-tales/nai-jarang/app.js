        ...
        beats: [
            {
                ...
                emoji: "🍚",
                left: [
                    "어느 날 여우와 사슴과 두꺼비가 한자리에 모였습니다. 마을 잔치에 나란히 초대를 받았거든요.",
                    "셋 다 아침부터 잔뜩 차려입고 왔지요.",
                    "떡과 나물이 푸짐한 잔칫상이 떡하니 놓여 있었지요.",
                    "김이 모락모락 나는 것이 보기만 해도 군침이 돌았답니다."
                ],
                right: [
                    "그런데 셋은 상 앞에서 우물쭈물하기만 했어요. 아무도 선뜻 앉지를 못했지요.",
                    "\"누가 윗자리에 앉지?\"",
                    "\"어르신 먼저 앉으시지요.\"",
                    "윗자리는 그중 가장 어른이 앉는 자리였거든요. 잘못 앉았다가는 두고두고 흉을 잡힐 판이었습니다."
                ]
            },
            {
                art: "02-rule.webp",
                emoji: "📜",
                left: [
                    "한참을 서 있던 여우가 헛기침을 하며 앞으로 나섰어요. 무언가 좋은 수가 떠오른 얼굴이었지요.",
                    "\"정해진 대로 하면 되지요.\"",
                    "여우가 둘을 둘러보았어요.",
                    "\"나이가 제일 많은 이가 윗자리에 앉는 겁니다. 예로부터 내려오는 법 아니겠소.\""
                ],
                right: [
                    "\"옳거니, 그렇게 합시다.\"",
                    "\"그럼 각자 나이를 말해 보기로 하지요.\"",
                    "사슴이 목을 길게 빼며 얼른 맞장구를 쳤습니다. 저도 자신이 있다는 듯한 얼굴이었지요.",
                    "두꺼비는 아무 말 없이 눈만 껌뻑껌뻑하고 있었답니다."
                ]
            },
            {
                art: "03-fox.webp",
                emoji: "🦊",
                left: [
                    "여우가 먼저 나섰어요. 헛기침을 두어 번 하고는 아주 점잖게 입을 열었습니다.",
                    "다들 여우를 쳐다보았지요.",
                    "\"나는 말이오,\"",
                    "\"하늘에 별이 몇 개인지 세던 시절에 태어났소.\"",
                    "상 앞이 조용해졌지요."
                ],
                right: [
                    "\"그때는 별이 겨우 열 개였지. 지금은 셀 수도 없이 많아졌지만 말이오.\"",
                    "여우는 수염을 쓸어내리며 잔뜩 으스댔습니다.",
                    "\"이만하면 윗자리는 내 것이지.\"",
                    "벌써 윗자리에 앉기라도 한 듯한 얼굴이었지요. 사슴은 그 꼴을 보고 눈을 가늘게 떴답니다."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                emoji: "🦌",
                left: [
                    "그러자 사슴이 대뜸 코웃음을 쳤어요. 콧방귀 소리가 어찌나 큰지 상이 다 울릴 지경이었지요.",
                    "\"허, 그거야 어린애 이야기지요.\"",
                    "사슴이 뿔을 흔들었어요.",
                    "\"내 이야기를 들으면 아마 놀라실 거요.\""
                ],
                right: [
                    "\"나는 저 앞산이 아직 조그만 언덕이던 시절에 뛰어놀았소.\"",
                    "\"내가 뿔로 긁어 놓은 자리가 바로 지금의 저 골짜기라오.\"",
                    "\"어떻소? 내가 더 윗사람이지요?\"",
                    "사슴이 뿔을 으쓱 치켜들자 여우의 얼굴이 굳어졌습니다. 질 수는 없다는 표정이었지요."
                ]
            },
            {
                art: "05-quarrel.webp",
                ...
                left: [
                    "\"허, 말도 안 되는 소리!\"",
                    "\"그쪽이야말로 지어낸 말 아니오?\"",
                    "떡 접시가 상 한가운데 그대로 있었지요.",
                    "\"뭐요? 지금 나를 거짓말쟁이라 하는 거요?\"",
                    "여우와 사슴은 얼굴이 벌게지도록 다투기 시작했어요. 서로 손가락질까지 해 가면서요."
                ],
                right: [
                    "잔칫상은 손도 대지 못한 채 자꾸만 식어 갔습니다.",
                    "떡에서 나던 김도 어느새 사라졌지요.",
                    "두꺼비는 그동안 상 아래에 가만히 앉아 있기만 했답니다. 배를 볼록볼록하며 숨만 쉬고 있었어요.",
                    "\"저것들이 언제까지 저럴꼬.\""
                ]
            },
            {
                ...
                left: [
                    ...
                    "우와아앙—!",
                    "두꺼비가 울음을 터뜨린 것이었어요.",
                    "난데없는 울음소리에 여우와 사슴은 입을 딱 다물었어요. 다투던 것도 잊고 얼른 소리 난 쪽을 돌아보았지요."
                ],
                right: [
                    "두꺼비의 두 눈에서 눈물이 물줄기처럼 콸콸 솟구치고 있었습니다. 상 위의 나물 접시까지 축축하게 젖을 지경이었지요.",
                    "\"아니, 두꺼비. 갑자기 왜 우시오?\"",
                    "여우가 어리둥절해서 물었어요.",
                    "사슴도 놀라 눈을 껌뻑였답니다."
                ]
        ...
        beats: [
            {
                ...
                emoji: "🌱",
                left: [
                    "두꺼비가 앞발로 눈물을 슥슥 닦으며 겨우 입을 열었어요. 목소리가 축축하게 잠겨 있었지요.",
                ...
                right: [
                    ...
                    "\"그 나무들이 지금 어찌 되었는지 아십니까?\"",
                    "듣고 있던 둘이 침을 꿀꺽 삼켰지요.",
                    "여우와 사슴이 슬그머니 서로를 쳐다보았습니다. 어쩐지 불길한 기분이 들었거든요."
                ]
            },
            {
                art: "08-trees.webp",
                emoji: "🌳",
                left: [
                    "두꺼비는 하늘을 한 번 올려다보고 천천히 말을 이었어요. 그 목소리가 어찌나 담담한지 더 무서웠지요.",
                    "여우와 사슴은 숨도 크게 쉬지 못했어요.",
                    "\"첫 번째 나무는 하늘을 떠받치는 기둥이 되었고,\"",
                    "\"두 번째 나무는 해와 달을 매다는 장대가 되었지요.\""
                ],
                right: [
                    "\"세 번째 나무는 별을 하늘에 박는 망치의 자루가 되었답니다.\"",
                    "\"그 나무들을 생각하니 그만…\"",
                    "여우와 사슴은 아무 말도 못 했지요.",
                    "두꺼비는 말끝을 흐리며 또 훌쩍였습니다. 어깨까지 들썩이며 우는 모습이 어찌나 서러워 보이던지요."
                ]
            },
            {
                art: "09-shock.webp",
                emoji: "😲",
                left: [
                    "여우와 사슴은 입을 딱 벌린 채 아무 말도 하지 못했습니다.",
                    "둘의 얼굴이 하얗게 질렸어요.",
                    "하늘도 해도 달도 별도, 두꺼비가 나무를 심고 난 뒤에야 생겼다는 말이었거든요.",
                    "그러니 나이를 견줄 것도 없었지요."
                ],
                right: [
                    "\"그, 그렇다면…\"",
                    "\"어르신이 제일 웃어른이시군요.\"",
                    "여우가 먼저 자리에서 일어났지요.",
                    "둘은 슬그머니 아랫자리로 물러났답니다.",
                    "조금 전까지 으스대던 것이 부끄러워 서로 얼굴도 들지 못했어요."
                ]
            },
            {
                art: "10-seat.webp",
                emoji: "🐸",
                left: [
                    "두꺼비는 엉금엉금 기어 윗자리로 올라갔어요. 자리에 앉더니 아주 흐뭇한 얼굴이 되었지요.",
                    "\"허허, 그럼 잘 먹겠습니다.\"",
                    "\"어이쿠, 두 분도 어서 드시지요.\"",
                    "두꺼비는 그제야 떡을 한 입 베어 물었답니다."
                ],
                right: [
                    "그런데 말이에요. 두꺼비가 정말 그 나무들을 심었는지는 아무도 알지 못한대요.",
                    "물어볼 사람이 하늘밖에 없으니까요.",
                    "여우와 사슴은 떡 한 조각도 못 먹었대요.",
                    "그날 잔칫상에서 제일 배불리 먹은 것은 두꺼비였다고 한답니다."
                ]
            }
        ],
...
const EN = {
    ...
    words: {
        ...
        "02-rule.webp": [
            ...
            { w: "looked round at ~ (look)", k: "둘러보았다", s: "The fox looked round at the other two." },
        ...
        "05-quarrel.webp": [
            ...
            { w: "went red in the face (go)", k: "얼굴이 벌게졌다", s: "The two of them went red in the face and argued" },
        ...
        "08-trees.webp": [
            { w: "went slowly on (go)", k: "천천히 말을 이었다", s: "The toad looked up at the sky once and went slowly on." },
        ...
        "09-shock.webp": [
            ...
            { w: "went white (go)", k: "하얗게 질렸다", s: "Both of their faces went white." },
        ...
        "10-seat.webp": [
            ...
            { w: "took a bite of ~ (take)", k: "한 입 베어 물었다", s: "And only then did he take a bite of rice cake." },
    ...
    spreads: [
        {
            art: 'end.webp',
            left: [
                "누가 가장 나이가 많은지를 다투는 이야기는 우리나라에도 있고 이웃 나라에도 있습니다. 짐승들이 저마다 아득한 옛일을 들어 자랑하는 짜임이 같습니다.",
                "이런 이야기가 웃긴 까닭은 아무도 확인할 수 없기 때문입니다. 하늘을 만들 때 있었다고 해도 아니라고 할 사람이 없습니다.",
                "다시 보면 두꺼비는 다른 것들처럼 오랜 옛일을 대지 않았습니다. 대신 눈물을 흘렸습니다.",
                "확인할 수 없는 자랑들 사이에서 확인할 수 없는 슬픔을 꺼낸 것이지요. 그 앞에서는 아무도 더 우길 수가 없었습니다."
            ],
            right: [
                "자랑은 부풀리기 쉽습니다. 여우도 사슴도 두꺼비도 정말 그랬는지는 아무도 확인할 수 없었습니다. 남보다 앞서려고 하는 말은 대개 그렇습니다.",
                "나를 크게 보이려고 사실보다 부풀려 말한 적이 있나요?"
            ]
        }
    ]
};
...
const WORDS_KO = {
    ...
    "01-feast.webp": [
        ...
        { w: "푸짐하다", k: "넉넉하고 많다.", s: "떡과 나물이 푸짐한 잔칫상이 떡하니 놓여 있었지요." },
        { w: "모락모락", k: "김이 조금씩 피어오르는 모양.", s: "김이 모락모락 나는 것이 보기만 해도 군침이 돌았답니다." },
        { w: "군침이 돌다", k: "먹고 싶어 입에 침이 고이다.", s: "보기만 해도 군침이 돌았답니다." },
        { w: "우물쭈물하다", k: "망설이며 선뜻 하지 못하다.", s: "그런데 셋은 상 앞에서 우물쭈물하기만 했어요." },
        { w: "선뜻", k: "망설이지 않고 얼른.", s: "아무도 선뜻 앉지를 못했지요." },
        { w: "윗자리", k: "웃어른이 앉는 높은 자리.", s: "윗자리는 그중 가장 어른이 앉는 자리였거든요." },
        { w: "흉을 잡히다", k: "흠을 들키어 두고두고 말을 듣다.", s: "잘못 앉았다가는 두고두고 흉을 잡힐 판이었습니다." }
    ],
    "02-rule.webp": [
        { w: "헛기침", k: "일부러 하는 기침.", s: "여우가 헛기침을 하며 앞으로 나섰어요." },
        { w: "수", k: "일을 풀어 갈 좋은 방법.", s: "무언가 좋은 수가 떠오른 얼굴이었지요." },
        { w: "예로부터", k: "옛날부터 죽.", s: "예로부터 내려오는 법 아니겠소." },
        { w: "옳거니", k: "잘됐다 싶을 때 내는 말.", s: "옳거니, 그렇게 합시다." },
        { w: "맞장구를 치다", k: "남의 말에 덩달아 맞추다.", s: "사슴이 목을 길게 빼며 얼른 맞장구를 쳤습니다." },
        { w: "껌뻑껌뻑", k: "눈을 자꾸 감았다 뜨는 모양.", s: "두꺼비는 아무 말 없이 눈만 껌뻑껌뻑하고 있었답니다." }
    ],
    "03-fox.webp": [
        { w: "점잖다", k: "말과 몸가짐이 무겁고 의젓하다.", s: "아주 점잖게 입을 열었습니다." },
        { w: "수염", k: "입가나 턱에 난 털.", s: "여우는 수염을 쓸어내리며 잔뜩 으스댔습니다." },
        { w: "으스대다", k: "잘난 체하며 뽐내다.", s: "여우는 수염을 쓸어내리며 잔뜩 으스댔습니다." },
        { w: "꼴", k: "겉으로 드러난 모양새.", s: "사슴은 그 꼴을 보고 눈을 가늘게 떴답니다." }
    ],
    "04-deer.webp": [
        { w: "대뜸", k: "이것저것 볼 것 없이 그 자리에서 곧.", s: "그러자 사슴이 대뜸 코웃음을 쳤어요." },
        { w: "코웃음", k: "남을 우습게 여겨 웃는 웃음.", s: "사슴이 대뜸 코웃음을 쳤어요." },
        { w: "콧방귀", k: "콧김을 내며 비웃는 짓.", s: "콧방귀 소리가 어찌나 큰지 상이 다 울릴 지경이었지요." },
        { w: "지경", k: "그쯤 되는 형편.", s: "상이 다 울릴 지경이었지요." },
        { w: "골짜기", k: "산과 산 사이 깊고 좁은 곳.", s: "내가 뿔로 긁어 놓은 자리가 바로 지금의 저 골짜기라오." },
        { w: "으쓱", k: "우쭐하여 어깨를 들썩이는 모양.", s: "사슴이 뿔을 으쓱 치켜들자" }
    ],
    "05-quarrel.webp": [
        { w: "거짓말쟁이", k: "거짓말을 잘하는 사람.", s: "지금 나를 거짓말쟁이라 하는 거요?" },
        { w: "벌게지다", k: "얼굴이 붉어지다.", s: "여우와 사슴은 얼굴이 벌게지도록 다투기 시작했어요." },
        { w: "손가락질", k: "손가락으로 남을 가리키는 짓.", s: "서로 손가락질까지 해 가면서요." },
        { w: "볼록볼록", k: "자꾸 볼록해지는 모양.", s: "배를 볼록볼록하며 숨만 쉬고 있었어요." }
    ],
    "06-tears.webp": [
        { w: "난데없다", k: "갑작스러워 뜻밖이다.", s: "난데없는 울음소리에 여우와 사슴은 입을 딱 다물었어요." },
        { w: "물줄기", k: "흘러가는 물의 줄기.", s: "두 눈에서 눈물이 물줄기처럼 콸콸 솟구치고 있었습니다." },
        { w: "콸콸", k: "물이 세차게 쏟아지는 소리.", s: "눈물이 물줄기처럼 콸콸 솟구치고 있었습니다." },
        { w: "축축하다", k: "물기가 있어 눅눅하다.", s: "나물 접시까지 축축하게 젖을 지경이었지요." },
        { w: "어리둥절하다", k: "무슨 일인지 몰라 멍하다.", s: "여우가 어리둥절해서 물었어요." }
    ],
    "07-why.webp": [
        { w: "슥슥", k: "가볍게 문지르는 모양.", s: "두꺼비가 앞발로 눈물을 슥슥 닦으며 겨우 입을 열었어요." },
        { w: "잠기다", k: "목소리가 젖어 가라앉다.", s: "목소리가 축축하게 잠겨 있었지요." },
        { w: "훌쩍이다", k: "코를 들이마시며 울다.", s: "두꺼비가 훌쩍이며 말을 이었어요." },
        { w: "그루", k: "나무를 세는 말.", s: "제가 아주 어렸을 적에 나무 세 그루를 심었지요." },
        { w: "꿀꺽", k: "한꺼번에 삼키는 모양.", s: "듣고 있던 둘이 침을 꿀꺽 삼켰지요." },
        { w: "슬그머니", k: "남몰래 살짝.", s: "여우와 사슴이 슬그머니 서로를 쳐다보았습니다." },
        { w: "불길하다", k: "좋지 않은 일이 생길 것 같다.", s: "어쩐지 불길한 기분이 들었거든요." }
    ],
    "08-trees.webp": [
        { w: "담담하다", k: "들뜨지 않고 차분하다.", s: "그 목소리가 어찌나 담담한지 더 무서웠지요." },
        { w: "떠받치다", k: "밑에서 받쳐 들다.", s: "첫 번째 나무는 하늘을 떠받치는 기둥이 되었고" },
        { w: "장대", k: "길고 굵은 막대.", s: "해와 달을 매다는 장대가 되었지요." },
        { w: "자루", k: "연장에 달린 손잡이.", s: "별을 하늘에 박는 망치의 자루가 되었답니다." },
        { w: "말끝을 흐리다", k: "말을 분명하게 맺지 못하다.", s: "두꺼비는 말끝을 흐리며 또 훌쩍였습니다." },
        { w: "서럽다", k: "몹시 슬프고 억울하다.", s: "우는 모습이 어찌나 서러워 보이던지요." }
    ],
    "09-shock.webp": [
        { w: "질리다", k: "놀라 얼굴빛이 하얗게 변하다.", s: "둘의 얼굴이 하얗게 질렸어요." },
        { w: "견주다", k: "서로 대어 보다.", s: "그러니 나이를 견줄 것도 없었지요." },
        { w: "웃어른", k: "나이나 지위가 높은 어른.", s: "어르신이 제일 웃어른이시군요." },
        { w: "아랫자리", k: "아랫사람이 앉는 자리.", s: "둘은 슬그머니 아랫자리로 물러났답니다." }
    ],
    "10-seat.webp": [
        { w: "엉금엉금", k: "느리게 기어가는 모양.", s: "두꺼비는 엉금엉금 기어 윗자리로 올라갔어요." },
        { w: "흐뭇하다", k: "마음에 들어 기분이 좋다.", s: "자리에 앉더니 아주 흐뭇한 얼굴이 되었지요." },
        { w: "베어 물다", k: "이로 끊어 물다.", s: "두꺼비는 그제야 떡을 한 입 베어 물었답니다." }
    ],
    "after": [
        { w: "아득하다", k: "까마득히 멀다.", s: "짐승들이 저마다 아득한 옛일을 들어 자랑하는 짜임이 같습니다." },
        { w: "짜임", k: "이야기가 얽혀 있는 틀.", s: "아득한 옛일을 들어 자랑하는 짜임이 같습니다." },
        { w: "우기다", k: "억지로 제 말이 옳다고 하다.", s: "그 앞에서는 아무도 더 우길 수가 없었습니다." },
        { w: "부풀리다", k: "실제보다 크게 말하다.", s: "자랑은 부풀리기 쉽습니다." }
    ]
};
