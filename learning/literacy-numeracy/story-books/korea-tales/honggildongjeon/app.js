...
const CHAPTERS = [
    ...
    },
    {
        ...
        paras: [
            ...
            "\"어디로 가려느냐.\"<br>\"모르겠습니다. 다만 이 집에 있으면 아무것도 되지 못합니다.\" 홍 판서의 목소리가 잠겨 있었습니다. 마루 끝의 등잔불이 흔들렸습니다.",
            "홍 판서의 눈이 길동의 방 쪽으로 갔습니다. 열린 문 안으로 갈라진 이불이 보였습니다.<br>\"…오늘 밤 무슨 일이 있었느냐.\"",
    ...
    },
    {
        ...
        artAt: ["네 어미가 너에게 무어라 하였느냐", "신에게 병조 판서", "하늘로 훌쩍 몸을 솟구쳐 구름 속으로 사라졌습니다"],
        paras: [
    ...
    },
    {
        ...
        paras: [
            ...
            "홍 판서가 아들의 손을 잡았습니다.<br>\"내가 너에게 못 해 준 것이 많다.\"<br>\"아버지라 부르게 해 주셨지 않습니까. 그것이면 되었습니다.\" 손이 나뭇가지처럼 말라 있었습니다.",
...
const QUIZ = [
    { q: "서얼인 길동은 형 인형을 무어라 불러야 했습니까?", choices: ["대감", "나리", "형님"], answer: 1 },
    { q: "길동이 도술 책을 익힌 지 반년 만에 처음 할 수 있게 된 일은 무엇입니까?", choices: ["몸을 감추어 숨는 일", "종이 사람을 걸리는 일", "바람을 손짓으로 움직이는 일"], answer: 2 },
    { q: "길동을 없애려고 사람을 산 것은 누구입니까?", choices: ["초란", "맏형 인형", "무당"], answer: 0 },
    { q: "어머니 춘섬이 길동에게 당부한 것은 무엇입니까?", choices: ["사람을 해치지 말라고", "아버지를 원망하지 말라고", "언젠가 꼭 돌아오라고"], answer: 0 },
    { q: "길동이 도적 무리의 우두머리가 된 것은 무엇 덕분입니까?", choices: ["도적들과 싸워 이겨서", "아무도 못 든 돌을 들어서", "도술로 안개를 피워서"], answer: 1 },
    { q: "길동은 붙잡은 자객을 어떻게 했습니까?", choices: ["묶어서 아버지 앞에 데려갔다", "놓아주며 다시는 담을 넘지 말라 했다", "보낸 사람에게 도로 돌려보냈다"], answer: 1 },
    { q: "활빈당은 가져온 곡식과 돈을 어떻게 나누어 주었습니까?", choices: ["장터에 모아 놓고 줄을 세워 나눠 주었다", "고을 수령을 시켜 나누게 했다", "밤중에 문 앞에 소리 없이 놓고 물러났다"], answer: 2 },
    { q: "길동이 함경 감사의 창고를 열 때 쓴 방법은 무엇입니까?", choices: ["성 밖에 불을 질러 군사를 빼돌렸다", "한밤중에 담을 넘어 몰래 들어갔다", "문지기에게 돈을 주고 문을 열게 했다"], answer: 0 },
    { q: "홍 판서가 방문 틈으로 본 것은 무엇입니까?", choices: ["이불을 가른 칼자국", "똑같은 얼굴 여덟", "안개 가득한 방"], answer: 1 },
    { q: "홍 판서는 대궐 마당에서 어떻게 진짜 길동을 가려냈습니까?", choices: ["얼굴을 하나하나 만져 보고서", "칼로 베어 종이인 것을 밝혀서", "어머니가 한 말을 물어서"], answer: 2 },
    { q: "길동이 임금께 병조 판서를 청한 까닭은 무엇입니까?", choices: ["군사를 얻어 조선을 뒤집으려고", "서얼도 그곳에 설 수 있음을 보이려고", "아버지의 죄를 대신 갚으려고"], answer: 1 },
    { q: "병조 판서가 된 날 길동은 하루 내내 무엇을 했습니까?", choices: ["자리에 서서 아무 명도 내리지 않았다", "서얼도 과거를 보게 하라는 명을 내렸다", "신하들의 죄를 낱낱이 밝혔다"], answer: 0 },
    { q: "길동은 붙잡은 율도국 임금을 어떻게 했습니까?", choices: ["옥에 가두었다", "섬 한쪽에 땅을 주어 살게 했다", "배에 태워 뭍으로 보냈다"], answer: 2 },
    { q: "율도국의 법은 굶는 사람이 생기면 어떻게 하게 했습니까?", choices: ["임금의 곳간에서 곡식을 내려보내게 했다", "그 고을 수령이 먼저 곳간을 열게 했다", "이웃 고을이 곡식을 나누어 주게 했다"], answer: 1 },
    {
        q: "이 책을 읽고 난 반응으로 알맞지 않은 것은 무엇인가요?",
        wide: true,
        choices: [
            "아버지를 아버지라 부르지 못한 것을 보면, 사람을 나누어 놓은 법이 집 안에서부터 아팠구나.",
            "길동이 임금이 되고도 밤이면 수수한 옷으로 저잣거리에 나가 앉은 것을 보면, 듣는 자리를 놓지 않았네.",
            "율도국에서 신분을 가르는 법부터 없앤 것을 보면, 끝까지 마음에 걸린 것이 그것이었어.",
            "길동이 나이 들어 맏아들에게 율도국을 물려준 것을 보면, 제 핏줄만은 어쩌지 못했겠다."
        ],
        answer: 3
    }
];
...
const EN = {
    ...
    chapters: [
        ...
        },
        {
            ...
            paras: [
                ...
                "Minister Hong's eyes went toward Gildong's room. Through the open door he could see the cut quilt.<br>\"...What happened here tonight?\"",
        ...
        },
        {
            ...
            paras: [
                ...
                "Minister Hong took his son's hand.<br>\"There is much I never did for you.\"<br>\"You let me call you Father. That is enough.\" The hand was dry as a twig.",
    ...
    quiz: [
        { q: "As a seoeol, what did Gildong have to call his brother Inhyeong?", choices: ["Your Excellency", "Sir", "Brother"], answer: 1 },
        { q: "What was the first thing Gildong could do, half a year into the books of magic?", choices: ["Make himself unseen", "Make paper men walk", "Move the wind with his hand"], answer: 2 },
        { q: "Who hired a man to be rid of Gildong?", choices: ["Choran", "His elder brother Inhyeong", "The shaman"], answer: 0 },
        { q: "What did his mother Chunseom ask of Gildong?", choices: ["Never to harm people", "Never to resent his father", "To come home one day without fail"], answer: 0 },
        { q: "How did Gildong become chief of the band?", choices: ["He fought the bandits and won", "He lifted a stone nobody could lift", "He raised a mist with his magic"], answer: 1 },
        { q: "What did Gildong do with the assassin he caught?", choices: ["Tied him up and took him to his father", "Let him go, telling him never to climb a wall like that again", "Sent him straight back to whoever had hired him"], answer: 1 },
        { q: "How did the Hwalbindang hand out the grain and money they took?", choices: ["Piled it in the market and had people queue", "Had the town magistrate share it out", "Left it silently at doors in the night and withdrew"], answer: 2 },
        { q: "How did Gildong get into the governor of Hamgyeong's storehouse?", choices: ["They lit a fire outside to draw the soldiers away", "They went over the wall in secret at night", "They paid the gatekeeper to open it"], answer: 0 },
        ...
        { q: "How did Minister Hong pick out the real Gildong in the palace yard?", choices: ["By feeling each face with his hands", "By cutting one to show it was paper", "By asking what his mother had told him"], answer: 2 },
        { q: "Why did Gildong ask for the post of Minister of War?", choices: ["To get an army and overturn Joseon", "To show that a seoeol could stand in that place", "To pay off his father's guilt in his stead"], answer: 1 },
        { q: "What did Gildong do all day on the day he was Minister of War?", choices: ["Stood in his place and gave no order at all", "Ordered that seoeol be allowed to sit the exams", "Laid bare the crimes of the ministers"], answer: 0 },
        { q: "What did Gildong do with the king of Yuldo once he had caught him?", choices: ["Put him in prison", "Gave him a corner of the island to live on", "Put him on a ship and sent him to the mainland"], answer: 2 },
        { q: "Under Yuldo's law, what had to happen when somebody was going hungry?", choices: ["Grain was sent down from the king's storehouse", "The magistrate of that town had to open his storehouse first", "The neighbouring town had to share its grain"], answer: 1 },
        {
            q: "Which reaction to this book does NOT fit?",
            wide: true,
            choices: [
                "He could not call his father father, so the law that sorted people hurt inside the house first.",
                "Even as king he sat in the market at night in plain clothes, so he never gave up the seat where you listen.",
