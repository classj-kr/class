        ...
        beats: [
            {
                ...
                right: [
                    "겨울이 깊어 먹을 것이 다 떨어졌어요. 눈이 산을 덮어 풀씨 한 알 보이지 않았지요.",
                    "\"오늘은 온 식구가 나서서 찾아봅시다.\"",
                    "장끼가 꽁지를 세우며 말했어요.",
                    "까투리가 앞장서고 스물한 마리가 줄지어 눈밭으로 나갔지요."
                ]
            },
            {
                art: "02-bean.webp",
                emoji: "🫘",
                left: [
                    "얼마나 걸었을까요. 눈밭 한가운데에 무언가 붉은 것이 보였어요.",
                    "\"저것 봐라! 콩이다, 콩!\"",
                    "장끼가 날개를 퍼덕이며 달려갔어요.",
                    "하얀 눈 위에 붉은 콩 한 알이 놓여 있었어요. 굵고 붉은 것이 눈에 확 띄었지요."
                ],
                right: [
                    "그런데 까투리는 걸음을 멈췄어요.",
                    "\"여보, 잠깐만요.\"",
                    "\"콩이 왜 눈 위에 한 알만 있을까요? 이 산에는 콩밭도 없는데요.\"",
                    "까투리가 사방을 둘러보았지요. 눈 위에 발자국 같은 것이 어렴풋했어요.",
                    "\"아무래도 사람이 놓아둔 것 같습니다.\""
                ]
            },
            {
                ...
                left: [
                    "\"게다가 간밤 꿈이 영 좋지 않았어요.\"",
                    "까투리의 목소리가 떨렸어요.",
                    "\"꿈에 당신 머리에 검은 갓이 씌워지더니, 당신이 물 위로 둥둥 떠내려갔어요.\"",
                    "\"제발 그 콩은 두고 갑시다.\"",
                    "아이들도 어머니 곁으로 모여들었답니다."
                ],
                right: [
                    "장끼는 껄껄 웃었어요.",
                    "\"검은 갓은 벼슬을 하는 꿈이고, 물 위에 뜬 것은 복이 넘친다는 뜻이오.\"",
                    "\"꿈이란 좋게 풀면 다 좋은 법이오.\"",
                    "장끼는 콩에서 눈을 떼지 못했어요. 벌써 입에 침이 고였지요.",
                    "까투리 말은 귀에 들어오지도 않았지요."
                ]
            },
            {
                art: "04-scold.webp",
                ...
                left: [
                    "\"여보, 제 말 좀 들어 보세요.\"",
                    "까투리가 장끼의 날개를 붙들었어요.",
                    "그러자 장끼가 날개를 홱 뿌리쳤습니다.",
                    "\"아녀자가 무얼 안다고 자꾸 나서시오! 집안일이나 하시오.\"",
                    "장끼의 목소리가 산을 울렸어요. 아이들이 깜짝 놀라 움츠러들었지요."
                ],
                right: [
                    "아녀자란 여자를 낮추어 부르던 말이에요. 까투리는 가슴이 내려앉았지요.",
                    "\"아버지, 어머니 말씀대로 해요.\"",
                    "맏아들이 나섰지만 장끼는 고개를 저었어요.",
                    "\"사내가 한번 먹겠다고 했으면 먹는 것이다.\"",
                    "장끼가 콩을 향해 걸어갔답니다."
                ]
            }
        ]
        ...
        beats: [
            {
                ...
                emoji: "🪤",
                left: [
                    "까투리는 두 눈을 꼭 감았어요. 아이들은 어머니 치마폭에 얼굴을 묻었지요.",
                    "눈밭이 쥐 죽은 듯 고요했어요.",
                    "장끼가 콩 앞에 섰습니다.",
                    "\"이렇게 굵은 콩은 처음 보는구나.\"",
                    "장끼가 부리를 쭉 내밀어 콩을 콕 쪼았어요. 바로 그때였어요."
                ],
                right: [
                    "탁!",
                    "눈 속에 숨어 있던 덫이 튀어 올라 장끼의 목을 꽉 물었습니다. 덫은 짐승을 잡으려고 사람이 놓아둔 틀이에요.",
                    "콩은 미끼였던 것이지요.",
                    "\"여, 여보……\"",
                    "장끼가 날개를 파닥였지만 덫은 꿈쩍도 하지 않았어요."
                ]
            },
            {
                ...
                emoji: "🍂",
                left: [
                    "까투리가 달려가 덫을 부리로 쪼고 발로 밀었어요. 아이들도 매달렸지요.",
                    "하지만 쇠로 만든 덫은 꿈쩍도 하지 않았습니다.",
                    "장끼의 숨이 점점 가늘어졌어요.",
                    "\"당신 말을…… 들을 것을……\"",
                    "장끼의 눈에서 눈물이 굴러떨어졌지요."
                ],
                right: [
                    "\"내가 죽거든 아이들을 잘 키워 주오.\"",
                    "\"그리고 다시는 시집가지 마오. 혼자 살며 나만 생각해 주오.\"",
                    "장끼는 그 말을 남기고 숨을 거두었습니다.",
                    "눈밭 위에 긴 꽁지깃 하나가 바람에 흔들렸어요.",
                    "까투리는 그 자리에 한참을 앉아 있었답니다."
                ]
            },
            {
                art: "07-burial.webp",
                emoji: "❄️",
                left: [
                    "까투리와 스물한 마리 아이들이 소리 내어 울었어요. 울음소리가 온 산에 퍼졌지요.",
                    "\"아버지! 아버지!\"",
                    "해가 기울자 까투리가 눈물을 닦고 일어섰어요.",
                    "\"이대로 둘 수는 없다. 아버지를 묻어 드리자.\"",
                    "아이들이 발로 눈을 파기 시작했답니다."
                ],
                right: [
                    "양지바른 언덕에 장끼를 눕히고 눈을 덮었어요. 그 위에 그 콩을 놓았지요.",
                    "\"이 콩 때문에 가셨으니, 이 콩이나 가지고 가세요.\"",
                    "까투리의 목소리가 담담했어요.",
                    "아이들은 어머니 날개 밑으로 파고들었지요.",
                    "까투리는 밤새 눈을 붙이지 못했답니다."
                ]
            },
            {
                art: "08-crow.webp",
                emoji: "🐦‍⬛",
                left: [
                    "이튿날, 장끼 소식이 온 산에 퍼졌어요.",
                    "새들이 하나둘 조문을 왔어요. 조문은 슬픈 집을 찾아가 위로하는 일이지요.",
                    "제일 먼저 온 것은 까마귀였어요.",
                    "\"아이고, 이런 변이 있나.\"",
                    "까마귀가 검은 날개로 얼굴을 가리며 울었지요."
                ],
                right: [
                    "그런데 까마귀는 울면서도 까투리를 흘끔흘끔 살폈어요.",
                    "\"까투리 부인, 이제 어찌 사시려오.\"",
                    "\"아이들이 스물하나나 되는데 혼자서는 어렵지 않겠소.\"",
                    "까투리는 대답하지 않았어요.",
                    "뒤이어 부엉이와 물오리도 날아왔답니다."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                emoji: "🦆",
                left: [
                    "새들은 슬퍼하러 온 것이 아니었어요. 저마다 제 자랑을 늘어놓았지요.",
                    "\"내 검은 옷은 상복이오. 나와 살면 남편을 늘 기리는 셈이지.\"",
                    "상복은 초상 때 입는 옷이지요.",
                    "부엉이도 나섰어요. \"나는 밤눈이 밝아 밤마다 아이들을 지켜 주겠소.\""
                ],
                right: [
                    "\"우리 집은 물 위라오. 여름에 시원하고 물고기가 넘치지.\"",
                    "물오리도 끼어들었어요.",
                    "까투리가 조용히 입을 열었지요.",
                    "\"우리 아이들은 헤엄을 못 칩니다. 밤에는 자야 하고요. 검은 옷은 저도 있고요.\"",
                    "새들은 머쓱해져 날아가 버렸답니다."
                ]
            },
            {
                ...
                emoji: "🌙",
                left: [
                    "새들이 떠나고 산이 다시 조용해졌어요.",
                    "까투리는 언덕 위 무덤을 바라보았습니다. 아이들은 곁에서 잠이 들었지요.",
                    "'다시 시집가지 마오.'",
                    "장끼의 마지막 말이 귓가에 맴돌았어요.",
                    "'그런데 내가 어떻게 살고 싶은지는 아무도 묻지 않는구나.'"
                ],
                right: [
                    "겨울이 지나갔어요. 까투리는 혼자 아이들을 먹여 살렸지요.",
                    "눈을 헤쳐 풀뿌리를 찾고 덤불에서 열매를 찾았어요.",
                    "아이들은 하루가 다르게 자랐어요.",
                    "\"어머니, 우리도 이제 먹이를 찾을 수 있어요.\"",
                    "맏딸이 도토리 한 알을 내밀었답니다."
                ]
            },
            {
                ...
                emoji: "🌱",
                left: [
                    "봄이 왔어요. 눈이 녹고 산에 새순이 돋았지요.",
                    "어느 날 산 너머에서 낯선 장끼 한 마리가 찾아왔습니다. 짝을 잃고 혼자 사는 장끼였어요.",
                    "\"지나다가 들렀습니다.\"",
                    "그 장끼는 자랑을 늘어놓지 않았어요. 아이들 이름을 하나하나 물었지요."
                ],
                right: [
                    "함께 먹이를 찾다가 풀숲에서 콩 한 알을 보았어요.",
                    "까투리의 가슴이 철렁했습니다.",
                    "그런데 낯선 장끼가 콩을 보더니 까투리를 돌아보았어요.",
                    "\"이 콩, 먹어도 되겠습니까? 부인 보기에는 어떻습니까.\"",
                    "까투리는 그만 웃음이 터졌답니다."
                ]
            },
            {
                ...
                emoji: "🌸",
                left: [
                    "그날 밤 까투리는 아이들을 불러 모았어요.",
                    "\"어머니는 이제 저 장끼와 살아 볼까 한다. 너희 생각은 어떠니.\"",
                    "\"아버지가 시집가지 말라고 하셨잖아요.\"",
                    "맏아들이 물었지요.",
                    "\"그건 아버지 생각이었지. 이번에는 어머니가 정하마.\""
                ],
                right: [
                    "봄 산에 새 식구가 생겼어요. 아이들 뒤로 장끼와 까투리가 나란히 걸었지요.",
                    "새 장끼는 무엇이든 까투리에게 먼저 물었어요. 까투리도 제 뜻을 말했지요.",
                    "언덕 위 무덤에는 봄풀이 돋았답니다.",
                    "그 위에 두었던 콩에서도 싹이 텄대요."
                ]
            }
        ],
        moral: "장끼는 까투리의 말을 아녀자 말이라며 듣지 않다가 목숨을 잃었어요. 까투리는 남편의 마지막 말 대신 제 뜻을 따랐지요. 남의 말을 듣는 것과 제 뜻을 정하는 것, 둘 다 사는 데 꼭 필요하답니다.",
        question: "누군가의 말을 흘려듣다가 낭패를 본 적이 있나요? 반대로, 남의 말 대신 내 뜻대로 정해 본 적은요?"
    }
];
...
const COVER = {
    ...
    title: "장끼전",
    intro: [
        "장끼전은 지은이가 없는 옛이야기예요. 원래는 소리꾼이 북장단에 맞춰 부르던 판소리 「장끼타령」이었는데, 소리는 끊기고 글만 남았답니다.",
        "꿩 부부가 사람처럼 말하고 다투는 이야기예요. 짐승 이야기 같지만 사실은 그 시절 사람들 이야기지요. 대놓고 하기 어려운 말을 꿩의 입을 빌려 한 것이랍니다.",
        "눈밭에 떨어진 콩 한 알을 두고 하루 사이에 벌어진 일이에요. 그 하루가 한 집안의 겨울을 통째로 바꿔 놓는답니다."
    ]
};
    ...
    spreads: [
        {
            art: 'end.webp',
            left: [
                "이 이야기는 원래 판소리 「장끼타령」이었습니다. 판소리 열두 마당 가운데 소리가 끊긴 일곱 마당의 하나로, 옹고집전과 같은 처지입니다. 글로만 읽을 수 있습니다.",
                "꿩이 사람처럼 말하고 혼인하고 다툽니다. 이런 이야기를 우화라고 합니다. 옛사람들은 사람에게 대놓고 하기 어려운 말을 짐승의 입을 빌려 했습니다.",
                "장끼가 까투리에게 한 「아녀자가 무얼 안다고」는 그 시절 남자들이 흔히 하던 말입니다. 이야기는 그 말을 한 장끼를 덫에 걸리게 합니다. 누구 편인지 분명합니다.",
                "장끼의 마지막 말도 그렇습니다. 그때는 남편을 잃은 여자가 다시 혼인하는 것을 나쁘게 보았습니다. 까투리는 그 말을 따르지 않았습니다. 이 책은 까투리가 스스로 고르는 쪽으로 끝냈습니다."
            ],
            right: [
                "그러니 이것은 꿩 이야기가 아닙니다. 남의 말을 듣지 않은 사람과, 남이 정해 준 대로 살지 않은 사람의 이야기입니다. 콩 한 알이 그 둘을 다 보여 줍니다.",
                "누군가의 말을 흘려듣다 낭패를 본 적이 있나요? 반대로 남이 정해 준 것 대신 내 뜻대로 골라 본 적은요?"
            ]
        }
    ]
};
...
const WORDS_KO = {
    "cover": [
        { w: "소리꾼", k: "판소리를 부르는 사람.", s: "소리꾼이 북장단에 맞춰 부르던 판소리" },
        { w: "북장단", k: "북을 쳐서 맞추는 가락.", s: "소리꾼이 북장단에 맞춰 부르던" },
        { w: "판소리", k: "북장단에 맞춰 긴 이야기를 노래로 부르던 것.", s: "소리꾼이 북장단에 맞춰 부르던 판소리" },
        { w: "대놓고", k: "거리낌 없이 드러내 놓고.", s: "대놓고 하기 어려운 말을 꿩의 입을 빌려 한 것이랍니다." }
    ],
    "01-family.webp": [
        { w: "수꿩", k: "수컷 꿩.", s: "수꿩은 장끼, 암꿩은 까투리라 한답니다." },
        { w: "암꿩", k: "암컷 꿩.", s: "수꿩은 장끼, 암꿩은 까투리라 한답니다." },
        { w: "꽁지", k: "새의 꽁무니에 달린 깃.", s: "장끼는 꽁지가 길고 멋졌어요." },
        { w: "수수하다", k: "꾸밈없고 요란하지 않다.", s: "까투리는 깃털이 수수했지요." },
        { w: "보채다", k: "자꾸 조르며 칭얼대다.", s: "아이들이 자꾸 보챘어요." },
        { w: "풀씨", k: "풀의 씨앗.", s: "눈이 산을 덮어 풀씨 한 알 보이지 않았지요." },
        { w: "앞장서다", k: "맨 앞에 서서 가다.", s: "까투리가 앞장서고 스물한 마리가 줄지어 눈밭으로 나갔지요." }
    ],
    "02-bean.webp": [
        { w: "퍼덕이다", k: "날개를 힘차게 치다.", s: "장끼가 날개를 퍼덕이며 달려갔어요." },
        { w: "사방", k: "온 둘레.", s: "까투리가 사방을 둘러보았지요." },
        { w: "어렴풋하다", k: "또렷하지 않고 흐릿하다.", s: "눈 위에 발자국 같은 것이 어렴풋했어요." }
    ],
    "03-dream.webp": [
        { w: "간밤", k: "지난밤.", s: "게다가 간밤 꿈이 영 좋지 않았어요." },
        { w: "갓", k: "옛날 어른 남자가 머리에 쓰던 큰 모자.", s: "꿈에 당신 머리에 검은 갓이 씌워지더니" },
        { w: "벼슬", k: "나라 일을 맡아보던 자리.", s: "검은 갓은 벼슬을 하는 꿈이고" },
        { w: "복", k: "좋은 일이 생기는 운.", s: "물 위에 뜬 것은 복이 넘친다는 뜻이오." },
        { w: "침이 고이다", k: "먹고 싶어 입에 침이 돌다.", s: "벌써 입에 침이 고였지요." }
    ],
    "04-scold.webp": [
        { w: "홱", k: "갑자기 세게 뿌리치는 모양.", s: "그러자 장끼가 날개를 홱 뿌리쳤습니다." },
        { w: "뿌리치다", k: "붙잡은 손을 세게 떼어 내다.", s: "장끼가 날개를 홱 뿌리쳤습니다." },
        { w: "아녀자", k: "여자를 낮추어 부르던 말.", s: "아녀자란 여자를 낮추어 부르던 말이에요." },
        { w: "움츠러들다", k: "겁이 나서 몸을 오그리다.", s: "아이들이 깜짝 놀라 움츠러들었지요." },
        { w: "가슴이 내려앉다", k: "놀라거나 서러워 마음이 쿵 하다.", s: "까투리는 가슴이 내려앉았지요." },
        { w: "맏아들", k: "첫째 아들.", s: "맏아들이 나섰지만 장끼는 고개를 저었어요." }
    ],
    "05-trap.webp": [
        { w: "치마폭", k: "치마의 넓게 퍼진 부분.", s: "아이들은 어머니 치마폭에 얼굴을 묻었지요." },
        { w: "쥐 죽은 듯", k: "아무 소리도 없이 아주 조용한 모양.", s: "눈밭이 쥐 죽은 듯 고요했어요." },
        { w: "부리", k: "새의 뾰족한 입.", s: "장끼가 부리를 쭉 내밀어 콩을 콕 쪼았어요." },
        { w: "덫", k: "짐승을 잡으려고 놓아두는 틀.", s: "덫은 짐승을 잡으려고 사람이 놓아둔 틀이에요." },
        { w: "미끼", k: "꾀어 들이려고 놓아두는 먹이.", s: "콩은 미끼였던 것이지요." },
        { w: "파닥이다", k: "날개를 자꾸 치다.", s: "장끼가 날개를 파닥였지만 덫은 꿈쩍도 하지 않았어요." }
    ],
    "06-lastwords.webp": [
        { w: "가늘어지다", k: "점점 약해지다.", s: "장끼의 숨이 점점 가늘어졌어요." },
        { w: "숨을 거두다", k: "세상을 떠나다.", s: "장끼는 그 말을 남기고 숨을 거두었습니다." },
        { w: "꽁지깃", k: "새의 꽁무니에 난 긴 깃털.", s: "눈밭 위에 긴 꽁지깃 하나가 바람에 흔들렸어요." },
        { w: "시집가다", k: "여자가 결혼하다.", s: "그리고 다시는 시집가지 마오." }
    ],
    "07-burial.webp": [
        { w: "기울다", k: "해가 저쪽으로 넘어가다.", s: "해가 기울자 까투리가 눈물을 닦고 일어섰어요." },
        { w: "양지바르다", k: "볕이 잘 들다.", s: "양지바른 언덕에 장끼를 눕히고 눈을 덮었어요." },
        { w: "담담하다", k: "들뜨지 않고 차분하다.", s: "까투리의 목소리가 담담했어요." },
        { w: "눈을 붙이다", k: "잠깐 잠을 자다.", s: "까투리는 밤새 눈을 붙이지 못했답니다." }
    ],
    "08-crow.webp": [
        { w: "이튿날", k: "그다음 날.", s: "이튿날, 장끼 소식이 온 산에 퍼졌어요." },
        { w: "조문", k: "슬픈 일을 당한 집을 찾아가 위로하는 일.", s: "조문은 슬픈 집을 찾아가 위로하는 일이지요." },
        { w: "변", k: "뜻밖에 일어난 나쁜 일.", s: "아이고, 이런 변이 있나." },
        { w: "흘끔흘끔", k: "곁눈으로 자꾸 보는 모양.", s: "까마귀는 울면서도 까투리를 흘끔흘끔 살폈어요." }
    ],
    "09-suitors.webp": [
        { w: "늘어놓다", k: "이것저것 자꾸 말하다.", s: "저마다 제 자랑을 늘어놓았지요." },
        { w: "상복", k: "초상 때 입는 옷.", s: "상복은 초상 때 입는 옷이지요." },
        { w: "기리다", k: "뜻깊게 여겨 오래 기억하다.", s: "남편을 늘 기리는 셈이지." },
        { w: "밤눈", k: "밤에 무엇을 알아보는 눈.", s: "나는 밤눈이 밝아 밤마다 아이들을 지켜 주겠소." },
        { w: "머쓱하다", k: "무안해서 어색하다.", s: "새들은 머쓱해져 날아가 버렸답니다." }
    ],
    "10-alone.webp": [
        { w: "맴돌다", k: "자꾸 떠올라 감돌다.", s: "장끼의 마지막 말이 귓가에 맴돌았어요." },
        { w: "헤치다", k: "덮인 것을 좌우로 밀어내다.", s: "눈을 헤쳐 풀뿌리를 찾고 덤불에서 열매를 찾았어요." },
        { w: "덤불", k: "풀과 나뭇가지가 얽혀 있는 곳.", s: "덤불에서 열매를 찾았어요." },
        { w: "맏딸", k: "첫째 딸.", s: "맏딸이 도토리 한 알을 내밀었답니다." }
    ],
    "11-spring.webp": [
        { w: "새순", k: "새로 돋아난 어린 싹.", s: "눈이 녹고 산에 새순이 돋았지요." },
        { w: "낯설다", k: "처음 보아 익숙하지 않다.", s: "산 너머에서 낯선 장끼 한 마리가 찾아왔습니다." },
        { w: "짝", k: "함께 사는 상대.", s: "짝을 잃고 혼자 사는 장끼였어요." },
        { w: "가슴이 철렁하다", k: "놀라서 마음이 쿵 내려앉다.", s: "까투리의 가슴이 철렁했습니다." }
    ],
    "12-choice.webp": [
        { w: "정하다", k: "마음을 굳혀 결정하다.", s: "이번에는 어머니가 정하마." },
        { w: "싹이 트다", k: "씨에서 싹이 돋아 나오다.", s: "그 위에 두었던 콩에서도 싹이 텄대요." }
    ],
    "after": [
        { w: "마당", k: "판소리 한 편을 세는 말.", s: "판소리 열두 마당 가운데 소리가 끊긴 일곱 마당의 하나로" },
        { w: "우화", k: "짐승을 빌려 가르침을 주는 이야기.", s: "이런 이야기를 우화라고 합니다." },
        { w: "흘려듣다", k: "마음에 두지 않고 지나쳐 듣다.", s: "누군가의 말을 흘려듣다 낭패를 본 적이 있나요?" },
        { w: "낭패", k: "일이 틀어져 딱하게 되는 것.", s: "낭패를 본 적이 있나요?" }
    ]
};
