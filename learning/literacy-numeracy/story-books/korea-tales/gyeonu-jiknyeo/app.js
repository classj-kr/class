        ...
        beats: [
            {
                ...
                emoji: "🐂",
                left: [
                    "아주 먼 옛날, 하늘나라에 견우라는 젊은이가 살았습니다. 은하수 건너편 들판에서 소를 돌보는 일을 했지요.",
                    "새벽부터 밤까지 소를 몰고 풀밭을 오르내렸어요.",
                    "\"이랴, 이랴. 저 언덕까지만 가자.\"",
                    "견우의 목소리는 늘 다정했지요."
                ],
                right: [
                    "\"오늘도 잘 먹었느냐?\"",
                    "견우는 소들의 등을 하나하나 쓸어 주었어요. 소들은 견우를 따라 어디든 순하게 걸었지요.",
                    "하늘나라에서 견우만큼 부지런한 이가 없었어요.",
                    "해가 지고도 한참을 들판에 남아 있었답니다."
                ]
            },
            {
                art: "02-jiknyeo.webp",
                emoji: "🧵",
                left: [
                    "은하수 이쪽에는 직녀가 살았어요. 은하수는 하늘을 가로지르는 커다란 강이었지요.",
                    "직녀는 하늘나라 임금 옥황상제의 하나뿐인 손녀였어요.",
                    "베를 짜는 솜씨가 하늘나라 으뜸이었습니다.",
                    "직녀는 하루 종일 베틀 앞에 앉아 있었지요."
                ],
                right: [
                    "찰칵, 찰칵, 찰칵, 찰칵.",
                    "베틀에서 실이 쉴 새 없이 오갔어요.",
                    "그 집에서 베틀 소리가 끊이는 날이 없었지요.",
                    "직녀가 짠 베로 하늘의 구름과 노을을 지었다고 해요.",
                    "하늘이 고운 것은 다 직녀 덕분이라고들 했답니다."
                ]
            },
            {
                art: "03-meet.webp",
                emoji: "💫",
                left: [
                    "옥황상제는 두 사람을 눈여겨보았어요. 아무리 보아도 둘만큼 부지런한 이가 없었거든요.",
                    "\"둘 다 참 성실하구나. 짝을 지어 주어야겠다.\"",
                    "옥황상제가 흐뭇하게 웃었어요.",
                    "그리하여 견우와 직녀는 부부가 되었습니다."
                ],
                right: [
                    "온 하늘나라 사람들이 나와 축하해 주었지요.",
                    "은하수에 다리가 놓이고, 둘은 그 다리를 건너 서로를 만났어요.",
                    "둘이 손을 맞잡은 날, 하늘나라 전체가 환하게 빛났대요.",
                    "두 사람은 세상에 부러울 것이 없었답니다."
                ]
            },
            {
                art: "04-idle.webp",
                emoji: "🕸️",
                left: [
                    "그런데 그때부터 일이 이상해졌어요. 아침에 눈을 뜨면 서로 얼굴부터 보았지요.",
                    "둘은 서로 곁에 있는 것이 좋아 다른 일이 손에 잡히지 않았습니다.",
                    "직녀는 베틀 앞에 앉지 않았어요.",
                    "베틀에는 먼지가 뽀얗게 앉았지요."
                ],
                right: [
                    "견우도 소 떼를 들판에 내버려 두었어요. 소들은 아무 데나 흩어져 남의 밭까지 들어갔지요.",
                    "그러는 사이 하늘에는 새 구름이 걸리지 않았습니다.",
                    "노을도 구름도 자꾸 흐릿해졌어요.",
                    "하늘빛이 날마다 흐려졌답니다."
                ]
            }
        ...
        beats: [
            {
                ...
                emoji: "⚡",
                left: [
                    "마침내 옥황상제가 노했습니다. 옥황상제가 두 사람을 불러 세웠어요.",
                    "\"내가 너희를 맺어 준 것은 서로 게을러지라는 뜻이 아니었다!\"",
                    "\"하늘이 며칠째 잿빛인 것을 보아라!\"",
                    "옥황상제의 수염이 부르르 떨렸지요."
                ],
                right: [
                    "\"용서해 주십시오! 잘못했습니다!\"",
                    "견우와 직녀가 그 자리에 무릎을 꿇었어요.",
                    "\"다시는 그러지 않겠습니다. 한 번만 봐주십시오.\"",
                    "하지만 옥황상제는 천천히 고개를 저었어요. 이미 마음을 정한 뒤였답니다."
                ]
            },
            {
                art: "06-parted.webp",
                ...
                left: [
                    ...
                    "옥황상제의 목소리가 아주 무거웠어요.",
                    "\"만나는 것은 일 년에 단 하루, 칠월 칠일 칠석날뿐이다.\"",
                    "\"일 년에 하루라도 만나게 해 주는 것이 나의 마지막 정이다.\""
                ],
                right: [
                    "두 사람은 은하수 이쪽과 저쪽으로 갈라졌습니다. 손을 뻗어도 서로에게 닿지 않았어요.",
                    "목이 터져라 소리쳐도 물소리에 묻혔지요.",
                    "은하수 물소리만 밤낮으로 흘렀어요.",
                    "그 넓은 강을 건널 방법은 없었답니다."
                ]
            },
            {
                art: "07-year.webp",
                ...
                left: [
                    ...
                    "소들이 다시 살이 오르고 베틀 소리가 다시 울렸어요.",
                    "하늘에 고운 노을이 돌아왔지요.",
                    "다만 일을 하다가도 자꾸 은하수 쪽을 바라보았습니다."
                ],
                right: [
                    "그렇게 봄이 가고 여름이 깊었어요. 견우는 날마다 손가락으로 남은 날을 세었지요.",
                    "직녀도 베틀 앞에서 같은 날을 세었어요.",
                    "그러다 드디어 칠월 칠일 칠석날이 되었답니다.",
                    "일 년을 기다려 딱 하루 오는 날이었지요."
                ]
            },
            {
                art: "08-river.webp",
                ...
                left: [
                    ...
                    "숨이 턱에 차도록 뛰었지요. 신도 한 짝 잃어버렸어요.",
                    "강 건너에 서로의 모습이 조그맣게 보였습니다.",
                    "\"여보!\"",
                    "\"여보, 나 여기 있소!\"",
                    "둘 다 손을 흔들었지요."
                ],
                right: [
                    "그런데 은하수 강폭이 너무나 넓었습니다. 건널 다리는 이미 치워지고 없었어요.",
                    "아무리 목청껏 소리쳐도 목소리가 닿지 않았지요.",
                    "둘은 강가에 주저앉아 울기만 했습니다.",
                    "해가 지도록 그렇게 앉아 있었답니다."
                ]
            }
        ]
        ...
        beats: [
            {
                ...
                emoji: "🐦",
                left: [
                    "그 울음소리가 하늘을 넘어 땅에까지 들렸어요.",
                    "아주 슬프고 긴 울음소리였지요. 밤새 그치지 않았어요.",
                    "까치와 까마귀들이 고개를 갸웃했습니다.",
                    "\"저게 무슨 소리지?\"",
                    "새들이 일제히 하늘을 올려다보았어요."
                ],
                right: [
                    "사정을 알게 된 새들은 서로를 쳐다보았어요. 일 년에 하루도 못 만난다니 딱하기 그지없었거든요.",
                    "\"우리가 다리를 놓아 주면 되지 않을까?\"",
                    "\"그래! 어서 올라가자!\"",
                    "새들이 한꺼번에 날개를 폈답니다."
                ]
            },
            {
                ...
                emoji: "🌉",
                left: [
                    "온 나라의 까치와 까마귀가 한꺼번에 하늘로 날아올랐어요. 까맣게 하늘을 덮을 만큼 많았지요.",
                    "날갯짓 소리가 천둥 치듯 요란했어요.",
                    "새들은 은하수 위에 모여 머리를 맞대고 줄지어 섰습니다.",
                    "긴 줄이 강 이쪽에서 저쪽까지 이어졌지요."
                ],
                right: [
                    "새들은 부리를 물고 날개를 맞대었어요. 수천 마리의 새가 몸으로 놓은 다리였지요.",
                    "사람들은 그 다리를 오작교라고 불렀답니다.",
                    "까마귀 오, 까치 작, 다리 교.",
                    "이름 그대로 까마귀와 까치가 놓은 다리였지요."
                ]
            },
            {
                art: "11-reunion.webp",
                emoji: "🤝",
                left: [
                    "견우와 직녀는 새들의 등을 밟고 강 한가운데로 걸어갔어요. 새들의 등이 조금씩 흔들렸지요.",
                    "그래도 새들은 이를 악물고 꿈쩍하지 않았어요.",
                    "두 사람은 한달음에 서로에게 달려갔습니다.",
                    "\"잘 지냈소?\""
                ],
                right: [
                    "\"보고 싶었어요.\"",
                    "소 이야기도 하고 베틀 이야기도 했어요. 그러나 만남은 하룻밤뿐이었습니다.",
                    "동이 트자 새들이 하나둘 내려앉기 시작했지요.",
                    "새들도 힘이 다해 가고 있었거든요.",
                    "두 사람은 다시 각자의 자리로 돌아가야 했답니다."
                ]
            },
            {
                art: "12-rain.webp",
                emoji: "🌧️",
                left: [
                    "돌아서는 견우도 직녀도 소리 내어 울었어요. 그 눈물이 구름을 지나 땅으로 떨어졌지요.",
                    "그해 칠석에 내린 빗방울은 굵고 따뜻했어요.",
                    "칠석 무렵에 비가 자주 오는 것은 그래서라고 한답니다.",
                    "만나서 흘린 눈물, 헤어지며 흘린 눈물이래요."
                ],
                right: [
                    "그리고 그 무렵이면 까치와 까마귀의 머리털이 듬성듬성해집니다.",
                    "밤새 머리를 밟히고 서 있었으니 그럴 만도 하지요.",
                    "그래도 새들은 해마다 그날이면 다시 날아오른대요.",
                    "누가 시키지 않아도 저희끼리 모여 올라가는 것이랍니다."
                ]
            }
        ],
        moral: "옥황상제가 두 사람을 갈라놓은 것은 서로를 좋아했기 때문이 아니라, 좋아하느라 자기 몫의 일을 놓았기 때문이었어요. 아끼는 마음과 해야 할 일은 둘 다 지켜야 하는 것이랍니다.",
        question: "좋아하는 일에 빠져 해야 할 일을 놓친 적이 있나요?"
    }
];
...
const COVER = {
    ...
    title: "견우와 직녀",
    intro: [
        "견우와 직녀는 지은이가 없는 이야기예요. 밤하늘의 별을 보고 만들어 낸 이야기라, 우리나라뿐 아니라 중국과 일본에도 함께 전해진답니다.",
        "은하수를 사이에 두고 마주 보는 두 개의 밝은 별이 실제로 있어요. 여름밤 하늘에서 볼 수 있는 견우성과 직녀성이지요. 두 별은 왜 은하수를 사이에 두고 있을까요? 이 이야기는 그 물음에서 시작되었답니다.",
        "음력 칠월 칠일을 칠석이라고 해요. 옛사람들은 이날 별을 보며 소원을 빌었지요. 칠석 무렵에 비가 자주 오는 것, 까치 머리가 성긴 것이 이 이야기와 무슨 상관인지 읽으며 찾아보세요."
    ]
};
    ...
    spreads: [
        {
            ...
            left: [
                ...
                "그 별들이 일 년에 한 번 가장 가까워 보이는 때가 음력 칠월 칠일 무렵입니다. 그래서 그날을 칠석이라 하고 이 이야기를 붙여 두었습니다.",
...
const WORDS_KO = {
    "cover": [
        { w: "은하수", k: "밤하늘에 강처럼 뿌옇게 흐르는 별 무리.", s: "은하수를 사이에 두고 마주 보는 두 개의 밝은 별이 실제로 있어요." },
        { w: "음력", k: "달의 모양이 바뀌는 것에 맞춰 세는 날짜.", s: "음력 칠월 칠일을 칠석이라고 해요." },
        { w: "칠석", k: "음력 칠월 칠일.", s: "음력 칠월 칠일을 칠석이라고 해요." },
        { w: "소원", k: "이루어지기를 바라는 일.", s: "옛사람들은 이날 별을 보며 소원을 빌었지요." },
        { w: "성기다", k: "사이가 뜨고 듬성듬성하다.", s: "까치 머리가 성긴 것이 이 이야기와 무슨 상관인지" }
    ],
    "01-gyeonu.webp": [
        { w: "들판", k: "넓게 펼쳐진 벌판.", s: "은하수 건너편 들판에서 소를 돌보는 일을 했지요." },
        { w: "몰다", k: "짐승을 이끌어 가게 하다.", s: "새벽부터 밤까지 소를 몰고 풀밭을 오르내렸어요." },
        { w: "다정하다", k: "마음이 따뜻하고 정답다.", s: "견우의 목소리는 늘 다정했지요." },
        { w: "순하다", k: "성질이 부드럽고 착하다.", s: "소들은 견우를 따라 어디든 순하게 걸었지요." }
    ],
    "02-jiknyeo.webp": [
        { w: "가로지르다", k: "이쪽에서 저쪽으로 질러 가다.", s: "은하수는 하늘을 가로지르는 커다란 강이었지요." },
        { w: "옥황상제", k: "하늘나라를 다스린다는 임금.", s: "하늘나라 임금 옥황상제의 하나뿐인 손녀였어요." },
        { w: "베", k: "실로 짠 천.", s: "베를 짜는 솜씨가 하늘나라 으뜸이었습니다." },
        { w: "으뜸", k: "여럿 가운데 첫째.", s: "베를 짜는 솜씨가 하늘나라 으뜸이었습니다." },
        { w: "베틀", k: "베를 짜는 나무 틀.", s: "직녀는 하루 종일 베틀 앞에 앉아 있었지요." },
        { w: "노을", k: "해가 뜨고 질 때 하늘이 붉게 물드는 것.", s: "직녀가 짠 베로 하늘의 구름과 노을을 지었다고 해요." }
    ],
    "03-meet.webp": [
        { w: "눈여겨보다", k: "주의 깊게 살펴보다.", s: "옥황상제는 두 사람을 눈여겨보았어요." },
        { w: "성실하다", k: "꾀부리지 않고 부지런하다.", s: "둘 다 참 성실하구나." },
        { w: "짝을 짓다", k: "둘을 부부로 맺어 주다.", s: "짝을 지어 주어야겠다." },
        { w: "흐뭇하다", k: "마음에 들어 기분이 좋다.", s: "옥황상제가 흐뭇하게 웃었어요." },
        { w: "맞잡다", k: "서로 마주 잡다.", s: "둘이 손을 맞잡은 날, 하늘나라 전체가 환하게 빛났대요." }
    ],
    "04-idle.webp": [
        { w: "손에 잡히다", k: "마음이 쏠려 일이 되어 가다.", s: "다른 일이 손에 잡히지 않았습니다." },
        { w: "뽀얗다", k: "먼지가 하얗게 덮인 모양.", s: "베틀에는 먼지가 뽀얗게 앉았지요." },
        { w: "내버려 두다", k: "돌보지 않고 그냥 두다.", s: "견우도 소 떼를 들판에 내버려 두었어요." },
        { w: "흩어지다", k: "여기저기 따로 떨어지다.", s: "소들은 아무 데나 흩어져 남의 밭까지 들어갔지요." },
        { w: "흐릿하다", k: "또렷하지 않고 흐리다.", s: "노을도 구름도 자꾸 흐릿해졌어요." }
    ],
    "05-anger.webp": [
        { w: "노하다", k: "몹시 화를 내다.", s: "마침내 옥황상제가 노했습니다." },
        { w: "게으르다", k: "부지런하지 않고 굼뜨다.", s: "서로 게을러지라는 뜻이 아니었다!" },
        { w: "잿빛", k: "재처럼 흐린 빛깔.", s: "하늘이 며칠째 잿빛인 것을 보아라!" },
        { w: "부르르", k: "잘게 떠는 모양.", s: "옥황상제의 수염이 부르르 떨렸지요." }
    ],
    "06-parted.webp": [
        { w: "정", k: "아끼고 사랑하는 마음.", s: "만나게 해 주는 것이 나의 마지막 정이다." },
        { w: "갈라지다", k: "따로 나뉘다.", s: "두 사람은 은하수 이쪽과 저쪽으로 갈라졌습니다." },
        { w: "묻히다", k: "다른 소리에 덮여 들리지 않다.", s: "목이 터져라 소리쳐도 물소리에 묻혔지요." }
    ],
    "07-year.webp": [
        { w: "살이 오르다", k: "몸에 살이 붙어 통통해지다.", s: "소들이 다시 살이 오르고 베틀 소리가 다시 울렸어요." }
    ],
    "08-river.webp": [
        { w: "한달음에", k: "쉬지 않고 단숨에.", s: "두 사람은 한달음에 은하수 강가로 달려갔어요." },
        { w: "숨이 턱에 차다", k: "숨이 몹시 가쁘다.", s: "숨이 턱에 차도록 뛰었지요." },
        { w: "강폭", k: "강의 너비.", s: "그런데 은하수 강폭이 너무나 넓었습니다." },
        { w: "목청껏", k: "있는 힘껏 큰 소리로.", s: "아무리 목청껏 소리쳐도 목소리가 닿지 않았지요." }
    ],
    "09-birds.webp": [
        { w: "갸웃하다", k: "고개를 조금 기울이다.", s: "까치와 까마귀들이 고개를 갸웃했습니다." },
        { w: "일제히", k: "여럿이 한꺼번에.", s: "새들이 일제히 하늘을 올려다보았어요." },
        { w: "사정", k: "일이 그렇게 된 까닭.", s: "사정을 알게 된 새들은 서로를 쳐다보았어요." },
        { w: "딱하다", k: "안됐고 가엾다.", s: "일 년에 하루도 못 만난다니 딱하기 그지없었거든요." }
    ],
    "10-bridge.webp": [
        { w: "요란하다", k: "시끄럽고 어수선하다.", s: "날갯짓 소리가 천둥 치듯 요란했어요." },
        { w: "줄지어", k: "줄을 서서 나란히.", s: "새들은 은하수 위에 모여 머리를 맞대고 줄지어 섰습니다." },
        { w: "맞대다", k: "서로 마주 대다.", s: "새들은 부리를 물고 날개를 맞대었어요." },
        { w: "오작교", k: "까마귀와 까치가 놓았다는 다리.", s: "사람들은 그 다리를 오작교라고 불렀답니다." }
    ],
    "11-reunion.webp": [
        { w: "이를 악물다", k: "이를 꽉 물고 참아 내다.", s: "새들은 이를 악물고 꿈쩍하지 않았어요." },
        { w: "꿈쩍하다", k: "조금이라도 움직이다.", s: "새들은 이를 악물고 꿈쩍하지 않았어요." },
        { w: "동이 트다", k: "날이 밝아 오다.", s: "동이 트자 새들이 하나둘 내려앉기 시작했지요." },
        { w: "힘이 다하다", k: "남은 힘이 없어지다.", s: "새들도 힘이 다해 가고 있었거든요." }
    ],
    "12-rain.webp": [
        { w: "굵다", k: "알이 크다.", s: "그해 칠석에 내린 빗방울은 굵고 따뜻했어요." },
        { w: "듬성듬성", k: "사이가 뜨고 성긴 모양.", s: "까치와 까마귀의 머리털이 듬성듬성해집니다." }
    ],
    "after": [
        { w: "장마", k: "여러 날 이어서 비가 내리는 때.", s: "실제로 그때가 우리나라 장마 끝 무렵입니다." },
        { w: "몫", k: "저마다 맡아서 해야 할 부분.", s: "좋아하느라 제 몫의 일을 놓았기 때문입니다." }
    ]
};
