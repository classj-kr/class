        ...
        beats: [
            {
                ...
                emoji: "🏠",
                left: [
                    "옛날 충주 땅에 소문난 부자가 살았어요. 논이 아주 넓고 곳간이 세 채나 되었지요.",
                    "그런데 그 집 앞에 서면 아무도 부자인 줄 몰랐어요.",
                    "지붕은 군데군데 내려앉고 담은 한쪽으로 기울어져 있었거든요.",
                    "마당에는 잡초가 무릎까지 자라 있었답니다."
                ],
                right: [
                    "동네 사람들은 그 앞을 지날 때마다 걸음을 늦추었어요.",
                    "\"저 집이 부잣집이라고?\"",
                    "\"쉿, 자린고비 어른 댁일세.\"",
                    "\"곳간 세 채가 다 쌀이라던데.\"",
                    "사람들이 수군거리며 지나갔지요. 대문은 오늘도 굳게 닫혀 있었답니다."
                ]
            },
            {
                art: "02-gulbi.webp",
                emoji: "🐟",
                left: [
                    "밥때가 되면 온 식구가 상 앞에 둘러앉았어요.",
                    "상 위에는 밥 한 그릇과 물 한 사발뿐이었어요. 나물 한 접시도 김치 한 조각도 없었지요.",
                    "대신 천장에서 굴비 한 마리가 대롱대롱 매달려 있었지요.",
                    "노릇노릇 잘 마른 굴비였어요."
                ],
                right: [
                    "자린고비가 숟가락을 들며 말했어요.",
                    "\"자, 한 술 뜨고 한 번 보아라.\"",
                    "식구들이 밥을 한 술 떴어요. 그러고는 고개를 들어 천장을 보았지요.",
                    "한 술, 한 번. 또 한 술, 또 한 번.",
                    "그것이 이 집의 반찬이었답니다."
                ]
            },
            {
                ...
                emoji: "😲",
                left: [
                    "그런데 그날, 막내가 그만 두 번을 쳐다보았습니다.",
                    "굴비가 하도 노릇노릇해서 눈이 자꾸 올라갔거든요.",
                    "자린고비의 숟가락이 딱 멈추었어요. 눈이 번쩍 뜨였지요.",
                    "\"이놈!\"",
                    "온 식구가 숟가락을 놓았어요."
                ],
                right: [
                    "자린고비가 벌떡 일어나 막내를 무섭게 내려다보았어요.",
                    "\"짜다! 짜! 어서 물을 마셔라!\"",
                    "막내는 물만 벌컥벌컥 들이켰어요. 입이 댓 발이나 나왔지요.",
                    "굴비는 그날도 천장에 그대로 매달려 있었답니다."
                ]
            },
            {
                art: "04-fan.webp",
                ...
                right: [
                    "옆에서 보던 아내가 눈이 휘둥그레졌어요.",
                    "\"영감, 그게 무슨 부채질이오?\"",
                    "자린고비는 고개를 흔들면서 대답했지요.",
                    "\"부채를 부치면 부채가 닳지 않소. 고개는 흔들어도 안 닳지요.\"",
                    "아내는 그만 할 말을 잃었답니다."
                ]
            }
        ]
        ...
        beats: [
            {
                ...
                emoji: "🪰",
                left: [
                    "하루는 파리 한 마리가 장독대에 앉았어요. 마침 된장독 뚜껑을 열어 둔 참이었지요.",
                    "파리가 된장을 앞발로 쓱 훔치더니 붕 날아올랐어요.",
                    "\"저놈 봐라! 내 된장!\"",
                    "자린고비가 눈을 부릅뜨고 벌떡 일어섰지요."
                ],
                right: [
                    "자린고비가 신도 못 신고 마당으로 뛰쳐나갔어요.",
                    "\"내 된장 내놓고 가거라!\"",
                    "장독대를 지나 담을 넘고 골목길까지 쫓아갔지요. 파리는 아랑곳없이 훨훨 날아갔어요.",
                    "그래도 자린고비는 멈추지 않았답니다."
                ]
            },
            {
                ...
                left: [
                    ...
                    "해가 기울도록 그렇게 갔어요. 숨이 턱까지 차올랐지요.",
                    "길 가던 사람이 그 꼴을 보고 물었어요.",
                    "\"어르신, 어디까지 가십니까?\""
                ],
                right: [
                    "\"한양! 저놈이 한양으로 가지 않느냐!\"",
                    "자린고비는 손가락으로 하늘을 가리키며 소리쳤어요.",
                    "구경하던 사람들이 배를 잡고 웃었지요. 파리 한 마리 때문에 한양까지 간다니요.",
                    "그래도 자린고비는 뒤도 돌아보지 않았답니다."
                ]
            },
            {
                art: "07-hanyang.webp",
                emoji: "🏙️",
                left: [
                    "사흘을 꼬박 걸어 한양 저잣거리에 닿았어요.",
                    "그런데 파리는 어느 기와집 담을 훌쩍 넘어 사라져 버렸습니다.",
                    "자린고비는 남의 집 담벼락에 털썩 주저앉았어요.",
                    "짚신은 다 해지고 발바닥은 벌겋게 부어 있었지요."
                ],
                right: [
            ...
            },
            {
                ...
                emoji: "🍚",
                left: [
                    "구두쇠가 대문을 두드리더니 인사도 없이 성큼 들어섰어요.",
                    "\"내가 경상도에서 온 사람이오.\"",
                    "자린고비는 반갑게 맞아들여 밥상을 내주었어요.",
                    "밥 한 그릇에 물 한 사발. 천장에는 어김없이 굴비가 매달려 있었지요."
                ],
                right: [
                    "구두쇠가 밥을 한 술 떴어요. 고개는 들지 않았지요.",
                    "두 술, 세 술. 그래도 그대로였어요.",
                    "자린고비가 숟가락을 놓고 쳐다보았어요.",
                    "\"손님, 굴비를 한 번도 안 보십니까?\"",
                    "\"보면 밥을 더 먹게 되지 않소.\"",
                    "자린고비가 그만 무릎을 탁 쳤답니다."
                ]
        ...
        beats: [
            {
                ...
                emoji: "🌾",
                left: [
                    "그해 여름, 비가 한 방울도 내리지 않았어요.",
                    "논바닥이 거북이 등처럼 쩍쩍 갈라졌어요. 개울도 바닥을 드러냈지요.",
                    "하늘은 날마다 쨍쨍하기만 했어요.",
                    "일곱 날이 가고 열흘이 가도 구름 한 점 뜨지 않았답니다."
                ],
                right: [
                    "벼는 뿌리째 말라 죽었어요. 가을이 되어도 거둘 것이 없었지요.",
                    "마을 사람들은 나무껍질을 벗겨다 죽을 쑤었어요.",
                    "그 죽마저 떨어진 집이 하나둘 늘어 갔지요.",
                    "아이들 울음소리가 밤새 끊이지 않았답니다."
                ]
            },
            {
                art: "11-mutter.webp",
                ...
                right: [
                    "그날 밤, 자린고비네 곳간에 불이 환하게 켜졌어요.",
                    "사람들이 담 밖에 몰려와 그것을 지켜보았지요.",
                    "\"보게, 밤새 쌀가마나 세고 있겠지.\"",
                    "다들 그렇게만 여기고 돌아갔어요. 불빛은 새벽까지 꺼지지 않았답니다."
                ]
            },
            {
                art: "12-open.webp",
                emoji: "🌅",
                left: [
                    "이튿날 새벽, 아직 동이 트기도 전이었어요.",
                    "쿵— 하는 소리에 마을 사람들이 잠에서 깼지요.",
                    "자린고비가 손수 곳간 문을 활짝 밀어젖힌 소리였어요.",
                    "문 안쪽으로 쌀가마가 마당 가득 줄지어 나와 있었답니다."
                ],
                right: [
                    "자린고비가 마당 한가운데 서서 목청껏 소리를 질렀어요.",
                    "\"한 집에 한 가마씩 가져가시오!\"",
                    "마을 사람들이 그 자리에 그대로 얼어붙었어요. 아무도 손을 내밀지 못했지요.",
                    "다들 잘못 들은 줄 알았거든요."
                ]
            },
            {
                ...
                emoji: "🍚",
                left: [
                    "사람들이 서로 눈치만 보았어요. 그러다 한 사람이 더듬더듬 물었지요.",
                    "\"어, 어르신… 이걸 다 내주시면…\"",
                    "\"곳간이 텅 빌 텐데요.\"",
                    "자린고비가 대문 기둥에 기대 빙긋 웃었어요.",
                    "삼십 년 만에 처음 보는 웃음이었지요."
                ],
                right: [
                    "\"내가 삼십 년을 아낀 게 무엇 때문이겠소.\"",
                    "자린고비의 목소리가 아주 담담했어요. 조금도 아까워하는 기색이 없었지요.",
                    "\"오늘 같은 날 쓰려고 아낀 것이지요.\"",
                    "사람들은 아무 말도 못 하고 서 있었어요. 눈이 벌게진 사람도 있었지요."
                ]
            },
            {
                art: "14-fish.webp",
                ...
                right: [
                    "\"자, 한 술 뜨고 한 번 보아라.\"",
                    "식구들이 밥을 한 술 뜨고 고개를 들었어요.",
                    "그런데 막내가 슬쩍, 또 슬쩍 두 번을 쳐다보았지요.",
                    "자린고비는 이번에는 못 본 척했어요. 그저 물그릇만 슬며시 밀어 주었답니다."
                ]
            }
        ],
        moral: "자린고비는 아끼는 것이 목적인 사람이 아니었어요. 아낀 것을 언제 써야 하는지 알고 있던 사람이었지요. 무엇을 아끼느냐보다 무엇을 위해 아끼느냐가 그 사람을 말해 준답니다.",
        question: "나는 무엇을 아끼고 있나요? 그것을 언제 쓰려고 아끼는 걸까요?"
    }
];
...
const COVER = {
    ...
    title: "자린고비",
    intro: [
        "자린고비는 충청도 충주 지방에서 전해 내려온 이야기예요. 지독하게 아끼는 사람을 두고 지금도 자린고비라고 부르지요.",
        "자린고비라는 말이 어디서 왔는지는 여러 이야기가 있어요. 제사 지낼 때 쓰는 글에 절인 고비라는 말이 있었다는 이야기, 기름에 절인 종이를 아까워 못 버렸다는 이야기 들이 함께 전해집니다.",
        "이야기의 자린고비에게는 짝이 되는 인물이 있어요. 경상도의 구두쇠 이야기와 자주 함께 묶여 전해지는데, 두 구두쇠가 서로 겨루다가 한쪽이 지고 마는 대목이 특히 인기가 많았답니다."
    ]
};
    ...
    spreads: [
        {
            ...
            left: [
                ...
                "다시 보면 이야기는 자린고비를 웃음거리로만 두지 않습니다. 흉년이 들었을 때 곳간을 여는 데까지 데려갑니다.",
                "그때 나온 쌀은 하늘에서 떨어진 것이 아닙니다. 굴비를 매달아 놓고 아끼던 그 세월이 쌓인 것입니다."
            ],
            right: [
                "자린고비는 아끼는 것이 목적인 사람이 아니었습니다. 아낀 것을 언제 써야 하는지 알고 있던 사람이었습니다. 무엇을 아끼느냐보다 무엇을 위해 아끼느냐가 그 사람을 말해 줍니다.",
                "나는 무엇을 아끼고 있나요? 그것을 언제 쓰려고 아끼는 걸까요?"
            ]
        }
    ]
};
...
const WORDS_KO = {
    "cover": [
        { w: "지독하다", k: "정도가 아주 심하다.", s: "지독하게 아끼는 사람을 두고 지금도 자린고비라고 부르지요." },
        { w: "제사", k: "조상을 기리며 올리는 예.", s: "제사 지낼 때 쓰는 글에 절인 고비라는 말이 있었다는 이야기" },
        { w: "구두쇠", k: "돈을 지나치게 아끼는 사람.", s: "경상도의 구두쇠 이야기와 자주 함께 묶여 전해지는데" },
        { w: "겨루다", k: "누가 더 나은지 다투다.", s: "두 구두쇠가 서로 겨루다가" }
    ],
    "01-house.webp": [
        { w: "곳간", k: "곡식이나 물건을 넣어 두는 창고.", s: "논이 아주 넓고 곳간이 세 채나 되었지요." },
        { w: "채", k: "집이나 건물을 세는 말.", s: "곳간이 세 채나 되었지요." },
        { w: "군데군데", k: "여기저기 몇 군데.", s: "지붕은 군데군데 내려앉고" },
        { w: "잡초", k: "저절로 나서 자라는 풀.", s: "마당에는 잡초가 무릎까지 자라 있었답니다." },
        { w: "수군거리다", k: "남몰래 작은 소리로 이야기하다.", s: "사람들이 수군거리며 지나갔지요." }
    ],
    "02-gulbi.webp": [
        { w: "밥때", k: "밥을 먹는 때.", s: "밥때가 되면 온 식구가 상 앞에 둘러앉았어요." },
        { w: "사발", k: "국이나 물을 담는 그릇.", s: "상 위에는 밥 한 그릇과 물 한 사발뿐이었어요." },
        { w: "굴비", k: "소금에 절여 말린 조기.", s: "천장에서 굴비 한 마리가 대롱대롱 매달려 있었지요." },
        { w: "대롱대롱", k: "매달려 흔들리는 모양.", s: "굴비 한 마리가 대롱대롱 매달려 있었지요." },
        { w: "노릇노릇", k: "알맞게 익어 누런 모양.", s: "노릇노릇 잘 마른 굴비였어요." },
        { w: "한 술", k: "숟가락으로 한 번 뜬 만큼.", s: "자, 한 술 뜨고 한 번 보아라." }
    ],
    "03-twice.webp": [
        { w: "벌컥벌컥", k: "물을 급히 들이켜는 모양.", s: "막내는 물만 벌컥벌컥 들이켰어요." },
        { w: "들이켜다", k: "물을 세게 들이마시다.", s: "막내는 물만 벌컥벌컥 들이켰어요." },
        { w: "입이 나오다", k: "못마땅해 뾰로통해지다.", s: "입이 댓 발이나 나왔지요." }
    ],
    "04-fan.webp": [
    ...
    "05-fly.webp": [
        { w: "장독대", k: "장독을 놓아두는 자리.", s: "하루는 파리 한 마리가 장독대에 앉았어요." },
        { w: "훔치다", k: "남의 것을 몰래 가져가다.", s: "파리가 된장을 앞발로 쓱 훔치더니 붕 날아올랐어요." },
        { w: "부릅뜨다", k: "눈을 크게 뜨고 노려보다.", s: "자린고비가 눈을 부릅뜨고 벌떡 일어섰지요." },
        { w: "아랑곳없이", k: "남이야 어떻든 마음 쓰지 않고.", s: "파리는 아랑곳없이 훨훨 날아갔어요." }
    ],
    "06-chase.webp": [
        { w: "헐레벌떡", k: "숨이 차 몹시 서두르는 모양.", s: "자린고비는 그 뒤를 헐레벌떡 쫓았지요." },
        { w: "기울다", k: "해가 저쪽으로 넘어가다.", s: "해가 기울도록 그렇게 갔어요." },
        { w: "숨이 턱까지 차다", k: "숨이 몹시 가쁘다.", s: "숨이 턱까지 차올랐지요." },
        { w: "꼴", k: "겉으로 드러난 모양새.", s: "길 가던 사람이 그 꼴을 보고 물었어요." }
    ],
    "07-hanyang.webp": [
        { w: "꼬박", k: "하나도 빠짐없이 그대로.", s: "사흘을 꼬박 걸어 한양 저잣거리에 닿았어요." },
        { w: "저잣거리", k: "옛날에 장이 서던 거리.", s: "사흘을 꼬박 걸어 한양 저잣거리에 닿았어요." },
        { w: "담벼락", k: "담의 벽.", s: "자린고비는 남의 집 담벼락에 털썩 주저앉았어요." },
        { w: "해지다", k: "낡아서 떨어지다.", s: "짚신은 다 해지고 발바닥은 벌겋게 부어 있었지요." },
    ...
    "09-contest.webp": [
        { w: "성큼", k: "큰 걸음으로 대뜸.", s: "구두쇠가 대문을 두드리더니 인사도 없이 성큼 들어섰어요." },
        { w: "맞아들이다", k: "손님을 맞아 안으로 들이다.", s: "자린고비는 반갑게 맞아들여 밥상을 내주었어요." },
        { w: "어김없이", k: "틀림없이 늘 그대로.", s: "천장에는 어김없이 굴비가 매달려 있었지요." },
        { w: "무릎을 치다", k: "옳다 싶어 반가워하다.", s: "자린고비가 그만 무릎을 탁 쳤답니다." }
    ],
    "10-drought.webp": [
        { w: "쩍쩍", k: "크게 갈라지는 모양.", s: "논바닥이 거북이 등처럼 쩍쩍 갈라졌어요." },
        { w: "쨍쨍하다", k: "볕이 몹시 내리쬐다.", s: "하늘은 날마다 쨍쨍하기만 했어요." },
        { w: "뿌리째", k: "뿌리까지 통째로.", s: "벼는 뿌리째 말라 죽었어요." },
        { w: "거두다", k: "익은 곡식을 걷어 들이다.", s: "가을이 되어도 거둘 것이 없었지요." },
        { w: "쑤다", k: "죽이나 풀을 끓여 만들다.", s: "마을 사람들은 나무껍질을 벗겨다 죽을 쑤었어요." }
    ],
    "11-mutter.webp": [
        { w: "흘깃거리다", k: "곁눈으로 자꾸 훔쳐보다.", s: "사람들이 자린고비네 담 너머를 흘깃거렸어요." },
        { w: "톨", k: "쌀이나 밤을 세는 말.", s: "그 양반이 쌀 한 톨을 내놓겠나." },
        { w: "어림도 없다", k: "도무지 될 리가 없다.", s: "어림도 없지." },
        { w: "절레절레", k: "고개를 좌우로 젓는 모양.", s: "사람들이 고개를 절레절레 흔들었어요." },
        { w: "쌀가마", k: "쌀을 담은 큰 자루.", s: "밤새 쌀가마나 세고 있겠지." }
    ],
    "12-open.webp": [
        { w: "동이 트다", k: "날이 밝아 오다.", s: "이튿날 새벽, 아직 동이 트기도 전이었어요." },
        { w: "손수", k: "남을 시키지 않고 제 손으로.", s: "자린고비가 손수 곳간 문을 활짝 밀어젖힌 소리였어요." },
        { w: "밀어젖히다", k: "힘껏 밀어 활짝 열다.", s: "곳간 문을 활짝 밀어젖힌 소리였어요." },
        { w: "목청껏", k: "있는 힘껏 큰 소리로.", s: "자린고비가 마당 한가운데 서서 목청껏 소리를 질렀어요." },
        { w: "얼어붙다", k: "놀라서 그대로 굳다.", s: "마을 사람들이 그 자리에 그대로 얼어붙었어요." }
    ],
    "13-share.webp": [
        { w: "눈치를 보다", k: "남의 기색을 살피다.", s: "사람들이 서로 눈치만 보았어요." },
        { w: "더듬더듬", k: "말이 자꾸 막히는 모양.", s: "그러다 한 사람이 더듬더듬 물었지요." },
        { w: "빙긋", k: "소리 없이 살짝 웃는 모양.", s: "자린고비가 대문 기둥에 기대 빙긋 웃었어요." },
        { w: "담담하다", k: "들뜨지 않고 차분하다.", s: "자린고비의 목소리가 아주 담담했어요." },
        { w: "기색", k: "마음이 겉으로 드러난 낌새.", s: "조금도 아까워하는 기색이 없었지요." }
    ],
    "14-fish.webp": [
        { w: "살림", k: "집안을 꾸려 가는 일.", s: "살림은 하나도 달라지지 않았어요." },
        { w: "여전히", k: "전과 다름없이.", s: "천장에는 여전히 굴비 한 마리가 매달려 있었어요." },
        { w: "슬며시", k: "남모르게 살그머니.", s: "그저 물그릇만 슬며시 밀어 주었답니다." }
    ],
    "after": [
        { w: "나무라다", k: "잘못을 꾸짖다.", s: "너무 여러 번 봤다고 나무라는 대목까지가 한 짝입니다." },
        { w: "웃음거리", k: "남의 웃음을 사는 일.", s: "이야기는 자린고비를 웃음거리로만 두지 않습니다." },
        { w: "세월", k: "흘러가는 시간.", s: "굴비를 매달아 놓고 아끼던 그 세월이 쌓인 것입니다." }
    ]
};
