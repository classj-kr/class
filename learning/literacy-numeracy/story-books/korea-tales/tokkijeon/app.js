...
const QUIZ = [
    ...
    { q: "자라는 자기에게 남들에게 없는 것이 무엇이라고 했습니까?", choices: ["빠른 헤엄과 남다른 큰 몸집", "높은 벼슬과 크게 세운 공", "등딱지와 물뭍 다 가는 발"], answer: 2 },
    { q: "자라가 육지로 가면서 챙겨 간 것은 무엇입니까?", choices: ["용왕이 준 구슬", "토끼 그림 한 장", "바다에서 난 약초"], answer: 1 },
    ...
    { q: "토끼가 용왕 앞에서 한 말은 무엇입니까?", choices: ["간이 원래 없다고 했다", "간을 줄 수 없다고 했다", "간을 바위틈에 두고 왔다고 했다"], answer: 2 },
    { q: "토끼는 잔치에서 왜 술을 한 방울도 마시지 않았습니까?", choices: ["취하면 말이 헛나올까 봐", "수궁 술이 입에 맞지 않아서", "몸이 안 좋다고 둘러대느라"], answer: 0 },
    { q: "토끼는 달아나면서 자라에게 무어라 했습니까?", choices: ["간은 바위틈에 있으니 찾아가시오", "다음에 벼슬을 받으러 다시 오겠소", "그대가 나를 속였으니 나도 속인 것이오"], answer: 2 },
    { q: "노인은 토끼의 간을 말한 참뜻이 무엇이라고 했습니까?", choices: ["토끼를 불러 벼슬을 주려고", "뭍에 오를 자가 있는지 보려고", "산삼 있는 곳을 알려 주려고"], answer: 1 },
    { q: "자라는 상을 사양하며 무어라 했습니까?", choices: ["거짓말을 한 낯이 없다고", "이미 충분히 받았다고", "고향으로 가겠다고"], answer: 0 },
    { q: "자라는 수궁에서 어떤 자리에 앉게 되었습니까?", choices: ["가장 높은 벼슬자리", "벼슬 없는 맨 앞자리", "예전 그대로 기둥 아래 끝자리"], answer: 1 },
    {
        q: "이 책을 읽고 난 반응으로 알맞지 않은 것은 무엇인가요?",
        wide: true,
        choices: [
            "용왕이 제 병 때문에 남의 간을 찾은 것을 보면, 윗자리의 병을 아랫것이 갚는 셈이구나.",
            "자라가 일부러 느릿느릿 돌아서 간 것을 보면, 남의 마음을 잘 아는 자라였네.",
...
const AFTERWORD = {
    ...
    paras: [
        ...
        `그 짧은 이야기가 조선에 와서 판소리 「수궁가」가 되었습니다. 부르는 사람마다 살을 붙이다 보니 용궁 신하들이 서로 안 가겠다고 다투는 대목이 생기고, 토끼가 뭍에서 만난 짐승들 이야기가 생기고, 자라가 그림 한 장을 들고 헤매는 대목이 생겼습니다. 원래는 몇 줄이던 것이 몇 시간짜리가 된 것입니다.`,
...
const EN = {
    ...
    quiz: [
        ...
        { q: "What did the turtle say he had that the others did not?", choices: ["Fast swimming and a big body", "High office and great deeds", "A shell and feet for both water and land"], answer: 2 },
        ...
        { q: "What did the rabbit tell the Dragon King?", choices: ["That he had never had a liver at all", "That he would not give up his liver", "That he had left his liver in a cleft of rock"], answer: 2 },
        { q: "Why did the rabbit not touch a drop of wine at the feast?", choices: ["He feared drink would make him let something slip", "Sea-palace wine was not to his taste", "He was pretending to be unwell"], answer: 0 },
        { q: "What did the rabbit say to the turtle as he ran off?", choices: ["My liver is in the rock cleft, go and fetch it", "I will come back another day for that office", "You tricked me, so I tricked you"], answer: 2 },
        { q: "What did the old man say he had really meant by naming the rabbit's liver?", choices: ["To bring the rabbit to court for an office", "To see whether anyone would go on land for the king", "To tell the turtle where the ginseng grew"], answer: 1 },
        ...
        { q: "What place did the turtle end up with in the sea palace?", choices: ["The highest office of all", "The front seat with no office", "His old place at the foot of the pillar"], answer: 1 },
        {
            q: "Which reaction to this book does NOT fit?",
            wide: true,
            choices: [
                "The Dragon King went looking for another's liver for his own illness, so those below pay for what those above do.",
                "The turtle turned and crawled off on purpose, ever so slowly, so he knew how minds work.",
