        ...
        beats: [
            {
                ...
                emoji: "🌫️",
                left: [
                    "옛날 어느 마을에 가난한 나무꾼이 살았습니다.",
                    "날마다 지게를 지고 산을 올랐지요.",
                    "그날도 나무꾼은 지게를 지고 깊은 산으로 들어갔어요.",
                    "웬일인지 마른 나뭇가지 하나 눈에 띄지 않았습니다.",
                    "\"오늘은 좀 많이 해야 할 텐데.\""
                ],
                right: [
                    "해 질 무렵, 안개 속에서 흰 수염 노인이 나타났어요.",
                    "나무꾼은 깜짝 놀라 뒤로 물러섰어요.",
                    "\"자네, 오늘 나무를 몇 짐이나 했나?\"",
                    "\"한 짐도 못 했습니다. 이대로 가면 식구들이 굶습니다.\"",
                    "나무꾼은 빈 지게를 내려놓고 고개를 숙였어요."
                ]
            },
            {
                art: "02-mortar.webp",
                emoji: "🪨",
                left: [
                    "노인은 품에서 작은 돌절구 하나를 꺼내 내밀었습니다.",
                    "곡식을 빻는 돌절구는 어른 주먹만 했어요.",
                    "겉이 반들반들 윤이 났지요.",
                    "\"딱하구먼. 이것을 가져가게.\"",
                    "\"무엇이든 이름을 부르고 나와라, 하면 그대로 나온다네.\""
                ],
                right: [
                    "\"멈출 때는 그만, 하고 말하면 되고. 잊지 말게.\"",
                    "노인이 나무꾼의 손에 절구를 쥐여 주었어요.",
                    "나무꾼이 고맙다는 말을 하려고 고개를 들었어요.",
                    "그런데 노인은 이미 사라지고 없었답니다. 안개만 자욱했지요.",
                    "나무꾼은 한참을 서 있었답니다."
                ]
            },
            {
                ...
                emoji: "🍚",
                left: [
                    "집에 돌아온 나무꾼은 절구를 방바닥 한가운데에 놓았어요.",
                    "아내와 아이들이 둘러앉았어요.",
                    "정말일까 싶어 조심스레 말해 보았지요.",
                    "\"설마 정말 나올까.\"",
                    "\"쌀아, 나와라.\"",
                    "그러자 절구에서 하얀 쌀이 콸콸 쏟아져 나왔습니다!"
                ],
                right: [
                    "방바닥이 온통 쌀로 덮였어요.",
                    "\"어이쿠, 그만! 그만!\"",
                    "쌀은 딱 멈췄어요.",
                    "나무꾼은 그 길로 이웃들을 불러 쌀을 나누어 주었습니다.",
                    "오랜만에 온 마을에 밥 짓는 연기가 피어올랐답니다."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "\"부르기만 하면 뭐든 나온다지 뭐야.\"",
                    "처음에는 아무도 믿지 않았어요.",
                    "그런데 나무꾼네 굴뚝에서 날마다 연기가 났지요.",
                    "소문은 온 마을에, 그리고 옆 마을까지 쫙 퍼졌어요."
                ],
                right: [
            ...
            },
            {
                ...
                left: [
                    "달도 없는 캄캄한 밤이었어요.",
                    "온 식구가 깊이 잠든 뒤였어요.",
                    "도둑은 담을 훌쩍 넘었습니다. 살금살금.",
                    "마루가 삐걱 소리를 냈지요.",
                    "방문을 슬며시 열자 절구가 놓여 있었지요.",
                    "도둑은 절구를 자루에 담아 등에 지고 달아났답니다."
                ],
                right: [
                    "\"이제 나는 부자다!\"",
                    "도둑은 뒤도 안 돌아보고 바닷가로 내달렸어요.",
                    "이대로 육지에 있다가는 붙잡힐 것 같았거든요.",
                    "작은 배 한 척을 풀어 힘껏 노를 저었습니다.",
                    "손바닥이 다 벗겨지도록 저었지요."
                ]
            },
            {
                ...
                left: [
                    "배가 먼바다까지 나아갔을 때였어요.",
                    "뭍이 보이지 않을 만큼 멀리 나갔어요.",
                    "도둑은 절구를 꺼내 놓고 한참을 궁리했습니다.",
                    "'무엇을 달라고 할까? 쌀은 흔해서 값이 안 나가고…'",
                    "도둑은 절구를 무릎에 올려놓았지요."
                ],
                right: [
                    "\"옳지, 소금이다! 소금은 금값이지!\"",
        ...
        beats: [
            {
                ...
                emoji: "😰",
                left: [
                    "소금은 금세 배 바닥을 하얗게 덮었습니다.",
                    "도둑의 발목이 소금에 묻혔어요.",
                    "\"하하! 이만하면 됐다!\"",
                    "그런데 소금은 멈추지 않았어요. 쏟아지고 또 쏟아졌지요.",
                    "그제야 이상하다 싶었지요."
                ],
                right: [
                    "\"나오지 마! 이러다 큰일 난다!\"",
            ...
            },
            {
                ...
                emoji: "🌊",
                left: [
                    "소금은 도둑의 무릎까지, 허리까지 차올랐어요.",
                    "배가 점점 낮아졌어요.",
                    "배가 기우뚱 기울기 시작했습니다.",
                    "뱃전으로 시커먼 바닷물이 넘어 들어왔지요.",
                    "도둑은 두 손으로 소금을 퍼냈지요."
                ],
                right: [
                    "\"살려 줘! 누가 좀 살려 줘!\"",
                    "파도가 뱃전을 넘어왔어요.",
                    "도둑은 목이 터져라 소리쳤어요.",
                    "하지만 먼바다 한가운데에는 아무도 없었답니다. 파도 소리만 철썩거렸지요.",
                    "소리는 파도에 묻혀 버렸답니다."
                ]
            },
            {
                ...
                left: [
                    "마침내 배가 스르르 가라앉았습니다.",
                    "뱃머리가 먼저 물속으로 사라졌어요.",
                    "도둑은 떠다니는 널빤지 하나를 겨우 붙잡았어요.",
                    "밤새도록 파도에 이리저리 떠밀려 다녔지요.",
                    "도둑은 죽을힘을 다해 널빤지에 매달렸지요."
                ],
                right: [
                    "이튿날 아침에야 겨우 뭍에 닿았습니다.",
                    "온몸이 소금에 절어 쓰라렸어요.",
                    "손에는 아무것도 남아 있지 않았어요.",
                    "절구도, 배도, 소금도 모두 바닷속이었지요.",
                    "도둑은 그제야 잘못을 뉘우쳤답니다."
                ]
            },
            {
                ...
                emoji: "🌊",
                left: [
                    "절구는 바닷속 깊이깊이 가라앉았습니다.",
                    "아무도 그것을 건져 올릴 수 없었어요.",
                    "그런데 그 뒤로도 절구는 멈추지 않았어요.",
                    "아무도 그만, 하고 말해 주지 않았으니까요.",
                    "바닷속에는 아무도 없었으니까요."
                ],
                right: [
                    "지금도 저 깊은 바닷속에서 소금을 내고 있대요.",
                    "멈출 줄을 모른답니다.",
                    "콸콸, 콸콸.",
                    "바닷물이 그렇게 짠 것은 다 그 때문이라고 한답니다."
                ]
            }
        ],
        moral: "쓰는 법을 다 알지 못하면서 손에 넣기만 하면, 그 물건이 도리어 나를 삼켜요. 도둑은 나오게 하는 말만 알았을 뿐 멈추는 말은 몰랐답니다.",
        question: "잘 모르는 것을 서둘러 손에 넣으려다 곤란해진 적이 있나요?"
    }
];
...
const COVER = {
    ...
    title: "신기한 절구",
    intro: [
        "신기한 절구는 지은이가 없는 구전 설화예요. 신기한 맷돌, 소금 나오는 맷돌이라는 이름으로도 전해진답니다.",
        "이 이야기는 유래담이에요. 바닷물이 왜 짠지를 이야기로 설명하지요. 놀라운 것은 거의 같은 이야기가 아주 먼 나라에도 있다는 점이에요. 북유럽에는 그로티라는 맷돌 이야기가 있고, 일본에도 비슷한 맷돌 이야기가 전해요. 서로 만난 적 없는 사람들이 같은 궁금증을 같은 방식으로 풀어낸 셈이지요.",
        "절구는 곡식의 껍질을 벗기거나 떡을 치는 데 쓰던 도구예요. 통나무나 돌을 파서 만든 통에 곡식을 넣고 공이로 쿵쿵 찧었지요. 집집마다 하나씩 있던 살림살이라 옛이야기에도 자주 나온답니다."
    ]
};
...
const QUIZ = [
    ...
    { q: "바닷속에 가라앉은 절구는 어떻게 되었나요?", choices: ["파도에 밀려 뭍으로 돌아왔다", "도둑이 다시 건져 올렸다", "지금도 소금을 내고 있다"], answer: 2 },
    {
        ...
        wide: true,
        choices: [
            "나무꾼이 쌀이 나오자 이웃부터 부른 것을 보면, 얻은 것을 어떻게 쓰느냐가 사람을 가르는구나.",
            "도둑이 멈추는 말을 못 들은 것을 보면, 훔친 것은 반쪽만 아는 셈이야.",
            "바닷물이 짠 까닭을 이렇게 풀어 놓은 것을 보면, 옛사람들은 큰 것에도 이야기를 붙였네.",
            "도둑이 뭍에 닿은 뒤 나무꾼을 찾아가 절구 값을 갚은 것을 보면, 뉘우친 마음이 진짜였겠다."
        ],
        answer: 3
    }
];
    ...
    spreads: [
        {
            art: 'end.webp',
            left: [
                "북유럽에서 전하는 이야기에서는 절구 대신 맷돌이 나옵니다. 그리고 그 맷돌은 지금도 바다 밑에서 돌고 있다고 합니다. 멈추는 말을 아는 이가 아직 없다는 뜻이지요.",
                "서로 멀리 떨어진 곳에서 같은 이야기가 나온 것이 아니라, 아주 오래전부터 사람에게서 사람에게로 건너다닌 것으로 봅니다.",
                "나무꾼은 절구를 얻고 나서 먼저 이웃에게 쌀을 나누었습니다. 같은 물건을 두고 두 사람이 처음 한 일이 달랐습니다."
            ],
            right: [
                "쓰는 법을 다 알지 못하면서 손에 넣기만 하면 그 물건이 도리어 나를 삼킵니다. 도둑은 나오게 하는 말만 알았을 뿐 멈추는 말은 몰랐습니다.",
                "잘 모르는 것을 서둘러 손에 넣으려다 곤란해진 적이 있나요?"
            ]
        }
    ]
};
...
const WORDS_KO = {
    "cover": [
        { w: "유래담", k: "왜 그렇게 되었는지 풀어 주는 이야기.", s: "이 이야기는 유래담이에요." },
        { w: "맷돌", k: "곡식을 갈아 가루로 만드는 돌.", s: "북유럽에는 그로티라는 맷돌 이야기가 있고" },
        { w: "절구", k: "곡식을 넣고 찧는 돌그릇.", s: "절구는 곡식의 껍질을 벗기거나 떡을 치는 데 쓰던 도구예요." },
        { w: "공이", k: "절구에 넣고 곡식을 찧는 방망이.", s: "통에 곡식을 넣고 공이로 쿵쿵 찧었지요." },
        { w: "살림살이", k: "집에서 쓰는 살림 물건.", s: "집집마다 하나씩 있던 살림살이라" }
    ],
    "01-mountain.webp": [
        { w: "나무꾼", k: "산에서 나무를 해다 파는 사람.", s: "옛날 어느 마을에 가난한 나무꾼이 살았습니다." },
        { w: "지게", k: "등에 지고 짐을 나르는 나무 틀.", s: "날마다 지게를 지고 산을 올랐지요." },
        { w: "웬일인지", k: "어찌 된 일인지.", s: "웬일인지 마른 나뭇가지 하나 눈에 띄지 않았습니다." },
        { w: "짐", k: "한 번에 지고 나르는 만큼.", s: "자네, 오늘 나무를 몇 짐이나 했나?" },
        { w: "수염", k: "어른 남자의 턱이나 입가에 난 털.", s: "안개 속에서 흰 수염 노인이 나타났어요." }
    ],
    "02-mortar.webp": [
        { w: "빻다", k: "짓찧어 가루로 만들다.", s: "곡식을 빻는 돌절구는 어른 주먹만 했어요." },
        { w: "반들반들", k: "매끄럽고 윤이 나는 모양.", s: "겉이 반들반들 윤이 났지요." },
        { w: "딱하다", k: "안됐고 가엾다.", s: "딱하구먼. 이것을 가져가게." },
        { w: "자욱하다", k: "안개가 잔뜩 끼다.", s: "안개만 자욱했지요." }
    ],
    "03-rice.webp": [
        { w: "조심스레", k: "마음을 놓지 않고 삼가며.", s: "정말일까 싶어 조심스레 말해 보았지요." },
        { w: "설마", k: "아무리 그래도.", s: "설마 정말 나올까." },
        { w: "콸콸", k: "세차게 쏟아지는 소리.", s: "절구에서 하얀 쌀이 콸콸 쏟아져 나왔습니다!" },
        { w: "그 길로", k: "그 자리에서 곧바로.", s: "나무꾼은 그 길로 이웃들을 불러 쌀을 나누어 주었습니다." }
    ],
    "04-rumor.webp": [
        { w: "굴뚝", k: "연기가 빠져나가는 길.", s: "나무꾼네 굴뚝에서 날마다 연기가 났지요." },
        { w: "주막", k: "옛날에 술과 밥을 팔고 재워 주던 집.", s: "그 소문을 주막에 앉아 있던 도둑 하나가 들었지요." },
        { w: "평생", k: "살아 있는 동안 내내.", s: "그 절구만 있으면 평생 놀고먹겠구나." },
        { w: "꿀꺽꿀꺽", k: "자꾸 삼키는 모양.", s: "도둑은 침을 꿀꺽꿀꺽 삼켰습니다." },
        { w: "어슬렁거리다", k: "천천히 이리저리 돌아다니다.", s: "밤마다 나무꾼네 담 밖을 어슬렁거렸답니다." }
    ],
    "05-steal.webp": [
        { w: "훌쩍", k: "가볍게 뛰어넘는 모양.", s: "도둑은 담을 훌쩍 넘었습니다." },
        { w: "살금살금", k: "남몰래 조용히 움직이는 모양.", s: "도둑은 담을 훌쩍 넘었습니다. 살금살금." },
        { w: "삐걱", k: "나무가 쓸리며 나는 소리.", s: "마루가 삐걱 소리를 냈지요." },
        { w: "슬며시", k: "남모르게 살그머니.", s: "방문을 슬며시 열자 절구가 놓여 있었지요." },
        { w: "자루", k: "물건을 담는 큰 주머니.", s: "도둑은 절구를 자루에 담아 등에 지고 달아났답니다." },
        { w: "내달리다", k: "힘껏 뛰어가다.", s: "도둑은 뒤도 안 돌아보고 바닷가로 내달렸어요." },
        { w: "육지", k: "물이 아닌 뭍.", s: "이대로 육지에 있다가는 붙잡힐 것 같았거든요." },
        { w: "노", k: "배를 저어 나아가게 하는 긴 막대.", s: "작은 배 한 척을 풀어 힘껏 노를 저었습니다." }
    ],
    "06-salt.webp": [
        { w: "먼바다", k: "뭍에서 멀리 떨어진 바다.", s: "배가 먼바다까지 나아갔을 때였어요." },
        { w: "뭍", k: "바다가 아닌 땅.", s: "뭍이 보이지 않을 만큼 멀리 나갔어요." },
        { w: "궁리하다", k: "이리저리 헤아려 생각하다.", s: "도둑은 절구를 꺼내 놓고 한참을 궁리했습니다." },
        { w: "흔하다", k: "자주 있어 귀하지 않다.", s: "쌀은 흔해서 값이 안 나가고" },
        { w: "금값", k: "아주 비싼 값.", s: "소금은 금값이지!" },
        { w: "소복이", k: "수북하게 쌓인 모양.", s: "배 바닥에 소복이 쌓였지요." },
        { w: "껑충껑충", k: "크게 뛰는 모양.", s: "도둑은 손뼉을 치며 껑충껑충 뛰었어요." }
    ],
    "07-more.webp": [
        { w: "금세", k: "아주 빨리.", s: "소금은 금세 배 바닥을 하얗게 덮었습니다." },
        { w: "발목", k: "발과 다리가 이어진 곳.", s: "도둑의 발목이 소금에 묻혔어요." },
        { w: "마구", k: "함부로 세게.", s: "도둑이 절구를 두 손으로 붙들고 마구 흔들었어요." }
    ],
    "08-sinking.webp": [
        { w: "차오르다", k: "점점 가득 차다.", s: "소금은 도둑의 무릎까지, 허리까지 차올랐어요." },
        { w: "기우뚱", k: "한쪽으로 기우는 모양.", s: "배가 기우뚱 기울기 시작했습니다." },
        { w: "뱃전", k: "배의 가장자리.", s: "뱃전으로 시커먼 바닷물이 넘어 들어왔지요." },
        { w: "퍼내다", k: "안에 든 것을 떠서 밖으로 내다.", s: "도둑은 두 손으로 소금을 퍼냈지요." },
        { w: "묻히다", k: "다른 소리에 덮여 들리지 않다.", s: "소리는 파도에 묻혀 버렸답니다." }
    ],
    "09-plank.webp": [
        { w: "가라앉다", k: "물속으로 내려가다.", s: "마침내 배가 스르르 가라앉았습니다." },
        { w: "뱃머리", k: "배의 앞부분.", s: "뱃머리가 먼저 물속으로 사라졌어요." },
        { w: "널빤지", k: "넓고 판판한 나뭇조각.", s: "도둑은 떠다니는 널빤지 하나를 겨우 붙잡았어요." },
        { w: "떠밀리다", k: "물결에 밀려 이리저리 다니다.", s: "밤새도록 파도에 이리저리 떠밀려 다녔지요." },
        { w: "죽을힘", k: "죽기를 각오하고 내는 힘.", s: "도둑은 죽을힘을 다해 널빤지에 매달렸지요." },
        { w: "이튿날", k: "그다음 날.", s: "이튿날 아침에야 겨우 뭍에 닿았습니다." },
        { w: "절다", k: "소금기가 속까지 배어들다.", s: "온몸이 소금에 절어 쓰라렸어요." },
        { w: "뉘우치다", k: "잘못을 깨닫고 뉘우치다.", s: "도둑은 그제야 잘못을 뉘우쳤답니다." }
    ],
    "10-sea.webp": [
        { w: "건져 올리다", k: "물속에 있는 것을 꺼내 올리다.", s: "아무도 그것을 건져 올릴 수 없었어요." }
    ],
    "after": [
        { w: "도리어", k: "오히려 거꾸로.", s: "그 물건이 도리어 나를 삼킵니다." },
        { w: "곤란하다", k: "어렵고 딱한 처지가 되다.", s: "서둘러 손에 넣으려다 곤란해진 적이 있나요?" }
    ]
};
