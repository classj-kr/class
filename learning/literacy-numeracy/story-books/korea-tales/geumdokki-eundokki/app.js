        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "아내와 어린 아이 둘이 그 도끼 하나만 바라보고 살았어요.",
                    "새벽에 산에 올라 해가 져야 내려왔지요."
                ],
                right: [
                    "\"이 도끼가 우리 식구를 먹여 살린다.\"",
                    "도끼는 제 몸처럼 아끼는 물건이었지요. 나무꾼은 밤마다 도끼날을 숫돌에 갈았어요.",
                    "날이 무디면 나무가 안 넘어가거든요.",
                    "스윽, 스윽 하는 소리가 밤늦도록 났답니다."
                ]
            },
            {
                art: "02-splash.webp",
                emoji: "💦",
                left: [
                    "그날 나무꾼은 연못가 나무를 찍고 있었어요.",
                    "아름드리나무라 좀처럼 넘어가지 않았지요.",
                    "팍! 팍!",
                    "도끼질을 할 때마다 이마에서 땀이 비 오듯 흘렀습니다.",
                    "손잡이가 자꾸 미끄러웠어요.",
                    "그래도 나무꾼은 쉬지 않았지요."
                ],
                right: [
                    "그러다 그만 손잡이가 땀에 쭉 미끄러졌지 뭐예요. 도끼가 손에서 훌쩍 날아올랐어요.",
                    "풍덩!",
                    "물이 사방으로 높이 튀어 올랐지요.",
                    "도끼는 깊은 연못 한가운데로 가라앉았습니다.",
                    "\"아이고, 저를 어째! 내 도끼!\""
                ]
            },
            {
                ...
                emoji: "😭",
                left: [
                    "나무꾼은 물가에 털썩 주저앉았어요. 연못은 바닥이 안 보일 만큼 깊었습니다.",
                    "헤엄쳐 들어가 볼 엄두도 나지 않았지요.",
                    "물속을 한참이나 들여다보았어요.",
                    "\"저 도끼가 없으면 우리 식구는 뭘 먹고 사나.\""
                ],
                right: [
                    "나무꾼은 무릎에 얼굴을 묻고 엉엉 울었지요. 아이들 얼굴이 눈앞에 아른거렸어요.",
                    "빈손으로는 집에 갈 수가 없었습니다.",
                    "그러는 사이 해가 뉘엿뉘엿 넘어갔어요.",
                    "나무꾼은 그래도 일어서지 못했답니다."
                ]
            },
            {
                ...
                left: [
                    "그때였습니다.",
                    "연못 한가운데가 환해지더니 물이 스르르 갈라졌어요. 갈라진 물 사이로 하얀 빛이 솟았지요.",
                    "흰 수염에 흰옷을 입은 노인이 물 위로 올라섰습니다.",
                    "나무꾼은 눈이 부셔 손으로 얼굴을 가렸어요."
                ],
                right: [
                    "\"어인 일로 그리 서럽게 우느냐?\"",
                    "그 목소리가 온 산에 우렁우렁 울렸어요.",
                    "나무꾼은 두 눈을 비비고 또 비볐지요.",
                    "꿈이 아니었습니다. 이 산의 산신령이었어요.",
                    "나무꾼은 물가에 그대로 넙죽 엎드렸답니다."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                emoji: "🥇",
                left: [
                    "산신령이 물속으로 손을 넣더니 도끼 하나를 꺼냈어요. 번쩍번쩍하는 금도끼였지요.",
                    "어두워진 연못가가 대번에 환해졌어요.",
                    "날에서 금빛이 뚝뚝 떨어지는 것 같았습니다.",
                    "나무꾼은 그런 도끼를 본 적이 없었지요."
                ],
                right: [
                    "\"이것이 네 도끼냐?\"",
                    "산신령이 그 금도끼를 나무꾼 앞에 쑥 내밀었어요. 나무꾼은 도끼를 빤히 들여다보았습니다.",
                    "\"아닙니다. 제 것이 아닙니다.\"",
                    "나무꾼은 얼른 고개를 저었지요.",
                    "조금도 망설이지 않았답니다."
                ]
            },
            {
                ...
                emoji: "🥈",
                left: [
                    "산신령이 다시 물속에 손을 넣어 은도끼를 꺼냈어요. 은도끼가 달빛처럼 하얗게 빛났습니다.",
                    "손잡이에는 은실까지 곱게 감겨 있었지요.",
                    "\"그러면 이것이 네 도끼냐?\"",
                    "평생 한 번도 본 적 없는 도끼였어요."
                ],
                right: [
                    "\"그것도 제 것이 아닙니다. 제 도끼는 쇠도끼입니다.\"",
                    "나무꾼은 또 한 번 고개를 저었어요. 목소리가 조금도 흔들리지 않았지요.",
                    "산신령이 나무꾼의 얼굴을 가만히 살폈습니다.",
                    "나무꾼은 눈도 피하지 않았답니다."
                ]
            },
            {
                ...
                emoji: "🪓",
                left: [
                    "산신령이 세 번째로 손을 넣었어요. 이번에 꺼낸 것은 금도 은도 아니었지요.",
                    "날이 다 닳고 손잡이가 반들반들해진 낡은 쇠도끼였습니다.",
                    "여기저기 이가 빠진 볼품없는 도끼였어요.",
                    "그런데 나무꾼의 얼굴이 대번에 환해졌지요."
                ],
                right: [
                    "\"예! 그겁니다! 그게 제 도끼입니다!\"",
                    "나무꾼이 저도 모르게 소리를 질렀지요. 두 손을 내밀며 펄쩍펄쩍 뛰었어요.",
                    "아이처럼 좋아서 어쩔 줄을 몰랐습니다.",
                    "금도끼를 볼 때와는 얼굴이 아주 달랐답니다."
                ]
            },
            {
                art: "08-reward.webp",
                ...
                left: [
                    "산신령이 그만 껄껄 웃고 말았어요.",
                    "흰 수염이 들썩일 만큼 한참을 크게 웃었지요.",
                    "\"금과 은을 앞에 두고도 제 것만 찾는구나.\"",
                    "\"요즘 세상에 참으로 드문 일이로구나.\"",
                    "\"그러니 이 도끼 셋을 모두 가져가거라.\""
                ],
                right: [
                    "산신령이 도끼 셋을 모두 내밀었어요.",
                    "\"예? 저는 이 쇠도끼면 됩니다!\"",
                    "나무꾼이 손사래를 쳤지요.",
                    "\"그러니 주는 것이다.\"",
                    "산신령은 그 말만 남기고 사라졌습니다. 나무꾼은 그날 부자가 되었답니다."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "\"연못에 도끼만 빠뜨리면 된다고?\"",
                    "밤새 잠도 자지 않고 궁리했지요. 이튿날 욕심쟁이는 제 도끼를 들고 연못으로 달려갔습니다.",
                    "그러고는 있는 힘껏 물 한가운데로 던졌어요."
                ],
                right: [
                    "\"아이고, 내 도끼! 내 도끼! 엉엉!\"",
                    "일부러 눈물까지 짜내며 울었지요. 그런데 우는 소리가 어찌나 어색했는지 몰라요.",
                    "울다가 슬쩍 연못 쪽을 곁눈질하기도 했어요.",
                    "그래도 한참을 그렇게 울어 댔답니다."
                ]
            },
            {
                ...
                emoji: "💨",
                left: [
                    "그런데 정말로 물이 갈라지고 산신령이 나타났어요. 산신령이 금도끼를 꺼내 들고 물었지요.",
                    "욕심쟁이는 속으로 옳지 하고 좋아했어요.",
                    "\"이것이 네 도끼냐?\"",
                    "\"예! 바로 그겁니다! 제 것이 맞습니다!\"",
                    "대답이 너무 빨랐지요."
                ],
                right: [
                    "\"네 것이 아닌 줄 알면서 그러느냐.\"",
                    "산신령이 욕심쟁이를 한참 내려다보았어요. 그러고는 금도끼를 도로 물속에 넣고 스르르 사라졌습니다.",
                    "욕심쟁이는 제가 던진 도끼마저 끝내 찾지 못했어요.",
                    "빈손으로 터덜터덜 집에 돌아갔답니다."
                ]
            }
        ],
...
const COVER = {
    ...
    title: "금도끼 은도끼",
    intro: [
        "금도끼 은도끼는 우리나라에서 모르는 사람이 거의 없는 이야기예요. 그런데 뿌리는 우리 옛이야기가 아니라 이솝 우화랍니다.",
        "이솝 우화에 실린 원래 제목은 나무꾼과 헤르메스예요. 헤르메스는 그리스 신화에 나오는 심부름꾼 신이고, 도끼를 빠뜨린 곳도 연못이 아니라 강가였답니다.",
        "우리나라에는 1906년 초등소학이라는 교과서에 처음 실렸어요. 그때는 신도 산신령도 아니고 그냥 노인이었지요. 강가가 산속 연못이 되고 노인이 산신령이 된 것은 그 뒤의 일이랍니다.",
        "산신령은 우리 옛이야기에서 산을 지키는 신이에요. 흰 수염에 흰옷을 입고 나타나 사람을 시험하거나 도와주지요. 호랑이를 데리고 다니는 모습으로도 자주 그려진답니다."
    ]
};
    ...
    spreads: [
        {
            ...
            left: [
                ...
                "욕심쟁이가 잃은 것도 다시 보십시오. 금도끼를 못 얻은 것이 아니라 제 쇠도끼마저 잃었습니다. 얻으러 갔다가 있던 것을 놓친 것이지요."
            ],
            right: [
                "나무꾼이 금도끼를 마다한 것은 욕심이 없어서가 아니었습니다. 가난한 사람에게 금도끼가 왜 탐나지 않았겠습니까. 다만 제 것이 아닌 것을 제 것이라 말할 수가 없었을 뿐입니다.",
                "내 것이 아닌 줄 알면서 갖고 싶었던 것이 있나요?"
            ]
        }
    ]
};
...
const WORDS_KO = {
    "cover": [
        { w: "뿌리", k: "처음 나온 밑바탕.", s: "그런데 뿌리는 우리 옛이야기가 아니라 이솝 우화랍니다." },
        { w: "우화", k: "짐승을 빌려 가르침을 주는 이야기.", s: "뿌리는 우리 옛이야기가 아니라 이솝 우화랍니다." },
        { w: "신화", k: "신이나 나라의 시작을 이야기한 옛이야기.", s: "헤르메스는 그리스 신화에 나오는 심부름꾼 신이고" },
        { w: "산신령", k: "산을 지킨다고 믿던 신.", s: "산신령은 우리 옛이야기에서 산을 지키는 신이에요." },
        { w: "시험하다", k: "어떤 사람인지 알아보려고 겪게 하다.", s: "흰 수염에 흰옷을 입고 나타나 사람을 시험하거나 도와주지요." }
    ],
    "01-woodcutter.webp": [
        { w: "나무꾼", k: "산에서 나무를 해다 파는 사람.", s: "옛날 어느 산골에 가난한 나무꾼이 살았습니다." },
        { w: "지게", k: "등에 지고 짐을 나르는 나무 틀.", s: "가진 것이라고는 지게 하나와 낡은 쇠도끼 한 자루뿐이었지요." },
        { w: "자루", k: "도끼나 연장을 세는 말.", s: "낡은 쇠도끼 한 자루뿐이었지요." },
        { w: "숫돌", k: "칼이나 도끼를 가는 돌.", s: "나무꾼은 밤마다 도끼날을 숫돌에 갈았어요." },
        { w: "무디다", k: "날이 날카롭지 않다.", s: "날이 무디면 나무가 안 넘어가거든요." }
    ],
    "02-splash.webp": [
        { w: "아름드리", k: "두 팔로 안아야 할 만큼 굵은.", s: "아름드리나무라 좀처럼 넘어가지 않았지요." },
        { w: "좀처럼", k: "여간해서는.", s: "아름드리나무라 좀처럼 넘어가지 않았지요." },
        { w: "비 오듯", k: "몹시 많이 흐르는 모양.", s: "도끼질을 할 때마다 이마에서 땀이 비 오듯 흘렀습니다." },
        { w: "사방", k: "온 둘레.", s: "물이 사방으로 높이 튀어 올랐지요." },
        { w: "가라앉다", k: "물속으로 내려가다.", s: "도끼는 깊은 연못 한가운데로 가라앉았습니다." }
    ],
    "03-cry.webp": [
        { w: "털썩", k: "갑자기 힘없이 주저앉는 모양.", s: "나무꾼은 물가에 털썩 주저앉았어요." },
        { w: "엄두", k: "감히 해 보려는 마음.", s: "헤엄쳐 들어가 볼 엄두도 나지 않았지요." },
        { w: "아른거리다", k: "자꾸 눈앞에 어렴풋이 떠오르다.", s: "아이들 얼굴이 눈앞에 아른거렸어요." },
        { w: "뉘엿뉘엿", k: "해가 천천히 넘어가는 모양.", s: "그러는 사이 해가 뉘엿뉘엿 넘어갔어요." }
    ],
    "04-spirit.webp": [
        { w: "스르르", k: "소리 없이 천천히 움직이는 모양.", s: "연못 한가운데가 환해지더니 물이 스르르 갈라졌어요." },
        { w: "수염", k: "어른 남자의 턱이나 입가에 난 털.", s: "흰 수염에 흰옷을 입은 노인이 물 위로 올라섰습니다." },
        { w: "눈이 부시다", k: "빛이 세어 바로 보기 어렵다.", s: "나무꾼은 눈이 부셔 손으로 얼굴을 가렸어요." },
        { w: "어인", k: "어찌 된.", s: "어인 일로 그리 서럽게 우느냐?" },
        { w: "서럽다", k: "몹시 슬프고 억울하다.", s: "어인 일로 그리 서럽게 우느냐?" },
        { w: "우렁우렁", k: "소리가 크게 울리는 모양.", s: "그 목소리가 온 산에 우렁우렁 울렸어요." },
        { w: "넙죽", k: "바닥에 대고 얼른 엎드리는 모양.", s: "나무꾼은 물가에 그대로 넙죽 엎드렸답니다." }
    ],
    "05-gold.webp": [
        { w: "번쩍번쩍", k: "빛이 자꾸 나는 모양.", s: "번쩍번쩍하는 금도끼였지요." },
        { w: "대번에", k: "단번에 곧.", s: "어두워진 연못가가 대번에 환해졌어요." },
        { w: "빤히", k: "눈여겨 똑바로 보는 모양.", s: "나무꾼은 도끼를 빤히 들여다보았습니다." },
        { w: "망설이다", k: "할까 말까 마음을 못 정하다.", s: "조금도 망설이지 않았답니다." }
    ],
    "06-silver.webp": [
        { w: "은실", k: "은으로 만든 가는 실.", s: "손잡이에는 은실까지 곱게 감겨 있었지요." },
        { w: "평생", k: "살아 있는 동안 내내.", s: "평생 한 번도 본 적 없는 도끼였어요." },
        { w: "살피다", k: "두루 자세히 보다.", s: "산신령이 나무꾼의 얼굴을 가만히 살폈습니다." }
    ],
    "07-iron.webp": [
        { w: "닳다", k: "오래 써서 줄어들다.", s: "날이 다 닳고 손잡이가 반들반들해진 낡은 쇠도끼였습니다." },
        { w: "반들반들", k: "매끄럽고 윤이 나는 모양.", s: "손잡이가 반들반들해진 낡은 쇠도끼였습니다." },
        { w: "이가 빠지다", k: "날의 한쪽이 떨어져 나가다.", s: "여기저기 이가 빠진 볼품없는 도끼였어요." },
        { w: "볼품없다", k: "겉모양이 초라하다.", s: "여기저기 이가 빠진 볼품없는 도끼였어요." }
    ],
    "08-reward.webp": [
        { w: "껄껄", k: "크게 소리 내어 웃는 모양.", s: "산신령이 그만 껄껄 웃고 말았어요." },
        { w: "들썩이다", k: "자꾸 들렸다 내려앉다.", s: "흰 수염이 들썩일 만큼 한참을 크게 웃었지요." },
        { w: "드물다", k: "흔하지 않다.", s: "요즘 세상에 참으로 드문 일이로구나." },
        { w: "손사래를 치다", k: "손을 내저어 사양하다.", s: "나무꾼이 손사래를 쳤지요." }
    ],
    "09-copy.webp": [
        { w: "궁리하다", k: "이리저리 생각하다.", s: "밤새 잠도 자지 않고 궁리했지요." },
        { w: "이튿날", k: "그다음 날.", s: "이튿날 욕심쟁이는 제 도끼를 들고 연못으로 달려갔습니다." },
        { w: "짜내다", k: "억지로 나오게 하다.", s: "일부러 눈물까지 짜내며 울었지요." },
        { w: "어색하다", k: "자연스럽지 않고 서툴러 보이다.", s: "우는 소리가 어찌나 어색했는지 몰라요." },
        { w: "곁눈질", k: "곁으로 슬쩍 보는 짓.", s: "울다가 슬쩍 연못 쪽을 곁눈질하기도 했어요." }
    ],
    "10-greedy.webp": [
        { w: "옳지", k: "잘됐다 싶을 때 내는 말.", s: "욕심쟁이는 속으로 옳지 하고 좋아했어요." },
        { w: "도로", k: "다시 본디대로.", s: "금도끼를 도로 물속에 넣고 스르르 사라졌습니다." },
        { w: "터덜터덜", k: "힘없이 걷는 모양.", s: "빈손으로 터덜터덜 집에 돌아갔답니다." }
    ],
    "after": [
        { w: "세월", k: "흘러가는 시간.", s: "그 이야기가 아주 오랜 세월에 걸쳐 여러 나라를 건너오면서" },
        { w: "마다하다", k: "싫다고 물리치다.", s: "나무꾼이 금도끼를 마다한 것은 욕심이 없어서가 아니었습니다." },
        { w: "탐나다", k: "갖고 싶은 마음이 나다.", s: "가난한 사람에게 금도끼가 왜 탐나지 않았겠습니까." }
    ]
};
