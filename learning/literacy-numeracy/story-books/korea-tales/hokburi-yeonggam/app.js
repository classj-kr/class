        ...
        beats: [
            {
                ...
                emoji: "👴",
                left: [
                    "옛날 어느 마을에 혹부리 영감이 살았습니다. 턱 밑에 주먹만 한 혹이 하나 달려 있었지요.",
                    "걸을 때마다 그 혹이 덜렁덜렁 흔들렸어요. 아이들은 그것이 신기해 자꾸 쳐다보았답니다.",
                    "\"이 혹도 나하고 한평생이지.\"",
                    "영감은 하루 종일 싱글벙글이었지요."
                ],
                right: [
                    "영감은 노래를 어찌나 잘 부르는지요. 밭에서 노래를 시작하면 온 마을이 일손을 멈췄지요.",
                    "\"허, 저 소리 한번 좋구먼.\"",
                    "아이들도 영감 곁에 몰려 앉았어요.",
                    "\"영감, 한 곡 더 해 보시게!\"",
                    "사람들은 영감의 혹을 흉보는 대신 노래를 청했답니다."
                ]
            },
            {
                ...
                emoji: "🌄",
                left: [
                    "어느 날 영감은 나무를 하러 깊은 산에 들어갔습니다. 노래를 흥얼거리며 마른 가지를 척척 쳐 냈지요.",
                    "일이 하도 재미나서 시간 가는 줄을 몰랐어요.",
                    "\"한 짐만 더, 한 짐만 더.\"",
                    "\"이런, 벌써 이렇게 됐나.\"",
                    "그러다 그만 해가 넘어가 버렸답니다."
                ],
                right: [
                    "산속은 눈 깜짝할 사이에 캄캄해졌습니다. 어디가 길인지 벼랑인지 알 수 없었지요.",
                    "\"이거 큰일 났구먼.\"",
                    "나뭇가지에 옷이 자꾸 걸렸어요.",
                    "\"오늘 밤은 꼼짝없이 산에서 새우겠는걸.\"",
                    "영감은 지게를 지고 더듬더듬 골짜기 쪽으로 걸었어요."
                ]
            },
            {
                art: "03-hut.webp",
                emoji: "🏚️",
                left: [
                    "다행히 골짜기 안쪽에 빈 오두막이 있었습니다. 영감은 문을 밀고 들어가 지게를 내려놓았지요.",
                    "방바닥에 먼지가 뽀얗게 쌓여 있었어요. 오래 비어 있던 집이 분명했답니다.",
                    "\"오늘 밤은 여기서 신세를 지자.\"",
                    "어찌나 조용한지 오히려 무서웠지요."
                ],
                right: [
                    "바람이 문틈으로 휘휘 들어올 때마다 등골이 서늘해졌습니다. 어디선가 부엉이 우는 소리도 들렸지요.",
                    "\"에라, 노래나 부르자.\"",
                    "목소리가 오두막 안에 잘 울렸어요.",
                    "\"무서울 땐 노래가 제일이지.\"",
                    "영감은 목청을 가다듬고 노래를 시작했답니다."
                ]
            },
            {
                ...
                emoji: "👹",
                left: [
                    "노래가 두 곡, 세 곡 이어졌을 때였습니다. 영감은 무서운 것도 잊고 신이 나 있었지요.",
                    "쿵.",
                    "쿵.",
                    "쿵.",
                    "누가 발로 땅을 구르며 다가오는 소리였어요.",
                    "\"누, 누구요?\""
                ],
                right: [
                    "문이 벌컥 열리더니 시뻘건 도깨비 하나가 성큼 들어섰습니다.",
                    "뿔이 지붕에 닿을 듯이 컸지요.",
                    "뒤로 초록 도깨비와 새파란 아기 도깨비가 줄줄이 따라 들어왔어요.",
                    "영감은 노래를 뚝 멈추고 벽에 딱 붙었답니다. 다리가 굳어 도망칠 수도 없었지요."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                emoji: "❓",
                left: [
                    "도깨비 대장이 성큼성큼 다가왔어요. 영감의 얼굴에 코가 닿을 만큼 가까이 왔지요.",
                    "\"방금 그 소리, 네가 낸 것이냐?\"",
                    "도깨비의 콧김이 뜨거웠어요.",
                    "\"예, 예… 그렇습니다만.\"",
                    "영감의 목소리가 덜덜 떨렸습니다."
                ...
                right: [
                    ...
                    "도깨비들이 눈을 부릅뜨고 영감을 위아래로 들여다보았어요. 아기 도깨비는 영감의 옷자락까지 들춰 보았지요.",
                    "\"어서 말하지 못할까!\"",
                    "영감은 머리가 하얘졌습니다. 무슨 말이라도 해야 할 것 같았답니다."
                ]
            },
            {
                art: "06-lie.webp",
                ...
                right: [
                    ...
                    "\"우리도 노래를 부르고 싶다!\"",
                    "\"어쩐지 소리가 통통하더라니.\"",
                    "도깨비들은 서로 마주 보며 고개를 끄덕였습니다. 아기 도깨비는 손뼉까지 쳤지요."
                ]
            },
            {
                art: "07-trade.webp",
                ...
                left: [
                    ...
                    "\"어, 어르신들…\"",
                    "\"값은 넉넉히 쳐주마!\"",
                    "대장 도깨비가 노란 방망이를 뚝딱! 뚝딱! 두드렸어요. 방망이가 부딪힐 때마다 불꽃이 튀었지요."
                ],
                right: [
                    "금덩이가, 은덩이가, 구슬이 와르르 쏟아졌습니다. 어느새 영감의 무릎까지 수북이 쌓였지요.",
                    "\"이만하면 됐지?\"",
                    "\"자, 이제 혹을 내놓아라.\"",
                    "도깨비는 영감의 턱에서 혹을 쏙 떼어 갔답니다. 신기하게도 아프지가 않았어요."
                ]
            },
            {
                art: "08-home.webp",
                emoji: "🎉",
                left: [
                    "날이 밝자 영감은 산을 내려왔습니다. 턱은 매끈하고 지게에는 보물이 가득했지요.",
                    "마을 사람들이 영감을 보고 눈이 휘둥그레졌어요.",
                    "\"어디 좀 봅시다!\"",
                    "\"아니, 자네 혹은 어디 갔나?\""
                ],
                right: [
                    ...
                    "\"금덩이까지 받고 말일세.\"",
                    "\"세상에 이런 일이!\"",
                    "영감이 지게를 내려 보물을 보여 주자 사람들은 입을 다물지 못했습니다.",
                    "그날부터 마을이 온통 그 이야기로 들썩였답니다."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                emoji: "😏",
                left: [
                    "이웃 마을에도 혹부리 영감이 하나 살았어요. 그런데 이 영감은 욕심이 아주 많았지요.",
                    "소문을 듣자마자 한달음에 달려와 꼬치꼬치 캐물었습니다.",
                    "\"나도 가서 팔아야겠다!\"",
                    "\"어느 오두막인가? 노래는 무얼 불렀나?\""
                ],
                right: [
                    "\"몇 시쯤 왔던가? 도깨비가 몇이나 되던가?\"",
                    "\"허허, 그게 그렇게 될 일이 아닐 텐데.\"",
                    "\"괜히 갔다 후회하지 마시게.\"",
                    "첫 번째 영감이 웃으며 말렸지만 소용이 없었어요.",
                    "욕심쟁이 영감은 그길로 지팡이를 짚고 산으로 올라갔답니다."
                ]
            },
            {
                art: "10-sing.webp",
                emoji: "🎤",
                left: [
                    "그날 밤, 욕심쟁이 영감은 그 오두막에 떡하니 앉아 있었어요. 벌써 보물 생각에 입이 벌어졌지요.",
                    "\"자, 부르자!\"",
                    "\"어서 오너라, 도깨비들아!\"",
                    "영감은 목청껏 노래를 불렀습니다. 산이 떠나가라 소리를 질렀지요."
                ],
                right: [
                    "그런데 소리가 영 신통치 않았어요. 갈라지고 흔들리고 박자가 하나도 맞지 않았지요.",
                    "그래도 얼마 지나지 않아 쿵, 쿵, 쿵 소리가 났습니다.",
                    "\"옳지, 걸렸다!\"",
                    "도깨비들이 정말로 나타난 것이었어요. 영감은 속으로 신이 났답니다."
                ]
            },
            {
                art: "11-angry.webp",
                emoji: "😡",
                left: [
                    "\"이 소리도 혹에서 나옵니다! 어서 사 가시오!\"",
                    "욕심쟁이 영감이 턱을 쑥 내밀었어요. 손바닥까지 내밀며 값을 재촉했지요.",
                    "\"값은 넉넉히 쳐주셔야 합니다!\"",
                    "그런데 도깨비들의 얼굴이 시퍼렇게 굳어졌습니다."
                ],
                right: [
            ...
            },
            {
                ...
                left: [
                    "\"그 가짜 혹, 도로 가져가라!\"",
                    "대장 도깨비가 지난번에 떼어 간 혹을 품에서 꺼냈어요.",
                    "\"안 돼! 안 된다니까!\"",
                    "그러고는 욕심쟁이 영감의 턱 반대쪽에 척 붙여 버렸지요. 도깨비들은 그대로 사라졌답니다."
                ],
                right: [
                    "욕심쟁이 영감은 혹을 둘이나 달고 터덜터덜 산을 내려왔습니다. 턱이 양쪽으로 덜렁덜렁했지요.",
                    "보물은커녕 혹만 하나 더 얻은 것이었어요.",
                    "\"아이고, 내 신세야.\"",
...
const COVER = {
    ...
    title: "혹부리 영감",
    intro: [
        "혹부리 영감은 지은이가 없는 구전 설화예요. 우리가 흔히 쓰는 속담 하나가 이 이야기에서 나왔는데, 그것이 무엇인지는 다 읽고 나면 알게 된답니다.",
        "혹은 목이나 턱에 볼록하게 생기는 살덩이예요. 옛날에는 흔한 것이었고 아프지도 않았지만, 눈에 띄다 보니 놀림을 받기도 했지요. 이 이야기가 오래 사랑받은 데는, 누구나 하나쯤 감추고 싶은 것이 있다는 마음도 있었을 거예요.",
        "일본에도 거의 같은 이야기가 있어요. 일제강점기에 교과서로 퍼진 일본 이야기가 우리 이야기와 섞였다고 보는 학자도 있고, 두 나라에 각각 오래전부터 있었다고 보는 학자도 있답니다. 아직도 연구가 이어지는 문제예요."
    ]
};
    ...
    spreads: [
        {
            ...
            left: [
                ...
                "다시 보면 첫 번째 영감은 도깨비를 만나러 간 것이 아닙니다. 날이 저물어 빈 오두막에 들었다가 무서워서 노래를 부른 것입니다.",
...
const WORDS_KO = {
    "cover": [
        { w: "속담", k: "옛날부터 전해 오는 짧은 가르침의 말.", s: "우리가 흔히 쓰는 속담 하나가 이 이야기에서 나왔는데" },
        { w: "혹", k: "몸에 볼록 튀어나온 살덩이.", s: "혹은 목이나 턱에 볼록하게 생기는 살덩이예요." },
        { w: "일제강점기", k: "일본에 나라를 빼앗겼던 때.", s: "일제강점기에 교과서로 퍼진 일본 이야기가" }
    ],
    "01-oldman.webp": [
        { w: "영감", k: "나이 든 남자를 이르는 말.", s: "옛날 어느 마을에 혹부리 영감이 살았습니다." },
        { w: "덜렁덜렁", k: "매달린 것이 자꾸 흔들리는 모양.", s: "걸을 때마다 그 혹이 덜렁덜렁 흔들렸어요." },
        { w: "한평생", k: "살아 있는 동안 내내.", s: "이 혹도 나하고 한평생이지." },
        { w: "싱글벙글", k: "기분 좋게 자꾸 웃는 모양.", s: "영감은 하루 종일 싱글벙글이었지요." },
        { w: "일손을 멈추다", k: "하던 일을 잠시 그만두다.", s: "밭에서 노래를 시작하면 온 마을이 일손을 멈췄지요." },
        { w: "흉보다", k: "남의 흠을 들추어 말하다.", s: "사람들은 영감의 혹을 흉보는 대신 노래를 청했답니다." },
        { w: "청하다", k: "해 달라고 부탁하다.", s: "사람들은 영감의 혹을 흉보는 대신 노래를 청했답니다." }
    ],
    "02-mountain.webp": [
        { w: "흥얼거리다", k: "낮은 소리로 노래하다.", s: "노래를 흥얼거리며 마른 가지를 척척 쳐 냈지요." },
        { w: "짐", k: "한 번에 지고 나르는 만큼.", s: "한 짐만 더, 한 짐만 더." },
        { w: "벼랑", k: "깎아지른 듯한 낭떠러지.", s: "어디가 길인지 벼랑인지 알 수 없었지요." },
        { w: "꼼짝없이", k: "어찌해 볼 수 없이.", s: "오늘 밤은 꼼짝없이 산에서 새우겠는걸." },
        { w: "밤을 새우다", k: "자지 않고 밤을 보내다.", s: "오늘 밤은 꼼짝없이 산에서 새우겠는걸." },
        { w: "더듬더듬", k: "잘 안 보여 손으로 만지며 가는 모양.", s: "영감은 지게를 지고 더듬더듬 골짜기 쪽으로 걸었어요." },
        { w: "골짜기", k: "산과 산 사이 깊고 좁은 곳.", s: "더듬더듬 골짜기 쪽으로 걸었어요." }
    ],
    "03-hut.webp": [
        { w: "오두막", k: "작고 허름한 집.", s: "골짜기 안쪽에 빈 오두막이 있었습니다." },
        { w: "지게", k: "등에 지고 짐을 나르는 나무 틀.", s: "영감은 문을 밀고 들어가 지게를 내려놓았지요." },
        { w: "뽀얗다", k: "먼지 따위가 하얗게 덮인 모양.", s: "방바닥에 먼지가 뽀얗게 쌓여 있었어요." },
        { w: "신세를 지다", k: "남의 도움을 받다.", s: "오늘 밤은 여기서 신세를 지자." },
        { w: "등골이 서늘하다", k: "무서워서 등이 오싹하다.", s: "바람이 문틈으로 휘휘 들어올 때마다 등골이 서늘해졌습니다." },
        { w: "가다듬다", k: "흐트러진 것을 바로잡다.", s: "영감은 목청을 가다듬고 노래를 시작했답니다." }
    ],
    "04-dokkaebi.webp": [
        { w: "벌컥", k: "갑자기 세게 여는 모양.", s: "문이 벌컥 열리더니 시뻘건 도깨비 하나가 성큼 들어섰습니다." },
        { w: "시뻘겋다", k: "아주 붉다.", s: "시뻘건 도깨비 하나가 성큼 들어섰습니다." },
        { w: "성큼", k: "큰 걸음으로 대뜸.", s: "시뻘건 도깨비 하나가 성큼 들어섰습니다." },
        { w: "줄줄이", k: "여럿이 줄을 지어.", s: "뒤로 초록 도깨비와 새파란 아기 도깨비가 줄줄이 따라 들어왔어요." }
    ],
    "05-question.webp": [
        { w: "콧김", k: "코로 내쉬는 뜨거운 숨.", s: "도깨비의 콧김이 뜨거웠어요." },
        { w: "덜덜", k: "무서워 몸을 떠는 모양.", s: "영감의 목소리가 덜덜 떨렸습니다." },
        { w: "부릅뜨다", k: "눈을 크게 뜨고 노려보다.", s: "도깨비들이 눈을 부릅뜨고 영감을 위아래로 들여다보았어요." },
        { w: "옷자락", k: "옷의 아래로 드리운 부분.", s: "아기 도깨비는 영감의 옷자락까지 들춰 보았지요." },
        { w: "머리가 하얘지다", k: "놀라서 아무 생각도 안 나다.", s: "영감은 머리가 하얘졌습니다." }
    ],
    "06-lie.webp": [
        { w: "일제히", k: "여럿이 한꺼번에.", s: "그런데 도깨비들의 눈이 일제히 반짝였어요." }
    ],
    "07-trade.webp": [
        { w: "넉넉히", k: "모자람 없이 넉넉하게.", s: "값은 넉넉히 쳐주마!" },
        { w: "쳐주다", k: "값을 매겨 주다.", s: "값은 넉넉히 쳐주마!" },
        { w: "방망이", k: "무엇을 두드리는 굵은 막대.", s: "대장 도깨비가 노란 방망이를 뚝딱! 뚝딱! 두드렸어요." },
        { w: "와르르", k: "한꺼번에 쏟아지는 모양.", s: "금덩이가, 은덩이가, 구슬이 와르르 쏟아졌습니다." },
        { w: "수북이", k: "많이 쌓여 소복한 모양.", s: "어느새 영감의 무릎까지 수북이 쌓였지요." }
    ],
    "08-home.webp": [
        { w: "매끈하다", k: "걸리는 것 없이 반드럽다.", s: "턱은 매끈하고 지게에는 보물이 가득했지요." },
        { w: "휘둥그레지다", k: "놀라서 눈이 커지다.", s: "마을 사람들이 영감을 보고 눈이 휘둥그레졌어요." },
        { w: "들썩이다", k: "여럿이 떠들썩하게 움직이다.", s: "그날부터 마을이 온통 그 이야기로 들썩였답니다." }
    ],
    "09-greedy.webp": [
        { w: "한달음에", k: "쉬지 않고 단숨에.", s: "소문을 듣자마자 한달음에 달려와 꼬치꼬치 캐물었습니다." },
        { w: "꼬치꼬치", k: "하나하나 자세히.", s: "한달음에 달려와 꼬치꼬치 캐물었습니다." },
        { w: "캐묻다", k: "자꾸 따져 묻다.", s: "한달음에 달려와 꼬치꼬치 캐물었습니다." },
        { w: "말리다", k: "못 하게 붙잡다.", s: "첫 번째 영감이 웃으며 말렸지만 소용이 없었어요." }
    ],
    "10-sing.webp": [
        { w: "떡하니", k: "버젓이 자리를 차지한 모양.", s: "욕심쟁이 영감은 그 오두막에 떡하니 앉아 있었어요." },
        { w: "목청껏", k: "있는 힘껏 큰 소리로.", s: "영감은 목청껏 노래를 불렀습니다." },
        { w: "신통치 않다", k: "그리 좋지 않다.", s: "그런데 소리가 영 신통치 않았어요." },
        { w: "박자", k: "노래의 규칙적인 마디.", s: "갈라지고 흔들리고 박자가 하나도 맞지 않았지요." }
    ],
    "11-angry.webp": [
        { w: "재촉하다", k: "빨리하라고 조르다.", s: "손바닥까지 내밀며 값을 재촉했지요." },
        { w: "시퍼렇다", k: "몹시 푸르다. 화난 얼굴빛.", s: "도깨비들의 얼굴이 시퍼렇게 굳어졌습니다." },
        { w: "고함", k: "크게 지르는 소리.", s: "도깨비들의 고함에 오두막이 쩌렁쩌렁 울렸답니다." }
    ],
    "12-two.webp": [
        { w: "가짜", k: "진짜처럼 꾸민 것.", s: "그 가짜 혹, 도로 가져가라!" },
        { w: "척", k: "아주 선뜻 붙이는 모양.", s: "욕심쟁이 영감의 턱 반대쪽에 척 붙여 버렸지요." },
        { w: "터덜터덜", k: "힘없이 걷는 모양.", s: "욕심쟁이 영감은 혹을 둘이나 달고 터덜터덜 산을 내려왔습니다." },
        { w: "신세", k: "처지나 형편.", s: "아이고, 내 신세야." }
    ]
};
