const CHAPTERS = [
        ...
        beats: [
            {
                ...
                emoji: "😴",
                left: [
                    "김 첨지는 일보다 낮잠을 좋아하는 사람이었습니다. 지게를 지고 산에 올라가서는 나무는 안 하고 그늘부터 찾았지요.",
                    "그날도 커다란 나무 그늘에 벌렁 드러누웠어요.",
                    "솔바람이 얼굴을 간질이자 곧 코를 골았답니다.",
                    "\"오늘은 나무보다 잠이 먼저지.\""
                ],
                right: [
            ...
            },
            {
                ...
                left: [
                    ...
                    "부채질 한 번, 두 번.",
                    "그런데 코끝이 갑자기 간질간질하지 뭐예요.",
                    "\"어허, 이거 시원하구나.\"",
                    "김 첨지는 부채질을 멈추지 않았답니다."
                ],
                right: [
                    "쑤욱—",
                    "코가 손가락 하나만큼 길어졌습니다!",
                    "김 첨지는 제 코를 두 손으로 붙잡고 눈을 껌뻑였어요.",
                    "\"어어? 내 코가 왜 이래!\"",
                    "꿈인가 싶어 볼을 세게 꼬집어 보기까지 했지요."
                ]
            },
            {
                art: "03-blue.webp",
                ...
                left: [
                    "\"으악! 이게 무슨 일이야!\"",
                    "김 첨지는 허둥지둥 파란 부채를 집어 들었습니다. 무슨 생각이 있어서가 아니라 그냥 손에 잡혔거든요.",
                    "파란 부채를 부치자마자 코가 스르륵 제자리로 돌아왔어요.",
                    "김 첨지는 그제야 숨을 크게 내쉬었지요."
                ],
                right: [
                    "김 첨지는 한참을 멍하니 앉아 있었습니다. 그러다 입가에 슬며시 웃음이 번졌지요.",
                    "'옳거니. 이걸로 돈을 벌겠구나.'",
                    "빨간 부채는 코를 늘이고 파란 부채는 코를 줄인다는 것이지요.",
                    "김 첨지는 부채 두 자루를 소매에 감추고 산을 내려왔답니다."
                ]
            },
            {
                art: "04-feast.webp",
                ...
                right: [
                    "김 첨지는 슬금슬금 기둥 뒤로 물러났습니다.",
                    "소매 속에서 빨간 부채를 꺼냈어요.",
                    "살랑, 살랑, 살랑.",
                    "아무도 기둥 뒤의 김 첨지를 눈여겨보지 않았어요.",
                    "부채가 움직일 때마다 김 첨지의 눈이 반짝였답니다."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "한 뼘, 두 뼘, 세 뼘.",
                    "처음에는 아무도 알아채지 못했어요. 그러다 국그릇에 코가 풍덩 빠지고 말았지요.",
                    "\"어어? 저게 뭐야!\"",
                    "옆에 앉은 사람이 젓가락을 떨어뜨렸어요."
                ],
                right: [
                    "\"으아악! 영감님 코가!\"",
                    "잔칫상이 뒤집히고 온 집안이 발칵 뒤집혔습니다. 손님들이 비명을 지르며 달아났지요.",
                    "영감의 코는 밤새도록 자라 마당까지 뻗어 나갔지요.",
                    "의원을 셋이나 불렀지만 아무도 그 코를 고치지 못했답니다."
                ]
            },
            {
                art: "06-cure.webp",
                emoji: "🩺",
                left: [
                    "그렇게 사흘이 지났어요. 영감의 코는 여전히 마당까지 뻗어 있었지요.",
                    "영감은 밥도 못 먹고 잠도 못 잤답니다.",
                    "\"코를 고쳐 주는 이에게 큰 상을 내리겠소!\"",
                    "그제야 김 첨지가 어슬렁어슬렁 나타났습니다."
                ],
                right: [
                    "김 첨지는 소매 속에서 파란 부채를 꺼내 몇 번 부쳤어요. 그러자 영감의 코가 스르륵 줄어들었지요.",
                    "\"오오! 이런 재주가!\"",
                    "그런데 영감은 코가 줄어든 것도 잊고 부채만 뚫어져라 바라보았어요.",
                    "그 파란 부채에서 도무지 눈을 뗄 수가 없었답니다."
                ]
            },
            {
                art: "07-trade.webp",
                ...
                left: [
                    ...
                    "\"싫습니다. 이걸로 먹고사는걸요.\"",
                    "\"값은 부르는 대로 주겠소!\"",
                    "김 첨지는 고개를 절레절레 저었어요. 그럴수록 영감의 마음은 더 달았지요."
                ],
                right: [
                    "\"그럼 이 집을 통째로 주겠소!\"",
                    "\"…예?\"",
                    "\"기와집도, 곳간도, 마당도 다 주겠소!\"",
                    "영감의 눈에서 불이 났습니다.",
                    "김 첨지는 못 이기는 척 부채 두 자루를 다 내밀었답니다."
                ]
            },
            {
                art: "08-moveout.webp",
                ...
                left: [
                    ...
                    "보따리를 머리에 이고, 지게에 세간을 지고, 항아리를 품에 안고.",
                    "줄줄이 대문을 나서는 모습이 꼭 피난 가는 것 같았어요.",
                    "구경 나온 마을 사람들이 혀를 끌끌 찼어요."
                ],
                right: [
                    "\"영감님, 정말 이래도 되는 겁니까?\"",
                    "\"시끄럽다! 저 부채만 있으면 집 열 채도 짓는다!\"",
                    "영감은 부채를 꼭 쥐고 큰소리를 쳤어요.",
                    "식구들은 울상이 되어 줄줄이 걸어 나갔답니다.",
                    "\"그깟 부채가 집보다 낫단 말입니까!\""
                ]
            }
        ]
    },
    {
        ...
        beats: [
            {
                ...
                right: [
                    "그러자 제 코가 쭉쭉 뻗어 올라갔어요. 영감은 그것이 어찌나 신기한지 몰랐지요.",
                    "\"하하! 이거 재미있구나!\"",
                    "\"더! 더!\"",
                    "영감은 멈출 줄을 몰랐답니다.",
                    "코가 자랄 때마다 영감은 배를 잡고 웃었지요."
                ]
            },
            {
                art: "10-sky.webp",
                ...
                left: [
                    ...
                    "지나가던 새가 깜짝 놀라 옆으로 비켜 날았지요.",
                    "그래도 영감은 부채질을 멈추지 않았습니다.",
                    "구름을 뚫고도 코는 계속 올라갔답니다.",
                    "\"이 맛에 부채를 샀지!\""
                ],
                right: [
                    "\"더! 더 높이!\"",
                    "영감은 자기 코가 어디까지 갔는지도 몰랐어요.",
                    "아래에서 부채질만 할 뿐이었지요.",
                    "그런데 그 구름 위에는 하늘나라가 있었답니다. 영감은 그것을 까맣게 몰랐지요."
                ]
            },
            {
                art: "11-emperor.webp",
                emoji: "🍚",
                left: [
                    "그때 옥황상제는 한창 밥을 드시는 중이었습니다. 밥상에 좋아하는 나물이 잔뜩 올라와 있었지요.",
                    "덜컹, 덜컹.",
                    "갑자기 상이 흔들리기 시작했어요.",
                    "옥황상제가 눈살을 찌푸렸지요."
                ],
            ...
            },
            {
                ...
                right: [
                    "\"저것을 그냥 둘 수는 없다.\"",
                    "\"거참 흉하구나. 흔들리지 않게 꽁꽁 묶어 두어라!\"",
                    "신하들이 굵은 밧줄을 들고 달려들었어요. 기둥을 몇 겹으로 칭칭 감아 놓았지요.",
                    "매듭을 어찌나 단단히 지었는지 꼼짝도 하지 않았지요."
                ]
            },
            {
                art: "13-tied.webp",
                ...
                left: [
                    ...
                    "\"아야야야! 아파! 아프다고!\"",
                    "영감은 허겁지겁 파란 부채를 부쳤습니다.",
                    "\"아이고, 코가 떨어지겠네!\""
                ],
                right: [
                    "그런데 코가 줄어들자 이번에는 몸이 하늘로 쑥 딸려 올라갔어요. 발이 땅에서 떨어졌지요.",
                    "\"어어어? 이건 또 뭐야!\"",
                    "영감은 두 발을 버둥거리며 하늘로 끌려 올라갔어요.",
                    "\"허, 기둥에 사람이 달렸구나.\"",
                    "하늘 신하들이 어이없어했답니다."
                ]
            },
        ...
        moral: "부자는 집을 주고 부채를 얻었고, 김 첨지는 부채를 주고 집을 얻었어요. 그런데 둘 다 남은 것이 없었지요. 제 힘으로 얻지 않은 것은 손에 오래 머물지 않는답니다.",
        question: "내가 가진 것 가운데 내 힘으로 얻은 것은 무엇인가요?"
    }
];
...
const COVER = {
    ...
    title: "빨간 부채 파란 부채",
    intro: [
        "빨간 부채 파란 부채는 지은이가 없는 구전 설화예요. 부치기만 하면 코가 늘었다 줄었다 하는 부채 두 자루가 나오는 이야기랍니다.",
        "일본과 중국에도 이와 아주 닮은 이야기가 전해요. 특히 일본에는 코가 늘어나는 부채 이야기가 널리 알려져 있어서, 세 나라를 오가며 퍼진 이야기로 보는 학자가 많답니다.",
        "코가 길어진다는 생각이 우스운 까닭은, 코가 얼굴에서 가장 눈에 띄면서도 마음대로 할 수 없는 곳이기 때문이에요. 옛이야기는 이렇게 몸의 한 군데를 크게 부풀려 웃음을 만들곤 한답니다."
    ]
};
    ...
    spreads: [
        {
            art: 'end.webp',
            left: [
                "몸이 늘었다 줄었다 하는 이야기는 아이들이 유난히 좋아합니다. 일본에도 같은 이야기가 있습니다. 눈에 보이는 것이 대뜸 달라지는 것만큼 재미난 구경거리가 없기 때문이지요.",
                "그런데 이런 이야기의 끝은 대개 같습니다. 그 물건을 얻은 사람은 오래 가지고 있지 못합니다. 물건이 사람을 시험하기 때문입니다.",
                "김 첨지가 부채를 처음 얻은 자리도 다시 보십시오. 그것도 제 힘으로 만든 것이 아니었습니다."
            ],
            right: [
                "부자는 집을 주고 부채를 얻었고 김 첨지는 부채를 주고 집을 얻었습니다. 그런데 둘 다 남은 것이 없었습니다. 제 힘으로 얻지 않은 것은 손에 오래 머물지 않습니다.",
                "내가 가진 것 가운데 내 힘으로 얻은 것은 무엇인가요?"
            ]
        }
    ]
};
...
const WORDS_KO = {
    "cover": [
        { w: "자루", k: "부채나 연장을 세는 말.", s: "부채 두 자루가 나오는 이야기랍니다." },
        { w: "학자", k: "한 가지를 깊이 공부하는 사람.", s: "세 나라를 오가며 퍼진 이야기로 보는 학자가 많답니다." },
        { w: "부풀리다", k: "실제보다 크게 하다.", s: "몸의 한 군데를 크게 부풀려 웃음을 만들곤 한답니다." }
    ],
    "01-nap.webp": [
        { w: "첨지", k: "옛날에 나이 든 남자를 부르던 말.", s: "김 첨지는 일보다 낮잠을 좋아하는 사람이었습니다." },
        { w: "지게", k: "등에 지고 짐을 나르는 나무 틀.", s: "지게를 지고 산에 올라가서는 나무는 안 하고 그늘부터 찾았지요." },
        { w: "벌렁", k: "뒤로 눕거나 자빠지는 모양.", s: "그날도 커다란 나무 그늘에 벌렁 드러누웠어요." },
        { w: "솔바람", k: "소나무 사이로 부는 바람.", s: "솔바람이 얼굴을 간질이자 곧 코를 골았답니다." },
        { w: "늘어지게", k: "아주 편하게 실컷.", s: "한숨 늘어지게 자고 일어나 보니" },
        { w: "사방", k: "온 둘레.", s: "김 첨지는 사방을 둘러보았지만 아무도 없었답니다." }
    ],
    "02-red.webp": [
        { w: "참", k: "마침 그때.", s: "마침 덥던 참이라 김 첨지는 빨간 부채를 집어 얼굴에 부쳤어요." },
        { w: "제법", k: "꽤 그럴듯하게.", s: "바람이 제법 시원했지요." },
        { w: "간질간질하다", k: "자꾸 간지러운 느낌이 들다.", s: "그런데 코끝이 갑자기 간질간질하지 뭐예요." },
        { w: "껌뻑이다", k: "눈을 자꾸 감았다 뜨다.", s: "김 첨지는 제 코를 두 손으로 붙잡고 눈을 껌뻑였어요." },
        { w: "꼬집다", k: "살을 집어 비틀다.", s: "꿈인가 싶어 볼을 세게 꼬집어 보기까지 했지요." }
    ],
    "03-blue.webp": [
        { w: "허둥지둥", k: "정신없이 서두르는 모양.", s: "김 첨지는 허둥지둥 파란 부채를 집어 들었습니다." },
        { w: "스르륵", k: "소리 없이 천천히 움직이는 모양.", s: "코가 스르륵 제자리로 돌아왔어요." },
        { w: "멍하니", k: "넋을 놓은 듯이.", s: "김 첨지는 한참을 멍하니 앉아 있었습니다." },
        { w: "슬며시", k: "남모르게 살그머니.", s: "그러다 입가에 슬며시 웃음이 번졌지요." },
        { w: "옳거니", k: "잘됐다 싶을 때 내는 말.", s: "옳거니. 이걸로 돈을 벌겠구나." },
        { w: "늘이다", k: "길게 늘어나게 하다.", s: "빨간 부채는 코를 늘이고 파란 부채는 코를 줄인다는 것이지요." },
        { w: "소매", k: "옷의 팔을 넣는 부분.", s: "김 첨지는 부채 두 자루를 소매에 감추고 산을 내려왔답니다." }
    ],
    "04-feast.webp": [
    ...
    "05-nose.webp": [
        { w: "쑥쑥", k: "자꾸 크게 자라는 모양.", s: "영감의 코가 쑥쑥 자라기 시작했습니다." },
        { w: "뼘", k: "손가락을 벌린 만큼의 길이.", s: "한 뼘, 두 뼘, 세 뼘." },
        { w: "알아채다", k: "낌새를 눈치로 알다.", s: "처음에는 아무도 알아채지 못했어요." },
        { w: "발칵 뒤집히다", k: "온통 시끄럽고 어수선해지다.", s: "잔칫상이 뒤집히고 온 집안이 발칵 뒤집혔습니다." },
        { w: "비명", k: "놀라거나 아플 때 지르는 소리.", s: "손님들이 비명을 지르며 달아났지요." },
        { w: "의원", k: "옛날에 병을 고치던 사람.", s: "의원을 셋이나 불렀지만 아무도 그 코를 고치지 못했답니다." }
    ],
    "06-cure.webp": [
        { w: "사흘", k: "세 날.", s: "그렇게 사흘이 지났어요." },
        { w: "여전히", k: "전과 다름없이.", s: "영감의 코는 여전히 마당까지 뻗어 있었지요." },
        { w: "어슬렁어슬렁", k: "천천히 걸어 다니는 모양.", s: "그제야 김 첨지가 어슬렁어슬렁 나타났습니다." },
        { w: "재주", k: "무엇을 잘하는 솜씨.", s: "오오! 이런 재주가!" },
        { w: "뚫어져라", k: "눈을 떼지 않고 뚫어지게.", s: "부채만 뚫어져라 바라보았어요." }
    ],
    "07-trade.webp": [
        { w: "절레절레", k: "고개를 좌우로 젓는 모양.", s: "김 첨지는 고개를 절레절레 저었어요." },
        { w: "마음이 달다", k: "몹시 애가 타 조바심이 나다.", s: "그럴수록 영감의 마음은 더 달았지요." },
        { w: "통째로", k: "나누지 않고 전부.", s: "그럼 이 집을 통째로 주겠소!" },
        { w: "기와집", k: "지붕을 기와로 덮은 좋은 집.", s: "기와집도, 곳간도, 마당도 다 주겠소!" },
        { w: "곳간", k: "곡식이나 물건을 넣어 두는 창고.", s: "기와집도, 곳간도, 마당도 다 주겠소!" },
        { w: "못 이기는 척", k: "마지못해 들어주는 척.", s: "김 첨지는 못 이기는 척 부채 두 자루를 다 내밀었답니다." }
    ],
    "08-moveout.webp": [
        { w: "보따리", k: "물건을 싸서 꾸린 꾸러미.", s: "보따리를 머리에 이고, 지게에 세간을 지고" },
        { w: "세간", k: "집에서 쓰는 살림살이.", s: "지게에 세간을 지고, 항아리를 품에 안고." },
        { w: "줄줄이", k: "여럿이 줄을 지어.", s: "줄줄이 대문을 나서는 모습이 꼭 피난 가는 것 같았어요." },
        { w: "피난", k: "재난을 피해 다른 곳으로 옮겨 가는 것.", s: "꼭 피난 가는 것 같았어요." },
        { w: "혀를 차다", k: "딱하거나 못마땅해 쯧쯧 소리를 내다.", s: "구경 나온 마을 사람들이 혀를 끌끌 찼어요." },
        { w: "울상", k: "울 것 같은 얼굴.", s: "식구들은 울상이 되어 줄줄이 걸어 나갔답니다." }
    ],
    "09-play.webp": [
        { w: "살랑살랑", k: "가볍게 자꾸 흔드는 모양.", s: "영감은 빨간 부채를 살랑살랑 부쳤습니다." },
        { w: "쭉쭉", k: "자꾸 길게 뻗는 모양.", s: "그러자 제 코가 쭉쭉 뻗어 올라갔어요." }
    ],
    "10-sky.webp": [
        { w: "비켜 날다", k: "옆으로 피해 날아가다.", s: "지나가던 새가 깜짝 놀라 옆으로 비켜 날았지요." },
        { w: "까맣게", k: "아주 까마득히.", s: "영감은 그것을 까맣게 몰랐지요." }
    ],
    "11-emperor.webp": [
        { w: "옥황상제", k: "하늘나라를 다스린다는 임금.", s: "그때 옥황상제는 한창 밥을 드시는 중이었습니다." },
        { w: "한창", k: "가장 활발한 때에.", s: "옥황상제는 한창 밥을 드시는 중이었습니다." },
    ...
    "12-pillar.webp": [
        ...
        { w: "뭉툭하다", k: "끝이 짧고 무디다.", s: "끝이 뭉툭한 것이 아무래도 이상했지요." },
        { w: "난데없이", k: "갑작스럽게 뜻밖에.", s: "난데없이 기둥이 하나 자랐사옵니다." },
        { w: "흉하다", k: "보기에 언짢고 나쁘다.", s: "거참 흉하구나." },
        { w: "칭칭", k: "여러 번 단단히 감는 모양.", s: "기둥을 몇 겹으로 칭칭 감아 놓았지요." },
        { w: "매듭", k: "끈을 맺어 놓은 자리.", s: "매듭을 어찌나 단단히 지었는지 꼼짝도 하지 않았지요." }
    ],
    "13-tied.webp": [
        { w: "펄쩍펄쩍", k: "자꾸 크게 뛰는 모양.", s: "그 아래 마당에서는 영감이 펄쩍펄쩍 뛰고 있었어요." },
        { w: "조이다", k: "단단히 죄어 오다.", s: "코가 조여 오는 통에 눈물이 다 났지요." },
        { w: "허겁지겁", k: "몹시 서둘러 정신없는 모양.", s: "영감은 허겁지겁 파란 부채를 부쳤습니다." },
        { w: "딸리다", k: "끌려서 따라가다.", s: "이번에는 몸이 하늘로 쑥 딸려 올라갔어요." },
        { w: "버둥거리다", k: "팔다리를 마구 놀리다.", s: "영감은 두 발을 버둥거리며 하늘로 끌려 올라갔어요." },
        { w: "어이없다", k: "하도 뜻밖이라 기가 막히다.", s: "하늘 신하들이 어이없어했답니다." }
    ],
    "14-fall.webp": [
    ...
    "after": [
        ...
        { w: "시험하다", k: "어떤 사람인지 알아보려고 겪게 하다.", s: "물건이 사람을 시험하기 때문입니다." }
    ]
};
