        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "새벽같이 일어나 물을 긷고 밥을 지었답니다.",
                    "\"우리 며느리 같은 사람이 어디 있나.\"",
                    "시집 식구들이 다들 좋아했어요. 동네에서도 소문이 자자했지요."
                ],
                right: [
                    "그런데 몇 달이 지나자 며느리의 얼굴빛이 이상해졌습니다. 노랗다 못해 푸르뎅뎅해졌지 뭐예요.",
                    "밥도 잘 넘기지 못하고 자꾸 배만 만졌지요. 걸음걸이도 예전 같지 않았습니다.",
                    "\"얘야, 어디 아픈 게냐?\"",
                    "시아버지가 걱정스레 물었어요."
                ]
            },
            {
                ...
                right: [
                    ...
                    "시아버지가 몸을 앞으로 기울였어요.",
                    "\"뭐, 뭐라고?\"",
                    "온 식구가 눈을 동그랗게 뜨고 며느리를 보았어요. 잘못 들은 줄 알았거든요."
                ]
            },
            {
                art: "03-permit.webp",
                ...
                left: [
                    "\"허허, 그게 무슨 대수라고.\"",
                    "시아버지가 껄껄 웃으며 손을 내저었습니다. 별것도 아닌 일로 여태 참았나 싶었거든요.",
                    "\"참으면 병이 나는 법이다.\"",
                    "\"어서 시원하게 뀌어라! 이 집에서 그걸 흉볼 사람이 어디 있느냐.\""
                ],
                right: [
                    "그러자 며느리가 조심스레 말했어요. 얼굴에 걱정이 가득했지요.",
                    "\"그럼… 다들 무언가를 꼭 붙잡으셔야 합니다.\"",
                    "시어머니가 고개를 갸웃했어요.",
                    "\"무얼 붙잡으라는 게냐?\"",
                    "\"아무거나요. 아주 단단히요.\"",
                    "식구들은 무슨 소린가 싶었답니다."
            ...
            },
            {
                ...
                right: [
                    "시어머니는 문고리를 잡고, 남편은 솥뚜껑 손잡이를 꼭 쥐었습니다.",
                    "\"자, 이제 뀌어 보아라.\"",
                    "\"자, 갑니다!\"",
                    "며느리가 숨을 크게 들이마셨어요. 방 안이 쥐 죽은 듯 조용해졌지요. 어디선가 마른침 삼키는 소리가 났답니다."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                left: [
                    "뿌우우우웅—!",
                    "집이 통째로 들썩였습니다. 문짝이 떨어져 나가고 기왓장이 우수수 쏟아졌어요.",
                    "온 마을이 다 들었을 소리였어요.",
                    "마당의 흙먼지가 하늘까지 치솟았지요. 온 동네 개들이 한꺼번에 짖어 댔답니다."
                ],
                right: [
                    "\"으아아악!\"",
                    "시아버지는 기둥을 끌어안은 채 빙글빙글 돌았어요. 두 발이 땅에서 완전히 떠 있었지요.",
                    "기둥이 우지끈 소리를 냈지요.",
                    "그런데 그것으로 끝이 아니었습니다. 바람은 아직 반도 나오지 않았거든요."
                ]
            },
            {
                art: "06-fly.webp",
                ...
                left: [
                    ...
                    "마당에서 모이를 쪼던 닭들은 깃털만 남기고 사라져 버렸답니다.",
                    "지붕 위에서 남편이 소리쳤어요.",
                    "\"여보— 나 좀 내려 주— 오—!\""
                ],
                right: [
                    "한참 뒤에야 온 집안이 겨우 조용해졌어요. 여기저기서 끙끙거리는 소리가 났지요.",
                    "\"…이제 좀 살 것 같습니다.\"",
                    "\"아이고, 내 허리야.\"",
                    "며느리의 얼굴빛은 어느새 발그레하게 돌아와 있었습니다."
                ]
            },
            {
                art: "07-send.webp",
                ...
                right: [
                    "며느리는 아무 말도 못 하고 고개를 푹 숙였어요.",
                    "이튿날 아침, 남편이 며느리를 데리고 길을 나섰습니다. 보따리 하나가 전부였지요.",
                    "\"여보, 미안하오.\"",
                    "그 말뿐이었어요. 둘은 발끝만 내려다보며 터덜터덜 걸었답니다."
                ]
            },
            {
                art: "08-road.webp",
                ...
                right: [
                    ...
                    "\"장대가 닿아야 말이지.\"",
                    "\"저 배를 어떻게 딴담!\"",
                    "가지가 하늘 높이 뻗어 있어 아무도 올라갈 수가 없었습니다.",
                    "장수들은 발만 동동 구르며 나무만 올려다보고 있었지요."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                emoji: "🍐",
                left: [
                    "그 모습을 한참 보던 며느리가 조심스레 다가갔어요.",
                    "남편이 소매를 붙잡았지만 며느리는 그냥 걸어 나갔지요.",
                    "무언가 생각이 난 얼굴이었습니다.",
                    "\"제가 따 드릴까요?\""
                ],
                right: [
                    "장수들이 며느리를 위아래로 훑어보았어요. 그러더니 저희끼리 킥킥 웃었지요.",
                    "\"댁이? 사다리도 없이?\"",
                    "\"어디 한번 해 보시오. 따 주기만 하면 절반을 드리리다!\"",
                    "아무도 진짜라고 믿지 않았답니다."
                ]
            },
            {
                ...
                right: [
                    "장수들이 어리둥절해하며 뒷걸음질을 쳤습니다.",
                    "남편만은 씩 웃으며 얼른 나무 뒤로 숨었지요.",
                    "그 뜻을 아는 사람은 남편뿐이었거든요.",
                    "며느리가 숨을 크게 들이마셨어요. 배가 볼록하게 부풀어 오르는 것이 보였답니다."
                ]
            },
            {
                art: "11-pears.webp",
            ...
            },
            {
                ...
                right: [
                    "시아버지는 대문 밖까지 나와 두 사람을 맞았습니다. 엽전 꾸러미를 보고 입이 함박만 해졌지요.",
                    "다만 그 뒤로 이 집안에는 규칙이 하나 생겼답니다.",
                    "\"뀌기 전에 미리 말만 해다오. 붙잡을 시간은 있어야지.\"",
                    "온 집안이 웃음바다가 되었답니다."
                ]
            }
        ],
        moral: "식구들이 흠이라 여겨 내보내려 한 것이, 밖에 나가 보니 누구도 못 하는 재주였어요. 남과 다른 것을 흠으로 볼지 재주로 볼지는 보는 사람에게 달렸답니다.",
        question: "남과 달라서 감추고 싶었던 것이 있나요? 그것이 쓸모 있는 자리는 어디일까요?"
    }
];
...
const COVER = {
    ...
    title: "방귀쟁이 며느리",
    intro: [
        "방귀쟁이 며느리는 지은이가 없는 구전 설화예요. 방귀 한 번에 기둥이 흔들릴 만큼 힘이 센 며느리가 나오는 이야기랍니다.",
        "옛이야기에는 몸에서 나는 소리와 냄새를 크게 부풀려 웃음을 만드는 갈래가 따로 있어요. 방귀 이야기가 그 대표지요. 아이들이 가장 크게 웃는 이야기이기도 하고요.",
        "옛날에 시집온 며느리는 시집 식구들 앞에서 마음대로 하지 못할 것이 아주 많았어요. 웃는 것도, 큰 소리로 말하는 것도 조심해야 했지요. 참다 참다 터져 버린 방귀 하나가 이렇게 큰 소동이 되는 것도 그런 시절이었기 때문이랍니다."
    ]
};
...
const WORDS_KO = {
    "cover": [
        { w: "며느리", k: "아들의 아내.", s: "방귀쟁이 며느리는 지은이가 없는 구전 설화예요." },
        { w: "기둥", k: "지붕을 받치고 선 굵은 나무.", s: "방귀 한 번에 기둥이 흔들릴 만큼 힘이 센 며느리가 나오는 이야기랍니다." },
        { w: "부풀리다", k: "실제보다 크게 말하다.", s: "몸에서 나는 소리와 냄새를 크게 부풀려 웃음을 만드는 갈래가 따로 있어요." },
        { w: "시집", k: "남편의 집안.", s: "옛날에 시집온 며느리는 시집 식구들 앞에서" },
        { w: "소동", k: "여럿이 놀라 벌어지는 큰 일.", s: "참다 참다 터져 버린 방귀 하나가 이렇게 큰 소동이 되는 것도" }
    ],
    "01-bride.webp": [
        { w: "야무지다", k: "하는 일이 빈틈없고 똑 부러지다.", s: "얼굴도 곱고 부지런한 데다 손끝까지 야무졌지요." },
        { w: "새벽같이", k: "아주 이른 아침에.", s: "새벽같이 일어나 물을 긷고 밥을 지었답니다." },
        { w: "긷다", k: "우물이나 샘에서 물을 떠 오다.", s: "새벽같이 일어나 물을 긷고 밥을 지었답니다." },
        { w: "자자하다", k: "소문이 널리 퍼지다.", s: "동네에서도 소문이 자자했지요." },
        { w: "푸르뎅뎅하다", k: "보기 싫게 푸르스름하다.", s: "노랗다 못해 푸르뎅뎅해졌지 뭐예요." }
    ],
    "02-ask.webp": [
        { w: "우물쭈물하다", k: "말을 못 하고 망설이다.", s: "며느리는 한참을 우물쭈물하기만 했습니다." },
        { w: "차마", k: "부끄럽거나 안타까워 도저히.", s: "차마 입이 떨어지지 않는 모양이었어요." },
        { w: "꼼지락거리다", k: "조금씩 느리게 움직이다.", s: "방바닥만 내려다보며 손가락을 꼼지락거렸지요." }
    ],
    "03-permit.webp": [
        { w: "대수", k: "크게 문제 될 일.", s: "허허, 그게 무슨 대수라고." },
        { w: "내젓다", k: "손을 좌우로 흔들다.", s: "시아버지가 껄껄 웃으며 손을 내저었습니다." },
        { w: "여태", k: "지금까지 줄곧.", s: "별것도 아닌 일로 여태 참았나 싶었거든요." },
        { w: "흉보다", k: "남의 잘못을 들추어 말하다.", s: "이 집에서 그걸 흉볼 사람이 어디 있느냐." },
        { w: "갸웃하다", k: "고개를 조금 기울이다.", s: "시어머니가 고개를 갸웃했어요." }
    ],
    "04-brace.webp": [
        { w: "설마설마", k: "그럴 리 없다고 자꾸 여기는 모양.", s: "식구들은 설마설마 하면서도 하나씩 붙들었습니다." },
        { w: "하도", k: "너무나.", s: "며느리가 하도 진지하게 말하니" },
        { w: "진지하다", k: "장난기 없이 참되다.", s: "며느리가 하도 진지하게 말하니" },
        { w: "대청", k: "옛집 가운데 있는 넓은 마루.", s: "시아버지는 대청 기둥을 두 팔로 끌어안았어요." },
        { w: "문고리", k: "문을 여닫을 때 잡는 고리.", s: "시어머니는 문고리를 잡고" },
        { w: "솥뚜껑", k: "솥을 덮는 뚜껑.", s: "남편은 솥뚜껑 손잡이를 꼭 쥐었습니다." },
        { w: "쥐 죽은 듯", k: "아무 소리도 없이 아주 조용한 모양.", s: "방 안이 쥐 죽은 듯 조용해졌지요." },
        { w: "마른침", k: "긴장했을 때 삼키는 침.", s: "어디선가 마른침 삼키는 소리가 났답니다." }
    ],
    "05-boom.webp": [
        { w: "들썩이다", k: "들렸다 내려앉았다 하다.", s: "집이 통째로 들썩였습니다." },
        { w: "기왓장", k: "지붕을 덮는 기와 한 장.", s: "문짝이 떨어져 나가고 기왓장이 우수수 쏟아졌어요." },
        { w: "우수수", k: "여럿이 한꺼번에 쏟아지는 모양.", s: "기왓장이 우수수 쏟아졌어요." },
        { w: "치솟다", k: "위로 세차게 솟아오르다.", s: "마당의 흙먼지가 하늘까지 치솟았지요." },
        { w: "우지끈", k: "단단한 것이 부러지는 소리.", s: "기둥이 우지끈 소리를 냈지요." }
    ],
    "06-fly.webp": [
        { w: "모이", k: "새에게 주는 먹이.", s: "마당에서 모이를 쪼던 닭들은 깃털만 남기고 사라져 버렸답니다." },
        { w: "쪼다", k: "부리로 콕콕 찍다.", s: "마당에서 모이를 쪼던 닭들은" },
        { w: "끙끙거리다", k: "아파서 앓는 소리를 내다.", s: "여기저기서 끙끙거리는 소리가 났지요." },
        { w: "발그레하다", k: "알맞게 발그스름하다.", s: "며느리의 얼굴빛은 어느새 발그레하게 돌아와 있었습니다." }
    ],
    "07-send.webp": [
        { w: "상투", k: "옛날 어른 남자가 머리를 틀어 올린 것.", s: "상투가 다 풀어져 머리가 산발이었지요." },
        { w: "산발", k: "머리가 마구 흐트러진 모양.", s: "상투가 다 풀어져 머리가 산발이었지요." },
        { w: "친정", k: "시집온 여자의 원래 집.", s: "아가야, 아무래도 친정에 다녀오는 게 좋겠구나." },
        { w: "보따리", k: "물건을 싸서 꾸린 짐.", s: "보따리 하나가 전부였지요." },
        { w: "터덜터덜", k: "힘없이 걷는 모양.", s: "둘은 발끝만 내려다보며 터덜터덜 걸었답니다." }
    ],
    "08-road.webp": [
        { w: "소란스럽다", k: "시끄럽고 어수선하다.", s: "한참을 걷는데 길가가 몹시 소란스러웠습니다." },
        { w: "웅성거리다", k: "여럿이 모여 수군대다.", s: "커다란 배나무 아래에 장수들이 잔뜩 모여 웅성거리고 있었어요." },
        { w: "주렁주렁", k: "열매가 많이 매달린 모양.", s: "나무에는 잘 익은 노란 배가 주렁주렁 달려 있었답니다." },
        { w: "장대", k: "길고 굵은 막대기.", s: "장대가 닿아야 말이지." },
        { w: "발을 동동 구르다", k: "안타까워 어쩔 줄 몰라 하다.", s: "장수들은 발만 동동 구르며 나무만 올려다보고 있었지요." }
    ],
    "09-offer.webp": [
        { w: "소매", k: "옷의 팔을 넣는 부분.", s: "남편이 소매를 붙잡았지만" },
        { w: "훑어보다", k: "위아래로 살펴보다.", s: "장수들이 며느리를 위아래로 훑어보았어요." },
        { w: "킥킥", k: "참으며 웃는 소리.", s: "그러더니 저희끼리 킥킥 웃었지요." },
        { w: "사다리", k: "높은 데를 오를 때 쓰는 것.", s: "댁이? 사다리도 없이?" },
        { w: "절반", k: "반.", s: "따 주기만 하면 절반을 드리리다!" }
    ],
    "10-aim.webp": [
        { w: "여미다", k: "옷을 단정히 잡아 매만지다.", s: "치맛자락을 단단히 여미면서요." },
        { w: "딴판", k: "아주 다른 모습.", s: "목소리가 아까와는 딴판으로 야무졌지요." },
        { w: "어리둥절하다", k: "뭐가 뭔지 몰라 얼떨떨하다.", s: "장수들이 어리둥절해하며 뒷걸음질을 쳤습니다." },
        { w: "볼록하다", k: "겉으로 도도록하게 나오다.", s: "배가 볼록하게 부풀어 오르는 것이 보였답니다." }
    ],
    "11-pears.webp": [
        { w: "휘청이다", k: "힘없이 이리저리 흔들리다.", s: "배나무가 통째로 휘청였습니다." },
        { w: "뿌리째", k: "뿌리까지 통째로.", s: "뿌리째 뽑히는 게 아닌가 싶을 만큼 크게 흔들렸지요." }
    ],
    "12-home.webp": [
        { w: "엽전", k: "옛날에 쓰던 둥근 쇠돈.", s: "장수들은 약속대로 배와 엽전을 한 아름 안겨 주었습니다." },
        { w: "한 아름", k: "두 팔로 안을 만큼의 양.", s: "배와 엽전을 한 아름 안겨 주었습니다." },
        { w: "꾸러미", k: "여럿을 한데 묶은 덩이.", s: "엽전 꾸러미를 보고 입이 함박만 해졌지요." },
        { w: "함박", k: "아주 큰 함지박.", s: "입이 함박만 해졌지요." },
        { w: "웃음바다", k: "여럿이 한꺼번에 크게 웃는 모습.", s: "온 집안이 웃음바다가 되었답니다." }
    ]
};
