        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "어른 다섯이 팔을 벌려야 겨우 안기는 나무였지요.",
                    "가지가 넓게 퍼져 한여름에도 그 아래는 서늘했어요.",
                    "여름이면 온 마을 사람이 그 아래에 모였지요."
                ],
                right: [
                    "그런데 그 나무는 마을에서 제일 부자인 영감의 집 담 옆에 있었어요.",
                    "나무가 마을 것인지 부자 것인지는 아무도 몰랐지요.",
                    "그래도 부자는 늘 그 나무를 제 것이라 여겼답니다.",
                    "누가 쉬고 있으면 눈을 흘겼어요."
                ]
            },
            {
                ...
                emoji: "😌",
                left: [
                    "몹시 무더워 숨이 턱턱 막히는 한여름 날이었어요.",
                    "먼 길을 걷던 나그네에게 멀리서부터 그 느티나무가 보였지요.",
                    "나그네는 그 그늘을 보고 걸음이 빨라졌습니다.",
                    "그늘에 닿자마자 지고 있던 짐을 내려놓았어요."
                ],
                right: [
                    "\"어이구, 살 것 같구나.\"",
                    "나그네가 짐을 베고 벌렁 누워 두 팔을 쭉 뻗었어요. 부채를 부치며 다리를 폈지요.",
                    "머리 위에서 매미 소리가 요란했어요.",
                    "이마의 땀이 저절로 식었지요.",
                    "금세 눈이 스르르 감겼답니다."
                ]
            },
            {
                ...
                left: [
                    ...
                    "마당에서 그 모습을 내다본 것이었지요.",
                    "\"여기가 어디라고 함부로 눕는 게냐!\"",
                    "부자의 얼굴이 벌겋게 달아올라 있었어요.",
                    "지팡이를 든 손이 부들부들 떨렸지요."
                ],
                right: [
                    "\"이 나무는 내 것이고, 이 그늘도 내 것이다!\"",
                    "부자가 지팡이로 땅을 쿵쿵 찍었어요.",
                    "\"당장 나가지 못할까! 어서!\"",
                    "나그네는 눈을 뜨고 부자를 올려다보았지요. 그러고는 한참을 그대로 누워 있었어요."
                ]
            },
            {
                art: "04-buy.webp",
                emoji: "💰",
                left: [
                    "나그네는 천천히 몸을 일으켰어요. 화를 내기는커녕 얼굴빛 하나 달라지지 않았지요.",
                    "그러고는 허리춤에서 엽전 꾸러미를 꺼냈습니다.",
                    "\"그렇다면 이 그늘을 제게 파시지요.\"",
                    "엽전이 짤랑짤랑 소리를 냈지요."
                ],
                right: [
                    "\"…뭐라고?\"",
                    "부자가 눈을 껌뻑껌뻑했어요. 잘못 들은 줄 알았거든요.",
                    "\"이 나무 그늘 값입니다. 넉넉히 드리겠습니다.\"",
                    "나그네가 엽전 꾸러미를 쑥 내밀었어요.",
                    "부자의 눈이 그 꾸러미에 딱 붙었답니다."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                emoji: "🤝",
                left: [
                    "부자는 속으로 옳다구나 했어요. 가만히 앉아서 돈이 굴러든 셈이었거든요.",
                    "'허허, 그늘을 돈 주고 사는 바보가 다 있구나.'",
                    "\"좋다. 오늘부터 저 그늘은 네 것이다.\"",
                    "부자가 얼른 두 손을 내밀었어요."
                ],
                right: [
                    "부자는 엽전을 하나하나 세어 품에 넣었어요. 흐뭇하게 돌아서며 콧노래까지 흥얼거렸지요.",
                    "나그네는 빙그레 웃기만 했답니다.",
                    "그러고는 다시 그늘에 누웠지요.",
                    "해가 조금씩 서쪽으로 기울고 있었어요."
                ]
            },
            {
                art: "06-move.webp",
                emoji: "🌇",
                left: [
                    "해가 서쪽으로 더 기울었어요. 나무 그림자가 길게 늘어졌지요.",
                    "그러자 나무 그늘이 조금씩 자리를 옮겼습니다.",
                    "처음에는 아무도 몰랐어요.",
                    "길에서 담 쪽으로, 담에서 담을 넘어, 마침내 부잣집 마당 한복판으로 들어갔지요."
                ],
                right: [
                    "부잣집 마당이 온통 시원해졌어요. 장독대에도 우물가에도 그늘이 내려앉았지요.",
                    "매미도 그 마당으로 옮겨 와 울었어요.",
                    "부자는 그것도 모르고 방에서 낮잠을 자고 있었답니다.",
                    "코까지 드르렁드르렁 골면서요."
                ]
            },
            {
                ...
                emoji: "🚶",
                left: [
                    "그때 나그네가 천천히 자리에서 일어섰어요. 짐을 챙겨 들고 그늘을 따라 걸었지요.",
                    "열린 대문을 지나 마당 한가운데로 들어갔습니다.",
                    "그러고는 그 자리에 돗자리를 척 폈어요.",
                    "\"아니, 이게 무슨 짓이오!\""
                ],
                right: [
                    "부자가 버선발로 뛰어나왔어요.",
                    "\"제 그늘이 여기로 왔으니 저도 따라온 것뿐입니다.\"",
                    "나그네가 태연하게 대답했지요. 부자는 말문이 막히고 말았어요.",
                    "제 입으로 판 그늘이었으니까요.",
                    "나그네는 돗자리에 벌렁 누웠답니다."
                ]
            },
            {
                ...
                emoji: "👥",
                left: [
                    "이튿날, 나그네는 이른 아침부터 길목에 서 있었어요. 그러고는 길에서 만난 사람들을 데려왔지요.",
                    "\"제 그늘입니다. 편히 쉬시지요.\"",
                    "한 사람, 두 사람 따라 들어왔어요.",
                    "어느새 열 사람도 넘었지요."
                ],
                right: [
                    "사람들이 마당에 둘러앉아 부채질을 하며 이야기꽃을 피웠습니다. 부자네 마당이 잔칫집처럼 시끌시끌했어요.",
                    "부자는 방 안에서 이를 갈았지요.",
                    "그러나 어쩔 도리가 없었어요.",
                    "제가 판 그늘이었으니까요."
                ]
        ...
        beats: [
            {
                ...
                emoji: "🏠",
                left: [
                    "날이 갈수록 그늘은 더 깊이 들어왔어요. 여름이 깊어질수록 해가 낮아졌거든요.",
                    "어느 날에는 대청마루까지 그늘이 닿았습니다.",
                    "마루가 서늘해졌지요.",
                    "사람들이 마루에 걸터앉아 낮잠을 자고 국수를 말아 먹었어요."
                ],
                right: [
                    "부자는 제 집 마루 한구석에서 눈치를 보게 되었답니다. 앉을 자리가 없어 툇마루 끝에 겨우 걸터앉았어요.",
                    "남이 말아 준 국수 한 그릇을 얻어먹은 날도 있었지요.",
                    "제 집인데도 손님 같았답니다.",
                    "부자는 밤마다 잠이 오지 않았어요."
                ]
            },
            {
                ...
                emoji: "🙏",
                left: [
                    "마침내 부자가 나그네를 찾아왔어요. 며칠을 벼르다 겨우 입을 뗐지요.",
                    "\"이보시오. 돈을 곱절로 돌려줄 테니 무릅시다.\"",
                    "목소리에 힘이 하나도 없었어요.",
                    "\"이 집이 내 집인지 저잣거리인지 알 수가 없구려.\""
                ],
                right: [
                    "부자가 한숨을 푹 쉬었어요. 부자의 어깨가 축 처져 있었습니다.",
                    "지팡이로 땅을 찍던 그 사람이 아니었지요.",
                    "나그네는 한참 동안 말이 없었어요.",
                    "나무만 올려다보았지요.",
                    "그러다 천천히 입을 열었답니다."
                ]
            },
            {
                ...
                left: [
                    "\"돈은 도로 가져가십시오.\"",
                    "나그네가 엽전 꾸러미를 부자 앞에 도로 내밀었어요.",
                    "\"…무르겠다는 말이오?\"",
                    "부자의 얼굴이 대번에 밝아졌어요.",
                    "\"아닙니다.\"",
                    "나그네가 고개를 저었지요. 부자의 얼굴이 다시 굳었어요."
                ],
                right: [
                    "\"이 그늘은 이제 제 것이니, 제 뜻대로 하겠습니다.\"",
                    "나그네가 마당에 모인 사람들을 둘러보았어요.",
                    "\"오늘부터 이 그늘은 마을 사람 모두의 것입니다.\"",
                    "\"그늘은 본디 그런 것이니까요.\"",
                    "부자의 얼굴이 붉어졌답니다."
                ]
            },
            {
                ...
                emoji: "🎋",
                left: [
                    "나그네는 그날로 짐을 챙겨 길을 떠났어요. 받은 돈도 도로 놓고 그냥 갔지요.",
                    "뒤도 돌아보지 않고 고개를 넘어갔어요.",
                    "부자는 한참 동안 나무를 올려다보고 서 있었습니다.",
                    "해가 질 때까지 그러고 있었지요."
                ],
                right: [
                    "이듬해 여름, 느티나무 아래에는 돗자리가 깔려 있었어요. 부자도 그 한쪽에 앉아 부채를 부치고 있었지요.",
                    "아이들이 그 위에서 뒹굴었어요.",
                    "이제 아무도 그늘을 제 것이라 하지 않았답니다.",
                    "느티나무는 해마다 더 넓게 그늘을 드리웠지요."
                ]
            }
        ],
        moral: "부자는 그늘을 팔아 돈을 벌었다고 생각했어요. 그런데 판 것은 그늘이 아니라 제 집 마당이었지요. 값을 매길 수 없는 것에 값을 붙이면, 잃는 쪽은 대개 값을 붙인 사람이랍니다.",
        question: "돈으로 사고팔 수 없는 것에는 무엇이 있을까요?"
    }
];
...
const COVER = {
    ...
    title: "그늘을 산 사람",
    intro: [
        "그늘을 산 사람은 지은이가 없는 구전 설화예요. 그늘처럼 아무도 값을 매기지 않던 것을 사고팔면 어떻게 되는지를 다룬 이야기랍니다.",
        "마을 어귀의 큰 느티나무는 옛날 우리 마을마다 있던 것이에요. 정자나무라고 불렀지요. 여름이면 그 아래에 돗자리를 깔고 사람들이 모여 쉬고, 이야기하고, 낮잠을 잤어요. 나무 한 그루가 마을의 사랑방 노릇을 한 셈이랍니다.",
        "그늘은 원래 누구의 것도 아니에요. 그런 것에 값을 붙이면 어떻게 되는지를 다룬 이야기는 세계 곳곳에 있답니다. 우리 이야기는 그 가운데서도 유난히 짧고 매섭지요."
    ]
};
...
const WORDS_KO = {
    "cover": [
        { w: "값을 매기다", k: "얼마짜리인지 값을 정하다.", s: "아무도 값을 매기지 않던 것을 사고팔면" },
        { w: "어귀", k: "드나드는 첫머리.", s: "마을 어귀의 큰 느티나무는 옛날 우리 마을마다 있던 것이에요." },
        { w: "정자나무", k: "마을 사람들이 모여 쉬던 큰 나무.", s: "정자나무라고 불렀지요." },
        { w: "사랑방", k: "손님을 맞아 이야기 나누던 방.", s: "나무 한 그루가 마을의 사랑방 노릇을 한 셈이랍니다." },
        { w: "매섭다", k: "몹시 날카롭고 무섭다.", s: "우리 이야기는 그 가운데서도 유난히 짧고 매섭지요." }
    ],
    "01-tree.webp": [
        { w: "아름드리", k: "두 팔로 안아야 할 만큼 굵은.", s: "어느 마을 어귀에 아름드리 느티나무 한 그루가 서 있었습니다." },
        { w: "그루", k: "나무를 세는 말.", s: "아름드리 느티나무 한 그루가 서 있었습니다." },
        { w: "서늘하다", k: "서느렇게 찬 기운이 돌다.", s: "가지가 넓게 퍼져 한여름에도 그 아래는 서늘했어요." },
        { w: "눈을 흘기다", k: "못마땅해 곁눈으로 노려보다.", s: "누가 쉬고 있으면 눈을 흘겼어요." }
    ],
    "02-rest.webp": [
        { w: "무덥다", k: "눅눅하고 몹시 덥다.", s: "몹시 무더워 숨이 턱턱 막히는 한여름 날이었어요." },
        { w: "나그네", k: "먼 길을 오가는 사람.", s: "먼 길을 걷던 나그네에게 멀리서부터 그 느티나무가 보였지요." },
        { w: "벌렁", k: "뒤로 눕거나 자빠지는 모양.", s: "나그네가 짐을 베고 벌렁 누워 두 팔을 쭉 뻗었어요." },
        { w: "요란하다", k: "시끄럽고 어수선하다.", s: "머리 위에서 매미 소리가 요란했어요." },
        { w: "금세", k: "아주 빨리.", s: "금세 눈이 스르르 감겼답니다." }
    ],
    "03-scold.webp": [
        { w: "벌컥", k: "갑자기 세게 여는 모양.", s: "그때 대문이 벌컥 열렸어요." },
        { w: "성큼성큼", k: "큰 걸음으로 걷는 모양.", s: "부자가 성큼성큼 걸어 나왔습니다." },
        { w: "함부로", k: "조심하지 않고 마구.", s: "여기가 어디라고 함부로 눕는 게냐!" },
        { w: "달아오르다", k: "붉게 뜨거워지다.", s: "부자의 얼굴이 벌겋게 달아올라 있었어요." },
        { w: "부들부들", k: "몸이 자꾸 떨리는 모양.", s: "지팡이를 든 손이 부들부들 떨렸지요." }
    ],
    "04-buy.webp": [
        { w: "얼굴빛", k: "얼굴에 드러난 기색.", s: "화를 내기는커녕 얼굴빛 하나 달라지지 않았지요." },
        { w: "허리춤", k: "허리에 두른 옷의 안쪽.", s: "그러고는 허리춤에서 엽전 꾸러미를 꺼냈습니다." },
        { w: "엽전", k: "옛날에 쓰던 둥근 쇠돈.", s: "허리춤에서 엽전 꾸러미를 꺼냈습니다." },
        { w: "짤랑짤랑", k: "쇠붙이가 부딪는 소리.", s: "엽전이 짤랑짤랑 소리를 냈지요." },
        { w: "껌뻑껌뻑", k: "눈을 자꾸 감았다 뜨는 모양.", s: "부자가 눈을 껌뻑껌뻑했어요." },
        { w: "넉넉히", k: "모자람 없이 넉넉하게.", s: "이 나무 그늘 값입니다. 넉넉히 드리겠습니다." }
    ],
    "05-deal.webp": [
        { w: "옳다구나", k: "잘됐다 싶을 때 내는 말.", s: "부자는 속으로 옳다구나 했어요." },
        { w: "굴러들다", k: "뜻밖에 저절로 들어오다.", s: "가만히 앉아서 돈이 굴러든 셈이었거든요." },
        { w: "흐뭇하다", k: "마음에 들어 기분이 좋다.", s: "흐뭇하게 돌아서며 콧노래까지 흥얼거렸지요." },
        { w: "흥얼거리다", k: "낮은 소리로 노래하다.", s: "콧노래까지 흥얼거렸지요." },
        { w: "빙그레", k: "소리 없이 살짝 웃는 모양.", s: "나그네는 빙그레 웃기만 했답니다." }
    ],
    "06-move.webp": [
        { w: "늘어지다", k: "길게 처지다.", s: "나무 그림자가 길게 늘어졌지요." },
        { w: "한복판", k: "한가운데.", s: "마침내 부잣집 마당 한복판으로 들어갔지요." },
        { w: "장독대", k: "장독을 놓아두는 자리.", s: "장독대에도 우물가에도 그늘이 내려앉았지요." },
        { w: "드르렁드르렁", k: "코를 크게 고는 소리.", s: "코까지 드르렁드르렁 골면서요." }
    ],
    "07-enter.webp": [
        { w: "돗자리", k: "바닥에 까는 자리.", s: "그러고는 그 자리에 돗자리를 척 폈어요." },
        { w: "버선발", k: "신을 신지 않은 버선 바람의 발.", s: "부자가 버선발로 뛰어나왔어요." },
        { w: "태연하다", k: "아무렇지 않은 듯 차분하다.", s: "나그네가 태연하게 대답했지요." },
        { w: "말문이 막히다", k: "할 말이 없어지다.", s: "부자는 말문이 막히고 말았어요." }
    ],
    "08-friends.webp": [
        { w: "이튿날", k: "그다음 날.", s: "이튿날, 나그네는 이른 아침부터 길목에 서 있었어요." },
        { w: "길목", k: "길이 갈라지거나 지나가는 자리.", s: "이른 아침부터 길목에 서 있었어요." },
        { w: "이야기꽃을 피우다", k: "즐겁게 이야기를 주고받다.", s: "사람들이 마당에 둘러앉아 부채질을 하며 이야기꽃을 피웠습니다." },
        { w: "이를 갈다", k: "분해서 두고 보자고 벼르다.", s: "부자는 방 안에서 이를 갈았지요." },
        { w: "도리", k: "할 수 있는 방법.", s: "그러나 어쩔 도리가 없었어요." }
    ],
    "09-porch.webp": [
        { w: "대청마루", k: "집 가운데 있는 넓은 마루.", s: "어느 날에는 대청마루까지 그늘이 닿았습니다." },
        { w: "걸터앉다", k: "걸치듯이 앉다.", s: "사람들이 마루에 걸터앉아 낮잠을 자고 국수를 말아 먹었어요." },
        { w: "눈치를 보다", k: "남의 기색을 살피다.", s: "부자는 제 집 마루 한구석에서 눈치를 보게 되었답니다." },
        { w: "툇마루", k: "방 앞에 좁게 낸 마루.", s: "앉을 자리가 없어 툇마루 끝에 겨우 걸터앉았어요." }
    ],
    "10-beg.webp": [
        { w: "벼르다", k: "마음먹고 기회를 기다리다.", s: "며칠을 벼르다 겨우 입을 뗐지요." },
        { w: "곱절", k: "두 배.", s: "돈을 곱절로 돌려줄 테니 무릅시다." },
        { w: "무르다", k: "사고판 것을 도로 물리다.", s: "돈을 곱절로 돌려줄 테니 무릅시다." },
        { w: "저잣거리", k: "옛날에 장이 서던 거리.", s: "이 집이 내 집인지 저잣거리인지 알 수가 없구려." },
        { w: "처지다", k: "아래로 축 내려앉다.", s: "부자의 어깨가 축 처져 있었습니다." }
    ],
    "11-return.webp": [
        { w: "대번에", k: "단번에 곧.", s: "부자의 얼굴이 대번에 밝아졌어요." },
        { w: "본디", k: "처음부터.", s: "그늘은 본디 그런 것이니까요." }
    ],
    "12-village.webp": [
        { w: "이듬해", k: "그다음 해.", s: "이듬해 여름, 느티나무 아래에는 돗자리가 깔려 있었어요." },
        { w: "뒹굴다", k: "이리저리 구르다.", s: "아이들이 그 위에서 뒹굴었어요." },
        { w: "드리우다", k: "아래로 늘어뜨리다.", s: "느티나무는 해마다 더 넓게 그늘을 드리웠지요." }
    ],
    "after": [
        { w: "팔아넘기다", k: "남에게 팔아 버리다.", s: "김선달은 남의 것을 팔아넘겼고" },
        { w: "셈", k: "이익과 손해를 따져 헤아리는 일.", s: "부자는 그 셈을 하지 않고 그날 손에 쥔 돈만 보았습니다." },
        { w: "억지를 부리다", k: "안 될 일을 우겨 대다.", s: "나그네는 억지를 부린 적이 없습니다." }
    ]
};
