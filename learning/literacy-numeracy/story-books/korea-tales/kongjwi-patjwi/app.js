...
const CHAPTERS = [
    {
        ...
        artAt: ["밥상이 두 개 차려졌습니다", "콩쥐는 자갈밭에 엎드려 나무 괭이를 내리찍었습니다", "산 쪽에서 무언가 걸어 내려왔습니다"],
        paras: [
            ...
            "콩쥐가 열 살이 되던 해, 아버지가 새 아내를 맞았습니다. 배 씨라는 여인이었는데, 앞서 낳은 딸 하나를 데리고 들어왔습니다. 그 아이의 이름이 팥쥐였습니다. 팥쥐는 콩쥐보다 한 살이 아래였습니다.",
            ...
            "아버지가 장에 나간 첫날부터 배 씨의 얼굴이 달라졌습니다. 콩쥐에게 부엌일을 몽땅 맡기고, 팥쥐에게는 손끝 하나 까딱하지 않게 했습니다. 문지방을 넘는 소리부터 달랐습니다. 팥쥐는 해가 중천에 뜨도록 이불 속에 있었습니다.",
            ...
            "콩쥐가 열두 살이 되던 봄이었습니다. 배 씨가 두 아이를 마당에 세워 놓고 괭이를 하나씩 내주었습니다. 아직 아침 이슬도 마르지 않은 때였습니다.",
            "\"오늘은 밭을 갈고 오너라. 다 갈기 전에는 들어올 생각 마라.\" 해가 아직 산머리에 걸려 있었습니다.",
            "팥쥐가 받은 것은 날이 시퍼렇게 선 쇠 괭이였습니다. 콩쥐가 받은 것은 나무를 깎아 만든 괭이였습니다. 자루도 팥쥐 것은 매끈했고 콩쥐 것은 거칠었습니다.",
            "밭도 달랐습니다. 팥쥐에게 준 것은 집 앞 모래밭이었습니다. 콩쥐에게 준 것은 산 밑 자갈밭이었습니다. 어른도 하루에 절반을 갈지 못하는 밭이었습니다. 돌이 어른 주먹만 했습니다.",
            "팥쥐는 모래밭을 한 시간 만에 다 갈고 돌아와 낮잠을 잤습니다. 돌아오면서 콩쥐 밭 쪽을 힐끔 보고 웃었습니다.",
            "콩쥐는 자갈밭에 엎드려 나무 괭이를 내리찍었습니다. 자갈에 부딪힐 때마다 손아귀가 울렸습니다. 몇 고랑 못 가서 괭이 날이 뚝 부러지고 말았습니다. 손바닥이 금세 부르텄습니다.",
            "콩쥐는 부러진 괭이를 들고 밭 가운데 주저앉았습니다. 그제야 눈물이 났습니다. 해는 벌써 머리 위에 있었습니다.",
            "\"이걸로 어떻게 저 밭을 다 갈아내나?\" 밭은 아직 반의반도 갈지 못했습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "수백 마리가 마당으로 내려앉았습니다. 참새들은 벼 무더기 위에 앉아 부리로 껍질을 벗기기 시작했습니다. 마당이 참새로 온통 덮였습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "집집마다 처녀들이 나와 신을 신어 보았습니다. 그러나 발에 맞는 사람이 하나도 없었습니다. 큰 발은 억지로 밀어 넣다 신코가 터질 듯했고, 작은 발은 신이 벗겨져 굴렀습니다. 하인들이 고을을 사흘이나 돌았습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "감사는 사람을 풀어 온 고을을 뒤졌습니다. 그러나 그런 소를 보았다는 사람은 아무도 없었습니다. 장마당에도 사람을 보내 알아보게 했습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "팥쥐와 배 씨가 마당에 끌려 나왔습니다. 감사가 호령했습니다.<br>\"이 죄가 어떤 죄인지 아느냐. 너희를 국법대로 다스리겠다.\"",
...
const QUIZ = [
    { q: "계모가 콩쥐에게 준 괭이는 어떤 것이었습니까?", choices: ["쇠로 만든 새 괭이", "나무로 만든 괭이", "날이 아주 무딘 괭이"], answer: 1 },
    { q: "검은 소는 밭을 다 갈고 나서 콩쥐에게 무엇을 남기고 갔습니까?", choices: ["처음 보는 붉은 과일 몇 알", "수를 놓은 꽃신 한 켤레", "곱게 접은 비단 옷 한 벌"], answer: 0 },
    { q: "두꺼비는 왜 콩쥐를 돕는다고 했습니까?", choices: ["감사 댁에서 날마다 밥알을 놓아 주어서", "지난여름 마당에서 밟지 않고 비켜 가서", "밑 빠진 독 안에 살게 해 주어서"], answer: 1 },
    { q: "참새 떼는 곳간의 벼를 어떻게 했습니까?", choices: ["쌀을 물어다 마당의 독에 채웠다", "벼를 절구에 넣어 대신 찧어 주었다", "껍질만 벗기고 쌀은 안 가져갔다"], answer: 2 },
    { q: "콩쥐는 왜 꽃신 한 짝을 잃어버렸습니까?", choices: ["통나무 다리가 부러져서", "팥쥐가 빼앗아 물에 던져서", "행차 소리에 놀라 발을 헛디뎌서"], answer: 2 },
    { q: "감사는 꽃신을 보고 하인에게 무엇을 시켰습니까?", choices: ["이 신의 임자를 찾아라", "이 신을 지은 사람을 잡아 오라", "이 신을 관아에 걸어 두라"], answer: 0 },
    { q: "배 씨는 팥쥐에게 꽃신을 신기려고 어떻게 했습니까?", choices: ["신코를 칼로 몰래 찢어 늘렸다", "발에 참기름을 바르고 밀어 넣었다", "발을 찬물에 오래 담가 줄였다"], answer: 1 },
    { q: "콩쥐가 연못에 빠진 뒤 팥쥐는 어떻게 했습니까?", choices: ["옷을 바꿔 입고 안방에 들어가 문을 잠갔다", "감사 댁 하인들에게 달려가 알렸다", "울면서 어머니가 있는 집으로 돌아갔다"], answer: 0 },
    { q: "감사가 지나가면 붉은 연꽃은 어떻게 했습니까?", choices: ["꽃잎을 오므렸다", "고개를 들었다", "줄기가 휘어 후려쳤다"], answer: 1 },
    { q: "할멈이 짝이 다른 젓가락을 내놓으며 한 말은 무엇입니까?", choices: ["짝이 바뀐 사람은 어찌 못 알아보시는지요", "밥은 짝이 안 맞아도 먹을 수 있습니다", "이 젓가락은 마님이 쓰시던 것입니다"], answer: 0 },
    { q: "콩쥐가 살아난 소식을 듣고 팥쥐는 어떻게 했습니까?", choices: ["마당에 나와 무릎을 꿇고 빌었다", "담을 넘어 달아나려다 굴러떨어졌다", "연못가에 가서 콩쥐를 붙들고 울었다"], answer: 1 },
    { q: "콩쥐는 배 씨와 팥쥐를 어떻게 해 달라고 했습니까?", choices: ["옥에 가두어 달라고", "종으로 부리게 해 달라고", "고을 밖으로 내보내 달라고"], answer: 2 },
    {
        q: "이 책을 읽고 난 반응으로 알맞지 않은 것은 무엇인가요?",
        wide: true,
        choices: [
            "팥쥐에게는 집 앞 모래밭을, 콩쥐에게는 산 밑 자갈밭을 준 것을 보면, 못 할 일을 시켜 놓고 흠을 잡으려는 것이었구나.",
...
const AFTERWORD = {
    ...
    paras: [
        ...
        `우리 이야기가 그 이야기들과 뚜렷하게 다른 데가 한 군데 있습니다. 결혼에서 끝나지 않는다는 것입니다. 서양 신데렐라는 신발이 맞고 나면 행복하게 살았다는 말로 끝납니다. 콩쥐 팥쥐는 거기가 절반입니다. 제4장부터가 진짜입니다.`,
        ...
        `콩쥐를 도운 것이 무엇이었는지 한번 세어 보십시오. 검은 소, 두꺼비, 참새 떼입니다. 요정 대모도 마법 지팡이도 없습니다. 밭 갈던 소와 마당의 두꺼비와 처마의 참새입니다. 옛사람들이 날마다 보던 것들이 그대로 돕는 편이 된 것입니다.`,
...
const EN = {
    ...
    chapters: [
        {
            ...
            paras: [
                ...
                "In the year Kongjwi turned ten, her father took a new wife. Her name was Lady Bae, and she came into the house with a daughter of her own. That child's name was Patjwi. Patjwi was a year younger than Kongjwi.",
                ...
                "\"Today you will till the fields. Don't think of coming home before it is done.\" The sun was still sitting on the ridge of the hill.",
                ...
                "The fields were different too. Patjwi was given the sandy plot in front of the house. Kongjwi was given the stony plot at the foot of the hill. It was a field a grown man could not till half of in a day. The stones were the size of a man's fist.",
                ...
                "\"How am I ever to till that field with this?\" And she had not done a quarter of it.",
        ...
        },
        {
            ...
            paras: [
                ...
                "Hundreds of them came down into the yard. The sparrows settled on the heaps of rice and began to strip the husks with their beaks. The whole yard was covered with sparrows.",
        ...
        },
        {
            ...
            paras: [
                ...
                "In house after house the young women came out and tried the shoe on. But it fitted nobody. Big feet nearly split the toe of it being forced in; small feet let it slip off and roll away. The servants went round the town for three whole days.",
        ...
        },
        {
            ...
            paras: [
                ...
                "The governor sent men out and had the whole district searched. But there was nobody who had seen such an ox. He even sent men to the markets to find out.",
        ...
        },
        {
            ...
            paras: [
                ...
                "Patjwi and Lady Bae were dragged out into the yard. The governor thundered at them.<br>\"Do you know what kind of crime this is? I shall deal with you by the law of the land.\"",
    ...
    quiz: [
        ...
        { q: "What did the black ox leave Kongjwi when the field was done?", choices: ["A few red fruits she had never seen", "A pair of embroidered flower shoes", "A neatly folded silk dress"], answer: 0 },
        { q: "Why did the toad say it was helping Kongjwi?", choices: ["She had put out rice for it every day", "She had stepped round it in the yard last summer", "She had let it live in the jar"], answer: 1 },
        { q: "What did the sparrows do with the rice in the barn?", choices: ["Carried the grains off to fill the jar", "Put the rice in the mortar and pounded it", "Took off only the husks and not one grain"], answer: 2 },
        { q: "Why did Kongjwi lose one flower shoe?", choices: ["The log bridge broke", "Patjwi snatched it and threw it in the water", "The noise of the procession startled her and she slipped"], answer: 2 },
        { q: "What did the governor tell his servant when he saw the shoe?", choices: ["Find the owner of this shoe", "Arrest whoever made this shoe", "Hang this shoe up at the office"], answer: 0 },
        { q: "How did Lady Bae try to get the shoe on Patjwi?", choices: ["She slit the toe with a knife in secret", "She oiled the foot with sesame oil and pushed", "She soaked the foot in cold water to shrink it"], answer: 1 },
        { q: "What did Patjwi do after Kongjwi went into the pond?", choices: ["Put on Kongjwi's clothes and locked herself in her room", "Ran to tell the governor", "Went home to her mother in tears"], answer: 0 },
        { q: "What did the red lotus do when the governor walked by?", choices: ["Closed its petals", "Lifted its head", "Bent its stem and struck"], answer: 1 },
        { q: "What did the old woman say as she set out the odd chopsticks?", choices: ["How is it you cannot tell a changed person?", "Odd chopsticks still eat rice", "These were the ones your lady used"], answer: 0 },
        { q: "What did Patjwi do when she heard Kongjwi was alive?", choices: ["Came into the yard and knelt to beg", "Tried to climb the wall and fell", "Ran to the pond and clung to Kongjwi weeping"], answer: 1 },
        { q: "What did Kongjwi ask to be done with Lady Bae and Patjwi?", choices: ["Lock them in prison", "Make them servants", "Send them out of the province"], answer: 2 },
        {
            q: "Which reaction to this book does NOT fit?",
            wide: true,
            choices: [
                "Patjwi got the sandy patch by the house and Kongjwi the stony field under the hill, so it was set up so she could not do it.",
    ...
    afterword: {
        ...
        paras: [
            ...
            "Count up what helped Kongjwi. A black ox, a toad, and sparrows. There is no fairy godmother and no magic wand. There is a ploughing ox, a toad in the yard, sparrows under the eaves. The things people saw every day are exactly the things that came over to her side.",
