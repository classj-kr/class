const CHAPTERS = [
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "\"누렁아, 가자!\"",
                    "부르기가 무섭게 발밑에 와 있었지요.",
                    "밭에 나갈 때도, 장에 갈 때도, 심지어 화장실에 갈 때도 한 번을 떨어지는 법이 없었답니다."
                ],
                right: [
                    "\"이 녀석은 내 그림자야.\"",
                    "김 서방은 그렇게 말하며 껄껄 웃었어요. 그러면 누렁이는 꼬리를 흔들었지요.",
                    "누렁이는 그 말을 알아듣는 것 같았어요.",
                    "동네 사람들도 김 서방과 누렁이를 늘 한 짝으로 여겼답니다.",
                    "\"저기 김 서방하고 누렁이 온다.\""
                ]
            },
            {
            ...
            },
            {
                ...
                left: [
                    ...
                    "들판에는 마른 풀이 무릎까지 자라 있었어요.",
                    "\"아이고, 다리야. 잠깐만 쉬었다 가자.\"",
                    "그러고는 마른 풀밭에 벌렁 드러누워 버렸지요.",
                    "\"딱 한숨만 자자꾸나.\""
                ],
                right: [
                    "김 서방은 그대로 드르렁드르렁 코를 골기 시작했습니다. 아무리 흔들어도 일어날 것 같지 않았어요.",
                    "누렁이만 잠들지 않았지요.",
                    "누렁이는 그 옆에 나란히 앉아 귀를 쫑긋 세우고 밤을 지켰답니다.",
                    "바람이 서늘하게 불어왔지요."
                ]
            }
        ]
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "처음에는 아주 작은 불빛이었어요.",
                    "누군가 버리고 간 불씨가 마른 풀에 옮아붙은 것이었지요. 그해 가을은 유난히 비가 오지 않았거든요.",
                    "들판 끝이 점점 밝아졌지요."
                ],
                right: [
                    "바람을 타고 불길이 성큼성큼 다가왔습니다. 마른 풀이 타닥타닥 소리를 내며 타올랐지요.",
                    "누렁이가 벌떡 일어났어요.",
                    "코끝으로 매캐한 냄새가 확 들어왔답니다.",
                    "연기가 벌써 눈을 찔렀지요."
                ]
            },
            {
                ...
                left: [
                    "\"컹! 컹! 컹컹컹!\"",
                    "누렁이가 주인의 얼굴에 대고 목이 터져라 짖었어요.",
                    "앞발로 주인의 가슴을 쿵쿵 두드렸지요.",
                    "\"으음… 시끄럽다… 저리 가거라…\"",
                    "김 서방은 손만 휘휘 내저을 뿐이었지요.",
                    "눈도 뜨지 않았답니다."
                ],
                right: [
                    "누렁이가 옷자락을 물고 흔들어도 소용없었습니다. 김 서방은 돌아누워 다시 코를 골았지요.",
                    "발을 동동 구르며 낑낑거렸어요.",
                    "불길은 이미 코앞까지 와 있었어요. 뜨거운 바람이 훅훅 끼쳐 왔답니다.",
                    "누렁이는 이제 짖는 것을 그만두었답니다."
                ]
            },
            {
                art: "06-stream.webp",
                ...
                left: [
                    ...
                    "무언가 생각해 낸 것이었어요.",
                    "한 번도 뒤를 돌아보지 않고 있는 힘껏 달렸어요. 발바닥이 다 벗겨질 것 같았지요.",
                    "돌부리에 발이 걸려도 멈추지 않았지요."
                ],
                right: [
                    "첨벙!",
                    "차가운 물이 온몸에 스며들었어요.",
                    "누렁이는 물속에 온몸을 푹 담갔다가 다시 뛰쳐나왔습니다. 털에서 물이 뚝뚝 떨어졌지요.",
                    "그러고는 왔던 길을 그대로 되돌아 달렸답니다.",
                    "숨이 턱까지 차올랐지요."
                ]
            }
        ]
    },
    {
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "데굴, 데굴, 데굴.",
                    "젖은 털에서 나온 물이 마른 풀을 조금씩 적셨습니다. 하지만 그 정도로는 어림도 없었지요.",
                    "온몸이 흙투성이가 되었지요.",
                    "누렁이는 다시 개울 쪽으로 고개를 돌렸어요."
                ],
                right: [
                    "그러고는 또 개울로 달렸습니다.",
                    "적시고, 굴리고, 또 적시고, 또 굴리고.",
                    "몇 번이나 그랬는지는 아무도 모른답니다. 그러는 사이 불길은 점점 더 가까워졌어요.",
                    "털이 마를 새도 없었지요.",
                    "다리가 후들거려 자꾸 넘어졌답니다."
                ]
            },
            {
                ...
                left: [
                    ...
                    "불길이 사람 키만큼 높았어요.",
                    "열기에 풀이 절로 오그라들었지요.",
                    "그런데 젖은 풀 앞에서 불길이 스르르 힘을 잃었어요. 치익 소리를 내며 하얀 연기만 피어올랐답니다."
                ],
                right: [
            ...
            },
            {
                ...
                left: [
                    ...
                    "재 냄새가 코를 찔렀어요.",
                    "타지 않은 곳은 자기가 누워 있던 자리, 딱 그 한 뼘뿐이었어요. 등골이 서늘해졌지요.",
                    "김 서방은 한참을 두리번거렸어요."
                ],
                right: [
        ...
        moral: "누렁이는 짖어도 소용없자 스스로 할 수 있는 일을 찾아냈어요. 말이 통하지 않을 때에도 마음을 전하는 방법은 남아 있답니다.",
        question: "말로 전할 수 없을 때, 마음을 보여 준 적이 있나요?"
    }
];
    ...
    spreads: [
        {
            art: 'end.webp',
            left: [
                "고려 때 엮은 책에도 이와 같은 이야기가 실려 있습니다. 그러니 적어도 팔백 년은 전해 온 이야기입니다. 그동안 그 자리를 지킨 것은 비석 하나와 땅 이름 하나였습니다.",
                "지금도 그곳에는 개를 기리는 비석이 서 있습니다. 임실 오수면이 그 고을입니다.",
...
const WORDS_KO = {
    ...
    "01-pair.webp": [
        { w: "고을", k: "옛날의 마을이나 고장.", s: "옛날 오수라는 고을에 김 서방이 살았습니다." },
        { w: "서방", k: "옛날에 남자를 부르던 말.", s: "옛날 오수라는 고을에 김 서방이 살았습니다." },
        { w: "심지어", k: "더 나아가 그것까지도.", s: "심지어 화장실에 갈 때도" },
        { w: "한 짝", k: "늘 붙어 다니는 한 쌍.", s: "김 서방과 누렁이를 늘 한 짝으로 여겼답니다." }
    ],
    "02-tavern.webp": [
        { w: "주막", k: "옛날에 술과 밥을 팔고 재워 주던 집.", s: "주막 앞을 지나다 아는 사람을 만났지요." },
        { w: "비틀", k: "몸이 한쪽으로 기울며 흔들리는 모양.", s: "걸음이 이리 비틀 저리 비틀했지요." },
        { w: "바싹", k: "아주 가까이 붙는 모양.", s: "누렁이가 그 곁을 바싹 따라 걸었어요." },
        { w: "받치다", k: "밑에서 괴어 버티다.", s: "얼른 몸으로 받쳐 주었답니다." }
    ],
    "03-asleep.webp": [
        { w: "들판", k: "넓게 펼쳐진 벌판.", s: "들판을 반쯤 건넜을 때였습니다." },
        { w: "벌렁", k: "뒤로 눕거나 자빠지는 모양.", s: "마른 풀밭에 벌렁 드러누워 버렸지요." },
        { w: "한숨", k: "잠깐 자는 잠.", s: "딱 한숨만 자자꾸나." },
        { w: "드르렁드르렁", k: "코를 크게 고는 소리.", s: "김 서방은 그대로 드르렁드르렁 코를 골기 시작했습니다." },
        { w: "쫑긋", k: "귀를 빳빳이 세우는 모양.", s: "귀를 쫑긋 세우고 밤을 지켰답니다." },
        { w: "서늘하다", k: "서느렇게 찬 기운이 돌다.", s: "바람이 서늘하게 불어왔지요." }
    ],
    "04-fire.webp": [
        { w: "일렁이다", k: "불빛이나 물결이 흔들리다.", s: "들판 끝에서 붉은 빛이 일렁이기 시작했어요." },
        { w: "불씨", k: "불을 일으키는 작은 불.", s: "누군가 버리고 간 불씨가 마른 풀에 옮아붙은 것이었지요." },
        { w: "불길", k: "타오르는 불꽃의 줄기.", s: "바람을 타고 불길이 성큼성큼 다가왔습니다." },
        { w: "타닥타닥", k: "마른 것이 타는 소리.", s: "마른 풀이 타닥타닥 소리를 내며 타올랐지요." },
        { w: "매캐하다", k: "연기 냄새가 맵고 텁텁하다.", s: "코끝으로 매캐한 냄새가 확 들어왔답니다." }
    ],
    "05-wake.webp": [
        { w: "내젓다", k: "손을 이리저리 흔들다.", s: "김 서방은 손만 휘휘 내저을 뿐이었지요." },
        { w: "옷자락", k: "옷의 아래로 드리운 부분.", s: "누렁이가 옷자락을 물고 흔들어도 소용없었습니다." },
        { w: "동동", k: "발을 자꾸 구르는 모양.", s: "발을 동동 구르며 낑낑거렸어요." },
        { w: "코앞", k: "아주 가까운 곳.", s: "불길은 이미 코앞까지 와 있었어요." },
        { w: "끼치다", k: "열이나 냄새가 확 닿다.", s: "뜨거운 바람이 훅훅 끼쳐 왔답니다." }
    ],
    "06-stream.webp": [
        { w: "홱", k: "갑자기 세게 돌리는 모양.", s: "누렁이는 몸을 홱 돌려 달리기 시작했습니다." },
        { w: "벗겨지다", k: "겉이 까져 떨어지다.", s: "발바닥이 다 벗겨질 것 같았지요." },
        { w: "돌부리", k: "땅에 묻힌 돌의 뾰족한 끝.", s: "돌부리에 발이 걸려도 멈추지 않았지요." },
        { w: "스며들다", k: "배어서 안으로 들다.", s: "차가운 물이 온몸에 스며들었어요." },
        { w: "담그다", k: "물속에 넣다.", s: "누렁이는 물속에 온몸을 푹 담갔다가 다시 뛰쳐나왔습니다." }
    ],
    "07-roll.webp": [
        { w: "적시다", k: "물기가 배게 하다.", s: "젖은 털에서 나온 물이 마른 풀을 조금씩 적셨습니다." },
        { w: "어림도 없다", k: "도무지 될 리가 없다.", s: "하지만 그 정도로는 어림도 없었지요." },
        { w: "흙투성이", k: "흙이 잔뜩 묻은 모양.", s: "온몸이 흙투성이가 되었지요." },
        { w: "후들거리다", k: "다리가 자꾸 떨리다.", s: "다리가 후들거려 자꾸 넘어졌답니다." }
    ],
    "08-stop.webp": [
        { w: "열기", k: "뜨거운 기운.", s: "열기에 풀이 절로 오그라들었지요." },
        { w: "오그라들다", k: "안으로 말리며 작아지다.", s: "열기에 풀이 절로 오그라들었지요." },
        { w: "스르르", k: "소리 없이 천천히 사그라드는 모양.", s: "젖은 풀 앞에서 불길이 스르르 힘을 잃었어요." },
        { w: "가쁘다", k: "숨쉬기가 벅차다.", s: "숨이 가빠 혀를 길게 늘어뜨린 채였어요." },
        { w: "털썩", k: "갑자기 힘없이 쓰러지는 모양.", s: "그 옆에 누렁이가 털썩 쓰러졌습니다." }
    ],
    "09-dawn.webp": [
        { w: "재", k: "타고 남은 가루.", s: "재 냄새가 코를 찔렀어요." },
        { w: "뼘", k: "손가락을 벌린 만큼의 길이.", s: "딱 그 한 뼘뿐이었어요." },
        { w: "등골이 서늘하다", k: "무서워서 등이 오싹하다.", s: "등골이 서늘해졌지요." },
        { w: "두리번거리다", k: "이리저리 둘러보다.", s: "김 서방은 한참을 두리번거렸어요." },
        { w: "흠뻑", k: "물기가 배어 아주 젖은 모양.", s: "물에 흠뻑 젖은 채" }
    ],
    "10-tree.webp": [
        { w: "들쳐 업다", k: "번쩍 들어 등에 업다.", s: "김 서방은 누렁이를 들쳐 업고 집으로 내달렸어요." },
        { w: "내달리다", k: "힘껏 뛰어가다.", s: "집으로 내달렸어요." },
        { w: "늘어지다", k: "힘이 빠져 축 처지다.", s: "누렁이의 몸이 축 늘어져 있었어요." },
        { w: "뿌리가 내리다", k: "뿌리를 뻗어 살아나다.", s: "지팡이를 꽂았더니 뿌리가 내렸다고도 해요." },
        { w: "드리우다", k: "아래로 늘어뜨리다.", s: "나무는 곧게 자라 큰 그늘을 드리웠어요." }
    ],
    "after": [
        { w: "대목", k: "이야기 가운데 어느 한 부분.", s: "불이 젖은 풀 앞에서 힘을 잃은 대목이 이 이야기의 답입니다." }
    ]
};
