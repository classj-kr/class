        ...
        beats: [
            {
                ...
                right: [
                    ...
                    "토끼가 코를 벌름거렸어요.",
                    "\"고소한 냄새가 여기까지 나네요.\"",
                    "호랑이는 벌써 입맛을 쩝쩝 다셨지요. 구수한 김이 언덕 아래까지 퍼져 나갔어요.",
                    "두꺼비는 시루 옆에서 눈만 껌뻑거렸답니다."
                ]
            },
            {
                art: "02-argue.webp",
                ...
                left: [
                    ...
                    "\"이걸 누가 다 먹지?\"",
                    "\"당연히 나지! 내가 다 먹는다!\"",
                    "호랑이가 앞발을 쿵 내리쳤습니다. 시루가 들썩할 만큼 세게요.",
                    "토끼가 얼른 뛰어들어 그 앞을 막아섰지요.",
                    "\"잠깐만요!\""
                ],
                right: [
                    "\"내가 제일 힘이 세니까!\"",
                    "호랑이가 이빨을 드러냈어요.",
                    "\"힘이 세면 다 먹나요? 저는 제일 빠른데요.\"",
                    "토끼도 지지 않고 귀를 쫑긋 세웠어요. 둘은 코가 닿을 만큼 얼굴을 들이밀었습니다.",
                    "떡은 식어 가는데 다툼은 그치지 않았답니다."
                ]
            },
            {
                art: "03-quiet.webp",
                emoji: "🐸",
                left: [
                    "호랑이와 토끼가 한참을 옥신각신했어요. 해가 벌써 기울고 있었지요.",
                    "그동안 두꺼비는 한마디도 하지 않았습니다.",
                    "시루 옆에 앉아 눈만 껌뻑거렸어요.",
                    "\"두꺼비, 너는 왜 가만있어?\"",
                    "토끼가 두꺼비를 툭 건드렸지요."
                ],
                right: [
                    "\"음… 저는 힘도 없고 빠르지도 않으니까요.\"",
                    "두꺼비는 느릿느릿 대답했어요. 얼굴에는 아무 기색도 없었지요.",
                    "호랑이와 토끼는 코웃음을 쳤어요.",
                    "그러고는 다시 다투기 시작했습니다.",
                    "두꺼비는 그저 언덕 아래만 내려다보았답니다."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                emoji: "💡",
                left: [
                    "그러다 두꺼비가 슬며시 입을 열었습니다. 두꺼비의 목소리가 아주 태연했어요.",
                    "\"이렇게 다투기만 해서는 끝이 안 납니다.\"",
                    "\"공평하게 내기를 하는 게 어떨까요?\"",
                    "다투던 둘이 딱 멈추고 두꺼비를 돌아보았지요."
                ],
                right: [
                    "\"내기? 무슨 내기?\"",
                    "호랑이가 눈을 크게 떴어요.",
                    "\"이 시루를 언덕 아래로 굴리는 거예요.\"",
                    "\"먼저 잡는 이가 다 먹기로 하고요.\"",
                    "두꺼비는 언덕 아래를 턱으로 가리켰습니다. 언덕은 길고 비탈이 제법 가팔랐답니다."
                ]
            },
            {
                art: "05-agree.webp",
                emoji: "😁",
                left: [
                    "호랑이가 껄껄껄 웃었어요. 앞발로 제 가슴을 쿵쿵 두드렸지요.",
                    "\"좋다! 나보다 빠른 놈이 어디 있겠느냐!\"",
                    "\"어림없어요. 달리기는 제가 최고예요!\"",
                    "토끼도 지지 않고 그 자리에서 껑충 뛰어올랐지요."
                ],
                right: [
                    "둘은 벌써 출발선에 서서 몸을 풀었습니다. 호랑이는 발톱으로 땅을 긁었어요.",
                    "토끼는 뒷다리를 폈다 굽혔다 했지요.",
                    "둘 다 두꺼비는 안중에도 없었어요.",
                    "두꺼비는 그저 느긋하게 앉아 눈만 껌뻑였답니다."
                ]
            },
            {
                art: "06-roll.webp",
                ...
                left: [
                    "\"자, 하나, 둘, 셋!\"",
                    "두꺼비가 시루를 언덕 쪽으로 슬쩍 밀었어요. 떡시루가 비탈을 따라 데굴데굴 굴러 내려갔습니다.",
                    "\"내 거다!\"",
                    "\"아니에요, 제가 먼저예요!\"",
                    "호랑이와 토끼가 동시에 튀어 나갔지요."
                ],
                right: [
                    "호랑이와 토끼는 쏜살같이 시루를 쫓아 내려갔어요. 둘은 뒤도 돌아보지 않았지요.",
                    "흙먼지가 뿌옇게 일었습니다.",
                    "두꺼비는 그 뒷모습을 한참 바라보았어요.",
                    "그러고는 엉금엉금 걷기 시작했지요.",
                    "서두를 까닭이 하나도 없었으니까요."
                ]
            }
        ...
        beats: [
            {
                ...
                emoji: "🍘",
                left: [
                    "두꺼비는 느릿느릿 언덕을 내려가기 시작했어요. 한 걸음, 또 한 걸음.",
                    "서두르는 기색이라고는 조금도 없었지요.",
                    "대신 두 눈은 부지런히 땅바닥을 살폈습니다.",
                    "숨도 차지 않았답니다.",
                    "다리도 아프지 않았지요."
                ],
                right: [
                    "그런데 시루가 구를 때마다 떡이 한 조각씩 툭, 툭 떨어졌어요. 언덕 여기저기에 하얀 떡이 흩어졌습니다.",
                    "떡은 풀 위에 얌전히 놓여 있었지요.",
                    "두꺼비는 그것을 하나도 놓치지 않았어요.",
                    "처음부터 이럴 줄 알았거든요."
                ]
            },
            {
            ...
            },
            {
                ...
                emoji: "😳",
                left: [
                    "언덕 아래에서 시루가 커다란 나무에 부딪혀 멈췄어요. 호랑이와 토끼가 동시에 시루를 붙잡았지요.",
                    "\"내가 먼저!\"",
                    "\"아니에요, 제가 먼저!\"",
                    "둘은 숨을 헐떡이며 서로를 노려보았습니다.",
                    "그러다 문득 시루 안이 궁금해졌어요."
                ],
                right: [
                    "그런데 시루 안을 들여다본 순간, 둘 다 입을 다물었어요. 호랑이가 시루를 번쩍 들어 뒤집어 보았어요.",
                    "텅.",
                    "떡이 한 조각도 남아 있지 않았거든요.",
                    "굴러오는 동안 죄다 흘린 것이지요.",
                    "둘은 서로 얼굴만 쳐다보았답니다."
                ]
            },
            {
                ...
                emoji: "🐸",
                left: [
                    "둘은 부랴부랴 언덕을 도로 기어 올라갔습니다. 떡이 어디로 갔는지 알아야 했거든요.",
                    "언덕 위에서는 두꺼비가 느긋하게 앉아 있었지요.",
                    "볼록해진 배를 두드리면서요.",
                    "\"아이고 배불러. 잘 먹었습니다.\""
                ],
                right: [
                    "\"너, 너 언제 그걸 다…!\"",
                    "토끼가 두꺼비의 볼록한 배를 가리켰어요. 호랑이는 아예 입을 벌린 채 말을 잇지 못했지요.",
                    "두꺼비는 대답 대신 눈만 껌뻑껌뻑했습니다.",
                    "그날 이후 셋은 떡을 미리 나누기로 했답니다."
                ]
            }
        ],
        moral: "빨리 가는 것보다 어디에 무엇이 떨어지는지 보는 눈이 나을 때가 있어요. 호랑이와 토끼는 시루만 보고 달렸고, 두꺼비는 길을 보며 걸었답니다.",
        question: "서두르다가 정작 중요한 것을 놓친 적이 있나요?"
    }
];
    ...
    spreads: [
        {
            art: 'end.webp',
            left: [
                "느린 쪽이 빠른 쪽을 이기는 이야기는 세계 어디에나 있습니다. 다만 대개는 빠른 쪽이 잠을 자거나 방심해서 집니다.",
                "그런데 이 이야기는 그것들과 한 군데가 다릅니다. 토끼와 거북에서는 토끼가 잠을 잡니다. 빠른 쪽이 실수를 해야 느린 쪽이 이기는 것이지요.",
                "다시 보십시오. 둘은 시루를 보고 달렸고 두꺼비는 땅을 보며 걸었습니다. 굴러가는 시루에서 떡이 흘렀다는 것을 안 것은 땅을 본 쪽뿐이었습니다.",
                "무엇을 얻느냐는 얼마나 빠른가보다 어디를 보고 있는가에 달릴 때가 있습니다."
            ],
            right: [
                "빨리 가는 것보다 어디에 무엇이 떨어지는지 보는 눈이 나을 때가 있습니다. 호랑이와 토끼는 시루만 보고 달렸고 두꺼비는 길을 보며 걸었습니다.",
                "서두르다가 정작 중요한 것을 놓친 적이 있나요?"
            ]
        }
    ]
};
...
const WORDS_KO = {
    ...
    "01-cake.webp": [
        { w: "모락모락", k: "김이 조금씩 피어오르는 모양.", s: "김이 모락모락 나는 떡시루가 놓여 있었지요." },
        { w: "갓", k: "이제 막.", s: "갓 쪄 낸 하얀 떡이 네모나게 썰려 수북이 담겨 있었어요." },
        { w: "수북이", k: "많이 쌓여 소복한 모양.", s: "갓 쪄 낸 하얀 떡이 네모나게 썰려 수북이 담겨 있었어요." },
        { w: "벌름거리다", k: "코를 자꾸 벌렸다 오므리다.", s: "토끼가 코를 벌름거렸어요." },
        { w: "입맛을 다시다", k: "먹고 싶어 혀로 입술을 핥다.", s: "호랑이는 벌써 입맛을 쩝쩝 다셨지요." },
        { w: "구수하다", k: "냄새나 맛이 좋고 고소하다.", s: "구수한 김이 언덕 아래까지 퍼져 나갔어요." },
        { w: "껌뻑거리다", k: "눈을 자꾸 감았다 뜨다.", s: "두꺼비는 시루 옆에서 눈만 껌뻑거렸답니다." }
    ],
    "02-argue.webp": [
        { w: "들썩하다", k: "한 번 들렸다 내려앉다.", s: "시루가 들썩할 만큼 세게요." },
        { w: "막아서다", k: "앞을 가로막고 서다.", s: "토끼가 얼른 뛰어들어 그 앞을 막아섰지요." },
        { w: "쫑긋", k: "귀를 빳빳이 세우는 모양.", s: "토끼도 지지 않고 귀를 쫑긋 세웠어요." },
        { w: "들이밀다", k: "앞으로 바짝 내밀다.", s: "둘은 코가 닿을 만큼 얼굴을 들이밀었습니다." },
        { w: "다툼", k: "서로 옥신각신하는 일.", s: "떡은 식어 가는데 다툼은 그치지 않았답니다." }
    ],
    "03-quiet.webp": [
        { w: "옥신각신하다", k: "서로 제 말이 옳다고 다투다.", s: "호랑이와 토끼가 한참을 옥신각신했어요." },
        { w: "기울다", k: "해가 저쪽으로 넘어가다.", s: "해가 벌써 기울고 있었지요." },
        { w: "느릿느릿", k: "아주 천천히.", s: "두꺼비는 느릿느릿 대답했어요." },
        { w: "기색", k: "마음이 겉으로 드러난 낌새.", s: "얼굴에는 아무 기색도 없었지요." },
        { w: "코웃음", k: "남을 우습게 여겨 웃는 웃음.", s: "호랑이와 토끼는 코웃음을 쳤어요." }
    ],
    "04-idea.webp": [
        { w: "슬며시", k: "남모르게 살그머니.", s: "그러다 두꺼비가 슬며시 입을 열었습니다." },
        { w: "태연하다", k: "아무렇지 않은 듯 차분하다.", s: "두꺼비의 목소리가 아주 태연했어요." },
        { w: "공평하다", k: "어느 쪽에도 치우치지 않다.", s: "공평하게 내기를 하는 게 어떨까요?" },
        { w: "비탈", k: "비스듬히 기울어진 곳.", s: "언덕은 길고 비탈이 제법 가팔랐답니다." },
        { w: "가파르다", k: "몹시 기울어져 있다.", s: "언덕은 길고 비탈이 제법 가팔랐답니다." }
    ],
    "05-agree.webp": [
        { w: "껄껄껄", k: "크게 소리 내어 웃는 소리.", s: "호랑이가 껄껄껄 웃었어요." },
        { w: "어림없다", k: "도무지 될 리가 없다.", s: "어림없어요. 달리기는 제가 최고예요!" },
        { w: "껑충", k: "몸을 크게 솟구쳐 뛰는 모양.", s: "토끼도 지지 않고 그 자리에서 껑충 뛰어올랐지요." },
        { w: "몸을 풀다", k: "움직이기 전에 몸을 부드럽게 하다.", s: "둘은 벌써 출발선에 서서 몸을 풀었습니다." },
        { w: "안중에도 없다", k: "아예 마음에 두지도 않다.", s: "둘 다 두꺼비는 안중에도 없었어요." },
        { w: "느긋하다", k: "서두르지 않고 여유롭다.", s: "두꺼비는 그저 느긋하게 앉아 눈만 껌뻑였답니다." }
    ],
    "06-roll.webp": [
        { w: "데굴데굴", k: "자꾸 굴러가는 모양.", s: "떡시루가 비탈을 따라 데굴데굴 굴러 내려갔습니다." },
        { w: "쏜살같이", k: "쏜 화살처럼 아주 빠르게.", s: "호랑이와 토끼는 쏜살같이 시루를 쫓아 내려갔어요." },
        { w: "뿌옇다", k: "안개가 낀 것처럼 흐리다.", s: "흙먼지가 뿌옇게 일었습니다." },
        { w: "엉금엉금", k: "느리게 기어가는 모양.", s: "그러고는 엉금엉금 걷기 시작했지요." },
        { w: "서두르다", k: "급하게 움직이다.", s: "서두를 까닭이 하나도 없었으니까요." }
    ],
    "07-scatter.webp": [
        { w: "살피다", k: "두루 자세히 보다.", s: "대신 두 눈은 부지런히 땅바닥을 살폈습니다." },
        { w: "숨이 차다", k: "숨이 가빠지다.", s: "숨도 차지 않았답니다." },
        { w: "흩어지다", k: "여기저기 따로 떨어지다.", s: "언덕 여기저기에 하얀 떡이 흩어졌습니다." },
        { w: "얌전히", k: "조용하고 가지런하게.", s: "떡은 풀 위에 얌전히 놓여 있었지요." }
    ],
    "08-eat.webp": [
        { w: "우물우물", k: "입 안에서 천천히 씹는 모양.", s: "우물우물, 냠냠." },
        { w: "볼록하다", k: "겉으로 도드라져 나오다.", s: "두꺼비의 배가 점점 볼록해졌습니다." },
        { w: "흐뭇하다", k: "마음에 들어 기분이 좋다.", s: "두꺼비는 그렇게 흐뭇할 수가 없었답니다." }
    ],
    "09-empty.webp": [
        { w: "헐떡이다", k: "숨을 가쁘게 몰아쉬다.", s: "둘은 숨을 헐떡이며 서로를 노려보았습니다." },
        { w: "노려보다", k: "매섭게 쏘아보다.", s: "둘은 숨을 헐떡이며 서로를 노려보았습니다." },
        { w: "문득", k: "갑자기 생각이 떠오르는 모양.", s: "그러다 문득 시루 안이 궁금해졌어요." },
        { w: "죄다", k: "남김없이 모두.", s: "굴러오는 동안 죄다 흘린 것이지요." }
    ],
    "10-belly.webp": [
        { w: "부랴부랴", k: "매우 급히 서두르는 모양.", s: "둘은 부랴부랴 언덕을 도로 기어 올라갔습니다." },
        { w: "아예", k: "처음부터 아주.", s: "호랑이는 아예 입을 벌린 채 말을 잇지 못했지요." }
    ],
    "after": [
        { w: "방심하다", k: "마음을 놓고 조심하지 않다.", s: "대개는 빠른 쪽이 잠을 자거나 방심해서 집니다." },
        { w: "정작", k: "막상 그때가 되어.", s: "서두르다가 정작 중요한 것을 놓친 적이 있나요?" }
    ]
};
