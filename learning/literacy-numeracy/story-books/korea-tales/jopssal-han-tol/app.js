        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "어머니와 단둘이 다 쓰러져 가는 초가집에 살았지요.",
                    "어느 날 소년은 큰 세상을 보러 길을 떠나기로 마음먹었어요. 언제까지고 이렇게 살 수는 없다고 생각했거든요.",
                    "\"어머니, 저 큰 세상 좀 보고 오겠습니다.\""
                ],
                right: [
                    "떠나기 전에 봇짐을 뒤져 보았지만 나올 것이 하나도 없었습니다. 이리 털고 저리 털어도 마찬가지였지요.",
                    "딱 하나, 좁쌀 한 톨이 굴러 나왔어요.",
                    "\"이거라도 있으니 다행이지.\"",
                    "소년은 그것을 정성스레 종이에 싸서 품 깊숙이 넣었답니다."
                ]
            },
            {
                art: "02-first.webp",
                emoji: "🏠",
                left: [
                    "하루 종일 걷다 보니 해가 저물었습니다. 소년은 불빛이 보이는 어느 집 문을 두드렸어요.",
                    "\"하룻밤만 묵어 갈 수 있을까요?\"",
                    "소년은 꾸벅 절을 했어요.",
                    "\"그러게. 어서 들어오게.\"",
                    "주인은 선선히 문을 열어 주었지요."
            ...
            },
            {
                ...
                emoji: "🐭",
                left: [
                    "이튿날 아침이었어요. 소년이 선반을 올려다보니 좁쌀이 온데간데없었습니다.",
                    "\"어? 어디 갔지요?\"",
                    "\"이런! 밤새 쥐가 먹어 버렸구먼.\"",
                    "주인은 얼굴이 벌게져 어쩔 줄을 몰랐지요."
                ],
                right: [
                    "\"미안하네. 대신 그 쥐라도 잡아 줌세.\"",
    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "🛤️",
                left: [
                    "소년은 커다란 황소의 고삐를 잡고 뚜벅뚜벅 길을 걸었습니다.",
                    "소년의 키보다 두 배는 큰 황소였지요.",
                    "지나가던 사람들이 하나같이 눈을 크게 떴어요.",
                    "소년의 걸음이 아주 당당했어요."
                ],
                right: [
            ...
            },
            {
                ...
                emoji: "🏡",
                left: [
                    "여러 날을 걸어 마침내 소년이 집에 닿았어요. 떠날 때와 똑같은 낡은 초가집이 그대로 서 있었지요.",
                    "마당에 어머니의 신발이 놓여 있었어요.",
                    "\"어머니, 저 왔어요!\"",
                    "소년이 마당에서 큰 소리로 불렀습니다."
                ],
                right: [
            ...
            },
            {
                ...
                emoji: "📜",
                left: [
                    "소년은 품에서 종이 한 장을 꺼내 폈어요. 좁쌀을 쌌던 바로 그 종이였지요.",
                    "이리저리 접힌 자국이 그대로 남아 있었습니다.",
                    "\"이 안에 좁쌀 한 톨이 들어 있었잖아요.\"",
                    "소년의 얼굴이 환했어요."
                ],
                right: [
                    "\"그 한 톨로 시작한 일이랍니다.\"",
                    "어머니는 그제야 아들을 꼭 끌어안았어요.",
                    "한참 동안 아무 말도 하지 못했지요.",
                    "마당에서 황소가 커다랗게 음메— 하고 울었습니다. 그 소리가 온 마을에 다 퍼졌지요."
                ]
            }
        ],
...
const EN = {
    ...
    words: {
        "cover": [
            ...
            { w: "is called ~ (call)", k: "~라고 부른다", s: "is called a chain tale" },
        ...
        "after": [
            ...
            { w: "it's been told (tell)", k: "전해져 왔다", s: "why it's been told for so long" },
            ...
            { w: "had been lost (lose)", k: "없어져 있었다", s: "that what was his had been lost" },
            { w: "each time", k: "그때마다", s: "Each time, the person who heard it felt sorry" },
            { w: "felt sorry (feel)", k: "미안해했다", s: "the person who heard it felt sorry" },
            { w: "handed (hand)", k: "건네주었다", s: "handed him something bigger" },
            { w: "it wasn't ~ that ...", k: "...한 것은 ~이 아니었다", s: "So it wasn't the millet that carried the boy so far." },
            { w: "carried ~ so far (carry)", k: "~을 그렇게 멀리까지 데려갔다", s: "the millet that carried the boy so far" },
            { w: "the way he kept ~ing (keep ~ing)", k: "그가 계속 ~한 그 방식", s: "It was the way he kept treating that one grain" },
            ...
            { w: "turned ~ into ... (turn into)", k: "~을 ...으로 바꾸었다", s: "turned one grain of millet into an ox" },
            { w: "made a fuss (make a fuss)", k: "억지를 부렸다", s: "The boy never once made a fuss." },
            { w: "looked after (look after)", k: "소중히 돌보았다", s: "He simply looked after what was his" },
        ...
        "02-first.webp": [
            ...
            { w: "the sun went down (go down)", k: "해가 졌다", s: "He walked all day, and the sun went down." },
        ...
        "03-mouse.webp": [
            ...
            { w: "turned ~ upside down (turn upside down)", k: "~을 발칵 뒤집었다", s: "He turned the whole house upside down" },
            { w: "the whole house", k: "온 집을", s: "turned the whole house upside down" },
            { w: "until he caught one (catch)", k: "한 마리 잡을 때까지", s: "upside down until he caught one" },
        ...
        "05-dog.webp": [
            { w: "tucked ~ under his arm (tuck)", k: "~을 품에 안았다", s: "The boy tucked the cat under his arm" },
        ...
        "07-ox.webp": [
            { w: "walked on (walk on)", k: "계속 걸어갔다", s: "The boy walked on, leading the big horse." },
            { w: "leading (lead)", k: "끌고 가며", s: "leading the big horse" },
            { w: "hooves (hoof)", k: "발굽", s: "Its hooves went clop, clop" },
            { w: "clop, clop", k: "저벅저벅 (발굽 소리)", s: "Its hooves went clop, clop along the road" },
        ...
        "08-road.webp": [
            ...
            { w: "opened their eyes wide (open ~ wide)", k: "눈을 크게 떴다", s: "Everyone who passed opened their eyes wide." },
            ...
            { w: "turned to look after ~ (turn to look)", k: "~을 돌아보았다", s: "People turned to look after him." },
            { w: "as he answered", k: "대답하면서", s: "The boy smiled as he answered." },
            { w: "This time nobody ~", k: "이번에는 아무도 ~ 않았다", s: "This time nobody laughed." }
        ],
        "09-home.webp": [
            ...
            { w: "called out loudly (call out)", k: "큰 소리로 불렀다", s: "The boy called out loudly from the yard." },
            { w: "her eyes went round (go round)", k: "눈이 휘둥그레졌다", s: "His mother opened the door and her eyes went round." },
        ...
        "10-millet.webp": [
            ...
            { w: "opened it out (open out)", k: "펼쳤다", s: "and opened it out" },
            { w: "the very paper", k: "바로 그 종이", s: "It was the very paper the millet had been wrapped in." },
            { w: "had been wrapped in (wrap)", k: "~에 싸여 있던", s: "the very paper the millet had been wrapped in" },
            { w: "Every fold", k: "접힌 자리마다", s: "Every fold was still creased into it." },
            { w: "creased (crease)", k: "접은 자국이 나 있다", s: "Every fold was still creased into it." },
            ...
            { w: "how all of this started (start)", k: "이 모든 게 어떻게 시작됐는지", s: "That one grain is how all of this started." },
            { w: "pulled ~ into her arms (pull)", k: "~을 끌어안았다", s: "Then his mother pulled him into her arms." },
            ...
            { w: "all through ~", k: "~ 구석구석까지", s: "carried all through the village" }
        ]
    },
    afterword: {
        title: 'After Reading',
