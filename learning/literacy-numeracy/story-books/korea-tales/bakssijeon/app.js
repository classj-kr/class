...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            "얼굴이 검은 데다 피부는 옴퉁옴퉁 파였고, 눈은 짝짝이였습니다. 코는 납작하고 입은 비뚤어져 있었습니다. 한양에서 제일가는 신랑이 평생 본 적 없는 얼굴이었습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "며느리는 그 집에 피화당(避禍堂)이라는 이름을 붙였습니다. 화를 피하는 집이라는 뜻이었습니다. 사람들은 그 이름을 이상하게 여겼지만 곧 잊었습니다.",
            ...
            "한 달이 지나자 털에 윤이 돌았습니다. 석 달이 지나자 갈비뼈에 살이 올랐습니다. 반년이 지나자 아무도 그 말을 보고 웃지 않았습니다. 뜰에서 한 바퀴만 돌아도 발굽 소리가 달랐습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "소식을 들은 용골대가 군사 삼천을 이끌고 달려왔습니다. 아우가 쓰러진 것을 보고 용골대가 이를 갈았습니다.<br>\"저 집을 흙더미로 만들어라!\"",
    ...
    },
    {
        ...
        paras: [
            "그 무렵 남한산성에서는 임금이 성문을 열었습니다. 청나라 군사에게 둘러싸인 채 마흔여섯 날을 버텼지만 먹을 것이 떨어졌습니다. 조선 임금은 청나라 임금 앞에 나아가 세 번 무릎을 꿇고 아홉 번 머리를 조아리는 굴욕을 당해야 했습니다. 조선이 진 것입니다.",
            ...
            "박씨는 그 뒤로도 피화당에서 살았습니다. 나무 군사들은 다시 나무로 돌아갔습니다. 계화는 나이가 들어서도 마님 곁을 떠나지 않았습니다.",
...
const COVER = {
    ...
    intro: [
        ...
        "얼굴이 몹시 못생겼다고 남편에게 버림받은 여인 박씨가 주인공이에요. 조선 소설에서 여자가 이야기 한가운데에 서는 일은 아주 드물지요.",
        "실제 병자호란에서 조선은 졌어요. 그 싸움이 닥쳤을 때 뒤뜰에 숨어 살던 박씨는 무엇을 할까요?",
        "박씨가 사는 뒤뜰 집 피화당, 몸종 계화, 청나라 장수 용골대는 시험에 자주 나오는 이름이랍니다."
    ]
};
...
const QUIZ = [
    { q: "박 처사는 어디에서 온 사람입니까?", choices: ["금강산", "묘향산", "지리산"], answer: 0 },
    { q: "혼인 첫날 밤, 너울을 벗은 신부를 본 시백은 어떻게 했습니까?", choices: ["아무 말 없이 사랑으로 나가 버렸다", "촛불을 등지고 밤새 돌아앉았다", "아버지께 달려가 혼인을 물리자고 했다"], answer: 1 },
    { q: "집안에서 유일하게 며느리의 재주를 알아본 사람은 누구입니까?", choices: ["시어머니", "남편 시백", "시아버지"], answer: 2 },
    { q: "박씨가 뒤뜰에 지은 집의 이름은 무엇입니까?", choices: ["낙산당", "피화당", "금강당"], answer: 1 },
    { q: "박씨 곁을 끝까지 지킨 몸종의 이름은 무엇입니까?", choices: ["계화", "옥매", "춘섬"], answer: 0 },
    { q: "박씨가 좋은 말 대신 제일 못난 말을 사 오라고 한 까닭은 무엇입니까?", choices: ["못난 말이 불쌍해 거두어 주려고", "삼백 냥으로는 좋은 말을 살 수 없어서", "아직 아무도 알아보지 못한 말을 찾으려고"], answer: 2 },
    { q: "박 처사가 딸의 얼굴을 삼 년 동안 껍질로 가려 둔 까닭은 무엇입니까?", choices: ["얼굴만 보는 신랑을 시험해 보려고", "큰 기운에 따르는 액운을 막으려고", "며느리의 재주를 시집에 감추려고"], answer: 1 },
    { q: "박씨가 시백을 통해 임금께 아뢴 것은 무엇입니까?", choices: ["청나라 사신을 내쫓고 명나라에 알리라", "임금은 미리 남한산성으로 옮기라", "먼저 사신을 보내 달래고 성을 고치라"], answer: 2 },
    { q: "기홍대가 이 상공 댁을 찾아온 참뜻은 무엇이었습니까?", choices: ["거문고 솜씨를 들려주려고", "박씨에게 재주를 배우려고", "시백을 몰래 없애려고"], answer: 2 },
    { q: "뒤뜰로 쳐들어온 용울대는 어떻게 되었습니까?", choices: ["안개에 갇혀 밤새 헤맸다", "나무 군사에 둘러싸여 쓰러졌다", "계화의 칼에 놀라 달아났다"], answer: 1 },
    { q: "강가에서 박씨는 어떻게 용골대를 물러서게 했습니까?", choices: ["부채를 부쳐 강을 얼리고 우박을 내렸다", "나무 군사를 불러 군사들을 에워쌌다", "안개를 일으켜 용골대를 가두었다"], answer: 0 },
    { q: "임금이 박씨에게 내린 이름은 무엇입니까?", choices: ["정경부인", "효열부인", "충렬부인"], answer: 2 },
    {
        q: "이 책을 읽고 난 반응으로 알맞지 않은 것은 무엇인가요?",
        wide: true,
        choices: [
            "며느리의 말씨와 걸음을 눈여겨본 것을 보면, 사람을 보는 눈은 얼굴이 아니라 말씨와 걸음에 있구나.",
            "박씨가 껍질이 벗겨졌다고 제가 달라진 것은 아니라고 한 것을 보면, 시백이 뒤늦게 사랑한 것이 무엇인지 묻는 말이었어.",
            "조정이 아녀자의 말이라며 웃어넘긴 것을 보면, 나라가 진 까닭이 청나라 군사 수만은 아니었네.",
            "박씨가 임금의 벼슬을 받아 조정에 나간 것을 보면, 뒤뜰 작은 집보다 대궐을 골랐나 봐."
        ],
        answer: 3
    }
];
...
const AFTERWORD = {
    ...
    paras: [
        ...
        `그런데 그 뒤가 다릅니다. 실제로는 세자와 세자빈을 비롯한 수만 명이 청나라로 끌려갔습니다. 소설에서는 박씨가 강가에서 그들을 지켜 냅니다. 실제로는 진 싸움을 소설에서는 한 여인이 되돌려 놓은 것입니다.`,
