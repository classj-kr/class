        ...
        beats: [
            {
                ...
                emoji: "🏠",
                left: [
                    "옛날 깊은 산 밑에 오누이가 어머니와 살았습니다. 아버지는 일찍 돌아가시고 셋이서 지냈지요.",
                    "어머니는 날마다 남의 집 일을 다니며 오누이를 먹여 살렸어요.",
                    "\"어머니, 오늘도 일 나가세요?\"",
                    "누이는 어머니 치맛자락을 붙들고 놓지 않았지요."
                ],
                right: [
                    "\"고개 너머 잔칫집에서 부르는구나. 떡을 준다니 얻어 오마.\"",
                    "어머니가 오누이의 머리를 차례로 쓰다듬었습니다.",
                    "\"문 꼭 잠그고 있어라. 누가 와도 열어 주면 안 된다.\"",
                    "\"예, 어머니.\"",
                    "오누이는 대문이 보이지 않을 때까지 손을 흔들었답니다."
                ]
            },
            {
                art: "02-tiger.webp",
                emoji: "🐯",
                left: [
                    "어머니는 잔칫집에서 하루 종일 설거지를 하고 일한 값으로 떡을 받았어요.",
                    "떡 광주리를 머리에 이고 돌아오는 길이었지요. 기다릴 아이들 생각에 걸음이 빨라졌어요.",
                    "첫 번째 고개에 막 올라섰을 때였습니다.",
                    "숲이 유난히 어두컴컴했지요."
                ],
                right: [
                    "\"어흥!\"",
                    "커다란 호랑이가 길을 떡 막아섰어요. 어머니는 그 자리에 얼어붙었지요.",
                    "\"떡 하나 주면 안 잡아먹지.\"",
                    "호랑이가 입맛을 다시며 말했답니다.",
                    "떡 냄새를 맡고 따라온 것이 분명했답니다."
                ]
            },
            {
                art: "03-pass.webp",
                emoji: "🍡",
                left: [
                    "어머니는 얼른 떡 하나를 던져 주고 고개를 넘었어요.",
                    "광주리를 끌어안고 정신없이 뛰었지요.",
                    "그런데 두 번째 고개에도 그 호랑이가 떡하니 앉아 있지 뭐예요.",
                    "\"아니, 아까 그 호랑이가 어떻게 여기에?\""
                ],
                right: [
                    "\"떡 하나 주면 안 잡아먹지.\"",
                    "어머니는 그때마다 떡을 하나씩 던져 주어야 했어요.",
                    "세 번째 고개에서도, 네 번째 고개에서도 똑같았습니다.",
                    "광주리가 점점 가벼워졌어요. 어머니의 다리도 점점 무거워졌지요.",
                    "어머니는 자꾸만 뒤를 돌아보았답니다."
                ]
            },
            {
                ...
                left: [
                    ...
                    "\"떡은 다 드렸잖습니까. 제발 보내 주세요.\"",
                    "\"이제 정말 아무것도 없다.\"",
                    "호랑이가 눈을 번뜩였어요.",
                    "하지만 호랑이는 길을 비켜 주지 않았답니다."
                ],
                right: [
                    "그날 밤, 어머니는 끝내 집에 돌아오지 못했답니다.",
                    "호랑이는 어머니 옷을 입고 산을 내려왔지요.",
                    "오누이는 등잔불을 켜 놓고 문만 바라보았어요.",
                    "\"오빠, 어머니가 왜 안 오시지?\"",
                    "\"오빠, 무서워.\"",
                    "오빠는 말없이 누이의 손을 꼭 잡아 주었답니다."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "\"얘들아, 엄마다. 문 열어라.\"",
                    "오누이는 서로 마주 보았어요. 기다리던 어머니 목소리였거든요.",
                    "\"어머니!\"",
                    "오누이가 반가워서 벌떡 일어섰어요."
                ],
                right: [
                    "그런데 오빠가 갑자기 누이의 소매를 붙잡았습니다. 무언가 이상했거든요.",
                    "\"…어머니 목소리가 왜 저래?\"",
                    "평소보다 훨씬 굵고 걸걸했지요.",
                    "누이도 그제야 걸음을 멈췄답니다.",
                    "오누이는 숨을 죽였답니다."
            ...
            },
            {
                ...
                left: [
                    ...
                    "문밖에서 재촉하는 소리가 자꾸 커졌어요.",
                    "오빠는 문고리를 잡은 채 한참을 망설였어요.",
                    "\"그럼 손을 좀 보여 주세요.\"",
                    "오빠는 목소리가 떨리지 않게 애를 썼지요."
                ],
                right: [
                    "문틈으로 손 하나가 쑥 들어왔습니다.",
                    "시커먼 털이 북슬북슬한 손이었지요. 어머니의 손이 아니었어요.",
                    "\"어머니 손은 이렇게 거칠지 않아.\"",
                    "오빠가 아주 작은 소리로 속삭였어요.",
                    "오누이는 서로를 꽉 붙들었답니다."
                ]
            },
            {
                ...
                left: [
                    ...
                    "오빠가 일부러 큰 소리로 말하고는 누이 손을 잡았어요.",
                    "부엌에서 솥뚜껑을 달그락거리기까지 했지요.",
                    "둘은 발소리를 죽이고 뒷문으로 빠져나갔지요.",
                    "문밖의 호랑이는 그 소리에 감쪽같이 속았지요."
                ],
                right: [
                    "마당 건너 우물가에 커다란 나무 한 그루가 서 있었습니다.",
                    "잎이 무성해서 몸을 숨기기에 꼭 알맞았지요.",
                    "오누이는 그 나무 위로 기어올랐어요.",
                    "높은 가지에 올라앉고서야 겨우 숨을 돌렸답니다.",
                    "\"오빠, 우리 어떻게 해.\"",
                    "\"쉿. 아무 소리도 내지 마.\""
                ]
            },
            {
                ...
                left: [
                    ...
                    "호랑이는 방이며 부엌이며 온 집을 뒤졌습니다.",
                    "이불을 들추고 장롱까지 열어 보았지요.",
                    "\"어디로 갔지? 분명 안에 있었는데.\"",
                    "호랑이의 목소리가 점점 사나워졌답니다."
                ],
                right: [
                    "밖으로 나온 호랑이가 우물 속을 들여다보았어요. 우물 위로 뻗은 가지에 앉은 오누이가 물에 비쳤거든요.",
                    "\"옳지, 저 안에 있구나!\"",
                    "나무 위에 있는 줄은 꿈에도 모른 것이었어요.",
                    "호랑이는 우물가를 빙빙 돌았답니다.",
                    "\"어디 얼마나 깊은지 보자.\""
                ]
            }
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "그 꼴이 어찌나 우스운지, 누이가 그만 참지 못하고 풋 하고 웃어 버렸습니다.",
                    "두 손으로 입을 틀어막았지만 이미 늦었지요.",
                    "웃음소리가 우물가에 또랑또랑 울렸답니다."
                ],
                right: [
                    "호랑이가 번쩍 고개를 들었어요. 나무 위에 오누이가 매달려 있는 것이 그제야 보였지요.",
                    "\"거기 있었구나! 어떻게 올라갔느냐?\"",
                    "\"어서 내려오지 못하겠느냐!\"",
                    "호랑이가 나무 밑동을 앞발로 툭툭 쳤답니다.",
                    "오빠의 머릿속이 바쁘게 돌아갔어요."
                ]
            },
            {
                ...
                left: [
                    "오빠가 얼른 둘러댔어요.",
                    "\"참기름을 바르고 올라왔지!\"",
                    "호랑이는 정말로 부엌에서 참기름을 가져다 손발에 발랐습니다. 그러고는 주르륵 미끄러지고 말았지요.",
                    "\"어라? 이거 왜 자꾸 미끄러지지!\""
                ],
                right: [
                    "그 꼴을 보고 누이가 저도 모르게 소리쳤어요.",
                    "\"바보야, 도끼로 찍고 올라오면 되잖아!\"",
                    "\"안 돼!\"",
                    "오빠가 누이의 입을 막았지만 이미 늦었답니다.",
                    "호랑이의 눈이 번쩍 뜨였지요."
                ]
            },
            {
                ...
                left: [
                    ...
                    "도끼 자국이 하나씩 늘 때마다 나무가 흔들렸어요.",
                    "오누이는 가지 끝까지 올라갔지만 더는 올라갈 데가 없었습니다.",
                    "\"이제 다 잡았다!\""
                ],
                right: [
                    "오누이는 두 손을 모으고 하늘에 빌었어요.",
                    "누이는 눈을 꼭 감았지요.",
                    "\"저희를 살리시려거든 튼튼한 동아줄을 내려 주세요!\"",
                    "그러자 하늘에서 굵은 새 동아줄이 스르르 내려왔지요.",
                    "오누이는 그 줄을 붙잡고 하늘로 올라갔답니다."
                ]
            },
            {
                art: "12-sky.webp",
                ...
                left: [
                    ...
                    "\"저 아이들만 갈 수는 없지!\"",
                    "\"나도 동아줄을 내려 주시오!\"",
                    "그런데 호랑이에게는 낡고 썩은 동아줄이 내려왔습니다.",
                    "호랑이는 그것도 모르고 신이 나서 줄을 탔지요."
                ],
                right: [
                    "뚝—",
                    "동아줄이 반쯤 가다 끊어져 호랑이는 수수밭으로 떨어졌어요. 수숫대가 붉은 것은 그때 묻은 호랑이 피래요.",
                    "\"오빠, 나는 밤이 무서워.\"",
                    "그래서 오빠가 달이, 누이가 해가 되었답니다.",
                    "누이는 쳐다보는 눈이 부끄러워 눈부시게 했대요."
                ]
            }
        ],
        moral: "오누이를 살린 것은 힘이 아니었어요. 어머니 목소리가 이상하다고 느꼈을 때 그냥 넘기지 않은 것, 손을 보여 달라고 한 번 더 물어본 것이었지요. 이상하다는 마음이 들면 그것부터 확인해 보는 것이 안전한 일이랍니다.",
        question: "무언가 이상하다고 느꼈는데 그냥 넘어간 적이 있나요?"
    }
];
    ...
    spreads: [
        {
            art: 'end.webp',
            left: [
                "이야기 하나가 이렇게 여러 몫을 하는 것은 흔한 일이 아닙니다. 하늘에 걸린 것을 설명하고, 들에 자란 것을 설명하고, 그러면서 문 앞에서 무엇을 조심해야 하는지까지 일러 줍니다.",
                "수수깡이 붉은 것은 정말입니다. 다만 호랑이 피가 묻어서는 아닙니다. 수수 줄기에는 붉은 물이 드는 성분이 들어 있어서 익어 갈수록 저절로 붉어집니다. 가을 들판에서 수수를 보면 이 이야기가 왜 하필 수수밭을 골랐는지 알 수 있습니다.",
                "짐승이 사람 흉내를 내며 문을 열게 하려는 이야기는 세계에 널리 있습니다. 서양의 늑대와 일곱 마리 아기 염소가 그렇고, 빨간 모자도 그렇습니다.",
                "그런 이야기의 가르침은 늘 같습니다. 문 앞에서 목소리만 믿지 말라는 것입니다.",
                "마지막에 오빠가 자리를 바꿔 준 대목도 다시 보십시오. 밤이 무섭다는 말 한마디에 제 몫을 내준 것입니다."
            ],
            right: [
                "오누이를 살린 것은 힘이 아니었습니다. 어머니 목소리가 이상하다고 느꼈을 때 그냥 넘기지 않은 것, 손을 보여 달라고 한 번 더 물어본 것이었습니다. 이상하다는 마음이 들면 그것부터 확인해 보는 것이 안전합니다.",
                "무언가 이상하다고 느꼈는데 그냥 넘어간 적이 있나요?"
            ]
        }
    ]
};
...
const WORDS_KO = {
    ...
    "01-family.webp": [
        ...
        { w: "치맛자락", k: "치마의 늘어진 끝.", s: "누이는 어머니 치맛자락을 붙들고 놓지 않았지요." },
        { w: "잔칫집", k: "잔치를 벌이는 집.", s: "고개 너머 잔칫집에서 부르는구나." },
        { w: "쓰다듬다", k: "손으로 부드럽게 문지르다.", s: "어머니가 오누이의 머리를 차례로 쓰다듬었습니다." }
    ],
    "02-tiger.webp": [
        { w: "광주리", k: "대나 싸리로 엮은 넓은 그릇.", s: "떡 광주리를 머리에 이고 돌아오는 길이었지요." },
        { w: "이다", k: "물건을 머리 위에 얹다.", s: "떡 광주리를 머리에 이고 돌아오는 길이었지요." },
        { w: "어두컴컴하다", k: "몹시 어둡다.", s: "숲이 유난히 어두컴컴했지요." },
        { w: "막아서다", k: "앞을 가로막고 서다.", s: "커다란 호랑이가 길을 떡 막아섰어요." },
        { w: "얼어붙다", k: "놀라서 그대로 굳다.", s: "어머니는 그 자리에 얼어붙었지요." },
        { w: "입맛을 다시다", k: "먹고 싶어 혀로 입술을 핥다.", s: "호랑이가 입맛을 다시며 말했답니다." }
    ],
    "03-pass.webp": [
        { w: "떡하니", k: "버젓이 자리를 차지한 모양.", s: "두 번째 고개에도 그 호랑이가 떡하니 앉아 있지 뭐예요." }
    ],
    "04-empty.webp": [
        { w: "사정하다", k: "딱한 처지를 말하며 부탁하다.", s: "어머니는 광주리를 뒤집어 보이며 사정했지요." },
        { w: "번뜩이다", k: "눈이 갑자기 빛나다.", s: "호랑이가 눈을 번뜩였어요." },
        { w: "비켜 주다", k: "길을 내주다.", s: "호랑이는 길을 비켜 주지 않았답니다." },
        { w: "등잔불", k: "기름을 태워 밝히던 불.", s: "오누이는 등잔불을 켜 놓고 문만 바라보았어요." }
    ],
    "05-knock.webp": [
        { w: "소매", k: "옷의 팔을 넣는 부분.", s: "오빠가 갑자기 누이의 소매를 붙잡았습니다." },
        { w: "걸걸하다", k: "목소리가 굵고 거칠다.", s: "평소보다 훨씬 굵고 걸걸했지요." },
        { w: "숨을 죽이다", k: "소리 나지 않게 조용히 하다.", s: "오누이는 숨을 죽였답니다." }
    ],
    "06-hand.webp": [
        { w: "목이 쉬다", k: "목이 잠겨 소리가 갈라지다.", s: "고개를 넘느라 목이 쉬었단다." },
        { w: "재촉하다", k: "빨리하라고 서두르다.", s: "문밖에서 재촉하는 소리가 자꾸 커졌어요." },
        { w: "문고리", k: "문을 여닫을 때 잡는 고리.", s: "오빠는 문고리를 잡은 채 한참을 망설였어요." },
        { w: "북슬북슬하다", k: "털이 많고 부슬부슬하다.", s: "시커먼 털이 북슬북슬한 손이었지요." },
        { w: "속삭이다", k: "아주 작은 소리로 말하다.", s: "오빠가 아주 작은 소리로 속삭였어요." }
    ],
    "07-escape.webp": [
        { w: "달그락거리다", k: "그릇이 부딪는 소리가 자꾸 나다.", s: "부엌에서 솥뚜껑을 달그락거리기까지 했지요." },
        { w: "감쪽같이", k: "티가 하나도 나지 않게.", s: "문밖의 호랑이는 그 소리에 감쪽같이 속았지요." },
        { w: "무성하다", k: "잎이나 풀이 빽빽하게 나다.", s: "잎이 무성해서 몸을 숨기기에 꼭 알맞았지요." },
        { w: "숨을 돌리다", k: "한숨 쉬며 마음을 놓다.", s: "높은 가지에 올라앉고서야 겨우 숨을 돌렸답니다." }
    ],
    "08-well.webp": [
        { w: "들추다", k: "덮인 것을 들어 올리다.", s: "이불을 들추고 장롱까지 열어 보았지요." },
        { w: "장롱", k: "옷을 넣어 두는 큰 가구.", s: "이불을 들추고 장롱까지 열어 보았지요." },
        { w: "사납다", k: "거칠고 무섭다.", s: "호랑이의 목소리가 점점 사나워졌답니다." },
        { w: "비치다", k: "물이나 거울에 모습이 나타나다.", s: "가지에 앉은 오누이가 물에 비쳤거든요." },
        { w: "꿈에도 모르다", k: "조금도 알아채지 못하다.", s: "나무 위에 있는 줄은 꿈에도 모른 것이었어요." }
    ],
    "09-laugh.webp": [
        { w: "바가지", k: "물을 푸는 둥근 그릇.", s: "호랑이가 바가지로 우물물을 푸기 시작했어요." },
        { w: "꼴", k: "겉으로 드러난 모양새.", s: "그 꼴이 어찌나 우스운지" },
        { w: "틀어막다", k: "꽉 막다.", s: "두 손으로 입을 틀어막았지만 이미 늦었지요." },
        { w: "또랑또랑", k: "소리가 맑고 똑똑한 모양.", s: "웃음소리가 우물가에 또랑또랑 울렸답니다." },
        { w: "밑동", k: "나무의 아래쪽 굵은 부분.", s: "호랑이가 나무 밑동을 앞발로 툭툭 쳤답니다." }
    ],
    "10-climb.webp": [
        { w: "둘러대다", k: "그럴듯하게 꾸며 말하다.", s: "오빠가 얼른 둘러댔어요." },
        { w: "참기름", k: "참깨로 짠 기름.", s: "참기름을 바르고 올라왔지!" },
        { w: "주르륵", k: "미끄러져 내려가는 모양.", s: "그러고는 주르륵 미끄러지고 말았지요." }
    ],
    "11-rope.webp": [
        { w: "자국", k: "무엇이 닿아 남은 흔적.", s: "도끼 자국이 하나씩 늘 때마다 나무가 흔들렸어요." },
        { w: "두 손을 모으다", k: "빌려고 두 손을 마주 대다.", s: "오누이는 두 손을 모으고 하늘에 빌었어요." },
        { w: "동아줄", k: "굵고 튼튼한 줄.", s: "튼튼한 동아줄을 내려 주세요!" }
    ],
    "12-sky.webp": [
        { w: "썩다", k: "오래되어 못 쓰게 되다.", s: "호랑이에게는 낡고 썩은 동아줄이 내려왔습니다." },
        { w: "눈이 부시다", k: "빛이 세어 바로 보기 어렵다.", s: "누이는 쳐다보는 눈이 부끄러워 눈부시게 했대요." }
    ],
    "after": [
        { w: "몫", k: "저마다 맡아서 하는 부분.", s: "이야기 하나가 이렇게 여러 몫을 하는 것은 흔한 일이 아닙니다." },
        { w: "성분", k: "무엇을 이루고 있는 알갱이.", s: "수수 줄기에는 붉은 물이 드는 성분이 들어 있어서" },
        { w: "하필", k: "다른 것도 많은데 왜 그것이.", s: "이 이야기가 왜 하필 수수밭을 골랐는지 알 수 있습니다." },
        { w: "흉내", k: "남이 하는 대로 따라 하는 짓.", s: "짐승이 사람 흉내를 내며 문을 열게 하려는 이야기는" }
    ]
};
