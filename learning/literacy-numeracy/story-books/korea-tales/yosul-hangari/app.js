const CHAPTERS = [
        ...
        beats: [
            {
                ...
                emoji: "🏺",
                left: [
                    "옛날 어느 마을에 가난한 농부 부부가 살았습니다. 논도 밭도 손바닥만 했지요.",
                    "부지런하기로는 마을에서 으뜸이었지요.",
        ...
        beats: [
            {
                ...
                right: [
                    "\"저 집이 갑자기 왜 저리 잘살지?\"",
                    "담 너머로 기웃거리는 사람이 부쩍 늘었어요.",
                    "\"밭에서 요술 항아리를 캤다지 뭔가.\"",
                    "소문은 금세 온 마을에 쫙 퍼졌답니다. 손바닥으로 하늘을 가릴 수는 없는 일이었지요."
                ]
            },
            {
                art: "05-seize.webp",
                emoji: "😤",
                left: [
                    "소문은 마을에서 제일 욕심 많은 부자 귀에도 들어갔어요.",
                    "부자는 벌써 곳간이 셋이나 있었어요. 그런데도 남의 것이 탐났지요.",
                    "부자는 밥을 먹다 말고 숟가락을 던지듯 놓았어요.",
                    "그러고는 곧장 농부의 집으로 달려왔습니다."
                ],
                right: [
                    "\"그 밭은 본래 우리 조상 땅이다!\"",
                    "부자가 마당에 들어서며 소리쳤어요.",
    ...
    },
    {
        ...
        beats: [
            {
                ...
                emoji: "👴",
                left: [
                    "그때 늙은 아버지가 문틈으로 안을 기웃거렸어요. 아들 방에서 밤새 이상한 소리가 났거든요.",
                    "\"얘야, 대체 무얼 하느냐?\"",
                    "\"아버지는 저리 가 계세요!\"",
                    "그래도 아버지는 궁금해서 견딜 수가 없었지요."
                ],
                right: [
            ...
            },
            {
                ...
                emoji: "👨‍👨‍👦‍👦",
                left: [
                    "꺼내고 꺼내도 아버지는 계속 나왔습니다.",
                    "하나를 꺼내면 또 하나가 나왔어요. 부자는 팔이 저리도록 아버지를 꺼냈지요.",
                    "어느새 마당이 아버지들로 가득 찼지요. 다들 똑같은 얼굴에 똑같은 옷차림이었어요.",
                    "\"얘야, 배고프다.\""
                ],
                right: [
                    "\"얘야, 나도 배고프다. 어서 밥을 다오.\"",
                    "아버지들이 저마다 손을 내밀며 다가왔어요.",
                    "\"얘야, 나도!\"",
                    "수십 명이 한꺼번에 부자를 불렀답니다. 부자는 귀를 막고 그 자리에 주저앉았지요.",
                    "\"이걸 어쩐담!\""
                ]
            },
            {
        ...
        moral: "남의 것을 억지로 빼앗으면 그 안에 무엇이 들었는지도 모른 채 가져오게 돼요. 부자가 손에 넣은 것은 재물이 아니라 감당할 수 없는 짐이었답니다.",
        question: "가지고 싶은 것을 옳지 않은 방법으로 얻으려 한 적이 있나요?"
    }
];
    ...
    spreads: [
        {
            art: 'end.webp',
            left: [
                "무엇이든 넣으면 두 개가 되어 나오는 그릇 이야기는 여러 나라에 있습니다. 그리고 그런 이야기의 끝은 늘 비슷합니다. 좋은 것만 늘어나지는 않습니다.",
                "이 이야기가 고른 방법이 특히 매섭습니다. 늘어난 것이 재물이 아니라 사람이었습니다. 그것도 밥을 달라는 사람이었지요.",
                "농부는 항아리를 잃고도 크게 아쉬워하지 않았습니다. 처음부터 밭에서 나온 것이었으니까요."
            ],
            right: [
                "남의 것을 억지로 빼앗으면 그 안에 무엇이 들었는지도 모른 채 가져오게 됩니다. 부자가 손에 넣은 것은 재물이 아니라 감당할 수 없는 짐이었습니다.",
                "가지고 싶은 것을 옳지 않은 방법으로 얻으려 한 적이 있나요?"
            ]
        }
    ]
};
...
const WORDS_KO = {
    "cover": [
        { w: "화수분", k: "넣기만 하면 끝없이 나오는 그릇.", s: "끝없이 나오는 그릇을 우리말로 화수분이라고 하는데" },
        { w: "짜임", k: "이야기가 얽혀 있는 틀.", s: "이야기의 짜임은 세계 곳곳의 이야기와 닮았어요." },
        { w: "낭패", k: "일이 틀어져 딱하게 되는 것.", s: "도리어 낭패를 본다는 뼈대지요." },
        { w: "뼈대", k: "이야기의 큰 줄기.", s: "도리어 낭패를 본다는 뼈대지요." },
        { w: "도리어", k: "오히려 거꾸로.", s: "힘으로 빼앗은 물건이 도리어 자기를 괴롭히는 것이지요." }
    ],
    "01-dig.webp": [
        { w: "으뜸", k: "여럿 가운데 첫째.", s: "부지런하기로는 마을에서 으뜸이었지요." },
        { w: "거두다", k: "익은 곡식을 걷어 들이다.", s: "봄이면 씨를 뿌리고 가을이면 거두었지만" },
        { w: "곳간", k: "곡식이나 물건을 넣어 두는 창고.", s: "늘 곳간이 비어 있었어요." },
        { w: "괭이", k: "땅을 파거나 고르는 농기구.", s: "괭이 끝에 갑자기 무언가 단단한 것이 부딪혔지요." },
        { w: "헤치다", k: "덮인 것을 좌우로 밀어내다.", s: "돌인가 싶어 흙을 헤쳐 보았어요." },
        { w: "통째로", k: "나누지 않고 전부.", s: "커다란 항아리가 통째로 묻혀 있었답니다." },
        { w: "걷어 내다", k: "치워서 없애다.", s: "농부는 괭이로 힘들여 흙을 다 걷어 내고" }
    ],
    "02-hoe.webp": [
        { w: "지게", k: "등에 지고 짐을 나르는 나무 틀.", s: "농부는 항아리를 지게에 얹어 집으로 지고 왔어요." },
        { w: "빠뜨리다", k: "잘못하여 속에 떨어뜨리다.", s: "그만 괭이를 항아리 속에 툭 빠뜨렸지요." },
        { w: "눈을 의심하다", k: "본 것이 믿기지 않다.", s: "농부는 제 눈을 의심했어요." },
        { w: "수북이", k: "많이 쌓여 소복한 모양.", s: "마당에 괭이가 수북이 쌓였지요." }
    ],
    "03-coin.webp": [
        { w: "목청껏", k: "있는 힘껏 큰 소리로.", s: "농부가 목청껏 부르자 아내가 부엌에서 뛰어나왔어요." },
        { w: "엽전", k: "옛날에 쓰던 둥근 쇠돈.", s: "엽전 한 닢을 넣어 보았어요." },
        { w: "닢", k: "엽전을 세는 말.", s: "엽전 한 닢을 넣어 보았어요." },
        { w: "짤랑짤랑", k: "쇠붙이가 부딪는 소리.", s: "방 안에 짤랑짤랑 소리가 가득했지요." },
        { w: "밤을 새우다", k: "자지 않고 밤을 보내다.", s: "저녁 먹는 것도 잊고 밤을 새우고 말았답니다." }
    ],
    "04-rich.webp": [
        { w: "초가지붕", k: "짚으로 인 지붕.", s: "초가지붕을 걷고 기와를 얹었지요." },
        { w: "기와", k: "지붕을 덮는, 흙으로 구운 판.", s: "초가지붕을 걷고 기와를 얹었지요." },
        { w: "기웃거리다", k: "자꾸 넘겨다보다.", s: "담 너머로 기웃거리는 사람이 부쩍 늘었어요." },
        { w: "부쩍", k: "눈에 띄게 갑자기.", s: "담 너머로 기웃거리는 사람이 부쩍 늘었어요." },
        { w: "금세", k: "아주 빨리.", s: "소문은 금세 온 마을에 쫙 퍼졌답니다." },
        { w: "손바닥으로 하늘을 가리다", k: "뻔히 드러날 일을 숨기려 하다.", s: "손바닥으로 하늘을 가릴 수는 없는 일이었지요." }
    ],
    "05-seize.webp": [
        { w: "탐나다", k: "갖고 싶은 마음이 나다.", s: "그런데도 남의 것이 탐났지요." },
        { w: "곧장", k: "딴 데 들르지 않고 바로.", s: "그러고는 곧장 농부의 집으로 달려왔습니다." },
        { w: "본래", k: "처음부터.", s: "그 밭은 본래 우리 조상 땅이다!" },
        { w: "틈", k: "어떤 일을 할 짬.", s: "농부가 말할 틈도 없었어요." },
        { w: "주저앉다", k: "힘이 빠져 그 자리에 앉다.", s: "농부 내외는 그 자리에 주저앉고 말았답니다." }
    ],
    "06-gold.webp": [
        { w: "걸어 잠그다", k: "문을 걸어 못 열게 하다.", s: "부자는 방문을 걸어 잠그고 항아리 앞에 딱 앉았습니다." },
        { w: "따위", k: "그런 것 정도.", s: "부자는 엽전 따위를 넣지 않았어요." },
        { w: "부들부들", k: "몸이 자꾸 떨리는 모양.", s: "부자는 두 손을 부들부들 떨었지요." },
        { w: "넘치다", k: "가득 차서 밖으로 나오다.", s: "금덩이가 방에 산처럼 쌓이더니 옆방에까지 넘쳤어요." }
    ],
    "07-father.webp": [
        { w: "문틈", k: "문의 벌어진 사이.", s: "늙은 아버지가 문틈으로 안을 기웃거렸어요." },
        { w: "문고리", k: "문을 여닫을 때 잡는 고리.", s: "아버지가 문고리를 잡아당겼어요." },
        { w: "까치발", k: "발끝만으로 서는 것.", s: "까치발을 들고 항아리 속을 들여다보았지요." },
        { w: "허공", k: "텅 빈 공중.", s: "아버지의 다리가 허공에서 버둥거렸지요." },
        { w: "버둥거리다", k: "팔다리를 마구 놀리다.", s: "아버지의 다리가 허공에서 버둥거렸지요." }
    ],
    "08-two.webp": [
        { w: "허둥지둥", k: "정신없이 서두르는 모양.", s: "부자는 허둥지둥 팔을 뻗어 아버지를 끌어냈어요." },
        { w: "헐떡이다", k: "숨을 가쁘게 몰아쉬다.", s: "아버지가 숨이 턱에 차서 헐떡였어요." },
        { w: "헛기침", k: "일부러 하는 기침.", s: "아버지는 수염을 쓸어 만지며 헛기침을 했지요." },
        { w: "가슴을 쓸어내리다", k: "놀란 마음을 겨우 가라앉히다.", s: "부자는 가슴을 쓸어내렸지요." },
        { w: "질리다", k: "놀라 얼굴빛이 하얗게 변하다.", s: "부자의 얼굴이 하얗게 질렸어요." }
    ],
    "09-many.webp": [
        { w: "저리다", k: "오래 눌려 감각이 무디고 아프다.", s: "부자는 팔이 저리도록 아버지를 꺼냈지요." },
        { w: "옷차림", k: "옷을 갖춰 입은 모양.", s: "다들 똑같은 얼굴에 똑같은 옷차림이었어요." },
        { w: "저마다", k: "각각 제 나름대로.", s: "아버지들이 저마다 손을 내밀며 다가왔어요." }
    ],
    "10-ruined.webp": [
        { w: "대다", k: "필요한 것을 마련해 주다.", s: "부자는 아버지들 밥을 대느라 곳간을 열었어요." },
        { w: "쌀가마", k: "쌀을 담은 큰 자루.", s: "쌀가마가 하루가 다르게 줄었어요." },
        { w: "등쌀", k: "몹시 귀찮게 구는 짓.", s: "아버지들 등쌀에 잠도 잘 수 없었지요." },
        { w: "마음을 고쳐먹다", k: "생각을 바꾸어 달리 정하다.", s: "부자는 결국 마음을 고쳐먹었답니다." },
        { w: "부디", k: "꼭 그렇게 되기를 바라며.", s: "부디 용서해 주십시오." },
        { w: "감쪽같이", k: "티가 하나도 나지 않게.", s: "아버지들도 감쪽같이 사라지고 없었답니다." }
    ],
    "after": [
        { w: "재물", k: "돈이나 값나가는 물건.", s: "늘어난 것이 재물이 아니라 사람이었습니다." },
        { w: "매섭다", k: "몹시 날카롭고 무섭다.", s: "이 이야기가 고른 방법이 특히 매섭습니다." },
        { w: "감당하다", k: "맡아서 능히 해내다.", s: "감당할 수 없는 짐이었습니다." }
    ]
};
