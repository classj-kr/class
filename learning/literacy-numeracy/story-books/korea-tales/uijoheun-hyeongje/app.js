        ...
        beats: [
            {
                ...
                left: [
                    "옛날 어느 마을에 형제가 살았습니다.",
                    "부모님이 물려주신 논을 반씩 나누어 지었지요.",
                    "논도 나란히, 집도 나란히.",
                    "어릴 때부터 한 번도 다툰 적이 없는 형제였어요. 밭을 매도 나란히, 물을 대도 나란히였지요.",
                    "\"우리는 죽을 때까지 이렇게 살자.\""
                ],
                right: [
                    "\"형님, 오늘은 형님 논부터 물을 대시지요.\"",
                    "둘은 늘 서로 먼저 챙겼어요.",
                    "\"아니다, 네 논이 더 마르지 않았느냐.\"",
                    "서로 양보하느라 도랑 앞에서 한참 서 있기도 했지요.",
                    "동네에서는 둘을 의좋은 형제라고 불렀답니다.",
                    "\"저 형제 보고 좀 배우게.\""
                ]
            },
            {
                ...
                emoji: "🌾",
                left: [
                    "가을이 왔어요. 온 들판이 누렇게 익어 고개를 숙였지요.",
                    "그해는 어느 해보다 벼가 잘 여물었어요.",
                    "형제는 나란히 서서 벼를 베고 볏단을 쌓았습니다.",
                    "낫질 소리가 하루 종일 들판에 울렸지요.",
                    "\"자, 똑같이 나누자.\"",
                    "\"예, 형님.\""
                ],
                right: [
                    "두 사람은 볏단을 하나하나 세어 가며 똑같이 나눴어요.",
                    "한 단이라도 어긋날까 봐 두 번씩 세었어요.",
                    "형네 논에 한 무더기, 동생네 논에 한 무더기.",
                    "높이까지 꼭 같았지요. 둘은 흐뭇하게 웃으며 집으로 돌아갔습니다.",
                    "가을 해가 벌써 뉘엿뉘엿했지요."
                ]
            },
            {
                ...
                emoji: "🌙",
                left: [
                    "그날 밤, 형은 도무지 잠이 오지 않았어요. 이리 뒤척이고 저리 뒤척여도 마찬가지였지요.",
                    "자꾸만 동생 생각이 났거든요.",
                    "'동생은 올봄에 살림을 새로 차렸지.'",
                    "'솥도 사야 하고 이불도 사야 할 텐데.'",
                    "형은 이불을 걷어차고 앉았어요."
                ],
                right: [
                    "'똑같이 나눈 건 아무래도 아니야.'",
                    "형은 지게를 지고 마당을 나섰지요.",
                    "식구들이 깨지 않게 문을 살살 밀고 논으로 나갔답니다.",
                    "달이 유난히 환한 밤이었답니다."
                ]
            }
        ]
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "볏단이 어깨를 묵직하게 눌렀어요.",
                    "영차, 영차.",
                    "달빛을 밟으며 동생네 논으로 갔지요. 논둑길에 형의 그림자가 길게 늘어졌습니다.",
                    "형은 숨을 몰아쉬며 한 발 한 발 옮겼지요."
                ],
                right: [
                    "형은 사방을 두리번거렸어요.",
                    "'동생이 알면 안 받으려 할 테니, 모르게 해야지.'",
                    "볏단을 동생네 무더기에 슬쩍 올려놓고 서둘러 돌아왔지요.",
                    "아무도 본 사람이 없어 마음이 놓였어요.",
                    "이불 속에 들어가서야 형은 겨우 잠이 들었답니다."
                ]
            },
            {
                ...
                left: [
                    ...
                    "형네 조카들 얼굴이 자꾸 떠올랐거든요.",
                    "'형님네는 식구가 많잖아.'",
                    "'조카들이 다섯이나 되는데. 겨울에 먹을 것이 모자라면 어쩌지.'",
                    "동생은 이불을 밀어내고 일어났어요."
                ],
                right: [
                    "'똑같이 나눈 건 아무래도 아니지.'",
                    "동생은 헛간에서 지게를 꺼냈지요.",
                    "아내가 깰까 봐 발끝으로 살금살금 논으로 나갔답니다.",
                    "동생도 달빛을 밟으며 걸었답니다."
                ]
            },
            {
                ...
                left: [
                    ...
                    "동생의 이마에도 땀이 맺혔어요.",
                    "영차, 영차.",
                    "형이 다녀간 그 길을 이번에는 반대로 걸었지요. 서로 엇갈린 줄도 모르고요.",
                    "논둑길이 어찌나 미끄러운지 몰랐지요."
                ],
                right: [
                    "동생은 형네 무더기에 볏단을 올려놓고 얼른 돌아왔습니다.",
                    "숨이 턱까지 차올랐지요.",
                    "'형님이 알면 도로 가져가라 하실 테니, 입 꼭 다물어야지.'",
                    "동생도 서둘러 집으로 돌아갔답니다."
                ]
            },
            {
                ...
                left: [
                    "이튿날 아침.",
                    "형이 논에 나가 보고 눈을 끔뻑였어요.",
                    "볏단 무더기가 어제 그대로였어요. 몇 번을 세어 보아도 마찬가지였지요.",
                    "\"어라? 어제랑 똑같잖아.\"",
                    "분명히 한 지게를 덜어 냈는데 말이지요."
                ],
                right: [
                    "동생도 자기 논 앞에서 고개를 갸웃했습니다.",
                    "눈을 비비고 또 비볐지요.",
                    "\"이상하다. 분명히 한 지게 덜어 냈는데.\"",
                    "두 사람 다 영문을 몰라 뒤통수만 긁적였답니다."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "형도 동생도 어제보다 더 많이 옮겼어요.",
                    "이튿날 아침, 볏단은 또 그대로였습니다.",
                    "한 단도 늘지 않고 한 단도 줄지 않았지요."
                ],
                right: [
                    "\"허, 이거 귀신이 곡할 노릇이네.\"",
                    "형이 혼잣말을 했어요.",
                    "\"밤새 누가 도로 갖다 놓는 것도 아니고…\"",
                    "동생도 같은 말을 했답니다.",
                    "형도 동생도 어리둥절할 뿐이었답니다."
                ]
            },
            {
                ...
                left: [
                    "사흘째 되는 밤.",
                    "구름 한 점 없는 밤이었어요.",
                    "형이 지게를 지고 논둑길을 걸어갔어요. 저쪽에서도 누군가 지게를 지고 오고 있었지요.",
                    "어둠 속에서 삐걱삐걱 지게 소리가 났지요.",
                    "달빛 아래에서 두 사람은 딱 마주쳤습니다."
                ],
                right: [
                    "\"형님?\"",
                    "\"너, 너는…\"",
                    "둘은 한참 동안 아무 말도 못 했어요.",
                    "두 지게에는 똑같이 볏단이 실려 있었어요. 그제야 사흘 동안의 수수께끼가 풀린 것이지요.",
                    "형의 눈에 눈물이 핑 돌았답니다."
                ]
            },
            {
                ...
                right: [
                    "두 형제는 지게를 내려놓고 논둑에 앉아 웃었어요.",
                    "웃음소리가 달빛 아래 논을 건너갔지요.",
                    "밤이 새도록 이야기가 그치지 않았어요.",
                    "달이 기울도록 자리를 뜨지 않았지요.",
                    "그 뒤로도 볏단은 늘 똑같았지만 둘은 궁금해하지 않았답니다."
                ]
            }
        ],
        moral: "고마운 마음은 말보다 행동에 먼저 나타나요. 두 형제는 사흘 동안 서로에게 한마디도 하지 않았지만, 볏단은 밤마다 오갔답니다.",
        question: "누군가를 위해 티 내지 않고 무언가를 해 준 적이 있나요?"
    }
];
...
const COVER = {
    ...
    title: "의좋은 형제",
    intro: [
        "의좋은 형제도 지은이가 없는 구전 설화예요. 우리나라 어느 고장에서나 전해지는 이야기라 마을마다 조금씩 다른 모습으로 남아 있답니다.",
        "충청남도 예산에는 이 이야기의 주인공으로 전해지는 이성만·이순 형제를 기리는 비석이 실제로 서 있어요. 조선 시대에 나라에서 두 형제의 우애를 널리 알리려고 세운 것이랍니다.",
        "우리 옛이야기에는 형제가 다투는 이야기와 형제가 서로 아끼는 이야기가 나란히 전해져요. 흥부와 놀부가 앞의 갈래라면 의좋은 형제는 뒤의 갈래지요. 두 갈래를 함께 읽으면 옛사람들이 무엇을 좋게 여기고 무엇을 부끄러워했는지가 보인답니다."
    ]
};
    ...
    spreads: [
        {
            art: 'end.webp',
            left: [
                "이 이야기는 우리나라 국어 교과서에 오래 실려 온 이야기입니다. 짧고 군더더기가 없어서 옛이야기 가운데서도 손꼽히는 짜임을 지녔습니다.",
                "충청도 예산에는 우애가 깊기로 이름난 형제를 기린 오래된 비석이 서 있습니다. 그 시절 사람들이 이런 형제를 얼마나 귀하게 여겼는지 알 수 있지요.",
                "달밤에 마주친 대목에서 두 사람이 아무 말도 못 한 것도 그래서입니다. 할 말이 없어서가 아니라 이미 다 알아 버렸기 때문이지요."
            ],
            right: [
                "고마운 마음은 말보다 행동에 먼저 나타납니다. 두 형제는 사흘 동안 서로에게 한마디도 하지 않았지만 볏단은 밤마다 오갔습니다.",
                "누군가를 위해 티 내지 않고 무언가를 해 준 적이 있나요?"
            ]
        }
    ]
};
...
const WORDS_KO = {
    "cover": [
        { w: "고장", k: "사람들이 모여 사는 지역.", s: "우리나라 어느 고장에서나 전해지는 이야기라" },
        { w: "기리다", k: "뜻깊게 여겨 오래 기억하다.", s: "형제를 기리는 비석이 실제로 서 있어요." },
        { w: "비석", k: "글을 새겨 세운 돌.", s: "형제를 기리는 비석이 실제로 서 있어요." },
        { w: "우애", k: "형제 사이의 도타운 정.", s: "두 형제의 우애를 널리 알리려고 세운 것이랍니다." },
        { w: "갈래", k: "같은 줄기에서 나뉜 무리.", s: "흥부와 놀부가 앞의 갈래라면" }
    ],
    "01-brothers.webp": [
        { w: "물려주다", k: "자식에게 넘겨주다.", s: "부모님이 물려주신 논을 반씩 나누어 지었지요." },
        { w: "매다", k: "논밭의 잡풀을 뽑다.", s: "밭을 매도 나란히, 물을 대도 나란히였지요." },
        { w: "물을 대다", k: "논밭에 물을 끌어 넣다.", s: "밭을 매도 나란히, 물을 대도 나란히였지요." },
        { w: "양보하다", k: "남에게 먼저 하도록 내주다.", s: "서로 양보하느라 도랑 앞에서 한참 서 있기도 했지요." },
        { w: "도랑", k: "물이 흐르도록 판 작은 물길.", s: "서로 양보하느라 도랑 앞에서 한참 서 있기도 했지요." },
        { w: "의좋다", k: "서로 사이가 좋다.", s: "동네에서는 둘을 의좋은 형제라고 불렀답니다." }
    ],
    "02-harvest.webp": [
        { w: "여물다", k: "열매가 잘 익어 단단해지다.", s: "그해는 어느 해보다 벼가 잘 여물었어요." },
        { w: "볏단", k: "벼를 베어 묶어 놓은 단.", s: "형제는 나란히 서서 벼를 베고 볏단을 쌓았습니다." },
        { w: "낫질", k: "낫으로 베는 일.", s: "낫질 소리가 하루 종일 들판에 울렸지요." },
        { w: "어긋나다", k: "서로 맞지 않고 틀어지다.", s: "한 단이라도 어긋날까 봐 두 번씩 세었어요." },
        { w: "무더기", k: "한데 쌓아 놓은 더미.", s: "형네 논에 한 무더기, 동생네 논에 한 무더기." },
        { w: "흐뭇하다", k: "마음에 들어 기분이 좋다.", s: "둘은 흐뭇하게 웃으며 집으로 돌아갔습니다." },
        { w: "뉘엿뉘엿", k: "해가 천천히 넘어가는 모양.", s: "가을 해가 벌써 뉘엿뉘엿했지요." }
    ],
    "03-elder-thinks.webp": [
        { w: "도무지", k: "아무리 해도.", s: "그날 밤, 형은 도무지 잠이 오지 않았어요." },
        { w: "뒤척이다", k: "잠 못 들고 몸을 이리저리 굴리다.", s: "이리 뒤척이고 저리 뒤척여도 마찬가지였지요." },
        { w: "살림을 차리다", k: "결혼해 새로 살림을 시작하다.", s: "동생은 올봄에 살림을 새로 차렸지." },
        { w: "걷어차다", k: "발로 세게 차서 밀어내다.", s: "형은 이불을 걷어차고 앉았어요." },
        { w: "유난히", k: "여느 때보다 눈에 띄게.", s: "달이 유난히 환한 밤이었답니다." }
    ],
    "04-elder-carries.webp": [
        { w: "묵직하다", k: "제법 무겁다.", s: "볏단이 어깨를 묵직하게 눌렀어요." },
        { w: "논둑길", k: "논 사이로 난 좁은 길.", s: "논둑길에 형의 그림자가 길게 늘어졌습니다." },
        { w: "몰아쉬다", k: "숨을 크게 여러 번 쉬다.", s: "형은 숨을 몰아쉬며 한 발 한 발 옮겼지요." },
        { w: "두리번거리다", k: "이리저리 둘러보다.", s: "형은 사방을 두리번거렸어요." },
        { w: "마음이 놓이다", k: "걱정이 없어져 편안해지다.", s: "아무도 본 사람이 없어 마음이 놓였어요." }
    ],
    "05-younger-thinks.webp": [
        { w: "조카", k: "형제자매가 낳은 자식.", s: "형네 조카들 얼굴이 자꾸 떠올랐거든요." },
        { w: "모자라다", k: "넉넉하지 못하고 부족하다.", s: "겨울에 먹을 것이 모자라면 어쩌지." },
        { w: "헛간", k: "물건을 넣어 두는 허름한 곳.", s: "동생은 헛간에서 지게를 꺼냈지요." },
        { w: "살금살금", k: "남몰래 조용히 움직이는 모양.", s: "발끝으로 살금살금 논으로 나갔답니다." }
    ],
    "06-younger-carries.webp": [
        { w: "맺히다", k: "방울져 생기다.", s: "동생의 이마에도 땀이 맺혔어요." },
        { w: "엇갈리다", k: "서로 어긋나 지나치다.", s: "서로 엇갈린 줄도 모르고요." },
        { w: "숨이 턱까지 차다", k: "숨이 몹시 가쁘다.", s: "숨이 턱까지 차올랐지요." },
        { w: "입을 다물다", k: "말하지 않고 참다.", s: "형님이 알면 도로 가져가라 하실 테니, 입 꼭 다물어야지." }
    ],
    "07-morning.webp": [
        { w: "이튿날", k: "그다음 날.", s: "이튿날 아침." },
        { w: "끔뻑이다", k: "눈을 크게 감았다 뜨다.", s: "형이 논에 나가 보고 눈을 끔뻑였어요." },
        { w: "덜어 내다", k: "있는 것에서 얼마를 떼어 내다.", s: "분명히 한 지게를 덜어 냈는데 말이지요." },
        { w: "갸웃하다", k: "고개를 조금 기울이다.", s: "동생도 자기 논 앞에서 고개를 갸웃했습니다." },
        { w: "영문", k: "일이 그렇게 된 까닭.", s: "두 사람 다 영문을 몰라 뒤통수만 긁적였답니다." }
    ],
    "08-again.webp": [
        { w: "귀신이 곡할 노릇", k: "도무지 알 수 없는 이상한 일.", s: "허, 이거 귀신이 곡할 노릇이네." },
        { w: "혼잣말", k: "혼자서 하는 말.", s: "형이 혼잣말을 했어요." },
        { w: "어리둥절하다", k: "무슨 일인지 몰라 멍하다.", s: "형도 동생도 어리둥절할 뿐이었답니다." }
    ],
    "09-meet.webp": [
        { w: "사흘", k: "세 날.", s: "사흘째 되는 밤." },
        { w: "삐걱삐걱", k: "나무가 쓸리며 나는 소리.", s: "어둠 속에서 삐걱삐걱 지게 소리가 났지요." },
        { w: "수수께끼", k: "알쏭달쏭해 풀기 어려운 일.", s: "그제야 사흘 동안의 수수께끼가 풀린 것이지요." },
        { w: "핑", k: "눈물이 갑자기 도는 모양.", s: "형의 눈에 눈물이 핑 돌았답니다." }
    ],
    "10-laugh.webp": [
        { w: "들썩이다", k: "자꾸 들렸다 내려앉다.", s: "어깨가 들썩일 만큼 크게 웃었지요." },
        { w: "기울다", k: "달이 저쪽으로 넘어가다.", s: "달이 기울도록 자리를 뜨지 않았지요." },
        { w: "자리를 뜨다", k: "있던 자리에서 떠나다.", s: "달이 기울도록 자리를 뜨지 않았지요." }
    ],
    "after": [
        { w: "군더더기", k: "쓸데없이 덧붙은 것.", s: "짧고 군더더기가 없어서" },
        { w: "짜임", k: "이야기가 얽혀 있는 틀.", s: "손꼽히는 짜임을 지녔습니다." },
        { w: "대목", k: "이야기 가운데 어느 한 부분.", s: "달밤에 마주친 대목에서" },
        { w: "티 내다", k: "겉으로 드러내 알리다.", s: "티 내지 않고 무언가를 해 준 적이 있나요?" }
    ]
};
