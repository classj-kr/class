...
const QUIZ = [
    ...
    { q: "심청이 물 아래에서 만난 사람은 누구입니까?", choices: ["돌아가신 어머니", "장 승상 댁 부인", "몽운사 스님"], answer: 0 },
    ...
    { q: "한양으로 가는 길에 심 봉사가 겪은 일은 무엇입니까?", choices: ["나라에서 보낸 가마를 타고 갔다", "주막에서 편히 묵으며 갔다", "봇짐과 노잣돈을 도둑맞았다"], answer: 2 },
    ...
    { q: "심 봉사가 앞을 보게 되자 무슨 일이 벌어졌습니까?", choices: ["하늘에서 꽃비가 쏟아져 내렸다", "인당수 물살이 잔잔해졌다", "잔치에 온 이들이 다 눈을 떴다"], answer: 2 },
    {
        ...
        choices: [
            ...
            "뱃사람들이 사람을 사서 바다에 바친 것을 보면, 그때는 목숨보다 뱃길이 앞서기도 했네.",
...
const EN = {
    ...
    quiz: [
        ...
        { q: "Whom did Simcheong meet under the water?", choices: ["Her own dead mother", "The lady of the Jang house", "The monk from Mongun Temple"], answer: 0 },
        ...
        { q: "What happened to Sim Bongsa on the road to Hanyang?", choices: ["He rode in a palanquin sent by the court", "He stayed comfortably at inns all the way", "His bundle and travel money were stolen"], answer: 2 },
