        ...
        beats: [
            {
                ...
                emoji: "🐕",
                left: [
                    "옛날에 봇짐을 지고 장을 떠도는 장수가 하나 있었습니다.",
                    "장수에게는 개 한 마리가 있었어요. 등에 까만 점이 박혀 있어서 이름은 바둑이였지요.",
                    "몇 해 전 눈 오는 날, 길가에서 떨던 것을 안고 온 개였답니다.",
                    "그때부터 둘은 한 번도 떨어진 적이 없었어요."
                ],
                right: [
                    "\"바둑아, 가자!\"",
                    "장수가 부르면 바둑이는 꼬리를 흔들며 달려왔습니다. 부르기가 무섭게 발밑에 와 있었지요.",
                    "바둑이는 늘 장수 뒤를 졸졸 따라다녔어요.",
                    "장수가 국밥을 먹으면 바둑이도 국밥을 먹었답니다. 장수가 잠들면 그 발치에서 잤지요."
                ]
            },
            {
                art: "02-market.webp",
                ...
                left: [
                    ...
                    "\"허허, 오늘은 운수가 좋구먼.\"",
                    "\"바둑아, 오늘은 고기라도 사 먹자꾸나.\"",
                    "바둑이가 알아듣는다는 듯 컹 하고 짖었습니다."
                ],
                right: [
                    "장수는 두둑해진 돈주머니를 허리춤에 단단히 매었어요. 한 해를 벌어 모은 돈이 다 거기 들어 있었지요.",
                    "이 돈이면 겨울을 넉넉히 날 수 있었습니다.",
                    "바둑이가 꼬리를 흔들며 앞장을 섰어요.",
                    "장수의 발걸음이 그렇게 가벼울 수가 없었답니다."
                ]
            },
            {
                art: "03-inn.webp",
                ...
                left: [
                    ...
                    "\"여기 국밥 두 그릇 주시오.\"",
                    "장수는 한 그릇을 바둑이 앞에 놓아 주었어요.",
                    "바둑이가 후룩후룩 소리를 내며 맛있게 먹었답니다."
                ],
                right: [
                    "그런데 옆자리에 앉은 사내가 자꾸 이쪽을 흘끔거렸어요. 장수의 허리춤을, 정확히는 그 돈주머니를요.",
                    "눈빛이 예사롭지 않았지요.",
                    "바둑이가 국밥을 먹다 말고 슬며시 고개를 들었습니다.",
                    "그러고는 그 사내를 노려보며 낮게 으르렁거렸어요."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                right: [
                    "그런데 바둑이가 자꾸 뒤를 돌아보며 걸음을 늦추었어요. 귀를 쫑긋 세우고 코를 킁킁거렸지요.",
                    "무언가 마음에 걸리는 모양이었습니다.",
                    "\"왜 그러느냐? 어서 가자.\"",
                    "장수가 재촉해도 바둑이는 자꾸 뒤처졌지요."
                ]
            },
            {
                art: "05-robbed.webp",
                ...
                left: [
                    "고갯마루에 이르렀을 때였습니다.",
                    "안개 속에서 누군가 불쑥 튀어나왔어요. 장수는 그 자리에서 우뚝 멈춰 섰지요.",
                    "어젯밤 주막에서 흘끔거리던 바로 그 사내였습니다.",
                    "손에는 몽둥이가 들려 있었어요."
                ],
                right: [
            ...
            },
            {
                ...
                emoji: "😞",
                left: [
                    "장수는 벌떡 일어나 숲으로 뛰어들었어요.",
                    "하지만 안개가 워낙 짙어 이내 방향을 잃고 말았습니다.",
                    "이리 헤매고 저리 헤매도 사내의 그림자조차 보이지 않았지요.",
                    "나뭇가지에 얼굴만 잔뜩 긁혔답니다."
                ],
                right: [
                    "\"한 해를 벌어 모은 돈인데…\"",
                    "\"이걸 어떻게 집에 가서 말한담.\"",
                    "장수는 그만 길바닥에 털썩 주저앉았어요. 눈앞이 캄캄했지요.",
                    "바둑이가 그 곁에서 땅에 코를 대고 킁킁거렸답니다."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "바둑이는 한 방향을 향해 컹! 하고 크게 짖었지요.",
                    "그러고는 장수를 한 번 돌아보았습니다.",
                    "마치 여기라고 말하는 것 같았어요."
                ],
                right: [
                    "\"바둑아! 어디 가느냐!\"",
                    "바둑이는 대답 대신 안개 속으로 뛰어들었습니다.",
                    "네 다리가 보이지 않을 만큼 빨랐어요. 장수가 아무리 불러도 돌아오지 않았지요.",
                    "짖는 소리만 점점 멀어져 갔답니다."
                ]
            },
            {
            ...
            },
            {
                ...
                left: [
                    "\"컹! 컹! 컹컹컹!\"",
                    "바둑이가 온 산이 울리도록 짖었어요. 목이 쉬도록 짖고 또 짖었지요.",
                    "사내는 화들짝 놀라 벌떡 일어났습니다.",
                    "\"저리 가! 저리 가란 말이야!\""
                ],
                right: [
            ...
            },
            {
                ...
                right: [
                    "바둑이는 그저 꼬리만 흔들었어요. 다리에 상처가 여러 군데 나 있었지요.",
                    "장수는 그 상처를 하나하나 닦아 주었습니다.",
...
const COVER = {
    ...
    title: "강도를 잡은 개",
    intro: [
        "강도를 잡은 개는 지은이가 없는 구전 설화예요. 의로운 개가 주인공인 이야기를 의견 설화라고 부르는데, 그 갈래에 속한답니다.",
        "우리나라에는 개를 기리는 비석과 무덤이 실제로 여러 곳에 남아 있어요. 전라북도 임실의 오수라는 곳에는 잠든 주인을 불에서 구해 낸 개의 무덤이 있는데, 그 이야기는 고려 시대 책에도 실려 있지요.",
        "옛날 시골에서 개는 귀여워하는 짐승이 아니라 함께 일하는 식구였어요. 집을 지키고, 짐승을 몰고, 먼 길에 주인을 따라나섰지요. 그래서 개가 주인공인 옛이야기가 유난히 많답니다."
    ]
};
...
const EN = {
    ...
    words: {
        "cover": [
            ...
            { w: "graves", k: "무덤", s: "Korea really does have monuments and graves for dogs." },
        ...
        "01-dog.webp": [
            ...
            { w: "spot", k: "점", s: "which means a spot." },
    ...
    spreads: [
        {
            art: 'end.webp',
            left: [
                "주인을 구한 개 이야기는 우리나라에 아주 많습니다. 그런 개를 의로운 개라 하여 의견이라 불렀고, 무덤을 만들어 주고 비석까지 세운 곳도 있습니다.",
                "전라북도 임실에는 오수라는 곳이 있는데, 마을 이름 자체가 개를 기린 데서 왔다고 전해 옵니다. 그곳에는 지금도 개를 기리는 비석이 서 있습니다.",
                "그때 장수는 무엇을 바라고 데려온 것이 아닙니다. 그러니 이 이야기는 갚음을 받은 이야기가 아니라, 그날의 일이 어디까지 갔는지를 보여 주는 이야기입니다.",
                "말을 못 하는 짐승이 사람을 구하는 이야기가 이토록 많이 남은 것은, 사람들이 그 곁을 오래 지켜보았다는 뜻이기도 합니다."
            ],
            right: [
                "바둑이는 눈 오는 날 길가에서 구해진 개였습니다. 그때 장수가 그냥 지나쳤다면 이날의 일도 없었을 것입니다. 베푼 마음은 잊고 지내도 어딘가에 남아 있습니다.",
                "내가 무심코 베푼 친절이 누군가에게 크게 남은 적이 있을까요?"
            ]
        }
    ]
};
...
const WORDS_KO = {
    "cover": [
        { w: "의롭다", k: "옳은 일을 굳게 지키다.", s: "의로운 개가 주인공인 이야기를" },
        { w: "의견", k: "의로운 개.", s: "의견 설화라고 부르는데" },
        { w: "기리다", k: "뜻깊게 여겨 오래 기억하다.", s: "우리나라에는 개를 기리는 비석과 무덤이 실제로 여러 곳에 남아 있어요." },
        { w: "비석", k: "글을 새겨 세운 돌.", s: "개를 기리는 비석과 무덤이 실제로 여러 곳에 남아 있어요." },
        { w: "따라나서다", k: "남을 따라 함께 나가다.", s: "먼 길에 주인을 따라나섰지요." }
    ],
    "01-dog.webp": [
        { w: "봇짐", k: "등에 지고 다니는 짐 보따리.", s: "봇짐을 지고 장을 떠도는 장수가 하나 있었습니다." },
        { w: "장수", k: "물건을 팔러 다니는 사람.", s: "장을 떠도는 장수가 하나 있었습니다." },
        { w: "떠돌다", k: "한곳에 있지 않고 옮겨 다니다.", s: "장을 떠도는 장수가 하나 있었습니다." },
        { w: "졸졸", k: "뒤를 바짝 따라다니는 모양.", s: "바둑이는 늘 장수 뒤를 졸졸 따라다녔어요." },
        { w: "발치", k: "발이 있는 쪽.", s: "장수가 잠들면 그 발치에서 잤지요." }
    ],
    "02-market.webp": [
        { w: "운수", k: "저절로 돌아오는 좋고 나쁜 일.", s: "허허, 오늘은 운수가 좋구먼." },
        { w: "두둑하다", k: "불룩할 만큼 넉넉하다.", s: "장수는 두둑해진 돈주머니를 허리춤에 단단히 매었어요." },
        { w: "허리춤", k: "허리에 두른 옷의 안쪽.", s: "돈주머니를 허리춤에 단단히 매었어요." },
        { w: "넉넉히", k: "모자람 없이 넉넉하게.", s: "이 돈이면 겨울을 넉넉히 날 수 있었습니다." },
        { w: "앞장을 서다", k: "맨 앞에 서서 가다.", s: "바둑이가 꼬리를 흔들며 앞장을 섰어요." }
    ],
    "03-inn.webp": [
        { w: "저물다", k: "해가 져서 어두워지다.", s: "해가 저물어 장수는 길가 주막에 들었습니다." },
        { w: "주막", k: "옛날에 술과 밥을 팔고 재워 주던 집.", s: "해가 저물어 장수는 길가 주막에 들었습니다." },
        { w: "저릿저릿하다", k: "다리가 저려 찌릿찌릿하다.", s: "마루에 앉으니 다리가 저릿저릿했지요." },
        { w: "흘끔거리다", k: "곁눈으로 자꾸 보다.", s: "옆자리에 앉은 사내가 자꾸 이쪽을 흘끔거렸어요." },
        { w: "예사롭다", k: "흔하고 별날 것이 없다.", s: "눈빛이 예사롭지 않았지요." },
        { w: "으르렁거리다", k: "사납게 울리는 소리를 내다.", s: "그 사내를 노려보며 낮게 으르렁거렸어요." }
    ],
    "04-dawn.webp": [
        { w: "이튿날", k: "그다음 날.", s: "이튿날 새벽, 장수는 남들보다 일찍 길을 나섰습니다." },
        { w: "자욱하다", k: "안개나 연기가 잔뜩 끼다.", s: "고갯길에는 안개가 자욱하게 깔려 있었지요." },
        { w: "한 치", k: "아주 짧은 거리.", s: "한 치 앞도 잘 보이지 않았어요." },
        { w: "재촉하다", k: "빨리하라고 서두르다.", s: "장수는 걸음을 재촉했답니다." },
        { w: "쫑긋", k: "귀를 빳빳이 세우는 모양.", s: "귀를 쫑긋 세우고 코를 킁킁거렸지요." },
        { w: "뒤처지다", k: "남보다 뒤로 떨어지다.", s: "장수가 재촉해도 바둑이는 자꾸 뒤처졌지요." }
    ],
    "05-robbed.webp": [
        { w: "고갯마루", k: "고개에서 가장 높은 곳.", s: "고갯마루에 이르렀을 때였습니다." },
        { w: "불쑥", k: "갑자기 쑥 나타나는 모양.", s: "안개 속에서 누군가 불쑥 튀어나왔어요." },
        { w: "우뚝", k: "갑자기 멈춰 선 모양.", s: "장수는 그 자리에서 우뚝 멈춰 섰지요." },
        { w: "몽둥이", k: "굵고 긴 막대기.", s: "손에는 몽둥이가 들려 있었어요." },
        { w: "밀치다", k: "힘껏 밀어내다.", s: "사내는 장수를 힘껏 밀치고 돈주머니를 낚아챘습니다." },
        { w: "낚아채다", k: "갑자기 잡아 빼앗다.", s: "돈주머니를 낚아챘습니다." },
        { w: "나동그라지다", k: "넘어져 나가떨어지다.", s: "장수는 그대로 나동그라졌지요." },
        { w: "쏜살같이", k: "쏜 화살처럼 아주 빠르게.", s: "사내는 몽둥이를 내던지고 숲속으로 쏜살같이 사라졌습니다." }
    ],
    "06-lost.webp": [
        { w: "짙다", k: "안개나 빛깔이 두껍고 진하다.", s: "안개가 워낙 짙어 이내 방향을 잃고 말았습니다." },
        { w: "이내", k: "곧바로.", s: "안개가 워낙 짙어 이내 방향을 잃고 말았습니다." },
        { w: "헤매다", k: "갈 곳을 몰라 이리저리 돌아다니다.", s: "이리 헤매고 저리 헤매도" },
        { w: "털썩", k: "갑자기 힘없이 주저앉는 모양.", s: "장수는 그만 길바닥에 털썩 주저앉았어요." },
        { w: "눈앞이 캄캄하다", k: "막막해서 어찌할 바를 모르다.", s: "눈앞이 캄캄했지요." }
    ],
    "07-scent.webp": [
        { w: "마치", k: "꼭 그런 것처럼.", s: "마치 여기라고 말하는 것 같았어요." }
    ],
    "08-chase.webp": [
        { w: "가로지르다", k: "이쪽에서 저쪽으로 질러 가다.", s: "바둑이는 나무 사이를 가로질러 달렸어요." },
        { w: "가시덤불", k: "가시 돋친 나무가 얽혀 있는 곳.", s: "가시덤불에 걸려 털이 뜯겨도 멈추지 않았습니다." },
        { w: "골짜기", k: "산과 산 사이 깊고 좁은 곳.", s: "골짜기 하나를 넘었을 때였어요." },
        { w: "헐떡이다", k: "숨을 가쁘게 몰아쉬다.", s: "바위 뒤에 숨을 헐떡이며 웅크리고 앉은 사내가 보였습니다." },
        { w: "숨을 고르다", k: "가쁜 숨을 가라앉히다.", s: "돈주머니를 품에 꼭 안고 숨을 고르고 있었지요." },
        { w: "따돌리다", k: "뒤쫓는 이를 떼어 버리다.", s: "이만하면 따돌렸다고 여기는 얼굴이었어요." }
    ],
    "09-bark.webp": [
        { w: "화들짝", k: "갑자기 크게 놀라는 모양.", s: "사내는 화들짝 놀라 벌떡 일어났습니다." },
        { w: "바짓자락", k: "바지의 아래 끝부분.", s: "바둑이가 힘껏 달려들어 바짓자락을 꽉 물고 늘어졌어요." },
        { w: "물고 늘어지다", k: "꽉 물고 놓지 않다.", s: "바짓자락을 꽉 물고 늘어졌어요." },
        { w: "엄두", k: "감히 해 보려는 마음.", s: "사내는 이제 달아날 엄두도 내지 못했지요." }
    ],
    "10-return.webp": [
        { w: "푼", k: "아주 적은 돈을 이르는 말.", s: "돈은 한 푼도 없어지지 않고 고스란히 돌아왔지요." },
        { w: "고스란히", k: "축나지 않고 그대로.", s: "한 푼도 없어지지 않고 고스란히 돌아왔지요." }
    ],
    "after": [
        { w: "갚음", k: "받은 것을 되돌려 주는 일.", s: "갚음을 받은 이야기가 아니라" },
        { w: "베풀다", k: "남에게 도움이나 마음을 나누어 주다.", s: "베푼 마음은 잊고 지내도 어딘가에 남아 있습니다." },
        { w: "무심코", k: "아무 생각 없이.", s: "내가 무심코 베푼 친절이" }
    ]
};
