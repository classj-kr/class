        ...
        beats: [
            {
                ...
                emoji: "🍚",
                left: [
                    "옛날 어느 마을에 가난한 소녀가 살았습니다. 부모를 일찍 잃고 남의 집 부엌일을 하며 지냈지요.",
                    "주인집 아주머니는 소녀에게 살갑지 않았어요.",
                    "새벽부터 물을 긷고 불을 때고 설거지를 했어요. 손이 늘 트고 갈라져 있었답니다.",
                    "\"밥값은 해야지.\""
                ],
                right: [
            ...
            },
            {
                ...
                emoji: "🐸",
                left: [
                    "어느 날 저녁, 소녀가 마지막 설거지를 하던 참이었어요.",
                    "부뚜막 구석에서 무언가 꿈틀했어요. 그림자가 어른거렸지요.",
                    "\"어머!\"",
                    "소녀는 깜짝 놀라 뒤로 물러섰습니다. 불 쑤시는 막대를 든 손이 부들부들 떨렸답니다."
                ],
                right: [
            ...
            },
            {
                ...
                emoji: "🤲",
                left: [
                    "소녀는 제 밥그릇에서 밥알을 덜어 부뚜막에 놓았어요.",
                    "그러잖아도 모자란 밥이었지요. 그것이 소녀의 저녁 몫 전부였거든요.",
                    "두꺼비가 우물우물 밥알을 받아먹었습니다. 소녀는 턱을 괴고 바라보았답니다.",
                    "그래도 아깝다는 생각이 들지 않았지요."
                ],
                right: [
                    "\"내일도 오려무나. 나 혼자 먹으면 심심하잖니.\"",
                    "두꺼비는 밥알을 남기지 않았어요.",
                    "그날부터 소녀는 날마다 밥을 덜어 두었어요.",
                    "적을 때는 밥알 몇 알, 많을 때는 한 숟갈이었지요.",
                    "소녀는 그 시간이 하루 중 제일 좋았답니다."
                ]
            },
            {
                art: "04-grow.webp",
                ...
                left: [
                    ...
                    "처음에는 소녀의 손바닥만 하더니, 어느새 두 손으로도 다 안기지 않을 만큼 커졌지요.",
                    "부뚜막이 좁아 보일 지경이었어요.",
                    "소녀는 그것이 신기하기만 했지요."
                ],
                right: [
                    "\"너 참 많이 컸구나.\"",
                    "소녀가 두꺼비의 등을 쓰다듬으며 웃었습니다.",
                    "두꺼비의 등이 따뜻했어요.",
                    "두꺼비는 알아듣는다는 듯 눈을 끔뻑였어요. 소녀에게는 그 두꺼비가 하나뿐인 동무였답니다.",
                    "소녀는 두꺼비에게 속엣말을 다 했지요."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                right: [
                    "그래서 마을에서는 지네를 달래려고 해마다 한 사람을 뽑아 사당에서 밤을 지내게 했어요.",
                    "제비뽑기로 정했지요.",
                    "그 하룻밤은 무섭기로 온 고을에 이름이 나 있었어요.",
                    "그 밤을 넘기고 돌아온 사람은 여태 없었답니다."
                ]
            },
            {
                art: "06-chosen.webp",
                ...
                left: [
                    ...
                    "제비를 뽑기도 전에 정해진 것이나 마찬가지였지요.",
                    "소녀는 아무 말도 하지 않았어요. 그저 고개만 한 번 끄덕였지요.",
                    "아무도 소녀를 말리지 않았지요."
                ],
                right: [
                    "\"미안하구나. 우리도 어쩔 수 없단다.\"",
                    "주인집 아주머니도 고개를 돌렸어요.",
                    "마을 사람들은 소녀와 눈을 마주치지 못했어요.",
                    "해가 기울자 소녀는 흰옷으로 갈아입고 산길을 올랐답니다. 아무도 따라오지 않았어요.",
                    "소녀는 뒤도 돌아보지 않았지요."
                ]
            },
            {
                ...
                left: [
                    ...
                    "달빛이 마룻바닥에 가늘게 깔렸지요.",
                    "소녀가 구석에 무릎을 안고 앉았을 때였어요. 치마폭이 이상하게 묵직했습니다.",
                    "무언가 안에서 꼼지락거렸지요."
                ],
                right: [
                    "소녀가 치마를 들춰 보았어요. 그 안에 두꺼비가 웅크리고 있었지요.",
                    "두꺼비가 소녀를 올려다보았어요.",
                    "\"너… 언제부터 따라온 거니?\"",
            ...
            },
            {
                ...
                left: [
                    "한밤중이었습니다.",
                    "천장에서 스르륵— 무언가 쓸리는 소리가 났어요.",
                    "소녀가 아주 천천히 고개를 들었지요. 숨을 쉬는 것도 잊어버렸답니다.",
                    "소녀는 치마폭을 꼭 움켜쥐었어요."
                ],
                right: [
                    "천장 아래 허공에 커다란 것이 떠 있었어요. 어마어마하게 큰 지네였지요.",
                    "몸통이 기둥만큼 굵고, 마디마다 구불구불 굽이쳤어요.",
                    "몸에서 시퍼런 빛이 뿜어져 나와 사당 안을 온통 물들였습니다.",
                    "소녀는 눈을 질끈 감았답니다."
                ]
            }
        ]
        ...
        beats: [
            {
                ...
                right: [
                    "두꺼비 등에서 따뜻한 노란빛이 피어올랐습니다.",
                    "사당 안이 대낮처럼 환해졌어요.",
                    "시퍼런 빛과 노란빛이 쩌엉— 하고 맞부딪혔어요.",
                    "기둥이 부르르 떨리고 천장에서 먼지가 쏟아졌지요.",
                    "소녀는 두꺼비 뒤에 몸을 붙이고 지켜보았답니다."
                ]
            },
            {
                art: "10-retreat.webp",
                ...
                right: [
                    "지네가 마지막으로 크게 몸부림쳤어요.",
                    "마침내 지네는 검은 연기가 되어 스르르 흩어졌습니다.",
                    "노란빛도 촛불이 꺼지듯 스러져 갔어요. 사당 안이 다시 캄캄해졌답니다.",
                    "두꺼비도 그 자리에 스르르 주저앉았답니다."
                ]
            },
            {
                art: "11-morning.webp",
                ...
                right: [
                    "끼익 하고 문을 열자 소녀가 무사히 앉아 있었어요. 사람들이 입을 딱 벌렸지요.",
            ...
            },
            {
                ...
                left: [
                    ...
                    "주인집 아주머니가 좋은 방을 내주었어요.",
                    "온 마을이 소녀를 도왔지요.",
                    "일곱 날이 지나자 두꺼비가 눈을 껌뻑 떴습니다."
                ],
                right: [
                    "\"고맙다. 정말 고맙다.\"",
                    "두꺼비가 소녀의 손가락을 툭 건드렸어요.",
                    "소녀는 두꺼비를 안고 한참을 울었어요.",
                    "그 뒤로 사당에서 밤을 지키는 일은 없어졌답니다. 지네가 다시는 나타나지 않았거든요.",
                    "두꺼비는 그 뒤로도 오래오래 소녀 곁에 있었지요."
                ]
            }
        ],
        moral: "소녀가 두꺼비에게 나눠 준 것은 남은 밥이 아니라 자기 몫의 밥이었어요. 넉넉해서 준 것이 아니라 모자란데도 나눈 것이지요. 그 마음이 여러 해 뒤에 소녀를 지켜 주었답니다.",
        question: "넉넉하지 않을 때에도 나눠 본 적이 있나요?"
    }
];
...
const COVER = {
    ...
    title: "은혜 갚은 두꺼비",
    intro: [
        "은혜 갚은 두꺼비는 지은이가 없는 구전 설화예요. 사람이 거두어 준 짐승이 되갚는 이야기 갈래에 속한답니다.",
        "옛날 우리 조상들은 두꺼비를 집을 지켜 주는 짐승으로 여겼어요. 부엌이나 마루 밑에 두꺼비가 들면 복이 든다고 해서 쫓지 않고 그냥 두었지요. 두꺼비가 은혜를 갚는 이야기가 여럿 전해지는 것도 그런 마음 때문이랍니다.",
        "이야기에 나오는 지네는 실제 벌레보다 훨씬 커요. 옛이야기에서 지네는 오래 묵어 이상한 힘을 얻은 짐승으로 자주 나와요. 그런 지네가 사는 마을에서는 어떤 일이 벌어질까요?"
    ]
};
    ...
    spreads: [
        {
            art: 'end.webp',
            left: [
                "짐승을 길러 준 사람이 뒷날 그 짐승에게 도움을 받는 이야기를 보은 이야기라고 합니다. 우리 옛이야기에서 가장 자주 나오는 틀 가운데 하나입니다.",
                "이 이야기에는 그것 말고 또 하나가 겹쳐 있습니다. 마을이 해마다 사람을 바치던 대목입니다. 무서운 것을 달래려고 사람을 내주는 이야기는 세계 곳곳에 있습니다.",
                "그런 이야기에서 사람을 구하는 것은 대개 힘센 장수입니다. 그런데 여기서는 소녀가 밥을 나눠 준 두꺼비가 옵니다.",
                "이 이야기가 마을을 구한 것으로 끝나지 않고 그 뒤 소녀가 어떻게 살았는지까지 말해 주는 것도 눈여겨볼 만합니다."
            ],
            right: [
                "두꺼비는 왜 소녀를 도왔을까요? 밥 때문일까요, 다른 무엇 때문일까요.",
                "소녀가 두꺼비에게 나눠 준 것은 남은 밥이 아니라 제 몫의 밥이었습니다. 넉넉해서 준 것이 아니라 모자란데도 나눈 것입니다. 그 마음이 여러 해 뒤에 소녀를 지켜 주었습니다.",
                "넉넉하지 않을 때에도 나눠 본 적이 있나요?"
            ]
        }
    ]
};
...
const WORDS_KO = {
    "cover": [
        { w: "은혜", k: "남에게서 받은 고마운 도움.", s: "두꺼비가 은혜를 갚는 이야기가 여럿 전해지는 것도" },
        { w: "갈래", k: "여러 가닥으로 나뉜 줄기.", s: "사람이 거두어 준 짐승이 되갚는 이야기 갈래에 속한답니다." },
        { w: "거두다", k: "돌보아 기르다.", s: "사람이 거두어 준 짐승이 되갚는 이야기" },
        { w: "복", k: "좋은 일이 생기는 운.", s: "두꺼비가 들면 복이 든다고 해서 쫓지 않고 그냥 두었지요." },
        { w: "묵다", k: "오랜 세월이 지나다.", s: "지네는 오래 묵어 이상한 힘을 얻은 짐승으로 자주 나와요." }
    ],
    "01-girl.webp": [
        { w: "살갑다", k: "마음씨가 다정하고 부드럽다.", s: "주인집 아주머니는 소녀에게 살갑지 않았어요." },
        { w: "긷다", k: "우물이나 개울에서 물을 퍼 오다.", s: "새벽부터 물을 긷고 불을 때고 설거지를 했어요." },
        { w: "트다", k: "살갗이 갈라지다.", s: "손이 늘 트고 갈라져 있었답니다." },
        { w: "몫", k: "저마다 차지하는 부분.", s: "밥을 지어도 소녀 몫은 한 줌뿐" },
        { w: "투덜대다", k: "못마땅해 불평을 늘어놓다.", s: "그래도 소녀는 투덜대는 법이 없었습니다." }
    ],
    "02-toad.webp": [
        { w: "부뚜막", k: "솥을 걸어 놓는 아궁이 위 자리.", s: "부뚜막 구석에서 무언가 꿈틀했어요." },
        { w: "어른거리다", k: "무엇이 자꾸 어렴풋이 보이다.", s: "그림자가 어른거렸지요." },
        { w: "부들부들", k: "몸이 자꾸 떨리는 모양.", s: "불 쑤시는 막대를 든 손이 부들부들 떨렸답니다." },
        { w: "울퉁불퉁", k: "고르지 않고 들쭉날쭉한 모양.", s: "등이 울퉁불퉁하고 배가 홀쭉했지요." },
        { w: "홀쭉하다", k: "살이 빠져 야위다.", s: "등이 울퉁불퉁하고 배가 홀쭉했지요." },
        { w: "슬며시", k: "남모르게 살그머니.", s: "소녀는 막대를 슬며시 내려놓았어요." }
    ],
    "03-share.webp": [
        { w: "덜다", k: "있는 것에서 얼마를 떼어 내다.", s: "소녀는 제 밥그릇에서 밥알을 덜어 부뚜막에 놓았어요." },
        { w: "우물우물", k: "입 안에서 천천히 씹는 모양.", s: "두꺼비가 우물우물 밥알을 받아먹었습니다." },
        { w: "턱을 괴다", k: "손으로 턱을 받치다.", s: "소녀는 턱을 괴고 바라보았답니다." },
        { w: "숟갈", k: "숟가락으로 한 번 뜬 만큼.", s: "많을 때는 한 숟갈이었지요." }
    ],
    "04-grow.webp": [
        { w: "무럭무럭", k: "잘 자라는 모양.", s: "두꺼비는 밥을 먹을수록 무럭무럭 자랐어요." },
        { w: "지경", k: "그쯤 되는 형편.", s: "부뚜막이 좁아 보일 지경이었어요." },
        { w: "쓰다듬다", k: "손으로 부드럽게 문지르다.", s: "소녀가 두꺼비의 등을 쓰다듬으며 웃었습니다." },
        { w: "동무", k: "친구.", s: "소녀에게는 그 두꺼비가 하나뿐인 동무였답니다." },
        { w: "속엣말", k: "마음속에 담아 둔 말.", s: "소녀는 두꺼비에게 속엣말을 다 했지요." }
    ],
    "05-shrine.webp": [
        { w: "근심", k: "마음이 놓이지 않는 걱정.", s: "그 무렵 그 마을에는 큰 근심이 하나 있었어요." },
        { w: "사당", k: "조상을 모시는 작은 집.", s: "사당은 조상을 모시는 작은 집인데" },
        { w: "성이 나다", k: "몹시 화가 나다.", s: "지네가 성이 나면 논밭이 마르고 짐승이 병든다고 했지요." },
        { w: "달래다", k: "성난 마음을 가라앉히다.", s: "마을에서는 지네를 달래려고" },
        { w: "제비뽑기", k: "종이쪽을 뽑아 차례나 사람을 정하는 일.", s: "제비뽑기로 정했지요." },
        { w: "고을", k: "옛날의 마을이나 고장.", s: "그 하룻밤은 무섭기로 온 고을에 이름이 나 있었어요." },
        { w: "여태", k: "지금까지.", s: "그 밤을 넘기고 돌아온 사람은 여태 없었답니다." }
    ],
    "06-chosen.webp": [
        { w: "편들다", k: "어느 한쪽을 돕고 나서다.", s: "부모도 없고 편들어 줄 사람도 없었으니까요." },
        { w: "마찬가지", k: "서로 똑같음.", s: "제비를 뽑기도 전에 정해진 것이나 마찬가지였지요." },
        { w: "말리다", k: "못 하게 붙잡다.", s: "아무도 소녀를 말리지 않았지요." },
        { w: "기울다", k: "해가 저쪽으로 넘어가다.", s: "해가 기울자 소녀는 흰옷으로 갈아입고 산길을 올랐답니다." }
    ],
    "07-hidden.webp": [
        { w: "문틈", k: "문의 벌어진 사이.", s: "문틈으로 바람이 휘휘 들어왔지요." },
        { w: "마룻바닥", k: "마루의 바닥.", s: "달빛이 마룻바닥에 가늘게 깔렸지요." },
        { w: "치마폭", k: "치마의 넓게 퍼진 부분.", s: "치마폭이 이상하게 묵직했습니다." },
        { w: "묵직하다", k: "제법 무겁다.", s: "치마폭이 이상하게 묵직했습니다." },
        { w: "꼼지락거리다", k: "몸을 조금씩 움직이다.", s: "무언가 안에서 꼼지락거렸지요." },
        { w: "웅크리다", k: "몸을 오그려 작게 하다.", s: "그 안에 두꺼비가 웅크리고 있었지요." }
    ],
    "08-centipede.webp": [
        { w: "스르륵", k: "부드럽게 미끄러지는 소리.", s: "천장에서 스르륵— 무언가 쓸리는 소리가 났어요." },
        { w: "쓸리다", k: "스치며 문질러지다.", s: "무언가 쓸리는 소리가 났어요." },
        { w: "움켜쥐다", k: "손가락을 오므려 꽉 잡다.", s: "소녀는 치마폭을 꼭 움켜쥐었어요." },
        { w: "허공", k: "텅 빈 공중.", s: "천장 아래 허공에 커다란 것이 떠 있었어요." },
        { w: "마디", k: "사이사이가 나뉜 부분.", s: "몸통이 기둥만큼 굵고, 마디마다 구불구불 굽이쳤어요." },
        { w: "굽이치다", k: "크게 휘어지며 움직이다.", s: "마디마다 구불구불 굽이쳤어요." },
        { w: "질끈", k: "눈을 세게 감는 모양.", s: "소녀는 눈을 질끈 감았답니다." }
    ],
    "09-glow.webp": [
        { w: "가로막다", k: "앞을 막아서다.", s: "그러고는 소녀 앞을 딱 가로막고 섰지요." },
        { w: "부풀다", k: "크게 불어나다.", s: "두꺼비의 몸이 점점 부풀기 시작했습니다." },
        { w: "대낮", k: "환하게 밝은 한낮.", s: "사당 안이 대낮처럼 환해졌어요." },
        { w: "맞부딪히다", k: "서로 세게 부딪다.", s: "시퍼런 빛과 노란빛이 쩌엉— 하고 맞부딪혔어요." },
        { w: "부르르", k: "잘게 떠는 모양.", s: "기둥이 부르르 떨리고 천장에서 먼지가 쏟아졌지요." }
    ],
    "10-retreat.webp": [
        { w: "밀치다", k: "힘껏 밀어내다.", s: "두 빛이 밀치고 밀렸어요." },
        { w: "통째로", k: "나누지 않고 전부.", s: "사당이 통째로 흔들렸지요." },
        { w: "뼘", k: "손가락을 벌린 만큼의 길이.", s: "노란빛이 한 뼘, 또 한 뼘 밀고 올라갔습니다." },
        { w: "늘어지다", k: "힘이 빠져 축 처지다.", s: "지네의 몸이 힘없이 축 늘어졌지요." },
        { w: "몸부림치다", k: "몸을 마구 뒤틀며 애쓰다.", s: "지네가 마지막으로 크게 몸부림쳤어요." },
        { w: "스러지다", k: "차차 사라지다.", s: "노란빛도 촛불이 꺼지듯 스러져 갔어요." }
    ],
    "11-morning.webp": [
        { w: "선뜻", k: "망설이지 않고 얼른.", s: "아무도 선뜻 문을 열지 못했습니다." },
        { w: "각오하다", k: "어려운 일을 앞두고 마음을 단단히 먹다.", s: "다들 나쁜 일을 각오하고 있었어요." },
        { w: "무사히", k: "아무 탈 없이.", s: "문을 열자 소녀가 무사히 앉아 있었어요." },
        { w: "잠기다", k: "어떤 마음에 깊이 빠지다.", s: "소녀의 목소리는 슬픔에 잠겨 있었답니다." }
    ],
    "12-recover.webp": [
        { w: "정성껏", k: "온 마음을 다해.", s: "소녀는 두꺼비를 집으로 데려가 정성껏 돌보았어요." },
        { w: "내주다", k: "남이 쓰도록 내어 주다.", s: "주인집 아주머니가 좋은 방을 내주었어요." }
    ],
    "after": [
        { w: "보은", k: "받은 은혜를 갚는 것.", s: "보은 이야기라고 합니다." },
        { w: "바치다", k: "웃어른이나 신에게 드리다.", s: "마을이 해마다 사람을 바치던 대목입니다." },
        { w: "장수", k: "군사를 이끄는 힘센 사람.", s: "사람을 구하는 것은 대개 힘센 장수입니다." },
        { w: "눈여겨보다", k: "주의 깊게 살펴보다.", s: "눈여겨볼 만합니다." },
        { w: "넉넉하다", k: "모자라지 않고 남을 만큼 많다.", s: "넉넉해서 준 것이 아니라 모자란데도 나눈 것입니다." }
    ]
};
