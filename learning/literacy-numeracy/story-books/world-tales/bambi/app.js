        ...
        "beats": [
            {
                ...
                "right": [
                    "다리는 가늘어 나뭇가지 같았습니다. 일어서려다 자꾸 미끄러졌지요. 어미가 밤비를 정성껏 핥아 주었습니다.",
                    "한참 만에 밤비가 겨우 일어섰지요. 네 다리가 후들후들 떨렸습니다. 어미는 그것을 가만히 지켜보았지요.",
                    "덤불 사이로 아침 햇살이 들어왔습니다."
                ]
            },
            {
                "art": "01-birth-2.webp",
                ...
                "right": [
                    "다람쥐는 나무를 오르내리며 구경했지요. 밤비는 이웃들이 떠드는 소리를 다 들었습니다.",
                    "하지만 아직 무슨 말인지는 몰랐지요. 그저 어미 곁에 바싹 붙어 있었습니다.",
        ...
        "beats": [
            {
                ...
                "right": [
                    ...
                    "밤비가 소리쳤습니다. \"우아, 하늘이 이렇게 넓어요?\"",
                    "밤비는 당장 뛰어나가려 했지요. 그런데 어미가 앞을 막았습니다. \"잠깐 기다리렴.\""
                ]
            },
            {
                ...
                "emoji": "🌼",
                "left": [
                    "\"풀밭에서는 늘 조심해야 한단다. 숲과 달리 여기서는 몸을 숨길 데가 없거든.\"",
                    "어미는 목을 길게 빼고 섰습니다. \"먼저 서서 귀를 기울이는 거야. 바람 냄새도 맡아 보고. 그다음에 나가는 거란다.\""
                ],
                "right": [
                    "밤비는 고개를 끄덕였지요. 그런데 풀밭을 보자 그 말을 그만 잊었습니다. 밤비는 그냥 뛰쳐나갔지요.",
                    "어미가 얼른 뒤따라 나왔습니다. 이리저리 둘레를 살피느라 마음이 놓이지 않았지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "right": [
                    "둘은 온종일 뛰어다니며 놀았지요. 팔리네가 앞서 내달리며 외쳤습니다. \"나 잡아 봐라!\"",
                    "풀이 밤비의 키만큼 자라 있었습니다. 뛰어다니면 풀이 파도처럼 갈라졌지요. 나비들이 놀라 날아올랐습니다.",
                    "둘은 지칠 줄을 몰랐지요."
                ]
            },
            {
                ...
                "right": [
                    ...
                    "밤비와 팔리네는 걸음을 늦췄습니다. 셋은 나란히 풀밭에 엎드렸지요.",
                    "해가 등을 따뜻하게 데워 주었습니다. 밤비는 이런 날이 계속되기를 바랐지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "어른 사슴들이 모두 고개를 들었지요. 숲 가장자리에서 무언가가 걸어 나왔습니다. 아주 커다란 사슴이었지요.",
                    "뿔이 나뭇가지처럼 넓게 뻗어 있었습니다. 주둥이 둘레가 잿빛이었지요."
                ],
                "right": [
                    "그런데 발소리가 하나도 나지 않았습니다. 풀도 흔들리지 않았지요.",
                    "밤비는 숨을 죽이고 바라보았습니다. 이런 사슴은 처음이었지요.",
                    "밤비가 어미에게 소곤소곤 물었습니다. \"저분이 누구예요?\"",
                    "어미는 대답 대신 고개만 숙였습니다."
                ]
            },
            {
                ...
                "emoji": "🦌",
                "left": [
                    "늙은 사슴이 밤비 앞에 멈춰 섰습니다. 한참 동안 내려다보았지요. 밤비는 고개를 들 수가 없었습니다.",
                    "이윽고 늙은 사슴이 입을 열었지요. \"너는 혼자서도 다닐 줄 아느냐?\"",
                    "밤비는 대답을 못 했습니다."
                ],
                "right": [
                    "늘 어미 곁에만 있었으니까요. 늙은 사슴은 더 묻지 않았지요.",
                    "그 말만 남기고 숲으로 사라졌습니다. 왔을 때처럼 소리 없이 갔지요.",
                    "그날부터 밤비는 그 말이 자꾸 떠올랐습니다. 자면서도 그 목소리가 들렸지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "그러다 어느 날 아침이었습니다. 숲이 온통 하얗게 변해 있었지요. 밤비는 처음 보는 하얀 것에 코를 대 보았습니다.",
                    "\"앗, 차가워요!\"",
                    "밤비는 깜짝 놀라 뒤로 물러섰지요. 콧등에 눈이 하얗게 묻어 있었습니다."
                ],
                "right": [
                    "어미가 빙그레 웃었습니다. \"눈이란다. 겨울이 온 거야.\"",
                    "밤비는 눈밭을 폴짝폴짝 뛰어다녔지요. 발을 디딜 때마다 뽀드득뽀드득 소리가 났습니다. 발자국이 뒤로 죽 이어졌지요."
                ]
            },
            {
                ...
                "left": [
                    ...
                    "풀은 눈 밑에 파묻혔습니다. 먹을 것이 거의 없었지요.",
                    "사슴들은 나무껍질을 벗겨 먹었습니다. 밤비도 이빨로 껍질을 뜯었지요. 쓰고 딱딱했지만 참았습니다."
                ],
                "right": [
                    "어미는 자기 몫을 자꾸 밤비 쪽으로 밀어 주었지요. 어미의 등뼈가 도드라져 보였습니다.",
                    "밤비가 물었습니다. \"어머니는요?\" 어미는 고개를 저었지요. \"나는 배부르단다.\"",
                    "숲의 밤은 아주 조용했습니다. 바람에 마른 가지가 딱딱 부딪혔지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "그런데 어미가 갑자기 고개를 들었습니다. 귀가 한쪽으로 돌아갔지요. 풀밭 너머가 소란스러웠습니다.",
                    "사냥꾼들의 소리였지요. 개 짖는 소리도 섞여 있었습니다. 어미는 밤비를 덤불 쪽으로 밀었지요."
                ],
                "right": [
            ...
            },
            {
                ...
                "emoji": "🌫️",
                "left": [
                    "나무들이 옆으로 휙휙 지나갔습니다. 발밑에서 눈이 여기저기 튀었지요.",
                    "얼마나 달렸는지 알 수 없었습니다. 다리에 힘이 하나도 남지 않았지요.",
                    "한참 뒤 밤비는 걸음을 멈췄지요. 그러고는 뒤를 돌아보았습니다."
                ],
                "right": [
        ...
        "beats": [
            {
                ...
                "right": [
                    "팔리네도 훌쩍 자라 있었지요. 팔리네가 반갑게 외쳤습니다. \"너, 키가 많이 컸구나!\"",
                    "\"너도 그런걸.\"",
                    "팔리네가 소식을 전했지요. \"고보도 겨울을 넘겼어. 아직 조금만 뛰면 헉헉대지만.\"",
                    "둘은 오랜만에 나란히 걸었습니다. 밤비가 눈에 코를 대고 놀랐던 이야기를 하자 팔리네가 깔깔 웃었지요."
                ]
            },
            {
                ...
                "emoji": "🌸",
                "left": [
                    "팔리네가 풀밭으로 나가려 했습니다. 그런데 밤비가 걸음을 멈췄지요. \"잠깐만.\"",
                    "밤비는 목을 길게 빼고 섰습니다. 귀를 이쪽저쪽으로 돌리고, 바람 냄새도 맡았지요."
                ],
                "right": [
                    "한참 만에 밤비가 고개를 끄덕였지요. \"이제 됐어. 나가자.\"",
                    "팔리네가 눈을 동그랗게 떴습니다. \"너 언제 그런 걸 배웠어?\"",
                    "\"어머니가 가르쳐 주셨어.\" 밤비는 어미가 가르쳐 준 것을 하나도 잊지 않았던 것입니다."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "해가 나무 사이로 길게 비껴들었지요. 밤비는 혼자 숲길을 걷고 있었습니다.",
                    "그때 앞쪽에 무언가가 서 있었지요. 늙은 사슴이었습니다.",
                    "\"따라오너라.\""
                ],
                "right": [
            ...
            },
            {
                ...
                "left": [
                    ...
                    "늙은 사슴이 조용히 방향을 틀자 밤비도 따라 틀었지요. 그렇게 여러 날을 나란히 걸었습니다."
                ],
                "right": [
                    "어느 날 저녁, 늙은 사슴이 밤비를 돌아보았습니다. \"이제 혼자서도 다닐 수 있겠구나.\"",
                    "그러고는 조용히 걸어갔지요. 나무 사이로 모습이 사라졌습니다. 밤비는 이제 혼자서도 숲을 걸었지요."
                ]
            }
        ],
        "moral": "누군가 곁에서 가르쳐 준 것들이, 혼자가 되었을 때 나를 지켜 준답니다."
    }
];
    ...
    spreads: [
        {
            ...
            right: [
                ...
                "늙은 사슴은 마지막까지 밤비에게 이름을 알려 주지 않습니다. 왜 그랬을까요?"
            ]
        }
    ]
};
...
const EN = {
    ...
    chapters: [
        ...
        {
            num: 2,
            title: 'Chapter 2 · The Wide Meadow',
            beats: [
                {
                    art: '02-meadow.webp',
                    emoji: '🌾',
        ...
        {
            num: 3,
            title: 'Chapter 3 · Friends in the Wood',
            beats: [
                {
                    art: '03-friends.webp',
                    emoji: '🌼',
        ...
        {
            num: 5,
            title: 'Chapter 5 · The First Snow',
            beats: [
                {
                    art: '05-winter.webp',
                    emoji: '❄️',
        ...
        {
            num: 6,
            title: 'Chapter 6 · The Day He Was Left Alone',
            beats: [
                {
                    art: '06-alone.webp',
                    emoji: '🌫️',
        ...
        {
            num: 8,
            title: 'Chapter 8 · How to Walk in the Wood',
            beats: [
                {
                    art: '08-ending.webp',
                    emoji: '🌲',
    ...
    quiz: [
        ...
        {
            q: 'What did the deer eat when the snow lay deep?',
            choices: ['Acorns from the squirrel', 'Bark stripped off the trees', 'Grass from under the snow'],
            answer: 1
        },
        {
        ...
        spreads: [
            {
                ...
                right: [
                    "In winter deer really do eat bark. Salten spent years walking in woods, and details like that are exact.",
                    "The old stag never tells Bambi his name, right to the end. Why do you think that is?"
                ]
            }
        ]
    },
    words: {
        'cover.webp': [
            { word: 'publish', meaning: '펴내다', sentence: 'Published by the Austrian writer Felix Salten in 1923.' },
            { word: 'fawn', meaning: '새끼 사슴', sentence: 'It is the story of a fawn born in the forest.' },
            { word: 'season', meaning: '계절', sentence: 'Growing up through one season after another.' },
            { word: 'from far off', meaning: '멀리서', sentence: 'Something strange coming toward you from far off.' }
        ],
        '01-birth.webp': [
        ...
        '01-birth-2.webp': [
            { word: 'go round', meaning: '퍼지다', sentence: 'The news went round the wood very quickly.' },
            { word: 'twitch', meaning: '씰룩거리다', sentence: 'Twitching his nose as he peered in.' },
            { word: 'magpie', meaning: '까치', sentence: 'The magpie chattered from a branch.' },
            { word: 'chatter', meaning: '재잘거리다', sentence: 'The magpie chattered from a branch.' },
            { word: 'squirrel', meaning: '다람쥐', sentence: 'The squirrel ran up and down a tree.' }
        ],
        '02-meadow.webp': [
        ...
        '02-meadow-2.webp': [
            { word: 'take care', meaning: '조심하다', sentence: 'On the meadow you must always take care.' },
            { word: 'nowhere to hide', meaning: '숨을 데가 없는', sentence: 'Out there is nowhere to hide.' },
            { word: 'stretch up', meaning: '길게 빼다', sentence: 'She stood with her neck stretched up.' },
            { word: 'bolt', meaning: '뛰쳐나가다', sentence: 'He simply bolted out into it.' },
        ...
        '03-friends.webp': [
            ...
            { word: 'tire', meaning: '지치다', sentence: 'The two of them never seemed to tire.' }
        ],
        '03-friends-2.webp': [
            { word: 'have one’s ears up', meaning: '귀를 쫑긋 세우다', sentence: 'The rabbit always had his ears up.' },
            { word: 'acorn', meaning: '도토리', sentence: 'The acorns have come on nicely this year!' },
            { word: 'out of breath', meaning: '숨이 찬', sentence: 'He was soon out of breath.' },
            { word: 'slow down', meaning: '걸음을 늦추다', sentence: 'Bambi and Faline slowed down.' }
        ],
        '04-old-stag.webp': [
            { word: 'stag', meaning: '수사슴', sentence: 'An enormous stag.' },
            { word: 'antler', meaning: '뿔', sentence: 'With antlers spread wide like branches.' },
            { word: 'muzzle', meaning: '주둥이', sentence: 'And grey all round his muzzle.' },
            { word: 'bow one’s head', meaning: '고개를 숙이다', sentence: 'His mother only bowed her head.' }
        ],
        '04-old-stag-2.webp': [
            { word: 'go about', meaning: '돌아다니다', sentence: 'Can you go about by yourself?' },
            { word: 'raise', meaning: '들다', sentence: 'Bambi could not raise his head.' },
            { word: 'silently', meaning: '소리 없이', sentence: 'As silently as he had come.' },
            { word: 'come back to', meaning: '자꾸 떠오르다', sentence: 'The question kept coming back to Bambi.' }
        ],
        '05-winter.webp': [
            { word: 'turn red', meaning: '붉게 물들다', sentence: 'The leaves turned red.' },
            { word: 'bound', meaning: '폴짝폴짝 뛰다', sentence: 'Bambi went bounding about over the snow.' },
            { word: 'print', meaning: '발자국', sentence: 'Leaving a line of prints behind him.' },
            { word: 'crunch', meaning: '뽀드득 소리 나다', sentence: 'It squeaked and crunched under his feet.' }
        ],
        '05-winter-2.webp': [
            { word: 'bury', meaning: '파묻다', sentence: 'The grass was buried under it.' },
            { word: 'strip', meaning: '벗기다', sentence: 'The deer stripped bark off the trees to eat.' },
            { word: 'bark', meaning: '나무껍질', sentence: 'The deer stripped bark off the trees.' },
            { word: 'bitter', meaning: '쓴', sentence: 'It was bitter and hard.' },
            { word: 'share', meaning: '몫', sentence: 'She kept pushing her own share over to him.' }
        ],
        '06-alone.webp': [
        ...
        '07-spring.webp': [
            { word: 'melt', meaning: '녹다', sentence: 'The winter ended and the snow melted.' },
            { word: 'shoot', meaning: '새싹', sentence: 'Green shoots came up out of the ground.' },
            { word: 'shoot up', meaning: '훌쩍 자라다', sentence: 'Faline had shot up too.' },
            { word: 'puff', meaning: '헉헉대다', sentence: 'He still puffs if he runs at all.' }
        ],
        '07-spring-2.webp': [
        ...
        '08-ending.webp': [
            ...
            { word: 'slant', meaning: '비껴들다', sentence: 'The sun came slanting in between the trees.' },
            { word: 'ahead of', meaning: '앞쪽에', sentence: 'Something was standing ahead of him.' },
        ...
        'end.webp': [
            ...
            { word: 'exact', meaning: '정확한', sentence: 'Details like that are exact.' },
            { word: 'right to the end', meaning: '마지막까지', sentence: 'The old stag never tells Bambi his name, right to the end.' }
        ]
    }
};
...
const WORDS_KO = {
    ...
    "01-birth.webp": [
        ...
        { w: "무성하다", k: "풀이 아주 많이 나 있다.", s: "고사리가 무성해서 아무도 들여다볼 수 없었지요." },
        { w: "어미", k: "짐승의 어머니.", s: "어미가 밤비를 정성껏 핥아 주었습니다." },
        { w: "후들후들", k: "힘이 없어 자꾸 떨리는 모양.", s: "네 다리가 후들후들 떨렸습니다." }
    ],
    "01-birth-2.webp": [
        { w: "오르내리다", k: "올라갔다 내려갔다 하다.", s: "다람쥐는 나무를 오르내리며 구경했지요." },
        { w: "바싹", k: "아주 가까이 붙게.", s: "그저 어미 곁에 바싹 붙어 있었습니다." },
        { w: "어른거리다", k: "보일 듯 말 듯 자꾸 움직이다.", s: "해가 나뭇잎 사이로 어른거렸지요." }
    ],
    "02-meadow.webp": [
        { w: "제법", k: "생각보다 꽤.", s: "며칠이 지나자 밤비는 제법 잘 걸었습니다." },
        { w: "펼쳐지다", k: "넓게 벌어져 눈앞에 보이다.", s: "끝없는 풀밭이 펼쳐져 있었지요." },
        { w: "통째로", k: "쪼개지 않고 전부.", s: "하늘이 통째로 내려앉은 것 같았습니다." }
    ],
    "02-meadow-2.webp": [
        { w: "귀를 기울이다", k: "소리를 들으려고 마음을 모으다.", s: "먼저 서서 귀를 기울이는 거야." },
        { w: "뒤따르다", k: "뒤에서 따라가다.", s: "어미가 얼른 뒤따라 나왔습니다." },
        { w: "둘레", k: "빙 둘러싼 가까운 곳.", s: "이리저리 둘레를 살피느라 마음이 놓이지 않았지요." }
    ],
    "03-friends.webp": [
        { w: "또래", k: "나이가 비슷한 아이.", s: "밤비 또래도 있었지요." },
        { w: "무늬", k: "겉에 나타난 모양이나 빛깔의 결.", s: "목에 하얀 무늬가 있었지요." },
        { w: "온종일", k: "아침부터 저녁까지 내내.", s: "둘은 온종일 뛰어다니며 놀았지요." },
        { w: "내달리다", k: "빠르게 앞으로 달리다.", s: "팔리네가 앞서 내달리며 외쳤습니다." }
    ],
    "03-friends-2.webp": [
        { w: "수다를 떨다", k: "쉬지 않고 말을 많이 하다.", s: "다람쥐는 나무 위에서 수다를 떨었지요." },
        { w: "여물다", k: "열매가 알차게 익다.", s: "\"오늘은 도토리가 잘 여물었어!\"" },
        { w: "엎드리다", k: "배를 바닥에 대고 눕다.", s: "셋은 나란히 풀밭에 엎드렸지요." },
        { w: "데우다", k: "차가운 것을 따뜻하게 하다.", s: "해가 등을 따뜻하게 데워 주었습니다." }
    ],
    "04-old-stag.webp": [
        { w: "그치다", k: "하던 것이 멈추다.", s: "새들도 울음을 그쳤습니다." },
        { w: "가장자리", k: "무엇의 바깥 끝 쪽.", s: "숲 가장자리에서 무언가가 걸어 나왔습니다." },
        { w: "잿빛", k: "재처럼 흐린 회색.", s: "주둥이 둘레가 잿빛이었지요." },
        { w: "숨을 죽이다", k: "소리가 나지 않게 숨을 참다.", s: "밤비는 숨을 죽이고 바라보았습니다." }
    ],
    "04-old-stag-2.webp": [
        { w: "이윽고", k: "얼마쯤 지난 뒤에.", s: "이윽고 늙은 사슴이 입을 열었지요." },
        { w: "입을 열다", k: "말을 하기 시작하다.", s: "이윽고 늙은 사슴이 입을 열었지요." },
        { w: "곁", k: "바로 옆자리.", s: "늘 어미 곁에만 있었으니까요." }
    ],
    "05-winter.webp": [
        { w: "온통", k: "빠짐없이 다.", s: "숲이 온통 하얗게 변해 있었지요." },
        { w: "콧등", k: "코의 윗부분.", s: "콧등에 눈이 하얗게 묻어 있었습니다." },
        { w: "빙그레", k: "소리 없이 부드럽게 웃는 모양.", s: "어미가 빙그레 웃었습니다." },
        { w: "디디다", k: "발을 바닥에 대고 누르다.", s: "발을 디딜 때마다 뽀드득뽀드득 소리가 났습니다." }
    ],
    "05-winter-2.webp": [
        { w: "뜯다", k: "붙어 있는 것을 떼어 내다.", s: "밤비도 이빨로 껍질을 뜯었지요." },
        { w: "등뼈", k: "등 한가운데를 지나는 뼈.", s: "어미의 등뼈가 도드라져 보였습니다." },
        { w: "도드라지다", k: "겉으로 툭 튀어나와 보이다.", s: "어미의 등뼈가 도드라져 보였습니다." }
    ],
    "06-alone.webp": [
        { w: "소란스럽다", k: "시끄럽고 어수선하다.", s: "풀밭 너머가 소란스러웠습니다." },
        { w: "사냥꾼", k: "짐승을 잡는 일을 하는 사람.", s: "사냥꾼들의 소리였지요." },
        { w: "숨이 턱에 닿다", k: "몹시 힘들어 숨이 가빠지다.", s: "숨이 턱에 닿도록 달렸습니다." }
    ],
    "06-alone-2.webp": [
        { w: "휙휙", k: "아주 빠르게 지나가는 모양.", s: "나무들이 옆으로 휙휙 지나갔습니다." },
        { w: "발밑", k: "발이 놓인 바로 아래.", s: "발밑에서 눈이 여기저기 튀었지요." }
    ],
    "07-spring.webp": [
        { w: "돋아나다", k: "싹이 밖으로 나오다.", s: "땅에서 새싹이 돋아났지요." },
        { w: "몰라보게", k: "알아보지 못할 만큼.", s: "밤비도 몰라보게 자랐지요." },
        { w: "낯익다", k: "전에 본 적이 있어 눈에 익다.", s: "어느 날 풀밭에서 낯익은 얼굴을 만났지요." },
        { w: "겨울을 넘기다", k: "힘든 겨울을 무사히 지나 보내다.", s: "고보도 겨울을 넘겼어." }
    ],
    "07-spring-2.webp": [
        { w: "한참", k: "꽤 오랜 동안.", s: "한참 만에 밤비가 고개를 끄덕였지요." },
        { w: "맡다", k: "코로 냄새를 느끼다.", s: "귀를 이쪽저쪽으로 돌리고, 바람 냄새도 맡았지요." }
    ],
    "08-ending.webp": [
    ...
    "08-ending-2.webp": [
        ...
        { w: "방향을 틀다", k: "가던 쪽을 다른 쪽으로 바꾸다.", s: "늙은 사슴이 조용히 방향을 틀자 밤비도 따라 틀었지요." }
    ],
    "end.webp": [
        { w: "대목", k: "글이나 이야기의 한 부분.", s: "잘텐은 숲을 오래 다닌 사람이라 이런 대목이 정확합니다." },
        { w: "내딛다", k: "발을 앞으로 옮겨 놓다.", s: "한참을 서서 듣고 냄새를 맡은 뒤에야 발을 내딛지요." },
        { w: "다만", k: "그런데 한 가지.", s: "다만 고개를 숙이지요." }
    ]
};
