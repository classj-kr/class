        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "곡식 자루를 등에 지고 방앗간과 장터를 오갔지요. 눈이 오나 비가 오나 마찬가지였습니다. 주인도 그런 당나귀를 아주 아꼈지요."
                ],
                "right": [
                    "그런데 세월이 흘러 당나귀도 늙었습니다. 다리가 후들거리고 등이 시큰거렸지요. 예전만큼 짐을 지지 못했습니다.",
                    "자루 하나를 지고도 몇 번씩 쉬어야 했습니다. 주인의 얼굴이 점점 굳어 갔지요.",
                    "어느 날 헛간에서 쉬는데 문밖에서 목소리가 들려왔습니다."
                ]
            },
            {
                ...
                "emoji": "🫏",
                "left": [
                    "주인의 목소리였지요. \"이제 저놈은 쓸모가 없구나. 먹이만 축내는걸.\"",
                    "당나귀는 귀를 쫑긋 세웠습니다. 가슴이 서늘해졌지요.",
                    "그날 밤 잠이 오지 않았습니다. 이대로 있다가는 큰일이 날 것 같았지요. 당나귀는 밤새 뒤척이다 마음을 정하고, 새벽이 오기 전에 슬그머니 빠져나갔습니다."
                ],
                "right": [
                    "달이 환한 밤이었지요. 당나귀는 뒤도 돌아보지 않고 큰길로 나섰습니다.",
                    "걷다가 목청을 가다듬어 보았지요. \"히히힝!\" 제법 우렁차서 숲이 쩌렁쩌렁 울렸습니다.",
                    "\"이만하면 됐다. 브레멘으로 가서 노래하는 악사가 되자.\" 브레멘은 사흘은 걸어야 닿는 큰 도시였지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "🐕",
                "left": [
                    "한참을 걸었을 때였습니다. 길가에 무언가 늘어져 있었지요. 가까이 가 보니 늙은 사냥개였습니다.",
                    "숨을 헐떡이며 겨우 고개만 들었습니다. 털이 여기저기 빠져 있었고 옆구리가 홀쭉했지요.",
                    "당나귀가 물었습니다. \"자네는 왜 그러고 있나?\""
                ],
                "right": [
                    "\"말도 마십시오. 이제 사냥을 못 한다고 주인이 저를 내쫓았지 뭡니까. 어제부터 아무것도 못 먹고 이 길에서 그냥 이러고 있지요.\"",
                    "당나귀는 한참 개를 내려다보았습니다. 남의 일 같지가 않았지요. 바로 자기 이야기였으니까요."
                ]
            },
            {
                "art": "02-dog-2.webp",
                "emoji": "🐕",
                "left": [
                    "당나귀가 앞발로 땅을 툭툭 쳤습니다. \"마침 잘됐군. 나와 브레멘에 가서 악사가 되세.\"",
                    "\"제가요? 저는 짖는 것밖에 못 하는데요.\"",
                    "\"그게 바로 노래 아닌가! 자네 목소리가 얼마나 우렁찬데.\"",
                    "개는 어리둥절한 얼굴로 당나귀를 올려다보았습니다."
                ],
                "right": [
                    "그러다 슬며시 웃었지요. 앞발에 힘을 주고 천천히 몸을 일으켰습니다. 다리가 후들거렸지만 그래도 섰지요.",
                    "\"멍멍! 이러면 됩니까?\"",
                    "당나귀가 껄껄 웃었습니다. \"아주 좋아. 자네는 북을 맡게.\" 개가 꼬리를 살랑살랑 흔들었지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "사흘은 굶은 얼굴이었지요. 수염도 여기저기 빠져 있었습니다.",
                    "당나귀가 물었지요. \"자네는 또 왜 그런가?\""
                ],
                "right": [
                    "\"이가 무뎌져서 쥐를 못 잡는다고 주인이 저를 내쫓았어요. 이제 저는 갈 곳도 없습니다.\"",
                    "\"그럼 자네도 함께 가세. 밤 노래는 자네가 제일이지.\"",
                    "고양이가 눈을 껌뻑였습니다. 한참 둘을 번갈아 보더니 슬며시 꼬리를 세웠지요. 그러고는 담에서 사뿐 내려왔습니다."
                ]
            },
            {
                "art": "03-four-2.webp",
                ...
                "left": [
                    ...
                    "당나귀가 올려다보며 물었지요. \"무슨 일로 그리 우나?\"",
                    "\"내일 잔칫상에 오른다지 뭡니까! 마지막으로 실컷 울어나 보려고요.\""
                ],
                "right": [
                    "당나귀가 고개를 저었습니다. \"그렇게 좋은 목청을 두고 잔칫상이라니, 말도 안 되지. 우리와 함께 가세. 자네 목소리면 어디서든 먹고살겠어.\"",
                    "수탉은 잠시 망설였습니다. 그러다 크게 날개를 퍼덕이며 담에서 내려왔지요. 이제 넷이 나란히 걸었습니다."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "🌲",
                "left": [
                    "해가 지고 넷은 숲에서 밤을 맞았습니다. 브레멘은 아직 한참 멀었지요. 하루 만에 닿을 거리가 아니었습니다.",
                    "당나귀와 개는 커다란 나무 밑에 자리를 잡았습니다. 고양이는 가지에 올라갔고, 수탉은 더 높이 날아올랐지요."
                ],
                "right": [
                    "수탉은 꼭대기에서 습관처럼 둘레를 살펴보았습니다. 늘 하던 일이었지요. 그러다 갑자기 소리쳤습니다. \"저기! 불빛이 보여요!\"",
                    "당나귀가 나무 밑에서 물었지요. \"멀리 있나?\"",
                    "\"아니요, 걸어갈 만해요!\"",
                    "넷은 배도 고프고 추웠습니다. 불빛이 있으면 집도, 먹을 것도 있겠지요."
                ]
            },
            {
                "art": "04-light-2.webp",
                ...
                "left": [
                    ...
                    "한참을 헤치고 나아가자 숲이 트였습니다. 빈터 한가운데 작은 오두막이 서 있었지요. 창문 하나가 아주 환했습니다.",
                    "넷은 몸을 낮추고 살금살금 다가갔습니다."
                ],
                "right": [
                    "안에서 웃음소리가 새어 나왔습니다. 그런데 창턱이 꽤 높았지요. 개도 고양이도 수탉도 어림없었습니다.",
                    "키가 제일 큰 당나귀가 나섰지요. \"내가 볼 테니 자네들은 좀 기다리게.\"",
                    "당나귀가 앞발을 창턱에 걸치고 안을 들여다보았습니다. 셋은 아래에서 발끝을 들고 기다렸지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "구석에는 묵직한 자루가 몇 개 쌓여 있었지요. 한눈에 보아도 도둑들이었습니다.",
                    "아래에서 개가 속삭였지요. \"뭐가 보여요?\""
                ],
                "right": [
                    "당나귀가 침을 꼴깍 삼켰습니다. \"먹을 게 산더미일세. 저 정도면 우리 넷도 배부르게 먹겠는걸.\"",
                    "아래에서 셋이 발을 동동 굴렀습니다. 배에서 꼬르륵 소리가 났지요. \"저희도 좀 보여 주세요!\""
                ]
            },
            {
                ...
                "left": [
                    ...
                    "좀처럼 좋은 수가 떠오르지 않았지요. 한참 만에 당나귀가 무릎을 쳤습니다. \"우리 목청을 한꺼번에 쓰면 어떻겠나? 놀라서 달아날 걸세.\""
                ],
                "right": [
                    "넷은 곧바로 자리를 잡았습니다. 당나귀가 앞발을 창턱에 올렸지요. 그 등에 개가 올라섰습니다.",
                    "개 등에는 고양이가, 고양이 등에는 수탉이 올라섰습니다. 넷이 겹겹이 쌓이자 창문 높이가 딱 맞았지요.",
                    "넷은 숨을 크게 들이켰습니다. 당나귀가 속삭였지요. \"하나, 둘, 셋!\""
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "💥",
                "left": [
                    "넷이 한꺼번에 목청을 높였습니다. \"히히힝! 멍멍! 야옹! 꼬끼오!\"",
                    "어찌나 요란한지 숲이 다 울렸습니다. 새들이 놀라 날아올랐지요.",
                    "그러다 넷이 그대로 창으로 쏟아져 들어갔습니다. 유리창이 와장창 깨졌지요."
                ],
                "right": [
                    "도둑들은 숟가락을 내던지고 튀어 올랐지요. 의자가 넘어지고 접시가 굴렀습니다.",
                    "\"괴, 괴물이다!\" \"살려 줘!\"",
                    "셋은 서로 부딪치며 문밖으로 뛰쳐나갔습니다. 신발도 챙기지 못한 채였지요."
                ]
            },
            {
                "art": "06-noise-2.webp",
                ...
                "left": [
                    ...
                    "그러고는 누가 먼저랄 것도 없이 상 앞에 둘러앉았습니다. 어찌나 배가 고팠던지요. 넷은 상 위의 것을 남김없이 먹어 치웠습니다."
                ],
                "right": [
                    "몇 달 만에 배가 불렀지요. 당나귀는 배를 두드리며 웃었습니다. \"이제 좀 살 것 같군.\"",
                    "넷은 불을 끄고 저마다 편한 자리를 찾았습니다. 당나귀는 마당 짚더미 위에, 개는 문 뒤에, 고양이는 아궁이 앞에, 수탉은 지붕에 자리를 잡았지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "\"불도 꺼졌는데 그냥 갈 텐가? 자루가 아직 저 안에 있잖나.\"",
                    "두목이 한 사람을 가리켰지요. \"자네가 한번 가 보게.\" 결국 그 도둑이 살그머니 오두막으로 돌아왔습니다."
                ],
                "right": [
                    "부엌은 캄캄했습니다. 도둑은 더듬더듬 아궁이를 찾았지요. 초에 불을 붙이려면 불씨가 필요했으니까요.",
                    "그때 어둠 속에서 불씨 두 개가 반짝였습니다. 도둑은 반가운 마음에 초를 갖다 댔지요.",
                    "그런데 그것은 불씨가 아니라 고양이의 눈이었습니다. 고양이가 어둠 속에서 눈을 번쩍 떴지요."
                ]
            },
            {
                ...
                "emoji": "😱",
                "left": [
                    "\"야옹!\" 고양이가 앞발로 도둑의 얼굴을 할퀴었습니다. 도둑이 비명을 지르며 뒷문으로 달아났지요.",
                    "그런데 하필 문 앞에 개가 엎드려 있었습니다. 개가 다리를 콱 물었지요. 도둑은 펄쩍 뛰어 마당으로 굴러 나갔습니다.",
                    "마당 짚더미 위에는 당나귀가 있었지요."
                ],
                "right": [
                    "당나귀가 뒷발로 힘껏 걷어찼습니다. 도둑이 담 너머로 붕 날아가 엉덩방아를 찧었지요.",
                    "그 소리에 잠이 깬 수탉이 지붕에서 외쳤습니다. \"꼬끼오!\"",
                    "도둑은 그대로 내달렸습니다. 온 숲이 수탉 울음소리로 가득 찼지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "\"저 집에는 무서운 것들이 잔뜩 있습니다! 마귀할멈이 손톱으로 얼굴을 할퀴었고, 문가에서는 칼 든 자가 다리를 찔렀습니다. 마당에는 몽둥이 든 놈이 지키고 있다가 저를 때려눕혔지요. 게다가 지붕에서 재판관이 잡아가라고 소리쳤습니다!\""
                ],
                "right": [
                    "사실은 고양이, 개, 당나귀, 수탉이었는데 말이지요.",
                    "두목은 고개를 절레절레 저었습니다. \"그런 집은 그냥 두는 게 낫겠군.\"",
                    "그 뒤로 도둑들은 그 집에 오지 않았지요."
                ]
            },
            {
                ...
                "left": [
                    ...
                    "뜰에는 우물과 텃밭이 있고, 헛간에는 마른 짚까지 쌓여 있었지요. 넷에게 꼭 맞는 집이었습니다."
                ],
                "right": [
                    "당나귀가 말했습니다. \"브레멘은 뭐, 다음에 가지. 여기가 더 좋은걸.\" 셋이 모두 고개를 끄덕였지요.",
                    "넷은 그 집에서 오래오래 함께 살았습니다. 저녁마다 네 목소리가 숲에 울려 퍼졌지요. 지나가던 사람들은 그 소리를 듣고 걸음을 멈추었답니다."
                ]
            }
        ],
        "moral": "혼자서는 쫓겨난 넷이었지만, 함께 서니 아무도 당해 내지 못했답니다."
    }
];
    ...
    spreads: [
        {
            art: 'end.webp',
            left: [
                "독일 브레멘에는 네 마리가 겹쳐 올라선 동상이 서 있습니다. 이 이야기에서 나온 것이지요.",
                "넷은 모두 쓸모없다며 버림받은 짐승들입니다. 당나귀와 개와 고양이는 늙어서, 수탉은 잔칫상에 오르게 되어 집을 떠났지요.",
                "넷은 브레멘에 끝내 닿지 못합니다. 가는 길에 집을 찾았으니까요. 목적지보다 도중에 만난 것이 좋았던 것입니다.",
                "도둑을 쫓아낸 방법도 다시 보십시오. 싸운 것이 아닙니다. 넷이 겹쳐 서서 한꺼번에 소리를 냈을 뿐이지요."
            ],
            right: [
                "혼자서는 아무도 못 했을 일입니다. 당나귀 울음만으로도, 닭 울음만으로도 안 되었을 테니까요.",
                "넷은 왜 브레멘까지 가지 않았을까요?"
            ]
        }
    ]
...
const EN = {
    ...
    chapters: [
        {
            num: 1,
            title: 'Chapter 1 · The Old Donkey',
            beats: [
                {
                    art: '01-donkey.webp',
                    emoji: '🫏',
        ...
        {
            num: 2,
            title: 'Chapter 2 · The Dog on the Road',
            beats: [
                {
                    art: '02-dog.webp',
                    emoji: '🐕',
        ...
        {
            num: 3,
            title: 'Chapter 3 · The Cat and the Cockerel',
            beats: [
                {
                    art: '03-four.webp',
                    emoji: '🐈',
        ...
        {
            num: 4,
            title: 'Chapter 4 · The Light in the Wood',
            beats: [
                {
                    art: '04-light.webp',
                    emoji: '🌲',
        ...
        {
            num: 5,
            title: "Chapter 5 · The Robbers' Table",
            beats: [
                {
                    art: '05-robbers.webp',
                    emoji: '🍖',
        ...
        {
            num: 7,
            title: 'Chapter 7 · A Robber Comes Back',
            beats: [
                {
                    art: '07-return.webp',
                    emoji: '🔥',
        ...
        {
            num: 8,
            title: 'Chapter 8 · They Never Got to Bremen',
            beats: [
                {
                    art: '08-ending.webp',
                    emoji: '🏡',
        ...
        spreads: [
            {
                ...
                right: [
                    "Not one of them could have done it alone. A donkey braying by itself would not have done it, nor a cockerel crowing by itself.",
                    "Why do you think they never went on to Bremen?"
                ]
            }
        ]
    },
    words: {
        ...
        '01-donkey.webp': [
            ...
            { word: 'mill', meaning: '방앗간', sentence: 'He went between the mill and the market.' },
            { word: 'grain', meaning: '곡식', sentence: 'With sacks of grain on his back.' },
            { word: 'ache', meaning: '시큰거리다', sentence: 'His legs shook and his back ached.' },
            { word: 'barn', meaning: '헛간', sentence: 'One day, resting in the barn, he heard a voice.' }
        ],
        '01-donkey-2.webp': [
            { word: 'no use', meaning: '쓸모없는', sentence: "He's no use to us now." },
            { word: 'make up one’s mind', meaning: '마음을 정하다', sentence: 'He turned it over and made up his mind.' },
            { word: 'slip away', meaning: '슬그머니 빠져나가다', sentence: 'Before dawn he slipped quietly away.' },
            { word: 'clear one’s throat', meaning: '목청을 가다듬다', sentence: 'The donkey cleared his throat.' },
            { word: 'ring', meaning: '울려 퍼지다', sentence: 'It rang all through the wood.' }
        ],
        '02-dog.webp': [
            { word: 'pant', meaning: '헐떡이다', sentence: 'He was panting.' },
            { word: 'coat', meaning: '털', sentence: 'His coat had come out in patches.' },
            { word: 'hollow', meaning: '홀쭉한', sentence: 'His sides were hollow.' },
            { word: 'turn out', meaning: '내쫓다', sentence: 'My master turned me out.' }
        ],
        '02-dog-2.webp': [
            { word: 'hoof', meaning: '발굽', sentence: 'The donkey tapped the ground with a front hoof.' },
            { word: 'bark', meaning: '짖다', sentence: 'All I can do is bark.' },
            { word: 'puzzled', meaning: '어리둥절한', sentence: 'The dog looked up at him, quite puzzled.' },
            { word: 'grin', meaning: '슬며시 웃다', sentence: 'And then he grinned.' },
            { word: 'to and fro', meaning: '살랑살랑', sentence: "The dog's tail went to and fro." }
        ],
        '03-four.webp': [
        ...
        '03-four-2.webp': [
            ...
            { word: 'ridiculous', meaning: '말도 안 되는', sentence: 'They want you for the table? Ridiculous.' }
        ],
        '04-light.webp': [
            { word: 'settle oneself', meaning: '자리를 잡다', sentence: 'They settled themselves under a big tree.' },
            { word: 'out of habit', meaning: '습관처럼', sentence: 'The cockerel looked all round him, out of habit.' },
            { word: 'walk it', meaning: '걸어갈 만하다', sentence: 'No — we could walk it!' }
        ],
        '04-light-2.webp': [
            { word: 'crackle', meaning: '바스락거리다', sentence: 'Dry leaves crackled underfoot.' },
        ...
        '05-robbers.webp': [
            ...
            { word: 'sack', meaning: '자루', sentence: 'In the corner stood several heavy sacks.' },
            { word: 'swallow hard', meaning: '침을 꼴깍 삼키다', sentence: 'The donkey swallowed hard.' },
            { word: 'rumble', meaning: '꼬르륵거리다', sentence: 'Their stomachs rumbled.' }
        ],
        '05-robbers-2.webp': [
        ...
        '06-noise.webp': [
            ...
            { word: 'racket', meaning: '요란한 소리', sentence: 'It was such a racket.' },
            { word: 'in fright', meaning: '놀라서', sentence: 'Birds went up in fright.' },
            { word: 'shoot to one’s feet', meaning: '벌떡 일어서다', sentence: 'The robbers shot to their feet.' }
        ],
        '06-noise-2.webp': [
        ...
        '07-return-2.webp': [
            { word: 'go for', meaning: '덤벼들다', sentence: 'The cat went for his face.' },
        ...
        '08-ending.webp': [
            ...
            { word: 'rake', meaning: '할퀴다', sentence: 'A witch raked my face with her nails.' },
            { word: 'club', meaning: '몽둥이', sentence: 'One with a club was waiting in the yard.' },
            { word: 'knock flat', meaning: '때려눕히다', sentence: 'And knocked me flat.' },
            { word: 'leave alone', meaning: '그냥 두다', sentence: 'Best leave that house alone.' }
        ],
        '08-ending-2.webp': [
        ...
        'end.webp': [
            { word: 'statue', meaning: '동상', sentence: 'There is a statue in Bremen of the four of them.' },
            { word: 'one on top of another', meaning: '겹쳐 올라선', sentence: 'Standing one on top of another.' },
            { word: 'useful', meaning: '쓸모 있는', sentence: 'Every one of them was useful once.' },
            { word: 'get rid of', meaning: '쫓아내다', sentence: 'How they got rid of the robbers.' },
            { word: 'bray', meaning: '(당나귀가) 울다', sentence: 'A donkey braying by itself would not have done it.' }
        ]
    }
};
...
const WORDS_KO = {
    "cover.webp": [
        { w: "처지", k: "지금 놓여 있는 딱한 형편.", s: "나이가 들어 쫓겨날 처지가 된 짐승 넷이 길에서 만나 함께 브레멘으로 떠나요." },
        { w: "짐승", k: "사람이 아닌 동물을 가리키는 말.", s: "늙은 짐승 넷이 모여 무엇을 할 수 있을까요?" }
    ],
    "01-donkey.webp": [
        { w: "거르다", k: "차례를 빼놓고 지나가다.", s: "하루도 거른 날이 없었습니다." },
        { w: "장터", k: "물건을 사고파는 장이 열리는 곳.", s: "곡식 자루를 등에 지고 방앗간과 장터를 오갔지요." },
        { w: "후들거리다", k: "힘이 없어 다리가 자꾸 떨리다.", s: "다리가 후들거리고 등이 시큰거렸지요." },
        { w: "얼굴이 굳다", k: "못마땅해서 웃음기가 사라지다.", s: "주인의 얼굴이 점점 굳어 갔지요." }
    ],
    "01-donkey-2.webp": [
        { w: "축내다", k: "먹거나 써서 줄어들게 하다.", s: "\"이제 저놈은 쓸모가 없구나. 먹이만 축내는걸.\"" },
        { w: "가슴이 서늘해지다", k: "겁이 나서 가슴이 차가워지는 느낌이 들다.", s: "가슴이 서늘해졌지요." },
        { w: "우렁차다", k: "소리가 크고 힘차다.", s: "제법 우렁차서 숲이 쩌렁쩌렁 울렸습니다." },
        { w: "악사", k: "악기를 연주하거나 노래를 하는 사람.", s: "\"이만하면 됐다. 브레멘으로 가서 노래하는 악사가 되자.\"" }
    ],
    "02-dog.webp": [
        { w: "늘어지다", k: "힘없이 축 처져 있다.", s: "길가에 무언가 늘어져 있었지요." },
        { w: "옆구리", k: "허리의 양쪽 옆.", s: "털이 여기저기 빠져 있었고 옆구리가 홀쭉했지요." },
        { w: "자네", k: "친한 사이에서 어른이 상대를 부르는 말.", s: "\"자네는 왜 그러고 있나?\"" },
        { w: "남의 일 같지 않다", k: "내 일처럼 마음에 걸리다.", s: "남의 일 같지가 않았지요." }
    ],
    "02-dog-2.webp": [
        { w: "마침", k: "때가 딱 맞게.", s: "\"마침 잘됐군. 나와 브레멘에 가서 악사가 되세.\"" },
        { w: "몸을 일으키다", k: "앉았거나 누운 몸을 세우다.", s: "앞발에 힘을 주고 천천히 몸을 일으켰습니다." },
        { w: "맡다", k: "어떤 일을 하기로 하다.", s: "\"아주 좋아. 자네는 북을 맡게.\"" }
    ],
    "03-four.webp": [
        { w: "돌담", k: "돌을 쌓아 만든 담.", s: "길가 돌담 위에 고양이가 앉아 있었지요." },
        { w: "사흘", k: "세 날. 삼 일.", s: "사흘은 굶은 얼굴이었지요." },
        { w: "무뎌지다", k: "날이 닳아 잘 들지 않게 되다.", s: "\"이가 무뎌져서 쥐를 못 잡는다고 주인이 저를 내쫓았어요. 이제 저는 갈 곳도 없습니다.\"" },
        { w: "사뿐", k: "소리 없이 가볍게.", s: "그러고는 담에서 사뿐 내려왔습니다." }
    ],
    "03-four-2.webp": [
        { w: "중천", k: "하늘의 한가운데.", s: "해도 이미 중천인데 무슨 일인가 싶었습니다." },
        { w: "잔칫상", k: "잔치 때 차리는 음식상.", s: "\"내일 잔칫상에 오른다지 뭡니까! 마지막으로 실컷 울어나 보려고요.\"" },
        { w: "고개를 젓다", k: "아니라는 뜻으로 머리를 옆으로 흔들다.", s: "당나귀가 고개를 저었습니다." },
        { w: "퍼덕이다", k: "날개를 힘차게 치다.", s: "그러다 크게 날개를 퍼덕이며 담에서 내려왔지요." }
    ],
    "04-light.webp": [
        { w: "밤을 맞다", k: "밤이 되어 그곳에서 밤을 지내게 되다.", s: "해가 지고 넷은 숲에서 밤을 맞았습니다." },
        { w: "닿다", k: "가서 이르다.", s: "하루 만에 닿을 거리가 아니었습니다." },
        { w: "둘레", k: "어떤 것을 빙 둘러싼 가까운 곳.", s: "수탉은 꼭대기에서 습관처럼 둘레를 살펴보았습니다." }
    ],
    "04-light-2.webp": [
        { w: "헤치다", k: "앞을 막는 것을 밀어 젖히며 나아가다.", s: "한참을 헤치고 나아가자 숲이 트였습니다." },
        { w: "오두막", k: "작고 허름하게 지은 집.", s: "빈터 한가운데 작은 오두막이 서 있었지요." },
        { w: "어림없다", k: "될 가망이 조금도 없다.", s: "개도 고양이도 수탉도 어림없었습니다." },
        { w: "걸치다", k: "한쪽을 무엇에 얹어 놓다.", s: "당나귀가 앞발을 창턱에 걸치고 안을 들여다보았습니다." }
    ],
    "05-robbers.webp": [
        { w: "사내", k: "남자를 이르는 말.", s: "방 안에는 사내 셋이 있었습니다." },
        { w: "묵직하다", k: "보기보다 꽤 무겁다.", s: "구석에는 묵직한 자루가 몇 개 쌓여 있었지요." },
        { w: "한눈에", k: "한 번 보아서 바로.", s: "한눈에 보아도 도둑들이었습니다." },
        { w: "산더미", k: "아주 많이 쌓여 있는 것.", s: "\"먹을 게 산더미일세. 저 정도면 우리 넷도 배부르게 먹겠는걸.\"" }
    ],
    "05-robbers-2.webp": [
        { w: "머리를 맞대다", k: "여럿이 모여 함께 생각하다.", s: "넷은 창 밑에 모여 머리를 맞댔습니다." },
        { w: "좀처럼", k: "여간해서는. 쉽게는.", s: "좀처럼 좋은 수가 떠오르지 않았지요." },
        { w: "무릎을 치다", k: "좋은 생각이 갑자기 떠오르다.", s: "한참 만에 당나귀가 무릎을 쳤습니다." },
        { w: "들이켜다", k: "숨이나 물을 한꺼번에 세게 마시다.", s: "넷은 숨을 크게 들이켰습니다." }
    ],
    "06-noise.webp": [
        { w: "목청을 높이다", k: "목소리를 아주 크게 내다.", s: "넷이 한꺼번에 목청을 높였습니다." },
        { w: "와장창", k: "단단한 것이 한꺼번에 부서지는 소리.", s: "유리창이 와장창 깨졌지요." },
        { w: "내던지다", k: "손에 든 것을 아무렇게나 던지다.", s: "도둑들은 숟가락을 내던지고 튀어 올랐지요." },
        { w: "뛰쳐나가다", k: "갑자기 밖으로 달려 나가다.", s: "셋은 서로 부딪치며 문밖으로 뛰쳐나갔습니다." }
    ],
    "06-noise-2.webp": [
        { w: "저편", k: "저쪽 너머.", s: "도둑들이 숲 저편으로 달아났습니다." },
        { w: "이내", k: "얼마 지나지 않아 곧.", s: "발소리가 한참 들리다 이내 조용해졌지요." },
        { w: "둘러앉다", k: "여럿이 동그랗게 모여 앉다.", s: "그러고는 누가 먼저랄 것도 없이 상 앞에 둘러앉았습니다." },
        { w: "저마다", k: "각각 자기 나름대로.", s: "넷은 불을 끄고 저마다 편한 자리를 찾았습니다." },
        { w: "아궁이", k: "불을 때려고 낸 부엌 구멍.", s: "고양이는 아궁이 앞에, 수탉은 지붕에 자리를 잡았지요." }
    ],
    "07-return.webp": [
        { w: "한밤중", k: "깊은 밤.", s: "한밤중이었습니다." },
        { w: "살그머니", k: "남이 모르게 가만히.", s: "결국 그 도둑이 살그머니 오두막으로 돌아왔습니다." },
        { w: "갖다 대다", k: "바짝 가까이 붙이다.", s: "도둑은 반가운 마음에 초를 갖다 댔지요." }
    ],
    "07-return-2.webp": [
        { w: "비명", k: "몹시 놀라거나 아플 때 지르는 소리.", s: "도둑이 비명을 지르며 뒷문으로 달아났지요." },
        { w: "하필", k: "어째서 꼭 그렇게.", s: "그런데 하필 문 앞에 개가 엎드려 있었습니다." },
        { w: "펄쩍", k: "갑자기 힘차게 뛰어오르는 모양.", s: "도둑은 펄쩍 뛰어 마당으로 굴러 나갔습니다." },
        { w: "엉덩방아를 찧다", k: "뒤로 넘어져 엉덩이를 바닥에 부딪다.", s: "도둑이 담 너머로 붕 날아가 엉덩방아를 찧었지요." }
    ],
    "08-ending.webp": [
        { w: "벌벌 떨다", k: "무서워서 몸을 자꾸 떨다.", s: "도둑은 두목에게 달려가 벌벌 떨며 말했습니다." },
        { w: "마귀할멈", k: "이야기에 나오는, 나쁜 힘을 쓰는 늙은 여자.", s: "마귀할멈이 손톱으로 얼굴을 할퀴었고, 문가에서는 칼 든 자가 다리를 찔렀습니다." },
        { w: "재판관", k: "죄가 있는지 없는지를 가려 정하는 사람.", s: "게다가 지붕에서 재판관이 잡아가라고 소리쳤습니다!" },
        { w: "절레절레", k: "머리를 옆으로 자꾸 흔드는 모양.", s: "두목은 고개를 절레절레 저었습니다." }
    ],
    "08-ending-2.webp": [
        { w: "둘러보다", k: "이곳저곳을 두루 살펴보다.", s: "넷은 오두막을 천천히 둘러보았지요." },
        { w: "뜰", k: "집 안에 있는 넓은 마당.", s: "뜰에는 우물과 텃밭이 있고, 헛간에는 마른 짚까지 쌓여 있었지요." }
    ],
    "end.webp": [
        { w: "동상", k: "사람이나 짐승을 쇠붙이로 만들어 세운 것.", s: "독일 브레멘에는 네 마리가 겹쳐 올라선 동상이 서 있습니다." },
        { w: "목적지", k: "가려고 하는 곳.", s: "목적지보다 도중에 만난 것이 좋았던 것입니다." },
        { w: "끝내", k: "마지막까지 가서도.", s: "넷은 브레멘에 끝내 닿지 못합니다." }
    ]
};
