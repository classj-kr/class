        ...
        "beats": [
            {
                ...
                "right": [
                    ...
                    "공주는 날마다 그 연못가 보리수 아래에서 놀았습니다. 그늘이 시원하고 물소리가 좋았거든요. 개구리 우는 소리도 심심찮게 들렸습니다."
                ]
            },
            {
                "art": "01-ball-2.webp",
                ...
                "left": [
                    ...
                    "한 번, 두 번, 세 번.",
                    "공은 해를 받아 반짝반짝 빛났지요. 공주는 그 빛을 보는 것이 제일 좋았습니다.",
                    "그런데 네 번째였지요."
                ],
                "right": [
                    "공이 손끝을 스치고 옆으로 튀었습니다. 데구루루 굴러 연못으로 빠져 버렸지요. 풍덩 소리와 함께 공이 저만치 떠내려갔지요.",
                    "\"어떡해, 내 공!\"",
                    "공주는 주저앉아 울음을 터뜨렸습니다. 손을 뻗어 봐도 공은 자꾸 멀어졌지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "나뭇잎 사이로 저녁 해가 기울었습니다. 이제 곧 어두워질 참이었지요.",
                    "그때 물결이 일렁거렸습니다. 무언가가 물 위로 고개를 쏙 내밀었지요."
                ],
                "right": [
                    "커다란 눈을 가진 개구리 한 마리였습니다. 공주는 깜짝 놀라 뒤로 물러섰지요.",
                    "그런데 개구리가 제법 점잖은 목소리로 말을 했습니다. \"공주님, 왜 그렇게 우십니까?\"",
                    "공주는 우는 것도 잊고 개구리를 빤히 보았습니다."
                ]
            },
            {
                "art": "02-frog-2.webp",
                "emoji": "🐸",
                "left": [
                    "공주는 눈물을 닦고 대답했습니다. \"공이 연못에 빠졌어. 너무 깊어서 꺼낼 수가 없어.\"",
                    "개구리가 눈을 껌뻑이더니 짧은 앞발로 물을 툭 쳤지요. \"저라면 꺼내 드릴 수 있습니다. 대신 약속을 하나 해 주십시오.\""
                ],
                "right": [
                    "공주는 벌떡 일어났습니다. \"무엇이든 해 줄게. 보석도 왕관도 줄게!\"",
                    "그런데 개구리는 천천히 고개를 저었습니다. \"저는 그런 건 필요 없습니다.\""
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "🤝",
                "left": [
                    "개구리는 물 위에 가만히 떠서 공주를 똑바로 보며 말했습니다.",
                    "\"저를 친구로 삼아 주십시오. 한 밥상에서 밥을 먹고, 같은 방에서 자게 해 주십시오. 그렇게 해 주시면 공을 꺼내 오겠습니다.\""
                ],
                "right": [
                    "공주는 속으로 코웃음을 쳤습니다. 개구리가 무슨 수로 궁궐까지 오겠나 싶었지요. 연못에서 궁궐까지는 한참 걸어야 했습니다.",
                    "개구리 걸음으로는 어림도 없어 보였지요. 공주는 건성으로 고개를 끄덕였습니다. \"그래, 그러자. 얼른 꺼내 오기나 해.\""
                ]
            },
            {
                ...
                "left": [
                    "개구리는 물속으로 쏙 들어갔습니다.",
                    "한참 뒤 입에 공을 물고 떠올랐지요. 물방울이 등에서 뚝뚝 떨어졌습니다. 개구리는 공을 풀밭 위에 놓아 주었지요.",
                    "공주는 공을 얼른 집어 들었습니다. 그러고는 뒤도 돌아보지 않고 달려갔지요."
                ],
                "right": [
                    "개구리가 뒤에서 소리쳤습니다. \"공주님, 저도 데려가 주십시오!\"",
                    "하지만 개구리 걸음으로는 따라갈 수가 없었지요. 공주는 그대로 궁궐로 돌아갔습니다.",
                    "그날 밤 공주는 개구리를 까맣게 잊었지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "김이 오르는 그릇이 죽 늘어서 있었습니다. 공주는 어제 일을 까맣게 잊고 있었지요.",
                    "그때 문에서 소리가 났습니다.",
                    "톡, 톡, 톡."
                ],
                "right": [
                    "이어서 낯익은 목소리가 들려왔지요. \"공주님, 문을 열어 주십시오.\"",
                    "공주는 숟가락을 떨어뜨렸습니다. 어제 일이 그제야 떠올랐지요.",
                    "공주는 가슴이 쿵쿵 뛰는 채로 문 쪽으로 걸어갔습니다."
                ]
            },
            {
                "art": "04-knock-2.webp",
                "emoji": "🚪",
                "left": [
                    "문을 연 공주는 그대로 얼어붙었습니다. 문턱에 개구리가 앉아 있었으니까요. 연못에서부터 먼 길을 뛰어온 모양이었습니다.",
                    "몸에는 흙이 잔뜩 묻어 있었지요. 발끝에는 마른 풀이 붙어 있었습니다.",
                    "공주는 문을 쾅 닫고 돌아왔습니다. 얼굴이 하얗게 질렸지요. 문밖에서 또 톡톡 소리가 났습니다."
                ],
                "right": [
                    "공주는 자리에 앉았지만 손이 덜덜 떨렸습니다.",
                    "언니가 옆에서 물었지요. \"왜 그러니?\" 공주는 대답을 하지 못했습니다.",
                    "온 식구가 숟가락을 놓고 공주를 쳐다보았습니다. 밥상이 조용해졌지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "👑",
                "left": [
                    "임금님이 딸의 얼굴을 보고 물었습니다. \"무슨 일이냐. 무엇이 그리 무서우냐.\"",
                    "공주는 얼른 대답하지 못했습니다. 개구리 이야기를 어떻게 꺼내야 할지 몰랐거든요.",
                    "임금님이 농담처럼 다시 물었습니다. \"혹시 거인이라도 서 있더냐?\""
                ],
                "right": [
                    "공주가 겨우 대답했지요. \"거인은 아니고요…… 개구리예요.\"",
                    "임금님이 숟가락을 내려놓았습니다. 언니들은 서로 눈짓을 주고받았지요. 공주는 하는 수 없이 어제 일을 이야기했습니다.",
                    "공을 빠뜨린 것부터 약속한 것까지 다 말했습니다. 말하면서도 얼굴이 화끈거렸지요. 왜 그런 약속을 했을까 후회가 되었습니다."
                ]
            },
            {
                "art": "05-king-2.webp",
                "emoji": "👑",
                "left": [
                    "임금님은 잠시 말이 없었습니다. 그러다 수염을 한 번 쓸고 조용히 입을 열었지요.",
                    "\"네가 한 약속이면 지켜야 하지 않겠느냐. 어려울 때 도와준 이를 모른 척해서는 안 된다.\"",
                    "목소리는 낮았지만 단단했습니다."
                ],
                "right": [
                    "공주는 발끝만 내려다보았습니다. 대꾸할 말이 없었지요.",
                    "아버지 말이 옳다는 것을 알고 있었으니까요. 결국 공주는 다시 문으로 갔습니다.",
                    "문을 열자 개구리가 그대로 앉아 있었습니다. 공주가 작은 목소리로 말했지요. \"들어와도 좋아.\""
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "개구리가 눈을 껌뻑였습니다. \"공주님 접시를 이리로 밀어 주십시오. 함께 먹기로 하지 않았습니까.\""
                ],
                "right": [
                    "젖은 발자국이 식탁보에 콕콕 찍혔지요. 공주는 인상을 잔뜩 찌푸렸습니다. 그래도 임금님이 보고 있어 접시를 슬그머니 밀어 주었지요.",
                    "개구리는 아주 맛있게 먹었습니다. 공주는 한 숟가락도 넘기지 못했지요. 언니들은 웃음을 참느라 애를 썼습니다.",
                    "임금님만 아무렇지 않게 밥을 드셨지요."
                ]
            },
            {
                ...
                "emoji": "🍽️",
                "left": [
                    "개구리가 배를 두드렸습니다. \"잘 먹었습니다. 이제 자러 갈까요?\"",
                    "\"뭐라고?\" 공주가 의자를 밀며 벌떡 일어섰습니다. 얼굴이 새빨개졌지요."
                ],
                "right": [
                    "공주가 임금님을 돌아보며 소리쳤습니다. \"개구리랑 한방에서 자라고요?\"",
                    "임금님이 헛기침을 했습니다. 공주는 입을 다물 수밖에 없었지요. 약속은 약속이었으니까요.",
                    "공주는 결국 개구리를 손끝으로 집어 들었습니다. 그러고는 팔을 쭉 뻗은 채 계단을 올라갔지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "🛏️",
                "left": [
                    "공주는 방에 들어서자마자 개구리를 구석 마룻바닥에 내려놓았습니다. 푹신한 잠자리에서 한참 떨어진 곳이었지요. 바닥은 손이 시릴 만큼 차가웠습니다.",
                    "\"거기 있어. 절대 올라오지 마.\"",
                    "공주는 이불을 머리끝까지 덮고 누웠습니다. 개구리는 대꾸가 없었지요. 방 안이 아주 조용해졌습니다."
                ],
                "right": [
                    "공주는 이불 속에서 눈을 감았습니다. 창밖에서 바람이 스쳐 지나갔지요.",
                    "그런데 자꾸 구석 쪽이 마음에 걸려 잠이 오지 않았습니다.",
                    "임금님이 한 말이 자꾸 떠올랐지요. \"어려울 때 도와준 이를 모른 척해서는 안 된다.\""
                ]
            },
            {
                "art": "07-room-2.webp",
                "emoji": "🛏️",
                "left": [
                    "한참 뒤 공주가 몸을 일으켰습니다. 촛불을 들고 구석으로 가 보았지요. 개구리는 차가운 마룻바닥에 웅크리고 있었습니다.",
                    "그 작은 몸이 조금씩 떨렸지요. 연못에서 여기까지 뛰어오느라 발도 여기저기 까져 있었습니다.",
                    "공주는 한숨을 쉬었습니다. 그러고는 개구리를 두 손으로 감싸 올렸지요."
                ],
                "right": [
                    "공주가 작게 말했습니다. \"……미안해. 약속은 약속이니까.\"",
                    "개구리는 여전히 아무 말이 없었지요. 공주는 그 등을 손가락으로 살살 쓸어 주었습니다.",
                    "공주는 개구리를 베개 옆에 살며시 내려놓았습니다. 그러자 개구리가 그제야 웅크렸던 몸을 폈지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    "그 순간이었습니다.",
                    "방 안이 대낮처럼 환해졌습니다. 공주는 눈이 부셔 두 손으로 얼굴을 가렸지요. 무슨 일이 났나 싶었습니다.",
                    "빛이 사라지고 나서야 다시 눈을 떴습니다. 방 안 공기가 달라져 있었지요. 촛불이 저 혼자 흔들렸습니다."
                ],
                "right": [
            ...
            },
            {
                ...
                "right": [
                    "왕자와 공주를 태운 마차가 달리는데 뒤에서 툭, 툭 소리가 났지요. 왕자가 놀라 물었습니다. \"무엇이 부러진 소리냐?\"",
                    "하인리히가 대답했지요. \"제 가슴을 조이던 쇠테입니다. 이제 필요 없지요.\"",
                    "두 사람은 오래오래 사이좋게 살았답니다."
                ]
            }
        ],
        "moral": "가볍게 한 약속도 약속이라, 지키는 순간에야 그 값이 드러난답니다."
    }
];
    ...
    spreads: [
        {
            ...
            left: [
                ...
                "그런데 개구리는 궁궐까지 뛰어옵니다. 잊지 않은 쪽은 개구리였지요.",
...
/* 영어판 — 한국어 원고를 줄 단위로 옮기지 않고 영어로 다시 썼다.
   충직한 하인리히는 원작 이름 그대로 Faithful Henry 로 둔다. */
const EN = {
    lang: 'en',
    cover: {
    ...
    chapters: [
        {
            ...
            beats: [
                ...
                },
                {
                    ...
                    emoji: '🟡',
                    left: [
                        "That day too the princess threw the ball high and caught it.",
                        "Once, twice, three times.",
                        "The ball flashed in the sunlight,",
                        "and that flash was the thing she liked best about it.",
                        "And then came the fourth time."
                    ],
                    right: [
                        "The ball grazed her fingers and went off sideways.",
                        "It rolled away and dropped into the pond.",
        ...
        {
            num: 2,
            title: 'Chapter 2 · A Voice from the Pond',
            beats: [
                {
                    art: '02-frog.webp',
                    emoji: '🐸',
                    left: [
                        "The princess cried for a long while.",
                        "Crying did not bring the ball back up.",
                        "The evening sun slanted down through the leaves.",
                        "It would be dark before long.",
                        "And then the water rippled,",
                        "and something put its head out."
                    ],
                    right: [
        ...
        {
            num: 3,
            title: 'Chapter 3 · An Easy Promise',
            beats: [
                {
                    art: '03-promise.webp',
                    emoji: '🤝',
                ...
                },
                {
                    ...
                    emoji: '🤝',
                    left: [
                        "The frog went straight down into the water.",
                        "A long while later he came up with the ball in his mouth.",
                        "The water ran off his back in drops,",
                        "and he set the ball down on the grass.",
                        "The princess snatched it up",
        ...
        {
            num: 4,
            title: 'Chapter 4 · A Knock at the Door',
            beats: [
                {
                    art: '04-knock.webp',
                    emoji: '🚪',
                    left: [
                        ...
                        "The whole family was sitting round the great table,",
                        "with steaming dishes set out in a row.",
                        "The princess had put the day before quite out of her mind.",
        ...
        {
            num: 5,
            title: 'Chapter 5 · What the King Said',
            beats: [
                {
                    art: '05-king.webp',
                    emoji: '👑',
                    left: [
                        "The king looked at his daughter's face and asked,",
                        "\"What is it? What has frightened you so?\"",
                        "The princess could not answer straight away.",
                        "She did not know how to begin about the frog.",
        ...
        {
            num: 7,
            title: 'Chapter 7 · Inside the Room',
            beats: [
                {
                    art: '07-room.webp',
                    emoji: '🕯️',
        ...
        {
            num: 8,
            title: 'Chapter 8 · The Spell Broken',
            beats: [
                {
                    art: '08-ending.webp',
                    emoji: '✨',
        ...
        spreads: [
            {
                ...
                right: [
                    "The princess did not dislike the frog out of spite. He was damp and strange to her. Disliking something and keeping a promise are two separate things.",
                    "What should the princess have done at the pond?"
                ]
            }
        ]
    },
    words: {
        ...
        '01-ball-2.webp': [
            ...
            { word: 'graze', meaning: '스치다', sentence: 'The ball grazed her fingers.' },
            { word: 'splash', meaning: '풍덩 소리', sentence: 'There was a splash, and the ball was gone.' },
        ...
        '02-frog-2.webp': [
            ...
            { word: 'blink', meaning: '눈을 껌뻑이다', sentence: 'The frog blinked.' },
            { word: 'fetch out', meaning: '꺼내 오다', sentence: 'I could fetch it out for you.' },
            { word: 'have no use for', meaning: '필요 없다', sentence: 'I have no use for such things.' }
        ],
        '03-promise.webp': [
        ...
        '03-promise-2.webp': [
            ...
            { word: 'set down', meaning: '내려놓다', sentence: 'He set the ball down on the grass.' },
            { word: 'snatch up', meaning: '얼른 집어 들다', sentence: 'The princess snatched it up.' },
            { word: 'keep up', meaning: '따라가다', sentence: "A frog's legs could not keep up." }
        ],
        '04-knock.webp': [
            { word: 'steaming', meaning: '김이 오르는', sentence: 'Steaming dishes set out in a row.' },
            { word: 'put out of one’s mind', meaning: '까맣게 잊다', sentence: 'She had put the day before out of her mind.' },
            { word: 'thump', meaning: '쿵쿵 뛰다', sentence: 'Her heart was thumping.' },
        ...
        '06-dinner-2.webp': [
            ...
            { word: 'I beg your pardon', meaning: '뭐라고요', sentence: 'I beg your pardon?' },
            { word: 'scarlet', meaning: '새빨간', sentence: 'Her face went scarlet.' },
            { word: 'at arm’s length', meaning: '팔을 뻗은 채', sentence: 'Holding him out at arm’s length.' }
        ],
        '07-room.webp': [
        ...
        'end.webp': [
            { word: 'stand first', meaning: '맨 앞에 실려 있다', sentence: 'This story stands first in the collection.' },
            { word: 'cost nothing', meaning: '아무것도 들지 않다', sentence: 'The promise cost her nothing.' },
            { word: 'intention', meaning: '생각, 의도', sentence: 'She had no intention of keeping it.' },
            { word: 'scold', meaning: '나무라다', sentence: 'The king does not scold his daughter.' },
            { word: 'out of spite', meaning: '미워서', sentence: 'She did not dislike the frog out of spite.' }
        ]
    }
};
...
const WORDS_KO = {
    "cover.webp": [
        { w: "펴내다", k: "책이나 글을 만들어 세상에 내놓다.", s: "독일의 그림 형제가 1812년에 펴낸 옛이야기 모음집의 맨 첫 번째 이야기예요." },
        { w: "전부", k: "빠짐없이 모두.", s: "한 번 한 약속을 지키느냐 마느냐가 이야기의 전부라고 할 만해요." }
    ],
    "01-ball.webp": [
        { w: "막내딸", k: "맨 마지막에 태어난 딸.", s: "임금님의 막내딸이었습니다." },
        { w: "머리맡", k: "누웠을 때 머리가 닿는 쪽.", s: "공주는 그 공을 잠잘 때도 머리맡에 두었습니다." },
        { w: "심심찮게", k: "가끔이 아니라 꽤 자주.", s: "개구리 우는 소리도 심심찮게 들렸습니다." }
    ],
    "01-ball-2.webp": [
        { w: "데구루루", k: "둥근 것이 굴러가는 모양.", s: "데구루루 굴러 연못으로 빠져 버렸지요." },
        { w: "저만치", k: "저쪽으로 조금 떨어진 곳에.", s: "풍덩 소리와 함께 공이 저만치 떠내려갔지요." },
        { w: "주저앉다", k: "서 있다가 힘없이 그 자리에 앉다.", s: "공주는 주저앉아 울음을 터뜨렸습니다." }
    ],
    "02-frog.webp": [
        { w: "해가 기울다", k: "해가 서쪽으로 넘어가다.", s: "나뭇잎 사이로 저녁 해가 기울었습니다." },
        { w: "참", k: "무엇이 일어나려는 바로 그때.", s: "이제 곧 어두워질 참이었지요." },
        { w: "제법", k: "생각보다 꽤.", s: "그런데 개구리가 제법 점잖은 목소리로 말을 했습니다." },
        { w: "빤히", k: "눈을 떼지 않고 똑바로.", s: "공주는 우는 것도 잊고 개구리를 빤히 보았습니다." }
    ],
    "02-frog-2.webp": [
        { w: "벌떡", k: "갑자기 힘차게 일어나는 모양.", s: "공주는 벌떡 일어났습니다." },
        { w: "왕관", k: "임금이 머리에 쓰는 꾸민 모자.", s: "\"무엇이든 해 줄게. 보석도 왕관도 줄게!\"" },
        { w: "고개를 젓다", k: "머리를 옆으로 흔들어 아니라고 하다.", s: "그런데 개구리는 천천히 고개를 저었습니다." }
    ],
    "03-promise.webp": [
        { w: "밥상", k: "밥과 반찬을 놓고 먹는 상.", s: "한 밥상에서 밥을 먹고, 같은 방에서 자게 해 주십시오." },
        { w: "코웃음을 치다", k: "우습게 여겨 속으로 비웃다.", s: "공주는 속으로 코웃음을 쳤습니다." },
        { w: "무슨 수로", k: "어떤 방법으로.", s: "개구리가 무슨 수로 궁궐까지 오겠나 싶었지요." },
        { w: "건성으로", k: "마음을 쓰지 않고 대충.", s: "공주는 건성으로 고개를 끄덕였습니다." }
    ],
    "03-promise-2.webp": [
        { w: "물다", k: "입에 넣어 꽉 잡다.", s: "한참 뒤 입에 공을 물고 떠올랐지요." },
        { w: "뒤도 돌아보지 않다", k: "뒤에 남은 것을 아예 살피지 않다.", s: "그러고는 뒤도 돌아보지 않고 달려갔지요." }
    ],
    "04-knock.webp": [
        { w: "식구", k: "한집에서 함께 사는 사람들.", s: "온 식구가 커다란 밥상에 둘러앉았지요." },
        { w: "죽", k: "줄지어 길게.", s: "김이 오르는 그릇이 죽 늘어서 있었습니다." },
        { w: "낯익다", k: "여러 번 보아 눈에 익다.", s: "이어서 낯익은 목소리가 들려왔지요." }
    ],
    "04-knock-2.webp": [
        { w: "모양이다", k: "그런 것 같다는 뜻으로 쓰는 말.", s: "연못에서부터 먼 길을 뛰어온 모양이었습니다." },
        { w: "하얗게 질리다", k: "놀라서 낯빛이 하얗게 변하다.", s: "얼굴이 하얗게 질렸지요." },
        { w: "숟가락을 놓다", k: "밥 먹기를 그치다.", s: "온 식구가 숟가락을 놓고 공주를 쳐다보았습니다." }
    ],
    "05-king.webp": [
        { w: "거인", k: "몸이 아주 큰 사람.", s: "\"혹시 거인이라도 서 있더냐?\"" },
        { w: "눈짓", k: "눈을 움직여 뜻을 알리는 것.", s: "언니들은 서로 눈짓을 주고받았지요." },
        { w: "빠뜨리다", k: "물속으로 떨어지게 하다.", s: "공을 빠뜨린 것부터 약속한 것까지 다 말했습니다." },
        { w: "후회", k: "지난 일을 잘못했다고 여기는 마음.", s: "왜 그런 약속을 했을까 후회가 되었습니다." }
    ],
    "05-king-2.webp": [
        { w: "입을 열다", k: "말을 꺼내기 시작하다.", s: "그러다 수염을 한 번 쓸고 조용히 입을 열었지요." },
        { w: "대꾸", k: "남의 말에 맞받아 하는 말.", s: "대꾸할 말이 없었지요." },
        { w: "발끝", k: "발의 앞쪽 끝.", s: "공주는 발끝만 내려다보았습니다." },
        { w: "옳다", k: "틀리지 않고 바르다.", s: "아버지 말이 옳다는 것을 알고 있었으니까요." }
    ],
    "06-dinner.webp": [
        { w: "슬그머니", k: "남이 모르게 슬쩍.", s: "그래도 임금님이 보고 있어 접시를 슬그머니 밀어 주었지요." },
        { w: "넘기다", k: "음식을 목으로 삼키다.", s: "공주는 한 숟가락도 넘기지 못했지요." },
        { w: "애를 쓰다", k: "몹시 힘들여 참고 버티다.", s: "언니들은 웃음을 참느라 애를 썼습니다." },
        { w: "아무렇지 않게", k: "아무 일도 없는 것처럼.", s: "임금님만 아무렇지 않게 밥을 드셨지요." }
    ],
    "06-dinner-2.webp": [
        { w: "배를 두드리다", k: "배부르게 먹어 기분이 좋다.", s: "개구리가 배를 두드렸습니다." },
        { w: "헛기침", k: "말을 꺼내려고 일부러 하는 기침.", s: "임금님이 헛기침을 했습니다." },
        { w: "입을 다물다", k: "말을 그치고 가만있다.", s: "공주는 입을 다물 수밖에 없었지요." }
    ],
    "07-room.webp": [
        { w: "마룻바닥", k: "나무를 깔아 만든 방바닥.", s: "공주는 방에 들어서자마자 개구리를 구석 마룻바닥에 내려놓았습니다." },
        { w: "잠자리", k: "잠을 자는 자리.", s: "푹신한 잠자리에서 한참 떨어진 곳이었지요." },
        { w: "마음에 걸리다", k: "잊히지 않고 자꾸 신경이 쓰이다.", s: "그런데 자꾸 구석 쪽이 마음에 걸려 잠이 오지 않았습니다." }
    ],
    "07-room-2.webp": [
        { w: "한숨을 쉬다", k: "답답해서 숨을 길게 내쉬다.", s: "공주는 한숨을 쉬었습니다." },
        { w: "쓸다", k: "손으로 가볍게 문지르다.", s: "공주는 그 등을 손가락으로 살살 쓸어 주었습니다." },
        { w: "살며시", k: "소리 없이 아주 가볍게.", s: "공주는 개구리를 베개 옆에 살며시 내려놓았습니다." },
        { w: "그제야", k: "그때에서야 비로소.", s: "그러자 개구리가 그제야 웅크렸던 몸을 폈지요." }
    ],
    "08-ending.webp": [
        { w: "일이 나다", k: "큰일이 벌어지다.", s: "무슨 일이 났나 싶었습니다." },
        { w: "맑다", k: "흐리지 않고 깨끗하다.", s: "눈이 맑고 고운 옷을 입은 왕자였지요." },
        { w: "공손히", k: "몸을 낮추고 예의 바르게.", s: "왕자가 공손히 말했습니다." }
    ],
    "08-ending-2.webp": [
        { w: "백마", k: "털이 흰 말.", s: "이튿날 아침, 궁궐 앞에 백마 두 마리가 끄는 마차가 섰습니다." },
        { w: "마부", k: "말을 부려 마차를 모는 사람.", s: "마부는 왕자를 어릴 때부터 모신 하인리히였지요." },
        { w: "두르다", k: "몸에 둥글게 감다.", s: "왕자가 개구리가 되던 날, 하인리히는 너무 슬퍼 가슴이 터질까 봐 가슴에 쇠테를 둘렀습니다." },
        { w: "조이다", k: "꽉 눌러서 좁히다.", s: "\"제 가슴을 조이던 쇠테입니다. 이제 필요 없지요.\"" }
    ],
    "end.webp": [
        { w: "실리다", k: "글이나 그림이 책에 들어가다.", s: "이 이야기는 그림 형제가 모은 것 가운데 맨 앞에 실려 있습니다." },
        { w: "첫머리", k: "맨 처음 자리.", s: "두 사람이 첫머리에 놓을 만큼 아꼈던 이야기지요." },
        { w: "나무라다", k: "잘못했다고 말로 혼내다.", s: "임금님은 딸을 나무라지 않습니다." }
    ]
};
