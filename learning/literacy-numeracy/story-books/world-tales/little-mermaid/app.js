        ...
        "beats": [
            {
                ...
                "right": [
                    ...
                    "\"거기엔 커다란 배가 다닌단다. 땅에는 나무가 자라고, 사람들은 다리로 걷지.\"",
                    "막내는 그때마다 눈을 반짝였습니다."
                ]
            },
            {
                ...
                "emoji": "🏰",
                "left": [
                    "할머니는 말했지요. \"열다섯 살이 되면 물 위에 올라가 봐도 된단다.\"",
                    "언니들이 해마다 차례로 물 위에 다녀왔지요. 돌아와서는 본 것을 들려주었습니다.",
                    "\"등대가 반짝이더라.\" 한 언니가 말하면 다른 언니가 거들었지요. \"종소리가 물속까지 들렸어.\"",
                    "막내는 제 차례만 손꼽아 기다렸지요."
                ],
                "right": [
                    "그렇게 몇 해가 지나 드디어 막내 차례가 왔습니다. 할머니가 머리를 곱게 빗기고 진주도 꽂아 주었지요. \"조심히 다녀오너라.\"",
                    "막내는 위로, 위로 올라갔지요. 그러고는 물 밖으로 살며시 얼굴을 내밀었습니다."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "갑판에서는 잔치가 한창이었습니다. 음악이 물 위로 흘러왔지요.",
                    "사람들 사이에 젊은 왕자가 서 있었습니다. 오늘이 왕자의 생일이라 잔치를 연 것이었지요."
                ],
                "right": [
                    "인어공주는 왕자에게서 눈을 떼지 못했습니다. 그렇게 밤이 깊어 갔지요.",
                    "그런데 바람이 갑자기 달라졌습니다. 먹구름이 몰려오고 파도가 배를 번쩍 들어 올렸지요.",
                    "우지끈! 돛대가 뚝 부러졌습니다."
                ]
            },
            {
                ...
                "left": [
                    ...
                    "인어공주는 눈으로 왕자를 찾았습니다. 파도 사이로 그 모습이 보였지요.",
                    "왕자는 이미 정신을 잃은 뒤였습니다. 몸이 천천히 가라앉고 있었지요."
                ],
                "right": [
                    "인어공주가 힘껏 헤엄쳐 갔습니다. 두 팔로 왕자를 받쳤지요.",
                    "그러고는 왕자의 머리를 물 위로 들어 올렸습니다. 파도가 밤새 사납게 몰아쳤지요.",
                    "그래도 인어공주는 손을 놓지 않았습니다. 동이 틀 무렵에야 물결이 잦아들었지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "🌅",
                "left": [
                    "멀리 흰 모래밭이 보였습니다. 인어공주는 그리로 천천히 헤엄쳤지요. 왕자를 모래 위에 조심스레 눕혔습니다.",
                    "가슴이 오르내리는 것을 보고서야 마음을 놓았지요. 인어공주는 한참을 그 곁에 있었습니다.",
                    "그때 멀리서 사람 소리가 났지요."
                ],
                "right": [
                    "인어공주는 얼른 바위 뒤로 몸을 숨겼습니다. 한 아가씨가 모래밭으로 달려왔지요.",
                    "그 소리에 왕자가 눈을 떴습니다. 왕자는 아가씨를 올려다보며 말했지요. \"당신이 저를 구했군요.\"",
                    "인어공주는 바위 뒤에서 그 말을 다 들었습니다."
                ]
            },
            {
                ...
                "emoji": "🌅",
                "left": [
                    "인어공주는 바위 뒤에서 나서지 못했습니다. 그저 조용히 물속으로 돌아왔지요.",
                    "그날부터 마음이 이상했습니다. 그렇게 좋아하던 노래도 나오지 않았지요.",
                    "언니들이 걱정스레 물었습니다. \"왜 그러니, 막내야?\""
                ],
                "right": [
                    "인어공주는 대답 대신 할머니께 여쭸지요. \"사람은 얼마나 사나요?\"",
                    "\"우리보다 훨씬 짧게 산단다.\" 그래도 인어공주는 사람이 자꾸만 부러웠습니다. 땅 위에서 왕자 곁을 걸어 보고 싶었지요.",
                    "그날 밤 인어공주는 마음을 정했습니다. 바다 마녀를 찾아가기로요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "인어공주는 그리로 헤엄쳐 갔습니다. 검은 물이 소용돌이쳤지요.",
                    "해골처럼 생긴 산호가 길가에 늘어서 있었습니다. 그래도 인어공주는 멈추지 않았지요."
                ],
                "right": [
                    "동굴 안에 마녀가 있었습니다. 긴 머리가 물속에서 흐느적거렸지요.",
                    "마녀가 먼저 입을 열었습니다. \"네가 올 줄 알았다. 다리를 갖고 싶은 게지?\"",
                    "인어공주가 말없이 고개를 끄덕이자 마녀가 말했지요. \"그러려면 값을 치러야 한다.\""
                ]
            },
            {
                "art": "04-witch-2.webp",
                ...
                "left": [
                    "\"무엇을 드리면 되나요?\"",
                    "마녀가 씩 웃었지요. \"네 목소리를 다오. 바다에서 제일 고운 목소리 말이다.\"",
                    "인어공주는 숨을 삼켰습니다. \"그러면 말을 못 하나요?\"",
                    "\"그래, 영영 못 한다.\""
                ],
                "right": [
                    "마녀가 덧붙였지요. \"걸을 때마다 칼날 위를 걷듯 아플 것이다. 왕자가 다른 사람과 혼인하면, 그다음 날 해가 뜰 때 너는 물거품이 된다.\"",
                    "인어공주는 한참 생각에 잠겼다가 천천히 입을 열었지요. \"그렇게 해 주세요.\"",
                    "마녀는 인어공주의 목소리를 가져가고 작은 약병 하나를 내주었습니다."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "👣",
                "left": [
                    "인어공주는 왕자가 사는 성 앞 바닷가로 헤엄쳐 가 약을 마셨습니다. 그 순간 온몸이 불에 닿은 듯했지요. 인어공주는 그대로 정신을 잃었습니다.",
                    "눈을 뜨니 모래밭이었지요. 꼬리가 감쪽같이 없어지고 대신 두 다리가 생겨 있었습니다.",
                    "인어공주는 제 몸을 몇 번이나 내려다봤지요."
                ],
                "right": [
                    "일어서려 하자 발끝이 몹시 아팠습니다. 정말 칼날 위에 선 것 같았지요. 그래도 인어공주는 이를 악물고 일어섰습니다.",
                    "그때 저편에서 발소리가 났습니다. 고개를 드니 그 왕자가 서 있었지요.",
                    "왕자가 다가와 물었습니다. \"어디서 오셨나요?\""
                ]
            },
            {
                "art": "05-legs-2.webp",
                "emoji": "👣",
                "left": [
                    "인어공주는 대답할 수 없었습니다. 입을 열어도 소리가 나지 않았지요.",
                    "왕자가 인어공주를 찬찬히 바라봤습니다. \"말을 못 하는 모양이군요. 그래도 눈이 참 맑네요.\"",
                    "왕자는 인어공주를 궁으로 데려가 고운 옷을 입혀 주었지요."
                ],
                "right": [
                    "인어공주는 날마다 춤을 췄습니다. 발이 아파도 웃으며 췄지요.",
                    "왕자는 인어공주를 늘 곁에 두었습니다. \"내 소중한 친구예요.\"",
                    "하지만 딱 그뿐이었지요. 왕자에게는 잊지 못할 사람이 따로 있었거든요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "💔",
                "left": [
                    "어느 날 왕자가 말했습니다. \"이웃 나라에 가야 해요. 그 나라 공주와 혼인 이야기가 오간답니다.\"",
                    "\"하지만 저는 혼인하지 않을 거예요. 제 마음에는 다른 사람이 있거든요. 바닷가에서 저를 구한 분이지요.\""
                ],
                "right": [
                    "인어공주는 가슴이 쿵 뛰었습니다. '그건 저예요.'",
                    "하지만 말할 수 없었지요. 손짓으로도 도무지 전할 수가 없었습니다.",
                    "인어공주도 왕자를 따라 배에 올랐지요. 이윽고 배가 이웃 나라에 닿았습니다. 항구에 사람들이 잔뜩 나와 있었지요."
                ]
            },
            {
                ...
                "right": [
                    "그날로 혼인 잔치가 열렸습니다. 잔치가 끝나자 왕자와 신부는 배를 타고 왕자의 나라로 떠났지요.",
                    "인어공주도 그 배에 있었습니다. 웃는 얼굴로 조용히 서 있었지요.",
                    "아무도 그 마음을 알지 못했습니다. 해가 뜨면 물거품이 된다는 것도요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "🌊",
                "left": [
                    "한밤중이었습니다. 물결 사이로 언니들이 얼굴을 내밀었지요. 그런데 머리가 모두 짧게 잘려 있었습니다.",
                    "\"마녀에게 머리를 주고 이걸 얻었어.\" 언니가 반짝이는 단검을 내밀었지요.",
                    "\"이 단검으로 왕자를 찌르면 돼.\""
                ],
                "right": [
                    "\"해가 뜨기 전에 해야 해. 그 피가 네 발에 떨어지면 다리가 도로 꼬리가 된단다. 그러면 너는 물거품이 되지 않고 우리에게 돌아올 수 있어.\"",
                    "인어공주는 말없이 단검을 받았습니다. 그러고는 갑판 위 천막 안으로 들어갔지요.",
            ...
            },
            {
                ...
                "left": [
                    ...
                    "아주 편안해 보였습니다. 단검을 쥔 손이 천천히 내려갔지요.",
                    "'이 사람이 행복하면 됐어.'",
                    "인어공주는 조용히 밖으로 나갔습니다."
                ],
                "right": [
                    "그러고는 뱃전에 섰지요. 단검을 힘껏 바다로 던졌습니다. 풍덩.",
                    "물결이 그것을 삼켰지요. 동쪽 하늘이 붉게 물들기 시작했습니다.",
                    "해가 떠오르고 있었지요. 인어공주는 눈을 감았습니다."
                ]
            }
        ]
    },
    ...
    spreads: [
        {
            art: 'end.webp',
            left: [
                "오늘날 널리 알려진 인어공주와 이 이야기는 끝이 다릅니다. 여기 실린 것이 안데르센이 적은 쪽에 가깝습니다.",
                "인어공주가 바다 마녀에게 내준 것은 목소리였습니다. 하필 목소리였지요. 그래서 왕자를 구한 사람이 저라는 말을 끝내 못 합니다.",
                "왕자는 눈을 떴을 때 옆에 있던 사람을 은인으로 여깁니다. 인어공주는 그 자리에 없었지요. 물속으로 돌아가야 했으니까요.",
                "인어공주가 바란 것은 왕자만이 아니었습니다. 물 밖 세상을 보고 싶었지요. 그것은 열다섯 살 생일에 이미 시작된 마음입니다."
            ],
            right: [
                "걸을 때마다 아팠지만 인어공주는 춤을 췄습니다. 아무도 그 아픔을 몰랐지요. 이야기에서 가장 조용한 아픔입니다.",
                "인어공주는 목소리 말고 무엇을 내줄 수 있었을까요?"
            ]
        }
    ]
};
...
const QUIZ = [
    ...
    {
        "q": "왕자가 자기를 구해 준 사람으로 안 것은 누구인가요?",
        "choices": [
            "말 못 하는 아가씨",
            "이웃 나라 공주",
            "왕자를 건져 낸 뱃사람"
...
const EN = {
    ...
    chapters: [
        {
            num: 1,
            title: 'Chapter 1 · The Palace Under the Sea',
            beats: [
                {
                    art: '01-palace.webp',
                    emoji: '🐚',
            ...
            beats: [
                {
                    ...
                    right: [
                        ...
                        "Then the wind changed all at once. Black clouds came rolling up, and a wave lifted the ship right off the water.",
                        "Crack.",
                        "The mast snapped clean through."
                    ]
                },
                {
                    art: '02-storm-2.webp',
                    ...
                    right: [
                        ...
                        "Then she lifted his head clear of the water.",
                        "The waves beat wildly all night long.",
                        "And still she did not let go.",
                        "It was near dawn before the sea grew quiet."
                    ]
                }
            ]
        },
        {
            num: 3,
            title: 'Chapter 3 · Laid Down on the Sand',
            beats: [
                {
                    art: '03-rescue.webp',
                    emoji: '🏖️',
        ...
        {
            num: 4,
            title: 'Chapter 4 · Down to the Sea Witch',
            beats: [
                {
                    art: '04-witch.webp',
                    emoji: '🌀',
        ...
        },
        {
            ...
            beats: [
                ...
                },
                {
                    ...
                    emoji: '🗡️',
                    left: [
                        "She stood there a long, long time, looking down at the prince's face.",
                        "He looked entirely at peace.",
                        "The hand holding the knife came slowly down.",
                        "'It is enough that he is happy.'",
                        "And the little mermaid went quietly out."
                    ],
                    right: [
                        "She stood at the ship's rail and threw the knife as hard as she could into the sea.",
                        "Splash.",
                        "The water swallowed it.",
                        "The eastern sky was turning red. The sun was coming up.",
                        "And the little mermaid closed her eyes."
                    ]
                }
            ]
        },
        {
            num: 8,
            title: 'Chapter 8 · A Child of the Wind',
            beats: [
                {
                    art: '08-air.webp',
                    emoji: '💨',
    ...
    words: {
        ...
        '02-storm.webp': [
            { word: 'lantern', meaning: '등불', sentence: 'Lanterns burned bright along the rail.' },
            { word: 'deck', meaning: '갑판', sentence: 'There was a party going on up on deck.' },
            { word: 'wear on', meaning: '깊어 가다', sentence: 'And so the night wore on.' },
            { word: 'mast', meaning: '돛대', sentence: 'The mast snapped clean through.' }
        ],
        '02-storm-2.webp': [
            { word: 'go over', meaning: '기울어지다', sentence: 'The ship went over hard.' },
            { word: 'catch sight of', meaning: '눈에 띄다', sentence: 'She caught sight of him between the waves.' },
            { word: 'lose consciousness', meaning: '정신을 잃다', sentence: 'He had already lost consciousness.' },
        ...
        '04-witch.webp': [
            { word: 'whirlpool', meaning: '소용돌이', sentence: 'The black water turned in whirlpools.' },
            { word: 'drift', meaning: '흐느적거리다', sentence: 'Her long hair drifted about her in the water.' },
            { word: 'price', meaning: '값', sentence: 'Then there is a price to pay.' }
        ],
        '04-witch-2.webp': [
            { word: 'catch one’s breath', meaning: '숨을 삼키다', sentence: 'The little mermaid caught her breath.' },
            { word: 'never again', meaning: '영영 못 하는', sentence: 'Never again.' },
        ...
        '05-legs-2.webp': [
            { word: 'clear', meaning: '맑은', sentence: 'But what clear eyes you have.' },
            { word: 'anyway', meaning: '그래도', sentence: 'She smiled and danced anyway.' },
            { word: 'dearest', meaning: '가장 소중한', sentence: 'She is my dearest friend.' }
        ],
        '06-wedding.webp': [
            { word: 'neighbouring', meaning: '이웃의', sentence: 'I must go to the neighbouring country.' },
            { word: 'troubled', meaning: '걱정하는', sentence: "But don't be troubled." },
            { word: 'get across', meaning: '전하다', sentence: 'There was no way to get it across.' },
            { word: 'harbour', meaning: '항구', sentence: 'The harbour was full of people waiting.' }
        ],
        '06-wedding-2.webp': [
            { word: 'stop dead', meaning: '걸음을 뚝 멈추다', sentence: 'The prince stopped dead.' },
            { word: 'overjoyed', meaning: '무척 기뻐하는', sentence: 'The prince was overjoyed.' },
            { word: 'fix', meaning: '정하다', sentence: 'The wedding was fixed that same day.' }
        ],
        '07-dagger.webp': [
        ...
        '07-dagger-2.webp': [
            { word: 'at peace', meaning: '편안한', sentence: 'He looked entirely at peace.' },
            { word: 'rail', meaning: '뱃전', sentence: "She stood at the ship's rail." },
        ...
        'end.webp': [
            ...
            { word: 'of all things', meaning: '하필', sentence: 'Of all things, her voice.' },
            { word: 'rescuer', meaning: '구해 준 사람', sentence: 'He takes her for his rescuer.' },
            { word: 'give up', meaning: '내주다, 포기하다', sentence: 'What could she have given up instead?' }
        ]
    }
};
...
const WORDS_KO = {
    ...
    "01-palace-2.webp": [
        { w: "거들다", k: "남이 하는 일을 옆에서 도와주다.", s: "한 언니가 말하면 다른 언니가 거들었지요." },
        { w: "손꼽아 기다리다", k: "날을 세면서 몹시 기다리다.", s: "막내는 제 차례만 손꼽아 기다렸지요." },
        { w: "빗기다", k: "머리를 빗으로 가다듬어 주다.", s: "할머니가 머리를 곱게 빗기고 진주도 꽂아 주었지요." },
        { w: "살며시", k: "남이 모르게 가만히.", s: "그러고는 물 밖으로 살며시 얼굴을 내밀었습니다." }
    ],
    "02-storm.webp": [
        { w: "척", k: "배를 세는 말.", s: "눈앞에 큰 배 한 척이 있었습니다." },
        { w: "한창", k: "가장 기운차고 흥겨운 때.", s: "갑판에서는 잔치가 한창이었습니다." },
        { w: "눈을 떼지 못하다", k: "눈길을 다른 데로 돌리지 못하다.", s: "인어공주는 왕자에게서 눈을 떼지 못했습니다." },
        { w: "먹구름", k: "비를 몰고 오는 검은 구름.", s: "먹구름이 몰려오고 파도가 배를 번쩍 들어 올렸지요." }
    ],
    "02-storm-2.webp": [
        { w: "받치다", k: "아래에서 위로 떠받쳐 주다.", s: "두 팔로 왕자를 받쳤지요." },
        { w: "몰아치다", k: "세차게 마구 들이치다.", s: "파도가 밤새 사납게 몰아쳤지요." },
        { w: "동이 트다", k: "날이 새어 아침 빛이 비치다.", s: "동이 틀 무렵에야 물결이 잦아들었지요." }
    ],
    "03-rescue.webp": [
        { w: "조심스레", k: "다치지 않게 가만가만.", s: "왕자를 모래 위에 조심스레 눕혔습니다." },
        { w: "마음을 놓다", k: "걱정을 덜고 편해지다.", s: "가슴이 오르내리는 것을 보고서야 마음을 놓았지요." },
        { w: "곁", k: "바로 옆자리.", s: "인어공주는 한참을 그 곁에 있었습니다." }
    ],
    "03-rescue-2.webp": [
        { w: "나서다", k: "앞으로 나와 모습을 보이다.", s: "인어공주는 바위 뒤에서 나서지 못했습니다." },
        { w: "여쭈다", k: "어른께 묻다.", s: "인어공주는 대답 대신 할머니께 여쭸지요." },
        { w: "마녀", k: "무서운 힘을 쓰는 여자.", s: "바다 마녀를 찾아가기로요." }
    ],
    "04-witch.webp": [
        { w: "해골", k: "살이 없어져 뼈만 남은 머리.", s: "해골처럼 생긴 산호가 길가에 늘어서 있었습니다." },
        { w: "동굴", k: "산이나 바위에 뚫린 큰 굴.", s: "동굴 안에 마녀가 있었습니다." },
        { w: "입을 열다", k: "말을 꺼내기 시작하다.", s: "마녀가 먼저 입을 열었습니다." },
        { w: "값을 치르다", k: "받은 만큼 내놓다.", s: "\"그러려면 값을 치러야 한다.\"" }
    ],
    "04-witch-2.webp": [
        { w: "덧붙이다", k: "하던 말에 더 보태어 말하다.", s: "마녀가 덧붙였지요." },
        { w: "칼날", k: "칼의 얇고 날카로운 쪽.", s: "\"걸을 때마다 칼날 위를 걷듯 아플 것이다. 왕자가 다른 사람과 혼인하면, 그다음 날 해가 뜰 때 너는 물거품이 된다.\"" },
        { w: "생각에 잠기다", k: "다른 것은 잊고 깊이 생각하다.", s: "인어공주는 한참 생각에 잠겼다가 천천히 입을 열었지요." },
        { w: "약병", k: "약을 담는 작은 병.", s: "마녀는 인어공주의 목소리를 가져가고 작은 약병 하나를 내주었습니다." }
    ],
    "05-legs.webp": [
        { w: "감쪽같이", k: "아무도 모르게 깨끗이.", s: "꼬리가 감쪽같이 없어지고 대신 두 다리가 생겨 있었습니다." },
        { w: "몹시", k: "아주 심하게.", s: "일어서려 하자 발끝이 몹시 아팠습니다." },
        { w: "저편", k: "저쪽 편.", s: "그때 저편에서 발소리가 났습니다." }
    ],
    "05-legs-2.webp": [
        { w: "찬찬히", k: "서두르지 않고 꼼꼼히.", s: "왕자가 인어공주를 찬찬히 바라봤습니다." },
        { w: "곁에 두다", k: "늘 가까이 있게 하다.", s: "왕자는 인어공주를 늘 곁에 두었습니다." },
        { w: "그뿐", k: "그것만이고 더는 없음.", s: "하지만 딱 그뿐이었지요." }
    ],
    "06-wedding.webp": [
        { w: "혼인", k: "결혼.", s: "\"이웃 나라에 가야 해요. 그 나라 공주와 혼인 이야기가 오간답니다.\"" },
        { w: "가슴이 쿵 뛰다", k: "놀라서 가슴이 크게 울리다.", s: "인어공주는 가슴이 쿵 뛰었습니다." },
        { w: "손짓", k: "손을 움직여 뜻을 알리는 일.", s: "손짓으로도 도무지 전할 수가 없었습니다." },
        { w: "잔뜩", k: "아주 많이.", s: "항구에 사람들이 잔뜩 나와 있었지요." }
    ],
    "06-wedding-2.webp": [
        { w: "드디어", k: "오래 기다린 끝에.", s: "\"드디어 찾았습니다.\"" },
        { w: "그날로", k: "그날 바로.", s: "그날로 혼인 잔치가 열렸습니다." },
        { w: "물거품", k: "물 위에 생기는 하얀 거품.", s: "해가 뜨면 물거품이 된다는 것도요." }
    ],
    "07-dagger.webp": [
        { w: "한밤중", k: "밤이 가장 깊은 때.", s: "한밤중이었습니다." },
        { w: "단검", k: "길이가 짧은 칼.", s: "\"이 단검으로 왕자를 찌르면 돼.\"" },
        { w: "도로", k: "본래 있던 대로 다시.", s: "\"해가 뜨기 전에 해야 해. 그 피가 네 발에 떨어지면 다리가 도로 꼬리가 된단다. 그러면 너는 물거품이 되지 않고 우리에게 돌아올 수 있어.\"" },
        { w: "곤히", k: "아주 깊이 편하게.", s: "왕자가 곤히 잠들어 있었습니다." }
    ],
    "07-dagger-2.webp": [
        { w: "오래도록", k: "아주 오랜 동안.", s: "인어공주는 오래도록 서 있었습니다." },
        { w: "쥐다", k: "손으로 꽉 잡다.", s: "단검을 쥔 손이 천천히 내려갔지요." },
    ...
    "end.webp": [
        { w: "하필", k: "다른 것도 많은데 꼭 그것으로.", s: "하필 목소리였지요." },
        { w: "은인", k: "나를 도와준 고마운 사람.", s: "왕자는 눈을 떴을 때 옆에 있던 사람을 은인으로 여깁니다." },
        { w: "끝내", k: "끝까지 그러다가 결국.", s: "그래서 왕자를 구한 사람이 저라는 말을 끝내 못 합니다." }
    ]
};
