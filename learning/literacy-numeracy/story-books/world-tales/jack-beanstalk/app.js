        ...
        "beats": [
            {
                ...
                "emoji": "🐄",
                "left": [
                    "잭은 어머니와 둘이 살았습니다. 가진 것이라고는 흰둥이라는 소 한 마리뿐이었지요.",
                    "두 사람은 흰둥이 우유를 팔아 살았습니다. 그런데 언제부턴가 젖이 나오지 않았지요. 살림은 갈수록 어려워졌습니다.",
                    "팔 만한 것은 벌써 다 팔았지요. 찬장에는 마른 빵 한 조각만 남아 있었습니다."
                ],
                "right": [
                    "어느 아침 어머니가 잭을 불렀지요. \"이제 흰둥이를 팔아야겠구나.\"",
                    "잭은 고개를 푹 숙였습니다.",
                    "\"값을 잘 받아 와야 한다. 그 돈으로 겨울을 나야 하니까.\"",
                    "잭은 말없이 고삐를 잡았지요."
                ]
            },
            {
                ...
                "left": [
                    ...
                    "길이 참 멀었습니다. 반쯤 갔을 때였지요.",
                    "길가에 웬 아저씨가 서 있었습니다. 챙이 넓은 모자를 쓴 아저씨가 먼저 말을 걸었지요. \"소를 팔러 가는 모양이구나.\""
                ],
                "right": [
                    "\"네, 장에 가는 길이에요.\"",
                    "잭이 대답하자 아저씨가 물었습니다. \"그 소를 나에게 팔지 않겠니?\"",
                    "잭은 잠시 아저씨를 올려다봤지요. \"얼마 주실 건데요?\"",
                    "아저씨가 천천히 주먹을 폈습니다. 손바닥에 콩 다섯 알이 놓여 있었지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "🫘",
                "left": [
                    "잭은 눈이 휘둥그레졌습니다. \"콩 다섯 알이요?\"",
                    "아저씨가 빙그레 웃었지요. \"이건 보통 콩이 아니란다. 심으면 하룻밤 만에 하늘까지 자라지.\"",
                    "콩이 햇빛을 받아 반짝반짝 빛났습니다. 잭은 그만 마음이 흔들렸지요."
                ],
                "right": [
                    "결국 잭은 흰둥이를 넘기고 콩을 주머니에 넣었습니다. 흰둥이가 뒤를 돌아보며 음매 하고 울었지요. 잭은 그 소리를 뒤로하고 집으로 뛰어갔습니다.",
                    "\"어머니, 이것 보세요!\"",
                    "어머니는 잭의 손바닥을 들여다봤지요. 얼굴이 새하얘졌습니다."
                ]
            },
            {
                "art": "02-beans-2.webp",
                ...
                "left": [
                    "\"소를 콩과 바꿔 왔단 말이냐!\"",
                    "어머니가 콩을 창밖으로 확 던졌습니다. 콩이 마당 여기저기로 흩어졌지요.",
                    "\"오늘은 저녁도 없다!\"",
                    "잭은 배가 고픈 채로 자리에 누웠습니다. 이불을 머리까지 뒤집어썼지요."
                ],
                "right": [
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "어마어마하게 굵은 줄기가 떡 버티고 서 있었지요. 잎사귀 하나가 방문만 했습니다.",
                    "\"어머니가 던진 콩이 밤새 자랐구나!\""
                ],
                "right": [
            ...
            },
            {
                ...
                "left": [
                    ...
                    "팔이 아프고 다리가 후들거렸지요. 손바닥에 물집이 잡혔습니다.",
                    "그래도 잭은 멈추지 않고 계속 올라갔습니다."
                ],
                "right": [
                    "이윽고 구름 속으로 들어갔지요. 앞이 하얗게 흐려져 아무것도 보이지 않았습니다. 축축한 안개가 얼굴에 닿았지요.",
                    "한참을 더 오르자 갑자기 구름이 걷혔지요. 발밑에 넓고 반듯한 길이 나 있었습니다. 구름 위 세상이었지요.",
                    "잭은 그 자리에 한참 서서 이리저리 둘러봤습니다."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "🏰",
                "left": [
                    "잭은 그 길을 따라 걸었습니다. 길 끝에 커다란 성이 있었지요. 문이 산더미만 했습니다.",
                    "까치발을 들어도 문고리에 손이 닿지 않았지요. 잭은 주먹으로 문을 쾅쾅 두드렸습니다.",
                    "그러자 문이 끼익 열렸습니다. 커다란 아주머니가 고개를 내밀었지요."
                ],
                "right": [
                    "\"얘야, 여긴 어쩐 일이니?\"",
                    "잭이 배를 움켜쥐었습니다. \"배가 고파서요. 먹을 것 좀 주시겠어요?\"",
                    "아주머니가 주위를 살피더니 목소리를 낮췄습니다. \"우리 남편은 무서운 거인이란다. 그래도 얼른 들어오렴.\""
                ]
            },
            {
                ...
                "left": [
                    ...
                    "접시 하나가 수레바퀴만 했습니다. 아주머니가 빵을 뚝 잘라 주었지요.",
                    "잭에게는 그 조각도 무릎만 했습니다. 잭은 허겁지겁 먹었지요."
                ],
                "right": [
                    "그때 갑자기 바닥이 흔들렸습니다. 쿵, 쿵, 쿵.",
                    "식탁 위 접시가 달그락달그락 춤을 췄지요.",
                    "\"어머, 남편이 벌써 왔네!\" 아주머니가 잭을 번쩍 안아 올렸습니다. 그러고는 커다란 솥 안에 얼른 숨겼지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "거인은 코를 킁킁거렸습니다. \"사람 냄새가 나는걸?\"",
                    "아주머니가 손사래를 쳤지요. \"아까 구운 고기 냄새겠지요.\""
                ],
                "right": [
                    "거인은 못 미더운 얼굴로 자리에 앉았습니다. \"빨리빨리 날라 와!\"",
                    "거인은 소 한 마리를 통째로 먹고 빵도 스무 덩이나 먹어 치웠지요.",
                    "잭은 솥뚜껑 틈으로 그 모습을 내다봤습니다. '어휴, 나 같은 건 한입에 삼키겠네.'"
                ]
            },
            {
                "art": "05-giant-2.webp",
                "emoji": "👹",
                "left": [
                    "이윽고 거인이 배를 통통 두드렸습니다. \"금화 자루를 가져와라!\"",
                    "아주머니가 묵직한 자루를 내왔습니다. 거인이 그것을 식탁에 좌르르 쏟았지요. 금화가 산더미처럼 쌓였습니다.",
                    "금화 한 닢이 잭의 얼굴만 했지요. 거인은 그것을 하나하나 세기 시작했습니다."
                ],
                "right": [
                    "하나, 둘, 셋…",
                    "그러다 세다 말고 하품을 크게 했습니다. 고개가 꾸벅꾸벅하더니 이내 코를 골았지요. 잭은 솥에서 살며시 기어 나왔습니다.",
                    "잭은 금화를 자루에 쓸어 담아 두 팔로 끌어안았지요. 그러고는 뒤도 안 보고 냅다 뛰었습니다."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "그날부터 두 사람은 배를 곯지 않았습니다. 하지만 금화도 조금씩 줄어들었지요.",
            ...
            },
            {
                ...
                "left": [
                    "거인이 소리쳤습니다. \"거위를 가져와라!\"",
                    "아주머니가 거위를 안고 왔습니다. 식탁 위에 살며시 내려놓았지요.",
                    "\"자, 알을 낳아라!\" 거인의 말에 거위가 몸을 웅크렸습니다. 툭!"
                ],
                "right": [
                    "황금알 하나가 떨어졌지요. 잭은 솥 안에서 입이 딱 벌어졌습니다.",
                    "이윽고 배부른 거인이 코를 골기 시작했지요. 잭은 살금살금 나와 거위를 품에 안았습니다.",
                    "그런데 거위가 꽥 소리를 냈지요. 거인이 눈을 번쩍 떴지만 잭은 벌써 문밖으로 내달린 뒤였습니다."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "🎵",
                "left": [
                    "잭은 거위를 안고 콩나무를 내려왔지요. 거위 덕분에 살림이 활짝 폈습니다.",
                    "그런데 잭은 또 궁금해졌지요. \"그 성에 뭐가 더 있을까?\"",
                    "어머니가 손사래를 치며 말렸습니다. \"이제 그만하렴!\"",
                    "잭은 고집을 부렸지요. \"한 번만 더요.\""
                ],
                "right": [
            ...
            },
            {
                ...
                "left": [
                    "거인이 명령했습니다. \"노래하라!\"",
                    "그러자 하프가 저절로 울리기 시작했지요. 어찌나 고운 소리인지 잭도 넋을 놓았습니다. 듣고 있던 거인의 눈이 스르르 감겼지요.",
                    "이내 드르렁드르렁 코를 골았지요. 잭이 아궁이 뒤에서 살금살금 나왔습니다."
                ],
                "right": [
                    "그러고는 하프를 두 팔로 안아 들었지요. 바로 그 순간 하프가 소리쳤습니다. \"주인님! 주인님!\"",
                    "거인이 벌떡 일어났지요. \"이 도둑놈!\"",
                    "잭은 문밖으로 내달렸습니다."
                ]
            }
        ...
        "beats": [
            {
                ...
                "emoji": "🪓",
                "left": [
                    "잭은 구름 길을 있는 힘껏 달렸습니다. 뒤에서 거인의 발소리가 바짝 쫓아왔지요.",
                    "쿵! 쿵! 쿵!",
                    "발소리가 날 때마다 구름 길이 흔들렸습니다."
                ],
                "right": [
            ...
            },
            {
                ...
                "right": [
                    ...
                    "잭은 도끼를 내려놓고 말했지요. \"다시는 거인의 성에 가지 않을게요.\"",
                    "어머니가 잭의 어깨를 두드려 주었지요."
                ]
            }
        ],
        "moral": "한 번의 행운은 고맙지만, 자꾸 기대다 보면 도끼를 들 날이 온답니다."
    }
];
...
const COVER = {
    ...
    intro: [
        ...
        '가난한 소년이 하늘 위 낯선 세계로 올라간다는 이야기 짜임은 세계 여러 나라의 옛이야기에서 비슷하게 발견돼요. 아득히 높은 곳에 우리와 다른 세상이 있다고 믿었던 옛사람들의 상상이 담겨 있는 것이지요.'
    ]
};
    ...
    spreads: [
        {
            ...
            left: [
                ...
                "잭은 구름 위에 세 번 올라갔습니다. 첫 번째는 무서워서 숨었고, 두 번째는 조금 익숙했고, 세 번째는 성에 무엇이 더 있나 궁금해서 갔습니다."
            ],
            right: [
                "거인의 아내를 다시 보십시오. 잭을 숨겨 준 사람은 그 사람입니다. 이야기에서 가장 위험한 집에서 잭을 지켜 준 것이지요.",
                "잭이 세 번째로 올라간 것은 옳았을까요? 이미 먹고살 만해진 뒤였는데 말입니다."
            ]
        }
    ]
};
...
const EN = {
    ...
    cover: {
        ...
        intro: [
            ...
            "A poor boy climbs into a strange world above the sky — that shape turns up in old stories all over the world. It holds what people once imagined about a place high above us where everything is different."
        ]
    },
    chapters: [
        {
            num: 1,
            title: 'Chapter 1 · Off to Sell the Cow',
            beats: [
                {
                    art: '01-cow.webp',
                    emoji: '🐄',
            ...
            beats: [
                {
                    ...
                    right: [
                        ...
                        "Jack left the sound behind him and ran all the way home.",
                        "\"Mother, look at these!\"",
                        "His mother peered into his palm. Her face turned white."
                    ]
                },
                {
                    art: '02-beans-2.webp',
        ...
        {
            num: 3,
            title: 'Chapter 3 · The Stalk that Reached the Sky',
            beats: [
                {
                    art: '03-beanstalk.webp',
                    emoji: '🌱',
                ...
                },
                {
                    ...
                    emoji: '🌱',
                    left: [
                        "Jack took hold of the stalk with both hands and climbed, one step and then another. The house got smaller, and soon the whole village was no bigger than his thumbnail.",
                        "His arms ached and his legs shook. Blisters came up on his palms.",
        ...
        {
            num: 4,
            title: 'Chapter 4 · The Castle in the Clouds',
            beats: [
                {
                    art: '04-castle.webp',
                    emoji: '🏰',
                ...
                },
                {
                    ...
                    emoji: '🏰',
                    left: [
                        "The kitchen was tremendous. The table was like a playing field, and a single plate was as wide as a cartwheel.",
                        "The woman cut him off a piece of bread. Even that piece came up to Jack's knee.",
        ...
        {
            num: 5,
            title: 'Chapter 5 · Boom, Boom, Boom',
            beats: [
                {
                    art: '05-giant.webp',
                    emoji: '💰',
                ...
                },
                {
                    ...
                    emoji: '💰',
                    left: [
                        "By and by the giant patted his stomach.",
                        "\"Fetch me my bag of gold.\"",
                        "His wife brought out a heavy sack, and the giant tipped it out across the table. The coins piled up like a hill.",
                        "One coin alone was as broad as Jack's face.",
                        "And the giant began to count them, one by one."
                    ],
                    right: [
                        "One, two, three…",
        ...
        {
            num: 6,
            title: 'Chapter 6 · The Goose that Laid Gold',
            beats: [
                {
                    art: '06-goose.webp',
                    emoji: '🪿',
        ...
        {
            num: 7,
            title: 'Chapter 7 · The Harp that Sang',
            beats: [
                {
                    art: '07-harp.webp',
                    emoji: '🎵',
                ...
                },
                {
                    ...
                    right: [
                        "He got both arms round the harp and lifted it. And at that very moment the harp cried out.",
                        "\"Master! Master!\"",
                        "The giant sprang to his feet.",
                        "\"You thief!\"",
                        "Jack bolted out of the door."
                    ]
                }
            ]
        },
    ...
    words: {
        'cover.webp': [
            { word: 'from mouth to mouth', meaning: '입에서 입으로', sentence: 'Passed from mouth to mouth in England for a very long time.' },
            { word: 'collect', meaning: '모으다', sentence: 'Joseph Jacobs travelled the country collecting old tales.' },
            { word: 'climb', meaning: '기어오르다', sentence: 'A poor boy climbs into a strange world above the sky.' },
            { word: 'imagine', meaning: '상상하다', sentence: 'What people once imagined about a place high above us.' }
        ],
        '01-cow.webp': [
            { word: 'cupboard', meaning: '찬장', sentence: 'One dry crust was all that was left in the cupboard.' },
            { word: 'crust', meaning: '빵 껍질, 마른 빵조각', sentence: 'One dry crust was all that was left.' },
            { word: 'hang one’s head', meaning: '고개를 푹 숙이다', sentence: 'Jack hung his head.' },
        ...
        '02-beans.webp': [
            { word: 'ordinary', meaning: '보통의', sentence: 'These are no ordinary beans.' },
            { word: 'glitter', meaning: '반짝이다', sentence: 'The beans caught the sunlight and glittered.' },
            { word: 'waver', meaning: '흔들리다', sentence: 'Jack felt his mind waver.' },
            { word: 'peer into', meaning: '들여다보다', sentence: 'His mother peered into his palm.' }
        ],
        '02-beans-2.webp': [
            { word: 'trade for', meaning: '~과 바꾸다', sentence: 'You traded our cow for beans!' },
        ...
        '03-beanstalk.webp': [
            ...
            { word: 'vanish', meaning: '사라지다', sentence: 'The stalk went up into the clouds and vanished.' },
            { word: 'twist', meaning: '얽히다', sentence: 'The stems were twisted round one another like a ladder.' },
            { word: 'swallow hard', meaning: '침을 꿀꺽 삼키다', sentence: 'Jack swallowed hard.' }
        ],
        '03-beanstalk-2.webp': [
            { word: 'thumbnail', meaning: '엄지손톱', sentence: 'The village was no bigger than his thumbnail.' },
            { word: 'blister', meaning: '물집', sentence: 'Blisters came up on his palms.' },
            { word: 'damp', meaning: '축축한', sentence: 'Damp mist touched his face.' },
            { word: 'level', meaning: '평평한, 반듯한', sentence: 'A wide, level road ran beneath his feet.' }
        ],
        '04-castle.webp': [
        ...
        '05-giant.webp': [
            ...
            { word: 'brush', meaning: '스치다', sentence: 'His head all but brushed the ceiling.' },
            { word: 'sniff', meaning: '킁킁거리다', sentence: 'He sniffed at the air.' },
            { word: 'unconvinced', meaning: '못 미더워하는', sentence: 'The giant sat down looking unconvinced.' },
            { word: 'ox', meaning: '소', sentence: 'He ate a whole ox and twenty loaves besides.' }
        ],
        '05-giant-2.webp': [
            { word: 'pat', meaning: '통통 두드리다', sentence: 'The giant patted his stomach.' },
            { word: 'tip out', meaning: '좌르르 쏟다', sentence: 'He tipped it out across the table.' },
            { word: 'yawn', meaning: '하품', sentence: 'He gave an enormous yawn.' },
        ...
        '06-goose-2.webp': [
            { word: 'lay', meaning: '알을 낳다', sentence: 'Now then. Lay.' },
            { word: 'hunch up', meaning: '몸을 웅크리다', sentence: 'The goose hunched herself up.' },
            { word: 'solid gold', meaning: '순금', sentence: 'Down dropped an egg of solid gold.' },
            { word: 'squawk', meaning: '꽥 소리', sentence: 'But the goose let out a squawk.' }
        ],
        '07-harp.webp': [
            { word: 'wonder', meaning: '궁금해하다', sentence: 'But Jack began to wonder again.' },
            { word: 'hearth', meaning: '아궁이', sentence: 'He hid in the shadow behind the hearth.' },
            { word: 'carve', meaning: '새기다', sentence: 'A small harp with a face carved into it.' }
        ],
        '07-harp-2.webp': [
            { word: 'forget oneself', meaning: '넋을 놓다', sentence: 'Jack quite forgot himself listening to it.' },
            { word: 'slide shut', meaning: '스르르 감기다', sentence: "The giant's eyes slid shut." },
            { word: 'spring to one’s feet', meaning: '벌떡 일어나다', sentence: 'The giant sprang to his feet.' },
            { word: 'bolt', meaning: '내달리다', sentence: 'Jack bolted out of the door.' }
        ],
        '08-axe.webp': [
            { word: 'as hard as one can', meaning: '있는 힘껏', sentence: 'Jack ran along the cloud road as hard as he could.' },
            { word: 'sway', meaning: '휘청이다', sentence: 'The whole beanstalk swayed.' },
            { word: 'shower down', meaning: '우수수 떨어지다', sentence: 'Leaves came showering down.' }
        ],
        '08-axe-2.webp': [
        ...
        'end.webp': [
            ...
            { word: 'enough to live on', meaning: '먹고살 만한', sentence: 'By then they had enough to live on.' }
        ]
    }
};
...
const WORDS_KO = {
    "cover.webp": [
        { w: "짜임", k: "이야기가 이어지는 모양.", s: "가난한 소년이 하늘 위 낯선 세계로 올라간다는 이야기 짜임은 세계 여러 나라의 옛이야기에서 비슷하게 발견돼요." },
        { w: "아득히", k: "아주 멀게.", s: "아득히 높은 곳에 우리와 다른 세상이 있다고 믿었던 옛사람들의 상상이 담겨 있는 것이지요." },
        { w: "실리다", k: "글이나 그림이 책에 들어가다.", s: "1890년, 영국의 조지프 제이컵스가 여러 지방을 다니며 모은 옛이야기집에 실리면서 지금의 모습으로 널리 알려졌답니다." }
    ],
    "01-cow.webp": [
        { w: "살림", k: "집에서 먹고 입고 사는 일.", s: "살림은 갈수록 어려워졌습니다." },
        { w: "고삐", k: "소나 말을 끌 때 잡는 줄.", s: "잭은 말없이 고삐를 잡았지요." },
        { w: "겨울을 나다", k: "겨울 동안을 지내다.", s: "\"값을 잘 받아 와야 한다. 그 돈으로 겨울을 나야 하니까.\"" }
    ],
    "01-cow-2.webp": [
        { w: "장터", k: "물건을 사고파는 자리.", s: "잭은 장터를 향해 걸어갔습니다." },
        { w: "웬", k: "어떤, 알 수 없는.", s: "길가에 웬 아저씨가 서 있었습니다." },
        { w: "알", k: "둥글고 작은 것을 세는 말.", s: "손바닥에 콩 다섯 알이 놓여 있었지요." }
    ],
    "02-beans.webp": [
        { w: "눈이 휘둥그레지다", k: "놀라서 눈이 크고 둥글게 되다.", s: "잭은 눈이 휘둥그레졌습니다." },
        { w: "빙그레", k: "소리 없이 부드럽게 웃는 모습.", s: "아저씨가 빙그레 웃었지요." },
        { w: "하룻밤", k: "하루의 밤. 곧 한 밤.", s: "\"이건 보통 콩이 아니란다. 심으면 하룻밤 만에 하늘까지 자라지.\"" },
        { w: "넘기다", k: "남에게 주어 옮기다.", s: "결국 잭은 흰둥이를 넘기고 콩을 주머니에 넣었습니다." }
    ],
    "02-beans-2.webp": [
        { w: "뒤집어쓰다", k: "머리까지 덮어쓰다.", s: "이불을 머리까지 뒤집어썼지요." },
        { w: "바보짓", k: "생각 없이 한 어리석은 일.", s: "'내가 정말 바보짓을 했나 봐!'" },
        { w: "뻗다", k: "길게 자라 나가다.", s: "마당 한가운데에서 굵은 줄기가 쑥쑥 하늘로 뻗어 오르고 있었습니다." }
    ],
    "03-beanstalk.webp": [
        { w: "이튿날", k: "그다음 날.", s: "이튿날 아침이었습니다." },
        { w: "잎사귀", k: "나무에 달린 잎 한 장.", s: "잎사귀 하나가 방문만 했습니다." },
        { w: "버티다", k: "움직이지 않고 굳게 서 있다.", s: "어마어마하게 굵은 줄기가 떡 버티고 서 있었지요." },
        { w: "한껏", k: "할 수 있는 데까지.", s: "고개를 한껏 젖혀 봐도 꼭대기가 보이지 않았지요." }
    ],
    "03-beanstalk-2.webp": [
        { w: "후들거리다", k: "힘이 빠져 자꾸 떨리다.", s: "팔이 아프고 다리가 후들거렸지요." },
        { w: "이윽고", k: "얼마 지난 뒤에.", s: "이윽고 구름 속으로 들어갔지요." },
        { w: "걷히다", k: "덮고 있던 것이 벗겨져 사라지다.", s: "한참을 더 오르자 갑자기 구름이 걷혔지요." }
    ],
    "04-castle.webp": [
        { w: "산더미", k: "산처럼 아주 크게 쌓인 것.", s: "문이 산더미만 했습니다." },
        { w: "문고리", k: "문을 여닫을 때 잡는 고리.", s: "까치발을 들어도 문고리에 손이 닿지 않았지요." },
        { w: "움켜쥐다", k: "손으로 꽉 잡다.", s: "잭이 배를 움켜쥐었습니다." },
        { w: "어쩐 일", k: "무슨 일.", s: "\"얘야, 여긴 어쩐 일이니?\"" }
    ],
    "04-castle-2.webp": [
        { w: "허겁지겁", k: "몹시 급하게 서둘러서.", s: "잭은 허겁지겁 먹었지요." },
        { w: "뚝", k: "한 번에 끊어지거나 떼어지는 모양.", s: "아주머니가 빵을 뚝 잘라 주었지요." },
        { w: "솥", k: "밥이나 국을 끓이는 큰 그릇.", s: "그러고는 커다란 솥 안에 얼른 숨겼지요." }
    ],
    "05-giant.webp": [
        { w: "손사래를 치다", k: "손을 내저어 아니라고 하다.", s: "아주머니가 손사래를 쳤지요." },
        { w: "나르다", k: "물건을 옮겨 오다.", s: "\"빨리빨리 날라 와!\"" },
        { w: "통째로", k: "쪼개지 않고 그대로 몽땅.", s: "거인은 소 한 마리를 통째로 먹고 빵도 스무 덩이나 먹어 치웠지요." },
        { w: "솥뚜껑", k: "솥을 덮는 뚜껑.", s: "잭은 솥뚜껑 틈으로 그 모습을 내다봤습니다." }
    ],
    "05-giant-2.webp": [
        { w: "묵직하다", k: "들기에 좀 무겁다.", s: "아주머니가 묵직한 자루를 내왔습니다." },
        { w: "닢", k: "돈처럼 얇고 둥근 것을 세는 말.", s: "금화 한 닢이 잭의 얼굴만 했지요." },
        { w: "꾸벅꾸벅", k: "졸면서 고개를 자꾸 떨어뜨리는 모습.", s: "고개가 꾸벅꾸벅하더니 이내 코를 골았지요." },
        { w: "냅다", k: "몹시 세차게. 힘껏.", s: "그러고는 뒤도 안 보고 냅다 뛰었습니다." }
    ],
    "06-goose.webp": [
        { w: "입을 딱 벌리다", k: "너무 놀라 입을 크게 열다.", s: "어머니가 금화를 보고는 입을 딱 벌렸지요." },
        { w: "배를 곯다", k: "먹을 것이 없어 배가 고프다.", s: "그날부터 두 사람은 배를 곯지 않았습니다." }
    ],
    "06-goose-2.webp": [
        { w: "거위", k: "목이 길고 몸이 큰, 집에서 기르는 새.", s: "\"거위를 가져와라!\"" },
        { w: "살금살금", k: "소리 나지 않게 가만가만.", s: "잭은 살금살금 나와 거위를 품에 안았습니다." },
        { w: "눈을 번쩍 뜨다", k: "잠에서 깨어 눈을 갑자기 크게 뜨다.", s: "거인이 눈을 번쩍 떴지만 잭은 벌써 문밖으로 내달린 뒤였습니다." }
    ],
    "07-harp.webp": [
        { w: "살림이 펴다", k: "먹고사는 일이 넉넉해지다.", s: "거위 덕분에 살림이 활짝 폈습니다." },
        { w: "말리다", k: "하지 못하게 옆에서 막다.", s: "어머니가 손사래를 치며 말렸습니다." },
        { w: "고집을 부리다", k: "제 생각을 굽히지 않고 우기다.", s: "잭은 고집을 부렸지요." },
        { w: "기어이", k: "끝내 마음먹은 대로.", s: "잭은 기어이 또 콩나무를 올라갔지요." },
        { w: "아궁이", k: "불을 때려고 낸 부엌 구멍.", s: "아궁이 뒤 그늘에 몸을 숨겼지요." }
    ],
    "07-harp-2.webp": [
        { w: "명령하다", k: "윗사람이 하라고 시키다.", s: "거인이 명령했습니다." },
        { w: "저절로", k: "누가 하지 않아도 스스로.", s: "그러자 하프가 저절로 울리기 시작했지요." },
        { w: "곱다", k: "보기에 예쁘고 듣기에 좋다.", s: "어찌나 고운 소리인지 잭도 넋을 놓았습니다." },
        { w: "드르렁드르렁", k: "크게 코를 고는 소리.", s: "이내 드르렁드르렁 코를 골았지요." }
    ],
    "08-axe.webp": [
        { w: "바짝", k: "아주 가깝게 붙어서.", s: "뒤에서 거인의 발소리가 바짝 쫓아왔지요." },
        { w: "겨우", k: "힘들게 가까스로.", s: "잭은 겨우 콩나무 꼭대기에 닿았지요." },
        { w: "목이 터져라", k: "목이 아플 만큼 크게 소리쳐.", s: "\"어머니, 도끼!\" 잭이 목이 터져라 외치자 어머니가 도끼를 두 자루나 안고 뛰어나왔지요." }
    ],
    "08-axe-2.webp": [
        { w: "내려서다", k: "높은 곳에서 내려와 서다.", s: "잭이 땅에 내려서자마자 도끼를 받아 들었습니다." },
        { w: "우지끈", k: "굵은 것이 부러질 때 나는 소리.", s: "우지끈." },
        { w: "어깨를 두드리다", k: "잘했다고 어깨를 가볍게 치다.", s: "어머니가 잭의 어깨를 두드려 주었지요." }
    ],
    "end.webp": [
        { w: "전해 오다", k: "옛날부터 사람들 입으로 이어져 내려오다.", s: "구름 위에 거인이 산다는 이야기는 영국에서 오래 전해 왔습니다." },
        { w: "밑지다", k: "낸 것보다 돌아온 것이 적어 잃게 되다.", s: "누가 봐도 밑진 장사였지요." },
        { w: "셈", k: "따져 보면 그런 것이나 마찬가지라는 말.", s: "화가 나서 한 일이 길을 열어 준 셈이지요." }
    ]
};
