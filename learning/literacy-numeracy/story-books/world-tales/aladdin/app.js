const CHAPTERS = [
    {
        ...
        "beats": [
            ...
            },
            {
                ...
                "right": [
                    "이튿날 아침, 둘은 성문을 나섰습니다. 한참을 걷고 또 걷자 집도 사람도 보이지 않았지요.",
                    "해가 머리 위에 올 무렵, 메마른 바위산에 이르렀습니다. 앞서 걷던 아저씨가 걸음을 뚝 멈추었지요.",
                    "\"여기다. 드디어 찾았구나.\""
                ]
            }
        ]
        ...
        "beats": [
            {
                ...
                "emoji": "🕳️",
                "left": [
                    "아저씨는 품에서 이상한 가루를 꺼내 땅에 뿌렸습니다. 그러고는 알아들을 수 없는 주문을 중얼거렸지요.",
                    "그러자 우르릉 소리와 함께 땅이 쩍 갈라졌습니다. 흙먼지가 걷히자 땅속으로 이어진 돌계단이 보였지요."
                ],
                "right": [
                    "\"저 아래에 낡은 램프가 하나 있다. 너는 그것만 가져오너라. 다른 것은 절대 만지면 안 된다.\"",
                    "아저씨는 알라딘의 손가락에 반지를 하나 끼워 주었습니다. \"이 반지가 너를 지켜 줄 게다.\"",
                    "알라딘은 계단을 조심조심 내려갔습니다. 그런데 아래는 눈이 부실 만큼 환했지요. 보석이 산처럼 쌓여 반짝이고 있었거든요."
                ]
            },
            {
                "art": "02-cave-2.webp",
        ...
        "beats": [
            {
                ...
                "emoji": "💨",
                "left": [
                    "땅이 닫히자 동굴 안은 캄캄해졌습니다. 알라딘은 목이 쉬도록 삼촌을 불렀지만 아무 대답도 없었지요. 그렇게 꼬박 이틀이 지났습니다.",
                    "배는 고프고 무서워서 눈물이 났지요. 알라딘은 두 손을 모아 싹싹 빌었습니다.",
                    "그러다 손가락에 낀 반지가 문질러졌지요. 그러자 반지가 번쩍 빛나더니 연기가 뭉게뭉게 피어올랐습니다."
                ],
                "right": [
                    "연기 속에서 지니가 나타났지요. 반지 속에 살고 있던 지니였습니다. \"부르셨습니까, 주인님. 무엇이든 말씀하십시오.\"",
        ...
        "beats": [
            {
                ...
                "right": [
                    "이윽고 공주를 태운 가마가 지나갔습니다. 그때 바람에 휘장이 살짝 들렸지요. 알라딘은 공주 얼굴을 보고 그 자리에 얼어붙고 말았습니다.",
                    "그날 밤 알라딘은 도무지 잠을 이룰 수가 없었지요.",
                    "\"어머니, 부탁이 있어요. 임금님께 가서 제가 공주님과 혼인하고 싶다고 말씀드려 주세요.\""
                ]
            },
            {
                ...
                "emoji": "👸",
                "left": [
                    "이튿날 어머니는 보석 쟁반을 들고 궁궐로 갔습니다. 알라딘이 동굴에서 가져온 바로 그 보석이었지요.",
                    "쟁반을 받아 든 임금님은 눈이 휘둥그레졌습니다. \"이런 보석은 처음 보는구려. 그 청년을 한번 데려와 보시오.\""
                ],
                "right": [
                    "소식을 들은 알라딘은 얼른 램프를 문질러 지니를 불렀지요. \"임금님을 뵈러 가야 해요. 멋진 옷과 말, 그리고 선물을 잔뜩 준비해 주세요.\"",
                    "이튿날 궁궐 앞은 사람들로 북적였습니다. 선물을 실은 낙타가 끝도 없이 줄을 이었지요. 온 도시 사람들이 구경을 나왔습니다."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "🏯",
                "left": [
                    "임금님은 혼인을 허락했지만 한 가지 조건을 걸었습니다.",
                    "\"공주가 살 궁전이 있어야 하네. 그것도 내 궁궐 바로 맞은편에 말일세.\"",
                    "알라딘은 공손히 고개를 숙였지요. \"그리하겠습니다, 임금님.\""
                ],
                "right": [
                    "그날 밤 알라딘은 램프를 문질렀습니다. \"하룻밤 사이에 임금님 궁궐 맞은편에 궁전을 지어 주세요.\"",
                    "이튿날 아침, 임금님이 창문을 열자 눈앞이 온통 번쩍였지요. 어제까지 텅 빈 땅이던 곳에 커다란 궁전이 서 있었거든요. 기둥마다 보석이 박혀 있었습니다.",
                    "임금님은 입을 다물지 못하고 한참을 서 있었지요."
                ]
            },
            {
                ...
                "emoji": "🏯",
                "left": [
                    "곧 성대한 혼례가 열렸습니다. 온 도시가 함께 잔치를 벌였지요.",
                    "알라딘과 공주는 사이좋게 지냈습니다. 알라딘은 어려운 사람들을 부지런히 도왔지요. 그래서 사람들은 알라딘을 무척 좋아했습니다. 그렇게 몇 해가 흘렀지요."
                ],
                "right": [
                    "그런데 그 소문이 먼 나라 마법사의 귀에까지 들어갔습니다. 바로 알라딘을 동굴에 가두었던 가짜 삼촌이었지요.",
                    "\"그 녀석이 살아 있었단 말이냐! 틀림없이 램프를 손에 넣었겠구나.\"",
                    "마법사는 그길로 짐을 꾸려 알라딘이 사는 도시로 향했습니다."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "🔃",
                "left": [
                    "마법사는 램프 장수로 꾸몄습니다. 수레에 반짝반짝 윤이 나는 새 램프를 잔뜩 실었지요.",
                    "그러고는 알라딘의 궁전 앞을 오가며 외쳤습니다. \"낡은 램프를 새 램프로 바꿔 드려요! 돈은 한 푼도 안 받아요!\""
                ],
                "right": [
                    "지나가던 사람들은 깔깔 웃었지요. \"세상에, 저런 바보 장사꾼이 다 있네!\"",
                    "그 소리가 궁전 안까지 들렸습니다. 마침 알라딘은 사냥을 나가고 없었지요. 공주는 램프에 지니가 산다는 것을 알지 못했습니다.",
                    "\"우리 궁전에도 낡은 램프가 하나 있지. 새것으로 바꿔 오너라.\" 공주는 시녀에게 낡은 램프를 내주었지요."
                ]
            },
            {
                "art": "06-swap-2.webp",
                "emoji": "🔃",
                "left": [
                    "시녀가 마법사에게 낡은 램프를 내밀었습니다. 마법사는 잽싸게 그것을 받아 챙기고 새 램프를 건네주었지요.",
                    "마법사는 아무도 없는 골목으로 들어가 램프를 벅벅 문질렀습니다. 곧 지니가 나타났지요.",
                    "\"이 궁전을 공주와 함께 멀리 사막 너머로 옮겨라!\""
                ],
                "right": [
                    "그날 저녁, 사냥에서 돌아온 알라딘은 제 눈을 의심했지요. 궁전이 있던 자리가 텅 비어 있었거든요. 공주도 함께 사라지고 없었습니다.",
                    "소식을 들은 임금님은 노발대발하며 알라딘을 불렀지요. \"사흘 안에 공주를 찾아오너라! 못 찾으면 용서하지 않겠다!\""
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "emoji": "🐫",
                "left": [
                    "알라딘은 눈앞이 캄캄했습니다. 어디서부터 찾아야 할지 몰라 밤새 성 밖을 헤맸지요.",
                    "그러다 문득 손가락에 낀 반지가 떠올랐습니다. 알라딘이 얼른 반지를 문지르자 반지의 지니가 나타났지요.",
                    "\"궁전은 어디에 있나요?\" 알라딘이 다급히 물었습니다."
                ],
                "right": [
                    "\"아주 먼 사막 너머에 있습니다, 주인님.\"",
                    "\"그럼 저를 그곳으로 데려다주세요.\"",
                    "눈을 감았다 뜨니 둘레가 온통 모래였지요. 저 멀리 낯익은 궁전이 보였습니다.",
                    "알라딘은 밤이 되기를 기다렸다가 몰래 담을 넘었습니다. 그러고는 공주의 방 창문을 가만히 두드렸지요."
                ]
            },
            {
        ...
        "beats": [
            {
                ...
                "emoji": "✨",
                "left": [
                    "알라딘은 마법사의 품에서 램프를 꺼내 벅벅 문질렀습니다. 램프의 지니가 다시 나타났지요. \"오랜만입니다, 주인님.\"",
                    "\"궁전을 공주와 함께 제자리로 돌려놓아 주세요. 마법사는 이 사막에 두고요.\""
                ],
                "right": [
                    "이튿날 아침, 임금님은 여느 때처럼 슬픈 얼굴로 창문을 열었습니다. 그런데 맞은편에 궁전이 떡하니 서 있는 게 아니겠어요?",
                    "며칠째 텅 비어 있던 자리였지요. 임금님은 맨발로 뛰어나갔습니다. 궁전 문 앞에서 공주가 환하게 웃고 있었지요."
                ]
            },
            {
                ...
                "emoji": "✨",
                "left": [
                    "사막에서 잠을 깬 마법사는 홀로 남아 발만 동동 굴렀습니다.",
                    "그 뒤 알라딘은 램프를 궤짝 깊이 넣어 두었지요. \"이젠 램프를 쓸 일이 없을 거예요.\"",
                    "공주가 물었습니다. \"정말 다시는 안 쓰실 거예요?\""
                ],
                "right": [
                    "\"꼭 필요할 때만 쓸 거예요.\"",
                    "알라딘은 궁전 문을 늘 열어 두었지요. 배고픈 사람에게 곡식을 나누고, 무너진 집도 고쳐 주었습니다.",
                    "사람들은 알라딘의 이름을 오래오래 기억했습니다. 요술 램프 때문이 아니라, 알라딘의 따뜻한 마음 때문이었지요."
                ]
            }
        ],
        "moral": "큰 힘을 가질수록 그것을 언제 쓰는지가 더 중요해요. 위기 앞에서도 침착하게 방법을 찾으면 잃은 것도 되찾을 수 있답니다."
    }
];
    ...
    spreads: [
        {
            ...
            left: [
                ...
                "알라딘이 처음 얻은 것은 램프가 아니라 반지였습니다. 마법사가 지켜 준다며 끼워 준 것이지요. 동굴에 갇혔을 때 알라딘을 꺼낸 것이 그 반지입니다.",
                "마법사가 제 손으로 준 물건이 제 계략을 무너뜨린 셈입니다."
            ],
            right: [
                "알라딘은 공주를 처음 본 뒤 어머니에게 부탁합니다. 제 입으로 나서지 못하고요. 그때는 아직 아무것도 아니었으니까요.",
                "마지막에 알라딘은 램프를 궤짝 깊이 넣어 둡니다. 왜 그랬을까요?"
            ]
        }
    ]
};
...
const EN = {
    ...
    words: {
        'cover.webp': [
            { word: 'collection', meaning: '모음', sentence: 'The great collection of tales long told across Arabia, Persia and India.' },
            { word: 'frame', meaning: '액자, 바깥 틀', sentence: 'Inside the frame of a queen who keeps a story going every night.' },
            { word: 'adventure', meaning: '모험', sentence: 'The adventures of Sindbad the Sailor, Ali Baba and many others.' },
...
const WORDS_KO = {
    "cover.webp": [
        ...
        { w: "한데", k: "여러 가지를 모은 한곳.", s: "천일야화는 아라비아와 페르시아, 인도 지방에서 오래도록 전해 오던 이야기들을 한데 모은 책이랍니다." },
        { w: "뱃사람", k: "배를 타고 일하는 사람.", s: "왕비가 천 하루 동안 밤마다 이야기를 이어 간다는 액자 구성 안에, 뱃사람 신드바드와 알리바바 같은 인물들의 모험담이 줄줄이 담겨 있어요." }
    ],
    "01-stranger.webp": [
        { w: "실패", k: "실을 감아 두는 작은 도구.", s: "어머니가 실패를 놓고 문밖으로 목을 뺐습니다." },
        { w: "걸터앉다", k: "높은 데에 엉덩이만 붙이고 다리를 늘어뜨려 앉다.", s: "알라딘은 담 위에 걸터앉아 친구들과 웃고 있었지요." },
        { w: "끼니를 잇다", k: "굶지 않고 겨우 먹고 살아가다.", s: "아버지가 세상을 떠난 뒤로 어머니는 밤늦도록 실을 자아 겨우 끼니를 이었습니다." },
        { w: "불러 세우다", k: "가는 사람을 불러서 멈추게 하다.", s: "그러던 어느 날, 먼 나라 옷을 입은 낯선 아저씨가 알라딘을 불러 세웠습니다." }
    ],
    "01-stranger-2.webp": [
        { w: "아낌없이", k: "조금도 아까워하지 않고.", s: "그래도 아저씨는 돈을 아낌없이 썼습니다." },
        { w: "잠을 설치다", k: "잠을 제대로 못 자다.", s: "알라딘은 너무 신이 나서 그날 밤 잠을 설쳤습니다." },
        { w: "이튿날", k: "바로 그다음 날.", s: "이튿날 아침, 둘은 성문을 나섰습니다." },
        { w: "무렵", k: "어떤 일이 있을 그때쯤.", s: "해가 머리 위에 올 무렵, 메마른 바위산에 이르렀습니다." }
    ],
    "02-cave.webp": [
        { w: "품", k: "옷의 안쪽 가슴 자리.", s: "아저씨는 품에서 이상한 가루를 꺼내 땅에 뿌렸습니다." },
        { w: "우르릉", k: "무거운 것이 울리며 나는 소리.", s: "그러자 우르릉 소리와 함께 땅이 쩍 갈라졌습니다." },
        { w: "걷히다", k: "덮여 있던 것이 흩어져 없어지다.", s: "흙먼지가 걷히자 땅속으로 이어진 돌계단이 보였지요." }
    ],
    "02-cave-2.webp": [
        { w: "눈에 밟히다", k: "잊히지 않고 자꾸 생각나다.", s: "돌아 나오는 길에 반짝이는 보석이 자꾸 눈에 밟혔지요." },
    ...
    "03-genie.webp": [
        ...
        { w: "싹싹 빌다", k: "두 손을 비비며 제발 도와 달라고 빌다.", s: "알라딘은 두 손을 모아 싹싹 빌었습니다." },
        { w: "끌어안다", k: "두 팔로 당겨서 안다.", s: "어머니가 맨발로 달려 나와 알라딘을 끌어안았습니다." }
    ],
    "03-genie-2.webp": [
        { w: "천", k: "옷이나 이불을 만드는 데 쓰는 얇은 감.", s: "어머니가 천으로 램프를 문지르는 순간이었지요." },
        { w: "솟다", k: "아래에서 위로 세게 오르다.", s: "펑! 엄청난 연기가 솟아 방 안을 가득 채웠습니다." },
        { w: "천장", k: "방의 위쪽을 막은 면.", s: "연기 속에서 천장에 머리가 닿을 만큼 커다란 지니가 나타났지요." },
        { w: "눈 깜짝할 사이에", k: "아주 짧은 동안에.", s: "그러자 눈 깜짝할 사이에 상 가득 음식이 차려졌습니다." }
    ],
    "04-princess.webp": [
        { w: "굶다", k: "끼니를 먹지 못하다.", s: "그날부터 알라딘네는 더 이상 굶지 않았습니다." },
        { w: "이윽고", k: "얼마쯤 지난 뒤에.", s: "이윽고 공주를 태운 가마가 지나갔습니다." },
        { w: "휘장", k: "가리기 위해 둘러 늘어뜨린 천.", s: "그때 바람에 휘장이 살짝 들렸지요." },
        { w: "잠을 이루다", k: "잠이 들다.", s: "그날 밤 알라딘은 도무지 잠을 이룰 수가 없었지요." }
    ],
    "04-princess-2.webp": [
        { w: "궁궐", k: "임금이 사는 큰 집.", s: "이튿날 어머니는 보석 쟁반을 들고 궁궐로 갔습니다." },
        { w: "눈이 휘둥그레지다", k: "몹시 놀라 눈이 크게 벌어지다.", s: "쟁반을 받아 든 임금님은 눈이 휘둥그레졌습니다." },
        { w: "청년", k: "스무 살 안팎의 젊은 남자.", s: "그 청년을 한번 데려와 보시오." },
        { w: "북적이다", k: "많은 사람이 모여 시끄럽게 움직이다.", s: "이튿날 궁궐 앞은 사람들로 북적였습니다." }
    ],
    "05-palace.webp": [
        { w: "조건을 걸다", k: "해 주는 대신 지켜야 할 것을 내놓다.", s: "임금님은 혼인을 허락했지만 한 가지 조건을 걸었습니다." },
        { w: "공손히", k: "말과 몸가짐을 예의 있게.", s: "알라딘은 공손히 고개를 숙였지요." },
        { w: "박히다", k: "속에 단단히 끼어 들어가 있다.", s: "기둥마다 보석이 박혀 있었습니다." },
        { w: "입을 다물지 못하다", k: "너무 놀라서 말이 나오지 않다.", s: "임금님은 입을 다물지 못하고 한참을 서 있었지요." }
    ],
    "05-palace-2.webp": [
        { w: "성대하다", k: "차림이 아주 크고 훌륭하다.", s: "곧 성대한 혼례가 열렸습니다." },
        { w: "귀에 들어가다", k: "말이 남에게 전해져 알려지다.", s: "그런데 그 소문이 먼 나라 마법사의 귀에까지 들어갔습니다." },
        { w: "손에 넣다", k: "제 것으로 가지다.", s: "틀림없이 램프를 손에 넣었겠구나." },
        { w: "짐을 꾸리다", k: "떠나려고 가지고 갈 것을 챙기다.", s: "마법사는 그길로 짐을 꾸려 알라딘이 사는 도시로 향했습니다." }
    ],
    "06-swap.webp": [
        { w: "꾸미다", k: "다른 사람처럼 보이게 겉모습을 바꾸다.", s: "마법사는 램프 장수로 꾸몄습니다." },
        { w: "수레", k: "바퀴를 달아 짐을 실어 끄는 것.", s: "수레에 반짝반짝 윤이 나는 새 램프를 잔뜩 실었지요." },
        { w: "한 푼", k: "아주 적은 돈.", s: "돈은 한 푼도 안 받아요!" },
        { w: "시녀", k: "궁궐에서 공주나 왕비를 가까이 모시는 여자.", s: "공주는 시녀에게 낡은 램프를 내주었지요." }
    ],
    "06-swap-2.webp": [
        { w: "잽싸게", k: "아주 빠르게.", s: "마법사는 잽싸게 그것을 받아 챙기고 새 램프를 건네주었지요." },
        { w: "벅벅", k: "세게 여러 번 문지르는 모양.", s: "마법사는 아무도 없는 골목으로 들어가 램프를 벅벅 문질렀습니다." },
        { w: "제 눈을 의심하다", k: "본 것이 믿기지 않다.", s: "그날 저녁, 사냥에서 돌아온 알라딘은 제 눈을 의심했지요." },
        { w: "사흘", k: "세 날. 삼 일.", s: "사흘 안에 공주를 찾아오너라!" }
    ],
    "07-desert.webp": [
        { w: "눈앞이 캄캄하다", k: "어떻게 해야 할지 몰라 막막하다.", s: "알라딘은 눈앞이 캄캄했습니다." },
        { w: "문득", k: "생각이 갑자기.", s: "그러다 문득 손가락에 낀 반지가 떠올랐습니다." },
        { w: "다급히", k: "몹시 급하게.", s: "알라딘이 다급히 물었습니다." },
        { w: "낯익다", k: "전에 본 적이 있어 눈에 익다.", s: "저 멀리 낯익은 궁전이 보였습니다." }
    ],
    "07-desert-2.webp": [
        { w: "약봉지", k: "약을 담은 작은 종이 주머니.", s: "알라딘은 잠시 생각하다가 공주에게 작은 약봉지를 건넸지요." },
        { w: "타다", k: "가루를 물에 넣고 섞다.", s: "그리고 마법사의 잔에 이 가루를 몰래 타세요." },
        { w: "단숨에", k: "쉬지 않고 한 번에.", s: "마법사는 기뻐서 잔을 단숨에 들이켰지요." },
        { w: "곯아떨어지다", k: "몹시 깊이 잠들다.", s: "그러고는 그 자리에서 쿨쿨 곯아떨어졌습니다." }
    ],
    "08-return.webp": [
        { w: "여느", k: "특별하지 않은 보통의.", s: "이튿날 아침, 임금님은 여느 때처럼 슬픈 얼굴로 창문을 열었습니다." },
        { w: "떡하니", k: "보란 듯이 크게.", s: "그런데 맞은편에 궁전이 떡하니 서 있는 게 아니겠어요?" },
        { w: "며칠째", k: "며칠 동안 계속.", s: "며칠째 텅 비어 있던 자리였지요." }
    ],
    "08-return-2.webp": [
        { w: "발을 동동 구르다", k: "안타깝고 급해서 발을 자꾸 구르다.", s: "사막에서 잠을 깬 마법사는 홀로 남아 발만 동동 굴렀습니다." },
        { w: "곡식", k: "쌀이나 보리처럼 밥을 지어 먹는 것.", s: "배고픈 사람에게 곡식을 나누고, 무너진 집도 고쳐 주었습니다." },
        { w: "요술", k: "신기한 힘으로 이상한 일을 해내는 재주.", s: "요술 램프 때문이 아니라, 알라딘의 따뜻한 마음 때문이었지요." }
    ],
    "end.webp": [
        { w: "옮기다", k: "다른 나라 말로 바꾸어 쓰다.", s: "삼백 년쯤 전 프랑스 사람이 옮기면서 새로 넣은 것입니다." },
        { w: "계략", k: "남을 속이려고 미리 꾸민 꾀.", s: "마법사가 제 손으로 준 물건이 제 계략을 무너뜨린 셈입니다." },
        { w: "궤짝", k: "물건을 넣어 두는 큰 나무 상자.", s: "마지막에 알라딘은 램프를 궤짝 깊이 넣어 둡니다." }
    ]
};
