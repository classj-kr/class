...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `가장 가까운 사람에게 속은 것입니다. 믿었던 만큼 크게 무너졌습니다. 작게 믿었으면 작게 무너졌을 것입니다. 크게 믿은 것이 화가 되었습니다. 그런데 크게 믿지 않고 사는 방법도 없습니다. 그 뒤로 왕이 달라졌습니다. 왕은 이렇게 생각했습니다.`,
    ...
    },
    {
        ...
        paras: [
            `가난한 어부가 하나 있었습니다. 그 어부에게는 규칙이 하나 있었습니다. 하루에 그물을 네 번만 던지는 것이었습니다. 네 번을 넘겨 욕심을 부리지 않겠다는 다짐이었습니다. 많이 던진다고 많이 잡히는 것도 아니었습니다. 네 번을 던지고 나면 그날은 그것으로 끝이었습니다. 잡히든 안 잡히든 그물을 걷어 어깨에 메고 돌아갔습니다. 그 규칙을 여러 해 지켰습니다. 바그다드 가까이의 바닷가에서 그물을 던졌습니다. 그날 잡은 것을 그날 장에 내다 팔았습니다.`,
            ...
            `그리고 마신이 이런 이야기를 했습니다. 그는 옛날에 어느 왕의 명령을 어겨 그 항아리에 갇혔습니다. 납으로 봉하고 도장을 찍어 바다에 던진 것이었습니다. 그 왕은 마신도 다스릴 줄 아는 사람이었다고 합니다. 그 도장은 아무나 뜯을 수 없는 것이었습니다. 그 도장에는 힘 있는 왕의 이름이 새겨져 있었습니다. 그것을 찍어 두면 아무도 손대지 못했습니다. 그래서 사백 년을 그 안에 있었습니다. 항아리 안은 캄캄하고 좁았습니다. 몸을 연기로 바꾸어야 겨우 들어갈 자리였습니다. 첫 백 해 동안 그는 이렇게 생각했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그 사람은 마법을 쓰는 사람이었습니다. 아주 멀리서 땅속에 숨겨진 낡은 램프 하나를 찾아 여기까지 온 것이었습니다. 그 문은 정해진 아이만 열 수 있었습니다. 그래서 알라딘이 필요했던 것입니다. 그 사람에게 알라딘은 조카가 아니라 문을 여는 열쇠였습니다. 그러니 문만 열리면 그다음은 필요가 없었습니다. 그 램프를 얻으려고 여러 해를 준비한 사람이었습니다. 아이 하나를 속이는 것쯤은 아무것도 아니었습니다.`,
            ...
            `마법사가 그 램프를 문지르자 마신이 나왔습니다. 마법사는 공주가 있는 궁전을 통째로 먼 나라로 옮기게 했습니다. 그날 궁전이 통째로 사라졌습니다. 알라딘은 반지의 마신에게 부탁해 공주가 있는 곳을 찾아갔고, 공주와 꾀를 내어 램프를 되찾았습니다. 그렇게 되찾기까지 아주 오래 걸렸습니다. 그리고 되찾은 뒤에 이렇게 말했다고 합니다.<br>"내가 이 램프 이야기를 미리 했더라면 이런 일은 없었을 것이오."`
        ]
    },
    {
        num: 4,
        ...
        paras: [
            ...
            `형수는 그 되에 몰래 밀랍<span class="gloss">(벌집에서 얻는 말랑한 덩어리)</span>을 발라 두었습니다. 바닥에 얇게 발라 두었습니다. 동생네가 무엇을 재는지 궁금했기 때문입니다. 가난한 집에서 되를 빌려 가는 것이 이상했던 것입니다. 곡식은 그 집에 있을 리가 없었습니다. 되는 곡식을 재는 그릇입니다. 그러니 되를 빌려 간다는 것은 곡식이 생겼다는 뜻이었습니다. 되를 돌려받아 보니 밀랍에 금화가 하나 붙어 있었습니다. 형수는 그것을 손에 들고 한참을 보았습니다. 그러고는 남편에게 달려갔습니다.`,
            ...
            `알리바바는 형이 돌아오지 않자 굴로 찾아가 형을 거두어 왔습니다. 도적들은 굴에 있던 사람이 사라진 것을 보고, 비밀을 아는 사람이 또 있다는 것을 알아챘습니다. 그 뒤 도적들은 그 마을을 뒤져 알리바바를 찾아냈습니다. 그리고 여러 번 그를 없애려고 했습니다. 그때마다 그것을 알아채고 막아 낸 사람이 있었습니다. 집안일을 하던 사람이었습니다. 알리바바의 집에서 일하는 모르지아나라는 여자였습니다. 그 집에서 밥을 짓고 물을 긷던 사람입니다. 제일 눈이 밝은 사람이기도 했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `구름을 가릴 만큼 큰 새였네. 로크라는 새라고 하네. 그 흰 것은 그 새의 알이었네. 그러니 그 새가 얼마나 큰지 알 만하지 않은가. 알 하나가 지붕만 하니 그 어미가 어떻겠는가. 나는 그때 나무 뒤로 몸을 숨겼네. 다리 하나가 나무 둥치만 했네.`,
            ...
            `나는 그것을 보고 알아챘네. 절벽 위의 사람들이 고기를 던져 넣고 있었네. 고기에 다이아몬드가 박히면, 독수리가 그것을 물고 올라가네. 그러면 위에서 그 고기를 빼앗는 것이네. 그렇게 하지 않으면 그 골짜기에 내려갈 길이 없기 때문이네. 사람이 못 가는 데에는 새를 보내는 것이네. 그것을 생각해 낸 사람이 누구인지는 나도 모르네.`,
    ...
    },
    {
        ...
        paras: [
            `짐꾼 신드바드가 다시 찾아간 날, 뱃사람 신드바드는 또 이런 이야기를 했습니다. 다섯 번째 항해 때의 일일세. 이번에는 배가 폭풍에 부딪쳤네. 배가 부서져서 나 혼자 어느 섬에 닿았네. 널빤지 하나에 매달려 떠밀려 온 것이네. 함께 탄 사람들은 어디로 갔는지 모르네. 나만 뭍에 닿은 것이네. 그 섬에는 물이 있고 열매가 있었네. 바나나 비슷한 것이 열려 있었네. 그래서 굶지는 않았네. 다만 사람이 하나도 없었네. 발자국 하나 없었네. 사람이 없는 데서 며칠을 지내 보면 알게 되네. 굶는 것보다 그것이 더 견디기 어렵네.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `장에서 물건을 팔던 사람은 물건을 팔던 자리에 서 있었고, 밥을 짓던 사람은 부뚜막 앞에 서 있었습니다. 불이 그대로 붙어 있었습니다. 솥에서 김이 올랐습니다. 여러 해가 지난 줄도 모르고 있었습니다. 자기가 물고기였던 것도 몰랐습니다. 그 사이에 밖에서는 여러 해가 흘렀습니다. 그 사람들만 그 세월을 겪지 않은 셈입니다.`,
            ...
            `그래서 검은 섬 사람들이 그 왕의 나라로 옮겨 가 살았습니다. 나라 하나가 통째로 옮겨 가는 일이었습니다. 사람과 짐승과 수레가 줄지어 갔습니다. 그 길이 한 해가 걸렸다고 합니다. 길에서 아이가 태어나기도 했습니다. 그 아이는 두 나라 어디에도 속하지 않은 데서 태어난 셈입니다. 그런 아이가 그 해에 여럿이었다고 합니다.`
        ]
    },
    {
        num: 10,
