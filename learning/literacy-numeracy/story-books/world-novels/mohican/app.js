...
const CHAPTERS = [
    {
        ...
        paras: [
            `이 이야기는 이백칠십 년쯤 전 북아메리카에서 벌어진 전쟁을 배경으로 합니다. 영국과 프랑스가 그 땅을 놓고 일곱 해 동안 싸운 전쟁이었습니다. 유럽에서 시작해 아메리카까지 번졌습니다. 그 전쟁을 유럽에서는 칠년 전쟁이라고 부릅니다. 미국에서는 프렌치 인디언 전쟁이라고 부릅니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `나쁜 일에는 대개 그 앞이 있습니다. 그 앞을 보지 않으면 같은 일이 또 일어납니다. 마과가 그렇게 되기까지 있었던 일이 그러했습니다. 남는 것이 사람 하나에 대한 미움뿐이면 안 됩니다. 그러면 아무것도 배우지 못한 것입니다. 그날 밤 일행은 강 한가운데 바위섬의 동굴에 숨었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `타메눈드가 말했습니다.<br>"나는 어릴 때 이 표시를 가진 사람을 보았다. 그것이 여든 해 전이다."<br>"그 집안이 아직 남아 있느냐."<br>웅카스가 말했습니다.<br>"저와 제 아버지입니다."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그 자리에 있던 사람들은 그 말을 그대로 믿었습니다. 그런데 그것은 사실이 아니었습니다. 다만 그 자리에서는 사실처럼 들렸습니다. 그리고 오래도록 사실로 여겨졌습니다. 그때 타메눈드가 일어섰습니다. 백 살이 넘은 그 늙은 사람 앞을 사람들이 비켰습니다.`,
...
const AFTERWORD = {
    ...
    paras: [
        ...
        `그 자리에서 매의 눈이 칭가치국의 손을 잡습니다. 그리고 자기가 곁에 있겠다고 합니다. 백인과 원주민이 손을 잡은 채로 이 책이 끝납니다.`,
