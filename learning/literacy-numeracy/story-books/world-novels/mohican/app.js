...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `모히컨, 델라웨어, 휴런이라고요. 그것이 그 사람들이 자기를 부르던 이름에 더 가깝습니다. 부족 이름은 대개 그 말로 사람이라는 뜻이었습니다. 델라웨어라는 이름도 남이 붙인 것입니다. 그 사람들이 스스로 부른 이름은 레나페였습니다. 유럽 사람들이 배를 타고 오면서 그 땅이 백 해 사이에 다 달라졌습니다.`,
            ...
            `그래서 그 땅 사람들끼리 서로 싸우게 되었습니다. 그것이 그 시절에 벌어진 일 가운데 제일 슬픈 일이었고, 두고두고 남은 일이었습니다. 그것이 이 이야기의 배경입니다. 이웃하고 살던 부족끼리 총을 겨누게 되었습니다. 그것을 만든 것은 바다 건너에서 온 나라들이었습니다.`,
    ...
    },
    {
        ...
        paras: [
            `1757년 여름, 전쟁이 시작된 지 세 해째였습니다. 끝이 보이지 않는 전쟁이었습니다. 그 전쟁은 그 뒤로 여섯 해를 더 갔습니다. 모두 아홉 해였습니다. 지금의 뉴욕주 북쪽 숲이었습니다. 호수와 강이 많아서 배로 다니는 것이 걸어 다니는 것보다 빨랐습니다. 자작나무 껍질로 만든 배를 썼습니다. 아주 가벼워서 한 사람이 어깨에 메고 옮겼습니다.`,
            ...
            `일행은 큰길로 가지 않고 숲길로 갔습니다. 큰길은 프랑스군이 지키고 있으니 숲길로 가는 편이 안전하고 빠르다고 마과가 말했기 때문입니다. 그 말은 맞는 말이기도 했습니다. 거짓말에는 대개 참말이 섞여 있습니다. 큰길에 프랑스군이 있는 것은 사실이었습니다. 그래서 헤이워드가 그 말을 따른 것이었습니다.`,
            `그것이 첫 번째 잘못이었습니다.`,
            ...
            `어릴 때부터 숲에서 지냈고, 델라웨어 사람들에게 사냥을 배웠습니다. 칭가치국과는 스무 해 넘게 함께 다녔습니다. 말이 없어도 서로 다 알았습니다. 손짓 하나로 뜻이 통했습니다. 함께 사냥하고 함께 잤습니다. 이십 년이면 그렇게 됩니다.`,
            `그래서 두 세계를 다 알았습니다. 그런데 어느 쪽에도 온전히 속하지 못했습니다. 백인들은 그를 야인<span class="gloss">(마을 밖에서 거칠게 사는 사람)</span>이라고 했고, 부족들은 그를 백인이라고 했습니다. 어디를 가도 그랬습니다. 마을에 가면 야인이라고 하고, 숲에 있으면 백인이라고 했습니다. 그 사이에 자리가 없었습니다.`,
    ...
    },
    {
        ...
        paras: [
            `그래도 헤이워드는 나무 사이로 보이던 해가 엉뚱한 쪽에 있던 것을 떠올리고 마과를 붙잡아 보기로 했습니다. 그런데 사람들이 다가가자 마과는 눈치를 채고 그 자리에서 달아났습니다. 매의 눈이 그 뒤를 쫓았지만 놓쳤습니다. 마과는 그 숲을 아주 잘 알았습니다. 나고 자란 숲이었습니다. 나무 하나하나를 다 알고 있었습니다. 어두워도 길을 잃지 않았습니다. 쫓기는 사람은 아는 길로 갑니다. 쫓는 사람은 그 길을 모릅니다.`,
            ...
            `나쁜 일에는 대개 그 앞이 있습니다. 그 앞을 보지 않으면 같은 일이 또 일어납니다. 마과가 그렇게 되기까지 있었던 일이 그러했습니다. 남는 것이 사람 하나에 대한 미움뿐이면 안 됩니다. 그러면 아무것도 배우지 못한 것입니다. 그날 밤 일행은 강 한가운데 바위섬의 동굴에 숨었습니다. 매의 눈이 물가에 숨겨 두었던 자작나무 껍질 배를 꺼내 일행을 태워 건넸습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `나이 차가 그만큼이었습니다. 코라는 아주 강한 사람이었습니다. 동생 앨리스가 무서워서 울면 코라가 안아 주었고, 결정을 해야 할 때는 늘 코라가 했습니다. 자기도 무서웠는데 그랬습니다. 무섭지 않아서 그런 것이 아니었습니다. 동생이 보고 있었기 때문입니다.`,
            `헤이워드보다 코라가 먼저 정했습니다. 헤이워드도 그것을 알고 있었습니다. 그래서 코라를 어려워했습니다. 헤이워드는 앨리스를 마음에 두고 있었습니다. 그런데 정할 일이 생기면 코라를 보았습니다. 그런 사람은 그 시절에 흔하지 않았습니다.`,
            ...
            `웅카스가 이 숲은 다닐 데가 아니라고 한 것은 나무라는 말이 아니었습니다. 걱정해서 한 말이었습니다. 부족이 몇 사람이냐는 물음에는 아주 담담하게 대답했습니다. 자랑도 아니고 원망도 아니었습니다. 그냥 셈을 말한 것이었습니다. 코라는 그다음 말을 잇지 못했습니다.`,
            ...
            `그 두 사람에게는 자기들만의 까닭이 있었습니다. 헤이워드는 그 까닭이 무엇인지 끝내 묻지 못했습니다. 물어도 대답을 듣지 못했을 것입니다. 그런 것은 묻는다고 말해 주지 않습니다. 매의 눈도 스무 해 만에 겨우 알았습니다.`
        ]
    },
    {
        num: 5,
        ...
        paras: [
            ...
            `헤이워드도 코라도 그랬습니다. 할 말이 없었기 때문입니다. 미안하다는 말도 나오지 않았습니다. 미안하다고 하면 자기가 한 일이 됩니다. 헤이워드는 그것을 한 적이 없었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그러던 어느 날, 프랑스군이 편지를 하나 보내왔습니다. 에드워드 요새의 사령관이 쓴 편지였습니다. 먼로 대령의 부탁으로 그 요새에 다녀오던 매의 눈이 길에서 프랑스군에 붙잡혔고, 프랑스군이 그 편지를 가로챈 것이었습니다. 그리고 일부러 먼로 대령에게 보낸 것이었습니다. 읽지 않고 태울 수도 있었습니다. 그런데 편지를 봉한 자리가 이미 뜯겨 있었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `1757년 팔월, 윌리엄 헨리 요새에서 물러나던 사람들이 요새를 나선 지 얼마 되지 않아 길에서 습격을 받았습니다.`,
            ...
            `그런데 쿠퍼는 그날 일을 아주 많은 사람이 한꺼번에 목숨을 잃은 것처럼 적었습니다. 실제보다 훨씬 크게 적은 것이었습니다. 소설이니 그럴 수 있다고 할 수도 있습니다.`,
            ...
            `그래서 이 장을 넣었습니다.`,
            `그날 그 혼란 속에서 마과가 코라와 앨리스를 데려갔습니다. 그리고 북쪽으로 갔습니다. 아무도 그것을 보지 못했습니다. 다들 제 목숨을 챙기고 있었고, 헤이워드는 긴 줄의 다른 쪽에 있어서 그것을 보지 못했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그래서 여러 가지 방법을 썼습니다. 헤이워드는 얼굴에 색을 칠하고 병 고치는 사람 행세를 하며 휴런 마을에 들어갔습니다. 그 마을에 앓는 사람이 있었기 때문입니다. 헤이워드는 의술을 몰랐습니다. 아는 척을 한 것이었습니다.`,
            ...
            `그리고 웅카스는 붙잡혔습니다. 일부러 붙잡힌 것인지도 모릅니다. 그 까닭은 아무도 몰랐습니다. 다만 그 덕에 마을 한가운데로 들어가게 되었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `손이 떨렸다는 것이 그 자리에서 제일 중요한 일이었는지도 모릅니다. 그 떨림 하나로 마과도 사람이 됩니다. 괴물은 손이 떨리지 않습니다. 떨리는 것은 사람뿐입니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `먼로 대령은 그 말을 알아듣지 못했습니다. 델라웨어 말이었기 때문입니다. 헤이워드는 매의 눈에게 그 뜻을 물어서 알았지만, 그 노래를 그대로 옮기지 못했습니다. 그 시절 백인 사회에서는 그런 말을 그대로 옮기기가 어려웠기 때문입니다. 옮기면 먼로 대령이 어떻게 나올지 몰랐습니다. 헤이워드는 그것을 겁냈습니다.`,
            ...
            `헤이워드는 그 말도 그대로 옮기지 못했습니다. 옮길지 말지를 한참 망설였습니다. 옮기는 사람이 망설이면 말은 건너가지 않습니다. 그날 그 말은 건너가지 못했습니다. 먼로 대령은 자기 말이 건너간 줄 알았습니다. 그래서 마음이 조금 편해졌습니다.`,
            ...
            `그때 매의 눈이 칭가치국 곁으로 가서 그 손을 잡았습니다.<br>"아니오, 당신은 혼자가 아니오. 우리는 살빛이 다르지만 같은 길을 걷게 되었소. 나는 당신 곁에 있겠소."<br>그 자리에 있던 사람들은 칭가치국이 마지막 모히컨이라고 한 말을 그대로 믿었습니다. 그런데 그것은 사실이 아니었습니다. 다만 그 자리에서는 사실처럼 들렸습니다. 그리고 오래도록 사실로 여겨졌습니다. 그때 타메눈드가 일어섰습니다. 백 살이 넘은 그 늙은 사람 앞을 사람들이 비켰습니다.`,
            `타메눈드가 이렇게 말했습니다.<br>"나는 너무 오래 살았다. 나는 우리가 이 땅의 주인이던 때를 보았다. 그리고 오늘 우리 가운데 마지막 한 사람이 자기 아들을 묻는 것을 본다."`,
            `그러고는 자리에 앉았습니다. 더는 말하지 않았습니다. 백 살이 넘은 사람이었습니다. 그 사람도 자기가 보아 온 것을 다 말할 수 없었습니다. 그것으로 그날이 끝났습니다. 사람들이 하나씩 흩어졌습니다. 칭가치국만 그 자리에 남았습니다. 해가 다 진 뒤에도 그 자리에 있었습니다. 아무도 부르지 않았습니다.`,
            `혼자 남은 그 모습을 사람들은 오래 기억했습니다. 뒷날까지 그날 밤 이야기를 하는 사람이 있었습니다. 늙은 사람 하나가 빈 자리에 서 있던 밤이었습니다. 바람이 불고 나뭇잎이 떨어졌습니다. 그 뒤로도 숲은 그 자리에 그대로 있었습니다.`,
            `그런데 칭가치국은 마지막 사람이 아니었습니다. 그날 밤에 그렇게 보였을 뿐입니다. 모히컨 사람들은 그 뒤로도 살아남았습니다. 수가 크게 줄고 여러 번 쫓겨 다녔지만 끊기지는 않았습니다. 지금도 미국 위스콘신주에 그 후손들의 마을이 있습니다. 웅카스는 마지막이 아니었습니다.`
        ]
    }
];
/* ── 쪽 나누기 ─────────────────────────────────────────
...
const EN = {
    ...
    chapters: [
        {
            ...
            paras: [
                `This story is set against a war fought in North America about two hundred and seventy years ago. Britain and France fought over that land for seven years. It began in Europe and spread to America. In Europe that war is called the Seven Years' War. In America it is called the French and Indian War.`,
                ...
                `A wrong name lasted five hundred years. Today many people try not to use that word. Those people each had their own name. So in this book, wherever possible, they will be called by the name of their nation. Today they are often called Native Americans. That too, of course, is a name others gave them.`,
                `Mohican, Delaware, Huron. That is closer to what those people called themselves. The name of a nation usually meant simply people in that language. Even the name Delaware was given by others. What those people called themselves was Lenape. As the Europeans arrived by ship, that whole land changed within a hundred years.`,
                `What spread first was disease. Diseases like smallpox. The disease ran ahead of the people, so that it reached villages that had never seen a white person. It spread along the routes by which goods were traded. Disease travelled faster than a man could walk.`,
                ...
                `Then the land was taken. A treaty was made and the land taken, another made and taken again. What was written on paper was not kept. The side that could not read always lost. Often what was written and what was heard were different. The one who read the treaty aloud was the interpreter. Whose side he was on was the question.`,
                `And when Britain and France fought, each nation had to take one side. Taking neither meant being counted an enemy by both, and that was the most dangerous of all. So it was not a choice but a push. Side with Britain and you fought France; side with France and you fought Britain. They were caught in between.`,
                `So the people of that land came to fight one another. That is the saddest part of this story, and also the part this novel fails to draw properly. That is the background to this story. Nations that had lived as neighbours came to point guns at each other. What made it so were the countries from across the sea.`,
                `The man who wrote this book was an American called James Fenimore Cooper. He wrote it about a hundred and ninety years ago. It is a novel that was read enormously in America. Schools taught it for a long time. Cooper grew up in New York State. His father owned a great deal of land in that region.`,
                `But there is a problem with this book. Cooper drew the people of that land in only two ways. One kind as very noble, the other as very savage. And the nations that sided with the white men he drew well, and those that sided with France he drew badly. So good and bad were decided by which side one stood on. That is not a way of seeing people.`,
                `In reality it was not so. People cannot be divided in two like that, and in any group there are many kinds. Both sides had chosen a side in order to survive.`,
                `Survival was at stake. It is not a thing to be judged lightly by anyone who was not there. Stand on no side, and both sides came for you. So standing on no side was the most dangerous. And the title, too, differs from the facts.`,
                `The Mohican people did not disappear then. Their numbers fell greatly, but they survived, and their descendants live in a community in Wisconsin today. So the word last in the title is what the white people of that time wanted to believe, not a fact. What one wants to believe and what is true are different things. Say those people are all gone, and the land becomes empty. Then it becomes land one may take.`,
                `But people mostly believe what they want to believe. This book will state that plainly and then begin the story. When reading an old book, two things must be done together. One is to read the story and enjoy it.`,
                `This story really is enjoyable. To be read for a hundred and ninety years, a book must be enjoyable. A dull book does not last ten. A chase runs from beginning to end. There are forests and rivers and cliffs, and your palms sweat to the last page. There is a reason it has been read for a hundred and ninety years. The other thing is to know from what place the story was written. Do only one of the two, and you have half. An old book carries inside it what the people of that time believed. Read it without knowing that, and you inherit it whole.`,
                `Look only at the fun and you are fooled; only pick holes and it cannot be read. This book tries to do both at once.`
            ]
        },
        {
            title: 'The Party That Went into the Forest',
            paras: [
                `In the summer of 1757, the war was in its third year. A war with no end in sight. It would go on for six more years. Nine years in all. This was the forest in the north of what is now New York State. There were so many lakes and rivers that travelling by boat was faster than walking. They used canoes of birch bark. So light that one man could carry one on his shoulder.`,
                ...
                `The party was six. They rode, with almost no baggage. On a forest track there was no room to carry any. It was a track hard even for a horse to pass. Branches brushed their faces.`,
                ...
                `The party did not take the main road but a forest path. Because Magua said the main road was held by the French and this way was quicker. That was true, in its way. A lie usually has some truth mixed in. It was a fact that the French were on the main road. That was why Heyward followed his advice.`,
                ...
                `A compass was no use, and the trees hid the sun. If the guide changed his mind, that was the end. And that was what was happening. A compass may tell you the direction, but without a path you cannot go that way. You know which way, and still you cannot get there.`,
                ...
                `He had lived in the forest since childhood, and learned hunting from the Delaware people. He had travelled with Chingachgook for more than twenty years. Without words, each knew the other's mind. One gesture was enough. They hunted together and slept together. Twenty years does that.`,
                `So he knew both worlds. But he belonged wholly to neither. The whites called him a wild man, and the nations called him a white man. Wherever he went it was so. In a settlement he was a wild man, and in the forest a white man. There was no place for him in between.`,
                `So he was at ease only in the forest. Several times in this novel Hawkeye says that he is "a white man without a cross in his blood", and that too means he always had to confirm where he stood. Because unless he said it, nobody would grant it. Whenever those words came, Chingachgook said nothing. Because he knew what they meant. And he did not reproach him either.`,
                `Heyward asked the way. And he mentioned Magua. A Huron was guiding them, he said, and his name was Magua.`,
                `At that name, all three went still. Hawkeye's face changed, and he exchanged a glance with Chingachgook. Both knew that name. Nobody in that forest did not know it. Only the white army did not.`,
                `"Where is he now?"<br>"Over there, under that tree."<br>Hawkeye said, very low,<br>"That man is leading you the wrong way."`,
                `Heyward could not readily believe it. Because it came from a man he had just met. Magua had worked for the army a long time. Hawkeye was a man he had first seen that day.`
            ]
        },
        {
            title: 'Magua',
            paras: [
                `Magua fled on the spot. Hawkeye went after him but lost him. Magua knew that forest very well. It was the forest he had been born and raised in. He knew every tree. Even in the dark he did not lose his way. The hunted takes the paths he knows. The hunter does not know them.`,
                ...
                `Magua had originally been a Huron. In his youth he had been a famous hunter, they said, and sat in the front rank of his nation. But some years before, he had been driven out. The Hurons were a people who lived in what is now southern Canada. They had long traded with the French. It was because of drink, they said.`,
                `That drink, too, had not existed in that land. When the whites traded, they added drink and took furs and land in return. After drinking it, a man's reckoning clouded. A great deal of land was lost that way. At the fur trade, drink was thrown in. It had become almost the fixed way of doing things. Driven out, Magua went to the Mohawks, and then came to work for the British army. A man with no place among his own nation or among the whites. A man driven from his nation had nowhere to go back to. That was the heaviest punishment of those days.`,
                `In the meantime this had happened. Magua had once got drunk in the British camp and made a disturbance. The commander had him flogged in front of the soldiers. That commander was Colonel Munro. Cora and Alice's father. He soon forgot it. Because to him it was a common thing. In the army such punishments were given often. British soldiers were flogged the same way.`,
                ...
                `It differed from nation to nation, but mostly it was so. Making the wrongdoer pay was thought more important. Goods were given to the injured family. Being sent out of the group was a heavier punishment than being hurt in the body. Because alone, nobody could live. Hunting alone through a winter and surviving was hard. So leaving the group was a matter of life and death.`,
                `But tying a man up and beating him where many could see meant not counting him as a person. To Magua it was heavier than losing his life. There were many people there, and they all saw. Being beaten in front of them was the point. It was not a matter of the pain.`,
                ...
                `What Magua does in this story is cruel. He seizes people and kills and terrifies them. It cannot be thought well of. Only, when reading this story, to read it as if that one man alone were bad is to misread the book.`,
                `A bad deed usually has something before it. Look away from what came before, and the same thing happens again. That is why this passage has been written at length. What remains after reading this story must not be hatred for one man. Then nothing has been learned. That night the party hid in a cave on a rocky island in the middle of the river.`,
                `A cave behind a waterfall. The water was so loud that voices could not be heard. It was a good place to hide. Being midstream, it could not be reached without a boat. Above and below the water ran fast. The place was called Glens Falls. It is still there today.`,
                `But at dawn Magua brought his band. There was a fight. On the narrow rock. There was nowhere to fall back to.`,
                `Below was the waterfall. Hawkeye and the two Mohicans ran out of powder. With no powder a rifle was useless. Only knives and hatchets were left. Magua's side numbered more than ten. They were climbing onto the rock one by one. The rock was wet and slippery. So they could come up only one at a time.`,
                `That would not hold for long. Three against ten, as it were. And without powder.`,
                ...
                `Cora left only those words. She said them with her sister behind her. Alice did not understand them. The three men leapt into the river. The current was so strong that Magua's band did not dare follow into that water. So the three got out alive.`,
        ...
        },
        {
            ...
            paras: [
                ...
                `He meant to repay it on the daughter. Because he could not repay it on the father. Colonel Munro was inside the fort. Two thousand soldiers guarded him. Magua could not get inside. Years of waiting and he had never come within reach. And then the daughters had walked into the forest. Cora refused.`,
                `She did not hesitate for a moment. Though it was a way to save her sister. Cora knew that too. If she agreed, Alice would go back to their father. She reckoned that and then refused.`,
                `Cora said this:<br>"I know that what my father did to you was wrong. But to make me pay for it is wrong as well."`,
                `Magua looked at Cora a long time. Because he had never heard such an answer. Mostly people wept or begged. Nobody had ever said first that what had been done was wrong. Least of all from the white side. Magua had never met a person who admitted a wrong. He had never heard an apology. Magua heard that answer and said nothing. And he turned away.`,
                `Cora did not give way to fear there. She stood in front with her sister behind her. Alice was seventeen and Cora past twenty. When Alice was frightened she cried. Cora did not cry.`,
                `That was the difference in their ages. In this novel Cora appears as a very strong person. When her sister Alice cried in fear, Cora held her, and when a decision had to be made, it was always Cora who made it. She did it though she was afraid herself. It was not that she felt no fear. It was that her sister was watching.`,
                `Cora decided before Heyward did. Heyward knew it too. So he was a little in awe of her. Heyward had his heart set on Alice. But when something had to be decided, he looked to Cora. For Cooper to draw a character this way was rare in the novels of that time.`,
                `The women of that era's novels were mostly there to be rescued. Cora was not. She decided for herself and spoke for herself. And she paid the price herself. Cora holds the hardest place in this novel. And she is also the character recognised latest. Then a shot rang out in the forest.`,
                ...
                `"Why did you come into this forest?"<br>"We are going to our father."<br>"This forest is no place for you to travel."<br>"I know."<br>Then Cora asked this:<br>"How many are your people?"<br>Uncas answered,<br>"My father and I."`,
                `Uncas did not say it as a reproach. He said it out of concern. He said it very calmly. Neither boast nor complaint. He simply stated the count. Cora could not find her next words.`,
                `She did not know what to say. It was the first time she had heard that a nation was two people. A whole nation was two people. After that Cora saw Uncas differently. If a nation is two, then when one is gone it becomes one. Cora did that sum where she stood.`,
                ...
                `Those two had reasons of their own. What those reasons were, Heyward never managed to ask. Had he asked, he would not have been answered. Such things are not told for the asking. Even Hawkeye had learned them only after twenty years.`
            ]
        },
        {
            title: "Chingachgook's Story",
            paras: [
                `That night by the fire, Chingachgook told this story. He began without being asked. It was the first time, he said, that he had told it. For years he had told nobody. Even Uncas heard it that day for the first time.`,
                ...
                `Chingachgook looked at the fire a long time. It took him a long while to answer. It was a number that needed no counting. Two. Answering that question took the longest of all. He kept looking at the fire.`,
                `Chingachgook said this:<br>"I and my son."<br>"And my son is the last."`,
                `After those words there was only the sound of the fire. Uncas kept his head bowed. It was the first time he had heard his father say it. Nobody could say anything. Uncas knew those words were about him. The word last.`,
                `Heyward and Cora were the same. Because there was nothing to say. Not even sorry would come. Say sorry, and it becomes something you did. Heyward had never done any of it.`,
                `There is something strange in that sorrow. The thought that "those people are bound to disappear". The white people of that time thought so. As the sun sets, they said, so those people were setting. The newspapers of the time printed such words. Schools taught it too.`,
                `There are no people who are bound to disappear. That phrase leaves out who made it so. Grieve only, and it ends there, and nothing changes. After weeping, one feels better. And then one goes on living as before.`,
                `Say it that way and nobody is at fault. That is the frightening thing about the phrase. It sounds very gentle and it is very strong. Words that sound bad, everybody notices. Words that sound good last longer.`,
                `But they did not disappear. They were made to disappear. The difference is one word, and the two are very different statements. In one nobody is responsible; in the other somebody is. Say they disappeared and it happened by itself. Say they were made to disappear and there is somebody who did it.`,
                `Carrying the sickness, taking the land, breaking the treaties were all things people did. It is not like the sun setting. What people did, people can also undo. And if it cannot be undone, it can be repaid. That is why the words must be chosen with care.`,
                `That is why setting these words right matters. And as was said earlier, the Mohican people did not disappear. They are living today. That story comes in the last chapter.`,
                `Please read to the end. The last chapter of this book is that story. Leave out that chapter, and you have read only half the book.`
            ]
        },
        {
            title: 'Reaching the Fort',
            paras: [
                `At last the party reached Fort William Henry. A journey that should have taken three days had taken many. Magua had turned them aside, and then they had been taken and freed. In the meantime the fort's situation had changed. The fort was already surrounded by the French. French tents filled the ground around it, and there were several cannon. The French numbered more than eight thousand. Four times those inside.`,
                ...
                `Then one day the French sent over a letter. A letter written by the commander of Fort Edward. The French had intercepted it. And sent it on to Colonel Munro on purpose. He could have burned it unread. But the seal was already broken.`,
                `It was meant to bring about surrender. Show a man there is nothing to wait for, and he cannot hold out. Montcalm counted on that. The letter said this:<br>"There is no army to send. Do as you think best."`,
                `That was all. Colonel Munro read the letter and sat a long time. He could not even tell whether it was genuine. The French might have forged it. There were two thousand people in the fort, and not only soldiers. The soldiers' families were there too. There were children in the fort.`,
                ...
                `He was known as a man who kept the rules, and did not favour destroying a fort and killing everyone in it. So he offered those terms according to the European rules. But those rules had been made in Europe. Settled among the countries that fought each other there. The people of that land had never been asked.`,
                `Colonel Munro thought long about it. Surrender, and he lost the fort. Hold out, and he lost his people. He could not tell whether the word could be trusted. Montcalm was known to keep the rules. That one thing was all he could trust. In the wars of those days there was such a way. Instead of fighting to the end, the losing side was allowed to withdraw safely. Then both sides lost fewer men. Because they would fight again another day.`,
                ...
                `Hold out longer and all would die. Once the wall fell, there was nothing left to reckon. Colonel Munro had seen it many times. Soldiers and women and children came to nearly two thousand. Water was running out too. The sick were growing more. The next morning, in thick fog, those people left the fort. The column was very long. The fog was so thick you could not see ahead. So the front and back of the column could not see each other.`,
                `But there was something Montcalm had failed to think of. The people of the several nations who had fought alongside the French. They had never agreed to those terms. They had not even been called to the parley. The French had not counted them in. Though they had fought together. There were said to be more than fifteen hundred. From many nations.`,
                `And the French had not given those people what they had promised. They had been brought with the promise that there would be something to gain if the battle was won. And that promise was not kept.`,
                `Those people had walked for months from far away to fight. And now they were to go home with nothing. That is the background to that morning. Some had walked a month. Some had come to get provisions for the winter. That day, on that road, a terrible thing happened. The side that broke its promise came first. That was what came before.`,
                `Montcalm was blamed for that day for a long time afterward. And there are records that he himself took it heavily. Not preventing it, he said, was also a fault. Before it lay the promise not kept to those who had fought beside him. Montcalm knew that too.`
            ]
        },
        {
            title: 'That Morning',
            paras: [
                `What happened that day will not be described here in detail. Because this is a book for children. It could be written, but it will not be. The more such things are described in detail, the more they become a spectacle. And also because of the people who were there that day. Their descendants are living still.`,
                `Only this will be set down. It really happened. It is not something the novel invented. The date and the place are recorded, and a marker stands on the spot today.`,
                `In August 1757, the people withdrawing from Fort William Henry were attacked on the road not long after they left the fort.`,
                `How many lost their lives is not known exactly even now. Some records say fewer than a hundred, some say far more. The records differ greatly, and the people who were there all told it differently. In confusion, each sees only what they saw. And what was seen changes with time. The more frightening the event, the more so.`,
                `The novel wrote it far larger than it was. One may say that a novel may do that.`,
                `Later, scholars studied the actual records and counted again. That was more than a hundred years afterward, and by then it was too late. What remained in people's heads was the novel. There are times when a story outlasts the facts.`,
                `Usually the story is stronger. Because a story settles into the heart. Numbers cannot settle there like that. A hundred and several thousand leave marks of very different size on the mind. Once the larger number is lodged, it does not easily shrink.`,
                `And this still happens today. When something happens, it is not the event itself but the story told about it that stays in people's heads. One film beats a book of facts. It is still so. What you saw in a film stays longer than what you learned at school. Because faces and voices stay with it.`,
                `One must look at who wrote the story. And from what place it was written. Whether the winning side or the losing side wrote it. And when a story paints only one side as cruel, that picture lasts a hundred years. Erasing it takes longer still. It is not yet fully erased.`,
                `That is why this chapter is here.`,
                `In the confusion of that day, Magua took Cora and Alice. And he went north. Nobody saw it. Everyone was saving their own life, and Heyward was not there either.`,
                `Some days later Hawkeye and Chingachgook and Uncas and Heyward arrived at the spot. There was nobody.`,
                ...
                `"This way."`,
                `To the others' eyes there was nothing. Only grass. Only Uncas could see it. The direction in which the grass lay flattened was different. Uncas traced it for them with his fingertip.`,
        ...
        },
        {
            ...
            paras: [
                ...
                `So they used various methods. Heyward painted his face and went into the Huron village pretending to be a healer. Because there was a sick person in that village. Heyward knew nothing of medicine. He pretended to.`,
                `The people of that village let in even a stranger if there was somebody sick. That one thing was the same in every nation. A healer was received as a guest whichever side he came from. If he could heal, it did not matter that his nation was different. That was their rule.`,
                `In the saving of a life they took no sides. Before a sick person, they held, all were alike. Heyward made use of that. Later he carried the memory of it a long time. Because he had used another people's rule.`,
                `The better the rule, the easier it is to exploit. The one who trusts is the one who loses. Hawkeye went in wearing a bearskin. A man who had lived so long in the forest could copy exactly the way a bear walks. He swayed his shoulders and went on all fours. The village dogs barked and then stopped.`,
                `And Uncas was captured. Perhaps he let himself be captured on purpose. The original does not give the reason. Only, thanks to it, he comes into the very centre of the village.`,
                `Here comes the most important scene in this story. The place of judgment in the middle of the village.`,
                ...
                `Magua came before him and asked that Cora be given to him. He had come as a guest, he said, so let the law be kept. Magua had come knowing that law. He knew too that the law protected him. That was why he had walked in without fear.`,
                `So he walked into the middle of the village. The captured Uncas was brought before him too. Tamenund told Uncas to come near. Because his eyes were dim and he could not see well.`,
                `And he asked this:<br>"Who are you?"`,
                `Uncas did not answer. Instead, bound as he was, he walked forward and stood before Tamenund. And he took off his shirt.`,
                ...
                `That was the second time those words were said. The son said just what the father had said. The village fell silent. Nobody moved. The hundred-year-old man laid his hand on the young man's shoulder. The hand stayed there a very long time.`
            ]
        },
        {
            title: "Tamenund's Judgment",
            paras: [
                `Tamenund had Uncas freed. He had the rope cut by Uncas's own hand. He called for a knife and had it cut before him. The villagers stood round and watched. The villagers were watching. Uncas stood just where he was. The rope had left marks on his wrists. Uncas did not even rub them. The rope marks stood red on his wrists. Everyone pretended not to see.`,
                ...
                `Heyward could make no answer to that. Because it was true. Tamenund did not even raise his voice. Said low, the words were heavier. In those days Europeans were seizing people in that land and selling them. Every year several ships carried people from Africa to America. It was a great trade in those days.`,
                `It was that side that first counted people as goods. They even loaded them on ships in Africa and carried them across the sea. They laid them in the holds of the ships. Very many never reached the far shore alive.`,
                `And the old rules among the nations had been twisted by it too. Before that, taking a captive into the family had been common. The place of somebody lost in a fight was filled that way, so the captive became one of that household. After that, the person was one of that nation. They had children and grew old in that village.`,
                `Tamenund asked Magua,<br>"Will you take only the woman, or do you want the rest as well?"<br>"Only the woman."<br>"Then go. But until the sun sets, nobody may follow you. That too is our law."<br>"After the sun sets, I will not hold them back."`,
                `It was that village's very old law, that a guest is not harmed. Without that law nobody could enter any village. So everyone kept that law at least. Nobody would go to a village that had broken it. Harm a guest, and neither news nor goods come to that village any more. Then the village starves. Magua wanted only Cora. He cared nothing for the rest, so he left Alice and Heyward. Magua took Cora and left the village, and nobody stopped him. Heyward started forward and was held back. The Delaware people restrained him.`,
                ...
                `They had waited for the sun to set. The law was the law, and what came after was what came after. The moment the sun set, they moved. After the shadow had fully covered the valley. They had not broken the law. They had waited until the point the law set. The Delaware people went down into the valley without a sound.`,
                `That evening a fight broke out in that valley. The Huron side had more men. But the Delaware side fought on its own ground. That made a great difference. It is the last fight of this story, and it ends very quickly.`,
                `It did not take half a day. And many people lost their lives there. At the valley floor the stream went on sounding as before. The same sound when the fight began and when it ended. That stream was the water both villages had shared. That day too, the water flowed on as it always had.`
            ]
        },
        {
            title: 'On the Cliff',
            paras: [
                ...
                `Uncas went after them. Very fast. The Delaware people followed behind. Uncas was the fastest. Those behind could not catch up.`,
                ...
                `Cora stood where she was. She did not run either. She did not step back one pace from the rock's edge. The drop was many times a person's height. One step, and she would fall. Cora stood knowing it.`,
                `Magua raised his knife. But he could not bring it down. Cora was looking him straight in the face. She did not even close her eyes. For a long moment they stood so. The hand with the knife did not come down. It was a moment he had waited years for. And the hand would not move.`,
                `Those few seconds were very long. In the original this passage reads like this. Magua's hand trembled.`,
                `That one line may be the most important line in the novel. With that one line Magua becomes a person. A monster's hand does not tremble. Only a person's trembles.`,
                `Cooper had drawn Magua as a terrible man from beginning to end. Not once had he drawn him kindly. And yet at the last moment he wrote that the hand trembled.`,
                `That is the greatest pity of this novel. One line more there, and it would have been a different book. That one line Cooper did not write. One line saying why the hand trembled would have done it. But he passed on to the next line. Then one of Magua's band stepped forward from behind. And did the thing. The thing Magua could not do.`,
                `Cora died there. Magua saw it and flew at the man. He raged that another had done what he himself could not. What that rage was, nobody knows. A thing he had waited years for had ended at another's hand. He had not ended it with his own. That remained. Whether it was rage or something else, nobody knows.`,
                `Magua himself probably did not know. At that instant Uncas leapt down from the cliff above and struck Magua. The two tangled on the narrow rock. He had jumped from above to below. A height about twice a man's.`,
                `There Uncas fell by Magua's hand. It happened so fast that nobody below could do anything.`,
                `Hawkeye saw it from below the rock. And at the instant Magua tried to leap across the cliff, he fired. It was a very long shot. Hawkeye could hit at such a distance. The hand holding the rifle did not shake in the least. Hawkeye, they say, never lifted that rifle again. The rifle had a name. It was called Killdeer.`,
                `Magua fell from that place. That day, on that cliff, Cora and Uncas died. And Magua too. All three ended in the same place. The pursuer and the pursued ended together. That cliff was the end.`,
                `That cliff is still there today. In the north of New York State. People still go to find the spot. A sign stands there saying it is the place from the novel.`
            ]
        },
        {
            title: 'The Burial',
            paras: [
                `The next day the burial was held in the Delaware village. The whole village came out. Hawkeye and Heyward and Colonel Munro came too. Colonel Munro had walked through the night to get there. He had set out the moment he heard where his daughter was. A man past sixty walked all night. Nobody could stop him.`,
                `Cora and Uncas were buried side by side. In those days that was no common thing. Two people of different colour laid side by side. In a white settlement it could not have happened. The women of the village took turns singing an old song. When one sang a verse, the next took it up. The song went on until the sun was fully up. It was a very old song. Nobody knew who had made it. A song of two people who would be together in the next world, a marriage song.`,
                `Colonel Munro heard the song and asked Heyward,<br>"What are they saying?"`,
                `Colonel Munro could not understand. Because it was the Delaware tongue. Heyward could not carry the song over as it was. Because in the white society of that time such words were hard to carry over as they were. If he did, there was no telling how Colonel Munro would take it. Heyward was afraid of that.`,
                `There would have been much said about two people of different colour buried side by side. That was how it was then. Heyward carried the song over in other words. Colonel Munro did not notice. Several there knew the Delaware tongue. They knew.`,
                ...
                `It was the first time Colonel Munro had said such a thing. After burying his daughter. That day he spoke of Cora's mother for the first time. Words he had not spoken for years.`,
                `Heyward could not carry those words over either. The original says that Heyward hesitated to translate them. When the one who carries the words hesitates, the words do not cross. That day those words did not cross. Colonel Munro believed his words had crossed. So his heart was a little eased.`,
                ...
                `Those are the words that became the title of this novel. And they are also words that are not true. In that place they sounded true. And for a hundred and ninety years they were read as true. Then Tamenund rose. The people made way for that old man of more than a hundred years.`,
                ...
                `And he sat down. He said no more. He was a man past a hundred. Even he could not say all that he had seen. That is the last scene of the novel. The people drifted away one by one. Only Chingachgook remained there. Even after the sun had fully set, he stayed. Nobody called him.`,
                `This scene is very famous. It has been painted many times, and made into plays and films many times. American schools taught it for a long time. In the paintings Chingachgook always stands alone. And every time people saw it, they wept. For a hundred and ninety years.`,
                `That is how strong the scene is. A picture of a man standing alone lodges in the heart. And that picture lasts a long time. But please be sure to read the next chapter.`
            ]
        },
        {
            title: 'What Happened Afterward',
            paras: [
                `You must not close the book here. One chapter remains. The story ended in the last chapter. But something outside the story remains. And this chapter is the most important.`,
                `This novel came out a hundred and ninety years ago. In 1826. About fifty years after the United States became a country. And it was read enormously. Not only in America. In Europe too it was translated into many languages.`,
                `But there is a picture this novel made. The picture that the people who lived there first are, sadly, bound to disappear. The word sadly goes in front. With that word there, the heart is at ease. That picture remains today. In a film made a hundred years later, the picture is there too. The picture of the last man standing alone. In films, and in cartoons. For more than a hundred years it has been drawn that way. Even in things made today, the trace of it remains.`,
                `And that picture had one convenient thing about it. Say they are bound to disappear, and nobody has to take responsibility. Nobody is blamed for the setting of the sun. The sun sets by itself. And nobody can stop it. One need only grieve, and there is nothing to repay. Grieving costs nothing. Repaying costs.`,
                `At that time America was spreading steadily west. It began on the eastern coast and pushed west every year. In a hundred years it reached the opposite sea. And on that land people were already living. It was not empty land. There were villages and fields and graves. So to take that land, some explanation was needed. Even taking requires a reason. Simply take, and even the taker is uneasy. So a reason is made.`,
                `People find it hard to do a bad thing without a reason. With a reason, sleep comes. Without one, it does not. The phrase "those people are disappearing anyway" served as that explanation. Then it is not taking but inheriting. One word does that. Taking and inheriting are very different words. Change one word and it becomes so.`,
                `But the facts were these. Four years after this novel came out, in 1830, a law was made in America. It was called the Indian Removal Act. The word removal was in the name of the law.`,
                `It was a law to move the nations living in the east to the west of the Mississippi River. A law telling them to leave the places they lived, and to leave their ancestors' graves behind. The Mississippi is the great river that divides that country from north to south. West of it was land that was then barely drawn on maps. People who had read the novel supported that law. There was a vote on it in Congress. It passed by a very narrow margin. Under that law several nations walked west. Cherokee, Choctaw, Creek, Chickasaw, Seminole. Those five nations alone were more than sixty thousand people.`,
                `In the case of the Cherokee, because they walked in winter, very many died on the road. One in four, it is said. It was a road of more than sixteen hundred kilometres. Months on foot. That road is now called the Trail of Tears. It was those people who named it so. It is not a name others gave.`,
                `So those people did not disappear. They were moved. They did not go of their own accord; soldiers drove them from behind. They were made to empty their houses and come out. They came out carrying only what they could bear.`,
                `Which means there were people who moved them. There were people who made the law, and people who carried it out. The name of the man who signed the law survives too. He was the President of the United States at the time. All the names survive. Because the records survive. Who did what is all written down. It was the same with the Mohican people.`,
                `In this novel Uncas was said to be the last. In fact it was not so. In the very year this novel came out, Mohican people were living. Cooper could not have failed to know it. Those people were moved from Massachusetts to New York, from New York to Indiana, from Indiana to Wisconsin. Four moves, and each time their numbers fell. From Massachusetts to Wisconsin is more than two thousand kilometres. They were moved that far over a hundred years.`,
                `And today in Wisconsin there is a self-governing community of Mohican people. Its name is the Stockbridge-Munsee Community. It has more than fifteen hundred people. There is a town, and representatives they elect themselves.`,
                `There is a school, there is a library, and there are classes that teach their own language again. A language that was lost is being learned again. There was a time when schools forbade the use of that language. So one generation lost it. What the grandmothers remembered was written down. It was begun when only a few who knew the language were left. It was recorded. Those people know the title of this novel very well. They have lived hearing that title for many years. They even studied the novel at school.`,
                `And about that title they say this.`,
                `"We are still here."`,
                `Those people wrote that on their own website. It was an answer to the novel's title. An answer to the word last. An answer a hundred and ninety years in coming.`,
                `Uncas was not the last. Generations followed. Two hundred and fifty years have passed since the place where the novel ends. Many generations have been born in that time. If there is one thing worth keeping after reading this story, it is that sentence. That one line matters more than the picture the novel left. Because it is true.`,
                `An old story should be read for pleasure. There is no reason to read it without pleasure. This novel is enjoyable even read today. That stays as it is. Only, when you have finished, think once more. Pick holes as you read, and there is no pleasure. Do it after you finish. Only, it is well to know from which side the story was written, and what really happened afterward.`
            ]
        }
    ],
    afterword: {
        ...
        paras: [
            ...
            `The writer was James Fenimore Cooper of America. This book is one of a series of five he wrote. They follow a man called Hawkeye from his youth to his old age.`,
            `The book came out in 1826. A book two hundred years old. And it is one of the first novels to be widely read in America.`,
            `Until then Americans had mostly read English novels. Few had written American stories set in America. Cooper did that.`,
            `Cooper wrote this story in five volumes. They show Hawkeye from youth until he dies in old age. This book is one of the five, and the most widely read.`,
            ...
            `The end of the book tells you. Because the son goes first, the one who remains becomes the last. And that he is the last means there is nobody after him.`,
            ...
            `So this book has in it a man who nursed a grudge for years over a flogging. Why such a figure appears in so many stories is worth thinking about too.`,
            `Fourth, read the last chapter again. The Delaware people sing as they send Uncas on his way. And Chingachgook says nothing.`,
            `There Hawkeye takes Chingachgook's hand. And he says he will stay beside him. The book ends with a white man and a native man hand in hand.`,
            ...
            `Look again at the character of Cora. She is the bravest person in this book. She steps forward in danger, shows no fear, and judges for herself.`,
            `And this book tells us that she has her mother's blood in her. In the America of that time, that was a great matter.`,
            ...
            `And they did not all vanish, as the title says. Their descendants are living today. Only, they were driven from their land many times and moved very far away.`,
            ...
            `So the title of this book differs from the facts. Writing that they vanished and writing that they were driven out are very different things.`,
            ...
            `In the few years after that, several nations of the south-east were moved west on foot. More than ten thousand lost their lives on the road. It is called the Trail of Tears.`,
            ...
            `And there is a problem in how the book draws the native peoples too. It divides good natives from bad, and draws the good as if fated to vanish.`,
            `Draw it that way and vanishing looks like a natural thing. In fact people made it so. Many scholars have long pointed this out.`,
            ...
            `After it appeared, this book was widely read in Europe too. And it gave Europeans a picture of America. A land of forests and rivers and native peoples and hunters.`,
    ...
    quiz: [
        ...
        { q: "What does this book say about the number who died that day?", choices: ['The novel greatly inflated it, and the novel is what stayed in people’s heads', 'The novel actually wrote it smaller than it was', 'The records differ so much that the number is still unknown'], answer: 0 },
...
const AFTERWORD = {
    ...
    paras: [
        ...
        `책은 1826년에 나왔습니다. 이백 년 전 책입니다. 그리고 미국에서 크게 읽힌 첫 소설 가운데 하나입니다.`,
        `그때까지 미국 사람들은 대개 영국 소설을 읽었습니다. 미국을 배경으로 미국 이야기를 쓴 사람이 드물었습니다. 쿠퍼가 그것을 했습니다.`,
        `쿠퍼는 이 이야기를 다섯 권으로 이어 썼습니다. 매의 눈이 젊을 때부터 늙어 죽을 때까지를 그린 것입니다. 이 책은 그 가운데 한 권인데, 다섯 권 중 제일 널리 읽힙니다.`,
        ...
        `그렇게 그리면 사라지는 것이 자연스러운 일처럼 됩니다. 실제로는 사람들이 그렇게 만든 것이었습니다. 이 점을 여러 학자들이 오래 지적해 왔습니다. 저절로 사라지는 것이라고 하면 아무도 책임을 지지 않아도 됩니다. 슬퍼하는 것은 값이 들지 않지만 갚는 것은 값이 듭니다.`,
