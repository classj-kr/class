...
const CHAPTERS = [
    ...
    },
    {
        ...
        paras: [
            ...
            `그 밤에 있었던 일을 두고 사람들은 여러 가지를 말합니다. 어떤 사람은 이것이 스웨덴의 역사를 말한 것이라고 합니다. 청동상은 전쟁을 하던 시절의 왕이고, 나무상은 배를 타고 일하던 보통 사람이라는 것입니다. 그리고 아이를 지킨 것은 나무상이었습니다. 이름이 남은 쪽이 아니라 이름이 없는 쪽이었습니다. 그것이 그 밤 일의 힘이었습니다.`,
