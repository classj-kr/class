...
const CHAPTERS = [
    ...
    },
    {
        ...
        paras: [
            ...
            `다만 하멜른의 피리 부는 사나이는 값을 못 받자 아이들까지 데려갔습니다. 닐스는 아무 값도 받지 않았습니다. 같은 피리로 한 사람은 앙갚음을 했고, 한 사람은 그러지 않았습니다. 손에 든 것이 같아도 쓰는 사람이 다르면 다른 것이 됩니다. 닐스와 그 사나이가 갈린 자리가 거기였습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `닐스가 지나가는 곳은 다 실제로 있는 곳입니다. 산도 호수도 도시도 다 진짜입니다. 지금도 스웨덴에 가면 그 자리에 그대로 있습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `사람이 사는 데가 넓어지면 짐승이 살 데가 줄어듭니다. 그러면 짐승이 사람 사는 데로 내려옵니다. 그리고 그것을 짐승 탓으로 여깁니다. 그 곰도 그렇게 몰린 것이었습니다. 이것은 지금도 그대로인 일입니다. 그래서 그 일이 오래 남았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `닐스가 자기를 보고 왜 놀라지 않느냐고 묻자 노인이 이렇게 말했습니다.<br>"내가 지키는 것이 옛날 것들이라서 그렇다. 옛날 것들 사이에 있다 보면 이상한 일에 익숙해진다."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `어제까지는 그 소리가 다 말이었습니다. 이제는 그냥 소리였습니다. 닐스는 소리쳐 부르려고 했습니다. 그런데 무슨 말로 불러야 하는지 알 수 없었습니다. 입만 벌렸다가 다물었습니다. 어제까지는 부르지 않아도 알아들었습니다. 이제는 부를 말조차 없었습니다.`,
...
const AFTERWORD = {
    ...
    paras: [
        ...
        `셋째, 빙어 마을 대목을 다시 읽어 보십시오. 섬의 빈 성터에 옛 도시가 백 년에 한 번 나타난다는 이야기입니다.`,
        ...
        `라겔뢰프는 그 뒤로도 여러 권을 냈고, 1909년에 노벨 문학상을 받았습니다. 그리고 나중에는 그 상을 주는 기관의 회원도 되었습니다.`,
