...
proportions with expressive faces; France around 1905 — Paris boulevards and
gaslit apartments, a Normandy château on a rock island in a river, transatlantic
liners, early corridor-less railway carriages, newspaper kiosks; frock coats,
top hats, high collars, long skirts and enormous hats.
Elegant, light-footed, never grim. No blood or wounds shown.
...
**뤼팽의 얼굴을 편마다 다르게 그려 주세요.** 이 사람은 변장이 본업입니다.
같은 사람이라는 것을 알아보게 하는 것은 얼굴이 아니라 **자세와 손짓** — 늘 편안하고,
남들이 긴장할 때 혼자 재미있어하는 표정입니다. 8편에서는 아예 그를 그리지 마세요.

**가니마르는 늘 반 박자 늦게 그려 주세요.** 뛰어들어 오는 순간, 막 놓친 순간, 편지를 읽는 순간.

## 인물 설명 (일관성을 위해 매번 붙여 넣으세요)

```
Arsène Lupin: a slim, elegant man in his late twenties or thirties. His face
changes from story to story — he is a master of disguise — but he always
stands at ease, hands relaxed, faintly amused. Beautifully cut clothes,
often a top hat, sometimes a monocle.
Inspector Ganimard: a stocky greying policeman of fifty in a heavy overcoat
and bowler, an honest tired face; usually arriving a moment too late.
The narrator: an ordinary well-dressed Frenchman of about forty.
Herlock Sholmès: a tall, spare, sharp-faced Englishman in tweed with a pipe —
recognisably a parody, but drawn with respect, never made a fool of.
Wilson: his shorter, rounder English companion.
```
...
| 파일명 | 장면 |
|---|---|
| `images/story-02-a.webp` | A medieval château on a rock in the middle of a river, one bridge to the bank, mist on the water at dusk. |
| `images/story-02-b.webp` | A picture gallery in the morning: bare walls with clean rectangles where four paintings hung, an untouched wax seal on the door, three policemen standing in the middle of the empty room. |

## 3편 · 탈옥

| 파일명 | 장면 |
|---|---|
| `images/story-03-a.webp` | A courtroom: a gaunt, hollow-cheeked man on a stretcher being carried in, the whole court craning to see, an inspector in the witness box with his mouth open and nothing coming out. |
| `images/story-03-b.webp` | Night under a Paris bridge: a shabby figure asleep on stone, and further off a policeman in an overcoat watching him from the shadows, cold. |

## 4편 · 기차 안의 사람

| 파일명 | 장면 |
|---|---|
| `images/story-04-a.webp` | The inside of a small closed railway compartment with two men facing each other, one behind a newspaper, one gripping the seat, a folded newspaper headline between them. |
| `images/story-04-b.webp` | A station platform: police lifting a bound man out of a luggage van, and on an empty seat in the compartment behind, a single visiting card propped against the cushion. |

## 5편 · 하트 일곱

| 파일명 | 장면 |
|---|---|
| `images/story-05-a.webp` | A playing card — the seven of hearts — held up to lamplight, with seven pinholes showing as points of light through it. |
| `images/story-05-b.webp` | A study wall of patterned panelling with one section swung open, papers inside, and a hand reaching in — a note lying on top of them. |

## 6편 · 검은 진주

| 파일명 | 장면 |
|---|---|
| `images/story-06-a.webp` | A shabby genteel Paris apartment turned upside down — wardrobes open, drawers on the floor — with the door still bolted on the inside. |
| `images/story-06-b.webp` | A jeweller's counter: a plain-looking man laying a large dark pearl on the velvet, and through the shop window two policemen already in the doorway. |

## 7편 · 왕비의 목걸이

| 파일명 | 장면 |
|---|---|
| `images/story-07-a.webp` | A grand bedroom the morning after a ball: an empty jewel case on the dressing table, the window bolted from inside, and a narrow fireplace nobody is looking at. |
| `images/story-07-b.webp` | Twenty years later: an elderly woman in a drawing room holding an opened parcel with a necklace in it and a small note in her other hand, her face collapsing. |

## 8편 · 숄메스 선생, 한발 늦다

| 파일명 | 장면 |
|---|---|
| `images/story-08-a.webp` | A tall spare Englishman in tweed standing alone in the middle of a stripped château room, hands behind his back, looking at the floor; a shorter companion waiting in the doorway. |
| `images/story-08-b.webp` | A railway goods platform: a crate prised open full of ancient carved objects, and on top of them a folded sheet of paper; the Englishman reading it while police crowd round. |
