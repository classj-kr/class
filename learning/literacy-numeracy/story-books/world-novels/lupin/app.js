...
const CHAPTERS = [
    ...
    },
    {
        ...
        paras: [
            ...
            `범인은 맨 뒤의 짐 싣는 칸에 묶인 채 실려 있었습니다. 제가 탄 칸의 그 사람이 그자를 묶어서 그 칸에 밀어 넣어 두었던 것입니다. 기차가 떠나기 바로 전에 한 일이었습니다. 그 사람이 막 떠나려는 기차에 뛰어든 것은 그 일을 마치고 오느라 그랬던 것입니다. 그리고 그 사람이 앉았던 좌석 위에는 명함이 한 장 놓여 있었다고 합니다. 아르센 뤼팽이라고 적혀 있었습니다.`
        ]
    },
    {
        num: 5,
