...
품위 있는 삼십 대 후반의 남자로, 눈매가 침착하고 몸가짐이 반듯하게 그려 주세요.
**과장된 얼굴, 우스꽝스러운 표정, 옛 삽화에 흔하던 희화화된 묘사는 절대 쓰지 마세요.**
헉과 나란히 있을 때 짐이 늘 보호자의 자리에 있도록 구도를 잡아 주세요.

## 인물 설명 (일관성을 위해 매번 붙여 넣으세요)

```
Huck Finn: a wiry sunburnt boy of about thirteen, tangled fair hair, barefoot,
a man's cast-off coat far too big for him, a battered straw hat.
Jim: a Black man of about thirty-eight, strongly built, calm steady eyes, a
...
Mary Jane Wilks: a red-haired young woman of nineteen with an open kind face.
```
...
| 파일명 | 장면 |
|---|---|
| `images/cover.webp` (세로 2:3 비율) | A tall portrait-format cover: a timber raft on the vast Mississippi at night seen from slightly above and behind — a barefoot boy lying on his back looking up at a sky full of stars, and a dignified Black man seated at the steering oar keeping watch over him; the river stretching away pale under the moon, dark wooded banks on both sides. The picture must bleed to all four edges: no white margin, no white border, no frame, no matting around the artwork. |
| `images/end.webp` | An empty raft drifting at dawn against a wide river and a low sun, a straw hat left on the boards, a road leading west from the far bank. |

## 1장 · 나는 헉이라고 한다

| 파일명 | 장면 |
|---|---|
| `images/story-01-a.webp` | A prim parlour: a boy in stiff new clothes and shoes sitting bolt upright at a laid table, plainly miserable, two elderly women at the other end. |
| `images/story-01-b.webp` | A boy entering his candlelit bedroom and stopping dead: a gaunt pale-faced man in rags sitting in the chair, half in shadow. |

## 2장 · 통나무집

| 파일명 | 장면 |
|---|---|
| `images/story-02-a.webp` | A windowless log cabin deep in the woods, the door padlocked from outside, a boy's face at the gap between two logs. |
| `images/story-02-b.webp` | Night: a boy pushing a sawn log out of a cabin wall and squeezing through, a canoe waiting in the reeds beyond, moonlight on the river. |

## 3장 · 섬의 모닥불

| 파일명 | 장면 |
|---|---|
| `images/story-03-a.webp` | A ferryboat on the river firing a cannon over the water while townspeople crowd the rail; from the island bank, a boy watches from the bushes. |
| `images/story-03-b.webp` | Dawn on a wooded island: a boy stepping out of the trees toward a small fire, and a Black man rising from his blanket — both astonished, both relieved. |
...
| 파일명 | 장면 |
|---|---|
| `images/story-05-a.webp` | Night on the open river: a boy and a man lying side by side on the raft looking up at an enormous field of stars, the raft small in the middle of dark water. |
| `images/story-05-b.webp` | Morning on the raft: the man cooking catfish and corn bread over a small fire box while the boy leans in with a plate, mist on the water behind them. |

## 6장 · 안개

| 파일명 | 장면 |
|---|---|
| `images/story-06-a.webp` | A canoe stopped between two armed men in a skiff and the distant raft; the boy in the canoe talking, the men already backing their oars away. |
| `images/story-06-b.webp` | Thick river fog: the raft almost invisible, a boy standing at the sweep unable to see the bank, everything grey and soft. |

## 7장 · 두 집안

| 파일명 | 장면 |
|---|---|
| `images/story-07-a.webp` | A country church interior on a Sunday: two groups of families in separate pews, rifles standing between their knees, the preacher speaking. |
| `images/story-07-b.webp` | A riverbank at dusk: a boy climbing down out of a cottonwood tree, and further along the shore a familiar figure rising from the cane and waving to him. |

## 8장 · 왕과 공작

| 파일명 | 장면 |
|---|---|
| `images/story-08-a.webp` | A raft with four aboard: two shabby strangers sprawled comfortably as if they own it, a boy and a man exchanging a look behind them. |
| `images/story-08-b.webp` | A rough village hall by lamplight: an old man in a ridiculous costume declaiming on a plank stage, a crowd of farmers watching with rapt faces. |
...
| 파일명 | 장면 |
|---|---|
| `images/story-10-a.webp` | An empty raft at a wooded landing, the sweep untended, no one aboard; a boy standing on the bank staring at it. |
| `images/story-10-b.webp` | Close: a boy alone on the raft holding a torn sheet of paper in both hands, the pieces just coming apart, his face set — the single most important moment of the book. |

## 11장 · 펠프스 농장

| 파일명 | 장면 |
|---|---|
| `images/story-11-a.webp` | A small cotton farm in the heat: a plain house, a yard full of hounds, a woman rushing off the porch to embrace a startled boy. |
| `images/story-11-b.webp` | Night: a boy at the boarded window of an outbuilding, and inside, in the dark, a man's face turning toward him and a hand going up in warning. |

## 12장 · 톰의 방법

| 파일명 | 장면 |
|---|---|
| `images/story-12-a.webp` | Two boys digging a pointless tunnel toward a shed with a shovel and a knife, a rope ladder made of torn sheets on the ground beside them. |
| `images/story-12-b.webp` | Night escape: three figures running for a fence while lanterns and dogs pour out of the farmhouse behind them. |
...
| 파일명 | 장면 |
|---|---|
| `images/story-14-a.webp` | A sickroom: a boy sitting bolt upright in bed announcing something, everyone in the room turned toward him in shock. |
| `images/story-14-b.webp` | Two figures sitting together on a porch step in the evening, the man speaking quietly, the boy listening with his head down. |

## 15장 · 서쪽으로

| 파일명 | 장면 |
|---|---|
| `images/story-15-a.webp` | A river landing at morning: a man with a small bundle stepping onto a steamboat headed upriver, turning to raise a hand to a boy on the bank. |
| `images/story-15-b.webp` | A boy walking away from the viewer along a dirt road heading west into open country at sunset, hat in hand, no house in sight. |
