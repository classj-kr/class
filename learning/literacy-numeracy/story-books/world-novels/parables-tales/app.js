...
const CHAPTERS = [
    ...
    },
    {
        ...
        paras: [
            ...
            `큰아들이 볼멘소리를 했어요.<br>"저는 여러 해 동안 아버지 곁에서 일했는데, 저에게는 잔치 한 번 열어 주신 적이 없잖아요."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"괜히 잘못 굴렸다가 다 잃으면 어떡하지? 잃어버리면 주인님께 뭐라고 말씀드리나."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"몸 쓰는 일은 자신 없고, 구걸하기는 부끄럽고. 어떻게 해야 앞날을 대비할 수 있을까?"`,
            `밤이 깊도록 방 안을 서성였어요.`,
            `그러다 청지기의 눈이 반짝했지요.`,
            `좋은 꾀가 떠오른 거예요.`,
